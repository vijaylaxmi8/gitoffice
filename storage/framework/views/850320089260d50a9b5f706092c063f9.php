                        ...
                        <div class="main-content">
                            ...
                            <div class="col-span-12 xl:col-span-6">
                                ...
                                <div class="box-body">
                                    ...
                                    <img src="<?php echo e(asset('build/assets/img/users/3.jpg')); ?>" class="avatar w-6 h-6 ltr:mr-2 rtl:ml-2 rounded-sm ring-0" alt="user-img">
                                    <span class="font-bold">Primary</span> alert! You should check in on some of those fields below.
                                    </div>
                                    <div class="bg-secondary border border-secondary text-white alert rounded-sm" role="alert">
                                    <img src="<?php echo e(asset('build/assets/img/users/1.jpg')); ?>" class="avatar w-6 h-6 ltr:mr-2 rtl:ml-2 rounded-sm ring-0" alt="user-img">
                                    <span class="font-bold">Secondary</span> alert! You should check in on some of those fields below.
                                    </div>
                                    <div class="bg-danger border border-danger text-white alert rounded-sm" role="alert">
                                    <img src="<?php echo e(asset('build/assets/img/users/4.jpg')); ?>" class="avatar w-6 h-6 ltr:mr-2 rtl:ml-2 rounded-sm ring-0" alt="user-img">
                                    <span class="font-bold">Danger</span> alert! You should check in on some of those fields below.
                                    </div>
                                    <div class="bg-warning border border-warning text-white alert rounded-sm" role="alert">
                                    <img src="<?php echo e(asset('build/assets/img/users/6.jpg')); ?>" class="avatar w-6 h-6 ltr:mr-2 rtl:ml-2 rounded-sm ring-0" alt="user-img">
                                    <span class="font-bold">Warning</span> alert! You should check in on some of those fields below.
                                    </div>
                                    <div class="bg-info  border border-info text-white alert rounded-sm" role="alert">
                                    <img src="<?php echo e(asset('build/assets/img/users/16.jpg')); ?>" class="avatar w-6 h-6 ltr:mr-2 rtl:ml-2 rounded-sm ring-0" alt="user-img">
                                    <span class="font-bold">Info</span> alert! You should check in on some of those fields below.
                                    </div>
                                    <div class="bg-success  border border-success text-white alert rounded-sm" role="alert">
                                    <img src="<?php echo e(asset('build/assets/img/users/14.jpg')); ?>" class="avatar w-6 h-6 ltr:mr-2 rtl:ml-2 rounded-sm ring-0" alt="user-img">
                                    <span class="font-bold">Success</span> alert! You should check in on some of those fields below.
                                    </div>
                                    <div class="bg-gray-100 border border-gray-200 text-gray-600 alert rounded-sm" role="alert">
                                    <img src="<?php echo e(asset('build/assets/img/users/12.jpg')); ?>" class="avatar w-6 h-6 ltr:mr-2 rtl:ml-2 rounded-sm ring-0" alt="user-img">
                                    <span class="font-bold">Light</span> alert! You should check in on some of those fields below.
                                    </div>
                                    <div
                                    class="bg-black/20 border border-white/10 text-white alert dark:bg-gray-900 dark:text-white rounded-sm"
                                    role="alert">
                                    <img src="<?php echo e(asset('build/assets/img/users/5.jpg')); ?>" class="avatar w-6 h-6 ltr:mr-2 rtl:ml-2 rounded-sm ring-0" alt="user-img">
                                    <span class="font-bold">Dark</span> alert! You should check in on some of those fields below.
                                    </div>
                                </div>
                                </div>
                            ...
                            <div class="col-span-12 xl:col-span-6">
                                ...
                                <div class="box-body">
                                    <div class="bg-primary border border-primary text-white alert rounded-full px-6" role="alert">
                                    <img src="<?php echo e(asset('build/assets/img/users/3.jpg')); ?>" class="avatar w-6 h-6 ltr:mr-2 rtl:ml-2 rounded-full ring-0" alt="user-img">
                                    <span class="font-bold">Primary</span> alert! You should check in on some of those fields below.
                                    </div>
                                    <div class="bg-secondary border border-secondary text-white alert rounded-full px-6" role="alert">
                                    <img src="<?php echo e(asset('build/assets/img/users/1.jpg')); ?>" class="avatar w-6 h-6 ltr:mr-2 rtl:ml-2 rounded-full ring-0" alt="user-img">
                                    <span class="font-bold">Secondary</span> alert! You should check in on some of those fields below.
                                    </div>
                                    <div class="bg-danger border border-danger text-white alert rounded-full px-6" role="alert">
                                    <img src="<?php echo e(asset('build/assets/img/users/4.jpg')); ?>" class="avatar w-6 h-6 ltr:mr-2 rtl:ml-2 rounded-full ring-0" alt="user-img">
                                    <span class="font-bold">Danger</span> alert! You should check in on some of those fields below.
                                    </div>
                                    <div class="bg-warning border border-warning text-white alert rounded-full px-6" role="alert">
                                    <img src="<?php echo e(asset('build/assets/img/users/6.jpg')); ?>" class="avatar w-6 h-6 ltr:mr-2 rtl:ml-2 rounded-full ring-0" alt="user-img">
                                    <span class="font-bold">Warning</span> alert! You should check in on some of those fields below.
                                    </div>
                                    <div class="bg-info  border border-info text-white alert rounded-full px-6" role="alert">
                                    <img src="<?php echo e(asset('build/assets/img/users/16.jpg')); ?>" class="avatar w-6 h-6 ltr:mr-2 rtl:ml-2 rounded-full ring-0" alt="user-img">
                                    <span class="font-bold">Info</span> alert! You should check in on some of those fields below.
                                    </div>
                                    <div class="bg-success  border border-success text-white alert rounded-full px-6" role="alert">
                                    <img src="<?php echo e(asset('build/assets/img/users/14.jpg')); ?>" class="avatar w-6 h-6 ltr:mr-2 rtl:ml-2 rounded-full ring-0" alt="user-img">
                                    <span class="font-bold">Success</span> alert! You should check in on some of those fields below.
                                    </div>
                                    <div class="bg-gray-100 border border-gray-200 text-gray-600 alert rounded-full px-6" role="alert">
                                    <img src="<?php echo e(asset('build/assets/img/users/12.jpg')); ?>" class="avatar w-6 h-6 ltr:mr-2 rtl:ml-2 rounded-full ring-0" alt="user-img">
                                    <span class="font-bold">Light</span> alert! You should check in on some of those fields below.
                                    </div>
                                    <div
                                    class="bg-black/20 border border-white/10 text-white alert dark:bg-gray-900 dark:text-white rounded-full px-6"
                                    role="alert">
                                    <img src="<?php echo e(asset('build/assets/img/users/5.jpg')); ?>" class="avatar w-6 h-6 ltr:mr-2 rtl:ml-2 rounded-full ring-0" alt="user-img">
                                    <span class="font-bold">Dark</span> alert! You should check in on some of those fields below.
                                    </div>
                                </div>
                                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\projects\my-projects\laravel\vite\synto\synto-laravel\synto\resources\views/pages/alerts.blade.php ENDPATH**/ ?>