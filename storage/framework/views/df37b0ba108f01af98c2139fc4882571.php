                                                ...
                                                <div id="hs-medium-modal" class="hs-overlay hidden ti-modal">
                                                    <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out md:!max-w-2xl md:w-full m-3 md:mx-auto">
                                                        ...
                                                        <div class="ti-modal-header">
                                                            ...
                                                            <?php if(($errors->has('dept_name'))||($errors->has('dept_shortname'))||($errors->has('yoe'))): ?>
                                                                <script>
                                                                    // alert(1);
                                                            ...
                                                            <div class="ti-modal-body">
                                                                ...
                                                                <div class="max-w-sm space-y-3 pb-6">
                                                                    ...
                                                                    <?php if($errors->has('dept_name')): ?>
                                                                        <div class="text-red-700"><?php echo e($errors->first('dept_name')); ?></div>
                                                                    <?php endif; ?>
                                                                ...
                                                                <div class="max-w-sm space-y-3 pb-6">
                                                                    ...
                                                                    <?php if($errors->has('dept_shortname')): ?>
                                                                        <div class="text-red-700"><?php echo e($errors->first('dept_shortname')); ?></div>
                                                                    <?php endif; ?>
                                                                ...
                                                                <div class="flex shadow-sm max-w-sm space-y-3 pb-6">
                                                                    ...
                                                                    <?php if($errors->has('yoe')): ?>
                                                                        <div class="text-red-700"><?php echo e($errors->first('yoe')); ?></div>
                                                                    <?php endif; ?>
                                                                </div>
                                    ...
                                    <div class="box-body">
                                        ...
                                        <table id="department_table" class="ti-custom-table ti-custom-table-head whitespace-nowrap">
                                            ...
                                            <tr class="">
                                                ...
                                                <th scope="col" class="dark:text-white/80"><?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('dept_name','Department Name'));?></th>
                                                <th scope="col" class="dark:text-white/80"><?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('dept_shortname','Department ShortName'));?></th>
                                                <th scope="col" class="dark:text-white/80"><?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('yoe','Year of Establishment'));?></th>
                                            ...
                                            <tr class="">
                                                ...
                                                <div class="hs-tooltip ti-main-tooltip">
                                                    <button data-hs-overlay="#dept_edit_modal<?php echo e($i); ?>" id="btn<?php echo e($i); ?>" btn-val=<?php echo e($i); ?>
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16"><path d="M16.7574 2.99666L14.7574 4.99666H5V18.9967H19V9.2393L21 7.2393V19.9967C21 20.5489 20.5523 20.9967 20 20.9967H4C3.44772 20.9967 3 20.5489 3 19.9967V3.99666C3 3.44438 3.44772 2.99666 4 2.99666H16.7574ZM20.4853 2.09717L21.8995 3.51138L12.7071 12.7038L11.2954 12.7062L11.2929 11.2896L20.4853 2.09717Z"></path></svg>
                                                        ...
                                                        <div id="dept_edit_modal<?php echo e($i); ?>" class="hs-overlay hidden ti-modal">
                                                            <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out md:!max-w-2xl md:w-full m-3 md:mx-auto">
                                                                <div class="ti-modal-content">
                                                                <div class="ti-modal-header">
                                                                    <h3 class="ti-modal-title">
                                                                    ...
                                                                    <?php if(($errors->has('edit_dept_name'))||($errors->has('edit_dept_shortname'))||($errors->has('edit_yoe'))||($errors->has('status'))): ?>
                                                                        <script>
                                                                            //alert(387);
                                                                    ...
                                                                    <form  action="<?php echo e(route('ESTB.departments.update',$dept->id)); ?>" method="post">
                                                                        <?php echo csrf_field(); ?>
                                                                        ...
                                                                        <div class="ti-modal-body">
                                                                            ...
                                                                            <div class="max-w-sm space-y-3 pb-6">
                                                                                <label for="with-corner-hint" class="ti-form-label">Department Name : </label>
                                                                                <input type="text" name="edit_dept_name" class="ti-form-input" required placeholder="Department name" value="<?php echo e($dept->dept_name); ?>">
                                                                                <?php if($errors->has('edit_dept_name')): ?>
                                                                                    <div class="text-red-700"><?php echo e($errors->first('edit_dept_name')); ?></div>
                                                                                <?php endif; ?>
                                                                                <div id="departmentNameError" class="error text-red-700"></div>
                                                                            </div>
                                                                            <div class="max-w-sm space-y-3 pb-6">
                                                                                <label for="" class="ti-form-label">Department Short Name : </label>
                                                                                <input type="text" name="edit_dept_shortname" class="ti-form-input" required placeholder="Department short name" value="<?php echo e($dept->dept_shortname); ?>">
                                                                                <?php if($errors->has('edit_dept_shortname')): ?>
                                                                                    <div class="text-red-700"><?php echo e($errors->first('edit_dept_shortname')); ?></div>
                                                                                <?php endif; ?>
                                                                                <div id="deptshortNameError" class="error text-red-700"></div>
                                                                            </div>
                                                                            <label for="" class="ti-form-label">Year of Establishment :</label>
                                                                            <div class="flex shadow-sm max-w-sm space-y-3 pb-6">
                                                                                ...
                                                                                <input type="date" name="edit_yoe"
                                                                                    class="ti-form-input rounded-l-none focus:z-10 flatpickr-input date"
                                                                                    required placeholder="Choose date"  value="<?php echo e($dept->yoe); ?>">
                                                                                    <div id="deptyoeError" class="error text-red-700"></div>
                                                                            </div>
                                                                            <?php if($dept->status == 'inactive'): ?>
                                                                            <br/>
                                                                                <div class="flex">
