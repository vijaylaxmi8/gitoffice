                        ...
                        <div class="main-content">
                            ...
                            <div class="col-span-12 md:col-span-6 xxl:col-span-3">
                                ...
                                <div class="box-body relative">
                                    ...
                                    <div class="flex-1 font-semibold">
                                        <h4 class="text-2xl text-gray-800 dark:text-white font-semibold">$98,450</h4>
                            ...
                            <div class="col-span-12 md:col-span-6 xxl:col-span-3">
                                ...
                                <div class="box-body relative">
                                    ...
                                    <div class="flex-1 font-semibold">
                                        <h4 class="text-2xl text-gray-800 dark:text-white font-semibold">15,379</h4>
                                        <div class="flex justify-between items-center">
                            ...
                            <div class="col-span-12 md:col-span-6 xxl:col-span-3">
                                ...
                                <div class="box-body relative">
                                    ...
                                    <div class="flex-1 font-semibold">
                                        <h4 class="text-2xl text-gray-800 dark:text-white font-semibold">377</h4>
                                        <div class="flex justify-between items-center">
                            ...
                            <div class="col-span-12 md:col-span-6 xxl:col-span-3">
                                ...
                                <div class="box-body relative">
                                    ...
                                    <div class="flex-1 font-semibold">
                                        <h4 class="text-2xl text-gray-800 dark:text-white font-semibold">11,016</h4>
                                        <div class="flex justify-between items-center">
                                    ...
                                    <table class="ti-custom-table ti-custom-table-head">
                                        ...
                                        <tr>
                                            ...
                                            <div class="flex items-center min-w-[200px]">
                                                ...
                                                <img src="<?php echo e(asset('build/assets/img/users/11.jpg')); ?>" alt=""
                                        ...
                                        <tr>
                                            ...
                                            <div class="flex items-center min-w-[200px]">
                                                <div class="ltr:mr-2 rtl:ml-2 leading-none">
                                                <img src="<?php echo e(asset('build/assets/img/users/3.jpg')); ?>" alt=""
                                                    class="avatar avatar-xs rounded-full bg-gray-100 dark:bg-black/20">
                                                </div>
                                                <div class="items-center">
                                        ...
                                        <tr>
                                            ...
                                            <div class="flex items-center min-w-[200px]">
                                                <div class="ltr:mr-2 rtl:ml-2 leading-none">
                                                <img src="<?php echo e(asset('build/assets/img/users/13.jpg')); ?>" alt=""
                                                    class="avatar avatar-xs rounded-full bg-gray-100 dark:bg-black/20">
                                                </div>
                                                <div class="items-center">
                                        ...
                                        <tr>
                                            ...
                                            <div class="flex items-center min-w-[200px]">
                                                <div class="ltr:mr-2 rtl:ml-2 leading-none">
                                                <img src="<?php echo e(asset('build/assets/img/users/2.jpg')); ?>" alt=""
                                                    class="avatar avatar-xs rounded-full bg-gray-100 dark:bg-black/20">
                                                </div>
                                                <div class="items-center">
                                ...
                                <div class="box-body">
                                    ...
                                    <li class="p-0 mb-6 ti-list-group border-0 text-gray-800 dark:text-white">
                                        ...
                                        <div class="flex items-center">
                                            ...
                                            <img class="avatar avatar-sm rounded-full" src="<?php echo e(asset('build/assets/img/users/2.jpg')); ?>" alt="image">
                                            </div>
                                    ...
                                    <li class="p-0 mb-6 ti-list-group border-0 text-gray-800 dark:text-white">
                                        ...
                                        <div class="flex items-center">
                                            <div class="leading-none">
                                            <img class="avatar avatar-sm rounded-full" src="<?php echo e(asset('build/assets/img/users/12.jpg')); ?>" alt="image">
                                            </div>
                                            <div class="flex-auto ltr:ml-2 rtl:mr-2">
                                    ...
                                    <li class="p-0 mb-6 ti-list-group border-0 text-gray-800 dark:text-white">
                                        ...
                                        <div class="flex items-center">
                                            <div class="leading-none">
                                            <img class="avatar avatar-sm rounded-full" src="<?php echo e(asset('build/assets/img/users/13.jpg')); ?>" alt="image">
                                            </div>
                                            <div class="flex-auto ltr:ml-2 rtl:mr-2">
                                    ...
                                    <li class="p-0 mb-6 ti-list-group border-0 text-gray-800 dark:text-white">
                                        ...
                                        <div class="flex items-center">
                                            <div class="leading-none">
                                            <img class="avatar avatar-sm rounded-full" src="<?php echo e(asset('build/assets/img/users/3.jpg')); ?>" alt="image">
                                            </div>
                                            <div class="flex-auto ltr:ml-2 rtl:mr-2">
                                    ...
                                    <li class="p-0 mb-6 ti-list-group border-0 text-gray-800 dark:text-white">
                                        ...
                                        <div class="flex items-center">
                                            <div class="leading-none">
                                            <img class="avatar avatar-sm rounded-full" src="<?php echo e(asset('build/assets/img/users/4.jpg')); ?>" alt="image">
                                            </div>
                                            <div class="flex-auto ltr:ml-2 rtl:mr-2">
                                    ...
                                    <li class="p-0 mb-6 ti-list-group border-0 text-gray-800 dark:text-white">
                                        ...
                                        <div class="flex items-center">
                                            <div class="leading-none">
                                            <img class="avatar avatar-sm rounded-full" src="<?php echo e(asset('build/assets/img/users/14.jpg')); ?>" alt="image">
                                            </div>
                                            <div class="flex-auto ltr:ml-2 rtl:mr-2">
                                    ...
                                    <li class="p-0 mb-6 ti-list-group border-0 text-gray-800 dark:text-white">
                                        ...
                                        <div class="flex items-center">
                                            <div class="leading-none">
                                            <img class="avatar avatar-sm rounded-full" src="<?php echo e(asset('build/assets/img/users/5.jpg')); ?>" alt="image">
                                            </div>
                                            <div class="flex-auto ltr:ml-2 rtl:mr-2">
                                    ...
                                    <li class="p-0 mb-0 ti-list-group border-0 text-gray-800 dark:text-white">
                                        ...
                                        <div class="flex items-center">
                                            <div class="leading-none">
                                            <img class="avatar avatar-sm rounded-full" src="<?php echo e(asset('build/assets/img/users/15.jpg')); ?>" alt="image">
                                            </div>
                                            <div class="flex-auto ltr:ml-2 rtl:mr-2">
                                ...
                                <div class="box-body">
                                    ...
                                    <li class="mb-6 !rounded-sm ti-list-group text-gray-800 dark:text-white w-full">
                                        ...
                                        <a href="javascript:void(0);" class="ltr:pr-4 rtl:pl-4 inline-block">
                                            <img src="<?php echo e(asset('build/assets/img/media/1.jpg')); ?>" alt="img" class="avatar w-28 h-28 rounded-sm">
                                        </a>
                                        <div class="mt-4 sm:mt-0 flex-1 font-semibold">
                                            ...
                                            <div class="flex items-center" title="Instructor">
                                                ...
                                                <img src="<?php echo e(asset('build/assets/img/users/3.jpg')); ?>" alt="img" class="avatar avatar-xs rounded-full">
                                                </a>
                                    ...
                                    <li class="mb-6 !rounded-sm ti-list-group text-gray-800 dark:text-white w-full">
                                        <div class="sm:flex items-center w-full">
                                        <a href="javascript:void(0);" class="ltr:pr-4 rtl:pl-4 inline-block">
                                            <img src="<?php echo e(asset('build/assets/img/media/4.jpg')); ?>" alt="img" class="avatar w-28 h-28 rounded-sm">
                                        </a>
                                        <div class="mt-4 sm:mt-0 flex-1 font-semibold">
                                            <a href="javascript:void(0);"
                                            class="text-gray-500 dark:text-white/70 block mb-1 font-medium text-xs" title="Category"><i
                                            ...
                                            <div class="flex items-center" title="Instructor">
                                                <a href="javascript:void(0);" class="ltr:pr-2 rtl:pl-2">
                                                <img src="<?php echo e(asset('build/assets/img/users/4.jpg')); ?>" alt="img" class="avatar avatar-xs rounded-full">
                                                </a>
                                    ...
                                    <li class="mb-0 !rounded-sm ti-list-group text-gray-800 dark:text-white w-full">
                                        <div class="sm:flex items-center w-full">
                                        <a href="javascript:void(0);" class="ltr:pr-4 rtl:pl-4 inline-block">
                                            <img src="<?php echo e(asset('build/assets/img/media/23.jpg')); ?>" alt="img" class="avatar w-28 h-28 rounded-sm">
                                        </a>
                                        <div class="mt-4 sm:mt-0 flex-1 font-semibold">
                                            <a href="javascript:void(0);"
                                            class="text-gray-500 dark:text-white/70 block mb-1 font-medium text-xs" title="Category"><i
                                            ...
                                            <div class="flex items-center" title="Instructor">
                                                <a href="javascript:void(0);" class="ltr:pr-2 rtl:pl-2">
                                                <img src="<?php echo e(asset('build/assets/img/users/12.jpg')); ?>" alt="img" class="avatar avatar-xs rounded-full">
                                                </a>
                                    ...
                                    <table class="ti-custom-table ti-custom-table-head whitespace-nowrap">
                                        ...
                                        <tr class="">
                                            ...
                                            <div class="flex space-x-3 rtl:space-x-reverse text-start">
                                                <img class="avatar avatar-sm rounded-sm" src="<?php echo e(asset('build/assets/img/media/1.jpg')); ?>" alt="Image Description">
                                        ...
                                        <tr class="">
                                            ...
                                            <td>
                                            <div class="flex space-x-3 rtl:space-x-reverse text-start">
                                                <img class="avatar avatar-sm rounded-sm" src="<?php echo e(asset('build/assets/img/media/4.jpg')); ?>" alt="Image Description">
                                                <div class="block my-auto">
                                        ...
                                        <tr class="">
                                            ...
                                            <td>
                                            <div class="flex space-x-3 rtl:space-x-reverse text-start">
                                                <img class="avatar avatar-sm rounded-sm" src="<?php echo e(asset('build/assets/img/media/10.jpg')); ?>" alt="Image Description">
                                                <div class="block my-auto">
                                        ...
                                        <tr class="">
                                            ...
                                            <td>
                                            <div class="flex space-x-3 rtl:space-x-reverse text-start">
                                                <img class="avatar avatar-sm rounded-sm" src="<?php echo e(asset('build/assets/img/media/15.jpg')); ?>" alt="Image Description">
                                                <div class="block my-auto">
                                        ...
                                        <tr class="">
                                            ...
                                            <td>
                                            <div class="flex space-x-3 rtl:space-x-reverse text-start">
                                                <img class="avatar avatar-sm rounded-sm" src="<?php echo e(asset('build/assets/img/media/23.jpg')); ?>" alt="Image Description">
                                                <div class="block my-auto">
...
<?php $__env->startSection('scripts'); ?>
        ...
        <!-- INDEX JS -->
        <?php echo app('Illuminate\Foundation\Vite')('resources/assets/js/index-12.js'); ?>
        

<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\projects\laravel\vite\synto\synto\resources\views/pages/index12.blade.php ENDPATH**/ ?>