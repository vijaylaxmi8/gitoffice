                    ...
                    <div class="main-content landing-main !p-0">
                        ...
                        <div class="landing-wrapper" id="home">
                            <div class="container lg:pt-40 lg:pb-24 pt-28 pb-12 relative z-10 mx-auto">
                                <div class="grid grid-cols-12 lg:gap-0 gap-6">
                                    ...
                                    <img alt="landing-banner" src="<?php echo e(asset('build/assets/img/landing/banner.png')); ?>" class="ltr:ml-auto rtl:mr-auto">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="section container mx-auto">
                                <div class="grid lg:grid-cols-2 gap-6">
                                    ...
                                    <div class="relative h-96 overflow-clip py-10 sm:h-[32rem] lg:p-20">
                                        <img src="<?php echo e(asset('build/assets/img/landing/3.png')); ?>"
                                    ...
                                    <a href="<?php echo e(url('about')); ?>" class="py-2 px-3 ti-btn m-0 ti-btn-primary mt-6">
                        ...
                        <div class="" id="our-mission">
                            <div class="section container mx-auto">
                                <div class="grid lg:grid-cols-2 gap-6">
                                    ...
                                    <a href="<?php echo e(url('about')); ?>p" class="py-2 px-3 ti-btn m-0 ti-btn-primary mt-6">
                                        Read More <i class="ri-arrow-right-line rtl:rotate-180"></i>
                                    </a>
                                    </div>
                                    <div class="relative bg-gradient-radial from-white to-gray-100 dark:from-bgdark dark:to-black/20">
                                    <div class="relative h-96 overflow-clip py-10 sm:h-[32rem] lg:p-20">
                                        <img src="<?php echo e(asset('build/assets/img/landing/4.png')); ?>"
                        ...
                        <div
                            ...
                            <div class="container mx-auto z-[0] text-center">
                                <h2 class="section-title text-center text-3xl font-bold text-white md:text-4xl lg:text-5xl justify-center">We
                                ...
                                <a href="<?php echo e(url('contactus')); ?>" class="ti-btn m-0 py-3 px-6 ti-btn-danger">Contact Us</a>
                            </div>
                        </div>
                        <!-- End::Banner Content -->
                        ...
                        <div id="statistics"
                            ...
                            <div class="container  mx-auto z-[0]">
                                <div class="text-center max-w-[80rem] mx-auto mb-12">
                                    <h2 class="section-title text-center text-3xl font-bold text-white md:text-4xl lg:text-5xl justify-center">
                            ...
                            <div class="section container mx-auto">
                                ...
                                <div class="swiper-slide !text-start !bg-transparent dark:!bg-transparent">
                                    ...
                                    <div class="box-footer">
                                        ...
                                        <a class="flex my-auto">
                                            <img alt="testimonial" src="<?php echo e(asset('build/assets/img/users/12.jpg')); ?>" class="avatar avatar-sm !rounded-full">
                                ...
                                <div class="swiper-slide !text-start !bg-transparent dark:!bg-transparent">
                                    ...
                                    <div class="box-footer">
                                        <div class="flex justify-between">
                                        <a class="flex my-auto">
                                            <img alt="testimonial" src="<?php echo e(asset('build/assets/img/users/2.jpg')); ?>" class="avatar avatar-sm !rounded-full">
                                            <div class="ltr:pl-4 rtl:pr-4 my-auto">
                                ...
                                <div class="swiper-slide !text-start !bg-transparent dark:!bg-transparent">
                                    ...
                                    <div class="box-footer">
                                        <div class="flex justify-between">
                                        <a class="flex my-auto">
                                            <img alt="testimonial" src="<?php echo e(asset('build/assets/img/users/3.jpg')); ?>" class="avatar avatar-sm !rounded-full">
                                            <div class="ltr:pl-4 rtl:pr-4 my-auto">
                                ...
                                <div class="swiper-slide !text-start !bg-transparent dark:!bg-transparent">
                                    ...
                                    <div class="box-footer">
                                        <div class="flex justify-between">
                                        <a class="flex my-auto">
                                            <img alt="testimonial" src="<?php echo e(asset('build/assets/img/users/13.jpg')); ?>" class="avatar avatar-sm !rounded-full">
                                            <div class="ltr:pl-4 rtl:pr-4 my-auto">
                                ...
                                <div class="swiper-slide !text-start !bg-transparent dark:!bg-transparent">
                                    ...
                                    <div class="box-footer">
                                        <div class="flex justify-between">
                                        <a class="flex my-auto">
                                            <img alt="testimonial" src="<?php echo e(asset('build/assets/img/users/4.jpg')); ?>" class="avatar avatar-sm !rounded-full">
                                            <div class="ltr:pl-4 rtl:pr-4 my-auto">
                                ...
                                <div class="swiper-slide !text-start !bg-transparent dark:!bg-transparent">
                                    ...
                                    <div class="box-footer">
                                        <div class="flex justify-between">
                                        <a class="flex my-auto">
                                            <img alt="testimonial" src="<?php echo e(asset('build/assets/img/users/14.jpg')); ?>" class="avatar avatar-sm !rounded-full">
                                            <div class="ltr:pl-4 rtl:pr-4 my-auto">
                            ...
                            <div class="section container mx-auto">
                                ...
                                <div class="grid sm:grid-cols-5 lg:!grid-cols-9 gap-6">
                                    ...
                                    <a href="<?php echo e(url('team')); ?>">
                                        <img src="<?php echo e(asset('build/assets/img/users/1.jpg')); ?>" alt="team" class="avatar rounded-full">
                                        <div class="">
                                    ...
                                    <div class="space-y-2 text-center">
                                    <a href="<?php echo e(url('team')); ?>">
                                        <img src="<?php echo e(asset('build/assets/img/users/10.jpg')); ?>" alt="team" class="avatar rounded-full">
                                        <div class="">
                                    ...
                                    <div class="space-y-2 text-center">
                                    <a href="<?php echo e(url('team')); ?>">
                                        <img src="<?php echo e(asset('build/assets/img/users/2.jpg')); ?>" alt="team" class="avatar rounded-full">
                                        <div class="">
                                    ...
                                    <div class="space-y-2 text-center">
                                    <a href="<?php echo e(url('team')); ?>">
                                        <img src="<?php echo e(asset('build/assets/img/users/12.jpg')); ?>" alt="team" class="avatar rounded-full">
                                        <div class="">
                                    ...
                                    <div class="space-y-2 text-center">
                                    <a href="<?php echo e(url('team')); ?>">
                                        <img src="<?php echo e(asset('build/assets/img/users/3.jpg')); ?>" alt="team" class="avatar rounded-full">
                                        <div class="">
                                    ...
                                    <div class="space-y-2 text-center">
                                    <a href="<?php echo e(url('team')); ?>">
                                        <img src="<?php echo e(asset('build/assets/img/users/4.jpg')); ?>" alt="team" class="avatar rounded-full">
                                        <div class="">
                                    ...
                                    <div class="space-y-2 text-center">
                                    <a href="<?php echo e(url('team')); ?>">
                                        <img src="<?php echo e(asset('build/assets/img/users/15.jpg')); ?>" alt="team" class="avatar rounded-full">
                                        <div class="">
                                    ...
                                    <div class="space-y-2 text-center">
                                    <a href="<?php echo e(url('team')); ?>">
                                        <img src="<?php echo e(asset('build/assets/img/users/6.jpg')); ?>" alt="team" class="avatar rounded-full">
                                        <div class="">
                                    ...
                                    <div class="space-y-2 text-center">
                                    <a href="<?php echo e(url('team')); ?>">
                                        <img src="<?php echo e(asset('build/assets/img/users/7.jpg')); ?>" alt="team" class="avatar rounded-full">
                                        <div class="">
                                ...
                                <div class="grid grid-cols-12 gap-6 max-w-[80rem] mx-auto">
                                    ...
                                    <div class="box mb-0">
                                        ...
                                        <div class="relative overflow-hidden bg-no-repeat bg-cover shadow-lg rounded-sm">
                                            <img src="<?php echo e(asset('build/assets/img/gallery/2.jpg')); ?>" class="w-full" alt="blog-img">
                                            <a href="<?php echo e(url('blog-details')); ?>">
                                            <div
                                    ...
                                    <div class="box">
                                        <div class="box-body p-0">
                                        <div class="relative overflow-hidden bg-no-repeat bg-cover shadow-lg rounded-sm">
                                            <img src="<?php echo e(asset('build/assets/img/gallery/3.jpg')); ?>" class="w-full" alt="blog-img">
                                            <a href="<?php echo e(url('blog-details')); ?>">
                                            <div
                                                class="absolute top-0 right-0 bottom-0 left-0 w-full h-full overflow-hidden bg-fixed bg-black/50">
                                                <div class="flex justify-start items-end h-full">
                                    ...
                                    <div class="box mb-0">
                                        <div class="box-body p-0">
                                        <div class="relative overflow-hidden bg-no-repeat bg-cover shadow-lg rounded-sm">
                                            <img src="<?php echo e(asset('build/assets/img/gallery/9.jpg')); ?>" class="w-full" alt="blog-img">
                                            <a href="<?php echo e(url('blog-details')); ?>">
                                            <div
                                                class="absolute top-0 right-0 bottom-0 left-0 w-full h-full overflow-hidden bg-fixed bg-black/50">
                                                <div class="flex justify-start items-end h-full">
                                    ...
                                    <div class="box">
                                        <div class="box-body p-0">
                                        <div class="relative overflow-hidden bg-no-repeat bg-cover shadow-lg rounded-sm">
                                            <img src="<?php echo e(asset('build/assets/img/gallery/8.jpg')); ?>" class="w-full" alt="blog-img">
                                            <a href="<?php echo e(url('blog-details')); ?>">
                                            <div
                                                class="absolute top-0 right-0 bottom-0 left-0 w-full h-full overflow-hidden bg-fixed bg-black/50">
                                                <div class="flex justify-start items-end h-full">
                                    ...
                                    <div class="box mb-0">
                                        <div class="box-body p-0">
                                        <div class="relative overflow-hidden bg-no-repeat bg-cover shadow-lg rounded-sm">
                                            <img src="<?php echo e(asset('build/assets/img/gallery/10.jpg')); ?>" class="w-full" alt="blog-img">
                                            <a href="<?php echo e(url('blog-details')); ?>">
                                            <div
                                                class="absolute top-0 right-0 bottom-0 left-0 w-full h-full overflow-hidden bg-fixed bg-black/50">
                                                <div class="flex justify-start items-end h-full">
                        ...
                        <div
                            ...
                            <div class="container mx-auto z-[0] text-center space-y-5">
                                <h2 class="section-title text-center text-3xl font-bold text-white md:text-4xl lg:text-5xl justify-center">Get
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.landing-app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\projects\laravel\vite\synto\synto\resources\views/pages/landing.blade.php ENDPATH**/ ?>