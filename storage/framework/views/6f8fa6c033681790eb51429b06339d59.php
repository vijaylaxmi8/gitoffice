                        ...
                        <div id="content"  class="authentication-page justify-center w-full max-w-7xl mx-auto p-6">
                            <div class="mt-7">
                                <div class="p-6 sm:p-7 space-y-8">
                                    <img src="<?php echo e(asset('build/assets/img/authentication/3.png')); ?>" alt="logo" class="mx-auto">
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.custom-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\projects\my-projects\laravel\vite\synto\synto-laravel\synto\resources\views/pages/comingsoon.blade.php ENDPATH**/ ?>