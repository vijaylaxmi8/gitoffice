<aside class="app-sidebar" id="sidebar">
                ...
                <div class="main-sidebar " id="sidebar-scroll">
                    ...
                    <nav class="main-menu-container nav nav-pills flex-column sub-open">
                        ...
                        <ul class="main-menu">
                            ...
                            <!-- End::slide__category -->
                            <li class="slide">
                                <a href="<?php echo e(url('/egov/dashboard')); ?>" class="side-menu__item">
                            ...
                            <li class="slide  has-sub">
                                ...
                                <ul class="slide-menu child1">
                                    <li class="slide  has-sub">
                                        ...
                                        <ul class="slide-menu child1">
                                            <li class="slide"><a href="<?php echo e(url('/egov/Teaching/activityattended')); ?>" class="side-menu__item">Attended</a></li>
                                            <li class="slide"><a href="<?php echo e(url('/egov/Teaching/activityconducted')); ?>" class="side-menu__item">Conducted</a></li>
                                        </ul>
                                    </li>
                                   <li class="slide  has-sub">
                                        <a href="javascript:void(0);" class="side-menu__item">
                                        ...
                                        <ul class="slide-menu child1">
                                            <li class="slide"><a href="<?php echo e(url('/egov/NonTeaching/attended')); ?>" class="side-menu__item">Attended</a></li>
                                            <li class="slide"><a href="<?php echo e(url('/egov/NonTeaching/conducted')); ?>" class="side-menu__item">Conducted</a></li>
                                        </ul>
                                    </li>     
                                </ul>
                            </li>
                            ...
                            <li class="slide  has-sub">
                                ...
                                <ul class="slide-menu child1">
                                    <li class="slide  has-sub">
                                        ...
                                        <ul class="slide-menu child1">
                                            <li class="slide"><a href="<?php echo e(url('/egov/Teaching/research/conferenceattended')); ?>" class="side-menu__item">Attended</a></li>
                                            <li class="slide"><a href="<?php echo e(url('/egov/Teaching/research/conferenceconducted')); ?>" class="side-menu__item">Conducted</a></li>
                                        </ul>
                                    </li>
                                    <li class="slide"><a href="<?php echo e(url('/egov/Teaching/research/publication')); ?>" class="side-menu__item">Publication</a></li>
                                    <li class="slide"><a href="<?php echo e(url('/egov/Teaching/research/fundedproject')); ?>" class="side-menu__item">Funded Project</a></li>
                                    <li class="slide"><a href="<?php echo e(url('/egov/Teaching/research/book_chapter')); ?>" class="side-menu__item">Book Chapter</a></li>
                                    <li class="slide"><a href="<?php echo e(url('/egov/Teaching/research/egov_consultancy')); ?>" class="side-menu__item">Consultancy</a></li>
                                    <li class="slide"><a href="<?php echo e(url('/egov/Teaching/research/patents')); ?>" class="side-menu__item">Patents</a></li>
                                    <li class="slide"><a href="<?php echo e(url('/egov/Teaching/research/copyrights')); ?>" class="side-menu__item">Copyrights</a></li>
                                    <li class="slide"><a href="<?php echo e(url('/egov/Teaching/research/achivements')); ?>" class="side-menu__item">Achivements</a></li>
                                    <li class="slide"><a href="<?php echo e(url('/egov/Teaching/research/reviewer_editor')); ?>" class="side-menu__item">Reviewer/Editor</a></li>
            ...
            </aside><?php /**PATH F:\laravel Apps\gitoffice\resources\views/layouts/components/egov_admin/sidebar.blade.php ENDPATH**/ ?>