<?php $__env->startSection('styles'); ?>
        ...
        <!-- SWEET ALERT CSS -->
        <link rel="stylesheet" href="<?php echo e(asset('build/assets/libs/sweetalert2/sweetalert2.min.css')); ?>">

        <!-- ANIMATE CSS -->
        <link rel="stylesheet" href="<?php echo e(asset('build/assets/libs/animate.css/animate.min.css')); ?>">
...
<?php $__env->startSection('scripts'); ?>
        ...
        <!-- SWEETALERT JS -->
        <script src="<?php echo e(asset('build/assets/libs/sweetalert2/sweetalert2.min.js')); ?>"></script>
        <?php echo app('Illuminate\Foundation\Vite')('resources/assets/js/swetalert.js'); ?>
        

<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\projects\my-projects\laravel\vite\synto\synto-laravel\synto\resources\views/pages/sweetalert.blade.php ENDPATH**/ ?>