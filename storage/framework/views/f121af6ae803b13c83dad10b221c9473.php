                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr class="invoice-list">
                                                            ...
                                                            <td>
                                                                <div class="flex space-x-3 rtl:space-x-reverse text-start min-w-[220px] truncate">
                                                                    <img class="avatar avatar-sm rounded-sm"
                                                                        src="<?php echo e(asset('build/assets/img/users/3.jpg')); ?>" alt="Image Description">
                                                                    <div class="block">
                                                        ...
                                                        <tr class="invoice-list">
                                                            ...
                                                            <td>
                                                                <div class="flex space-x-3 rtl:space-x-reverse text-start min-w-[220px] truncate">
                                                                    <img class="avatar avatar-sm rounded-sm"
                                                                        src="<?php echo e(asset('build/assets/img/users/10.jpg')); ?>" alt="Image Description">
                                                                    <div class="block">
                                                        ...
                                                        <tr class="invoice-list">
                                                            ...
                                                            <td>
                                                                <div class="flex space-x-3 rtl:space-x-reverse text-start min-w-[220px] truncate">
                                                                    <img class="avatar avatar-sm rounded-sm"
                                                                        src="<?php echo e(asset('build/assets/img/users/11.jpg')); ?>" alt="Image Description">
                                                                    <div class="block">
                                                        ...
                                                        <tr class="invoice-list">
                                                            ...
                                                            <td>
                                                                <div class="flex space-x-3 rtl:space-x-reverse text-start min-w-[220px] truncate">
                                                                    <img class="avatar avatar-sm rounded-sm"
                                                                        src="<?php echo e(asset('build/assets/img/users/12.jpg')); ?>" alt="Image Description">
                                                                    <div class="block">
                            ...
                            <div class="ti-modal-content">
                                ...
                                <div class="ti-modal-body p-6">
                                    <div class="flex flex-col md:flex-row space-y-6 justify-between mb-5">
                                        <div class="space-y-2">
                                            <div class="mb-2">
                                                <img src="<?php echo e(asset('build/assets/img/brand-logos/desktop-logo.png')); ?>" alt="logo" class="flex dark:hidden">
                                                <img src="<?php echo e(asset('build/assets/img/brand-logos/desktop-dark.png')); ?>" alt="logo" class="hidden dark:flex">
                                            </div>
...
<?php $__env->startSection('scripts'); ?>
        ...
        <!-- INVOICE JS -->
        <?php echo app('Illuminate\Foundation\Vite')('resources/assets/js/invoice.js'); ?>
        

<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\projects\my-projects\laravel\vite\synto\synto-laravel\synto\resources\views/pages/invoice-list.blade.php ENDPATH**/ ?>