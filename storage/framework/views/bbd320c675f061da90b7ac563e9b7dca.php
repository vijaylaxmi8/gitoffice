                            ...
                            <div class="grid grid-cols-12 gap-x-5">
                                ...
                                <div class="box">
                                    ...
                                    <div class="">
                                        ...
                                        <a href="<?php echo e(url('add-product')); ?>" class="ti-btn ti-btn-primary ltr:float-right rtl:float-left"><i class="ti ti-plus"></i>Add Prdouct</a>
                                    </div>
                                    </div>
                                </div>
                                <div class="grid grid-cols-12 gap-x-6">
                                    ...
                                    <div class="box product-box">
                                        ...
                                        <div class="product-image">
                                            <a href="<?php echo e(url('products-details')); ?>" class="image">
                                            <img class="mx-auto rounded-sm" src="<?php echo e(asset('build/assets/img/ecommerce/products/1.png')); ?>" alt="img">
                                            </a>
                                            <div class="product-icons">
                                            <a aria-label="anchor" href="<?php echo e(url('wishlist')); ?>" class="z-40 absolute top-2 ltr:right-2 rtl:left-2 block bg-white dark:bg-bgdark p-2 leading-none rounded-full text-gray-500 dark:text-white text-base"><i class="ri ri-heart-line"></i></a>
                                            <a aria-label="anchor" href="<?php echo e(url('cart')); ?>" class="z-40 absolute top-12 ltr:right-2 rtl:left-2 block bg-white dark:bg-bgdark p-2 leading-none rounded-full text-gray-500 dark:text-white text-base"><i class="ri ri-shopping-cart-2-line"></i></a>
                                            <a aria-label="anchor" href="<?php echo e(url('products-details')); ?>" class="z-40 absolute top-[5.5rem] ltr:right-2 rtl:left-2 block bg-white dark:bg-bgdark p-2 leading-[0] rounded-full text-gray-500 dark:text-white text-base"><i class="ri ri-eye-line leading-none"></i></a>
                                            </div>
                                            <a href="<?php echo e(url('products-details')); ?>" class="z-40 absolute bottom-2 ltr:left-2 rtl:right-2 block bg-success p-1 leading-none rounded-sm text-white text-xs">Available</a>
                                        </div>
                                    ...
                                    <div class="product-box box">
                                        ...
                                        <div class="product-image">
                                            <a href="<?php echo e(url('products-details')); ?>" class="image">
                                            <img class="mx-auto rounded-sm" src="<?php echo e(asset('build/assets/img/ecommerce/products/2.png')); ?>" alt="img">
                                            </a>
                                            <div class="product-icons">
                                            <a aria-label="anchor" href="<?php echo e(url('wishlist')); ?>" class="z-40 absolute top-2 ltr:right-2 rtl:left-2 block bg-white dark:bg-bgdark p-2 leading-none rounded-full text-gray-500 dark:text-white text-base"><i class="ri ri-heart-line"></i></a>
                                            <a aria-label="anchor" href="<?php echo e(url('cart')); ?>" class="z-40 absolute top-12 ltr:right-2 rtl:left-2 block bg-white dark:bg-bgdark p-2 leading-none rounded-full text-gray-500 dark:text-white text-base"><i class="ri ri-shopping-cart-2-line"></i></a>
                                            ...
                                            <a href="<?php echo e(url('products-details')); ?>" class="z-40 absolute bottom-2 ltr:left-2 rtl:right-2 block bg-danger p-1 leading-none rounded-sm text-white text-xs">Out Of Stock</a>
                                        </div>
                                        <div class="product-details space-y-1">
                                    ...
                                    <div class="product-box box">
                                        ...
                                        <div class="product-image">
                                            <a href="<?php echo e(url('products-details')); ?>" class="image">
                                            <img class="mx-auto rounded-sm" src="<?php echo e(asset('build/assets/img/ecommerce/products/3.png')); ?>" alt="img">
                                            </a>
                                            <div class="product-icons">
                                            <a aria-label="anchor" href="<?php echo e(url('wishlist')); ?>" class="z-40 absolute top-2 ltr:right-2 rtl:left-2 block bg-white dark:bg-bgdark p-2 leading-none rounded-full text-gray-500 dark:text-white text-base"><i class="ri ri-heart-line"></i></a>
                                            <a aria-label="anchor" href="<?php echo e(url('cart')); ?>" class="z-40 absolute top-12 ltr:right-2 rtl:left-2 block bg-white dark:bg-bgdark p-2 leading-none rounded-full text-gray-500 dark:text-white text-base"><i class="ri ri-shopping-cart-2-line"></i></a>
                                    ...
                                    <div class="product-box box">
                                        ...
                                        <div class="product-image">
                                            <a href="<?php echo e(url('products-details')); ?>" class="image">
                                            <img class="mx-auto rounded-sm" src="<?php echo e(asset('build/assets/img/ecommerce/products/4.png')); ?>" alt="img">
                                            </a>
                                            <div class="product-icons">
                                            <a aria-label="anchor" href="<?php echo e(url('wishlist')); ?>" class="z-40 absolute top-2 ltr:right-2 rtl:left-2 block bg-white dark:bg-bgdark p-2 leading-none rounded-full text-gray-500 dark:text-white text-base"><i class="ri ri-heart-line"></i></a>
                                            <a aria-label="anchor" href="<?php echo e(url('cart')); ?>" class="z-40 absolute top-12 ltr:right-2 rtl:left-2 block bg-white dark:bg-bgdark p-2 leading-none rounded-full text-gray-500 dark:text-white text-base"><i class="ri ri-shopping-cart-2-line"></i></a>
                                    ...
                                    <div class="product-box box">
                                        ...
                                        <div class="product-image">
                                            <a href="<?php echo e(url('products-details')); ?>" class="image">
                                            <img class="mx-auto rounded-sm" src="<?php echo e(asset('build/assets/img/ecommerce/products/5.png')); ?>" alt="img">
                                            </a>
                                            <div class="product-icons">
                                            <a aria-label="anchor" href="<?php echo e(url('wishlist')); ?>" class="z-40 absolute top-2 ltr:right-2 rtl:left-2 block bg-white dark:bg-bgdark p-2 leading-none rounded-full text-gray-500 dark:text-white text-base"><i class="ri ri-heart-line"></i></a>
                                            <a aria-label="anchor" href="<?php echo e(url('cart')); ?>" class="z-40 absolute top-12 ltr:right-2 rtl:left-2 block bg-white dark:bg-bgdark p-2 leading-none rounded-full text-gray-500 dark:text-white text-base"><i class="ri ri-shopping-cart-2-line"></i></a>
                                    ...
                                    <div class="product-box box">
                                        ...
                                        <div class="product-image">
                                            <a href="<?php echo e(url('products-details')); ?>" class="image">
                                            <img class="mx-auto rounded-sm" src="<?php echo e(asset('build/assets/img/ecommerce/products/6.png')); ?>" alt="img">
                                            </a>
                                            <div class="product-icons">
                                            <a aria-label="anchor" href="<?php echo e(url('wishlist')); ?>" class="z-40 absolute top-2 ltr:right-2 rtl:left-2 block bg-white dark:bg-bgdark p-2 leading-none rounded-full text-gray-500 dark:text-white text-base"><i class="ri ri-heart-line"></i></a>
                                            <a aria-label="anchor" href="<?php echo e(url('cart')); ?>" class="z-40 absolute top-12 ltr:right-2 rtl:left-2 block bg-white dark:bg-bgdark p-2 leading-none rounded-full text-gray-500 dark:text-white text-base"><i class="ri ri-shopping-cart-2-line"></i></a>
                                    ...
                                    <div class="product-box box">
                                        ...
                                        <div class="product-image">
                                            <a href="<?php echo e(url('products-details')); ?>" class="image">
                                            <img class="mx-auto rounded-sm" src="<?php echo e(asset('build/assets/img/ecommerce/products/7.png')); ?>" alt="img">
                                            </a>
                                            <div class="product-icons">
                                            <a aria-label="anchor" href="<?php echo e(url('wishlist')); ?>" class="z-40 absolute top-2 ltr:right-2 rtl:left-2 block bg-white dark:bg-bgdark p-2 leading-none rounded-full text-gray-500 dark:text-white text-base"><i class="ri ri-heart-line"></i></a>
                                            <a aria-label="anchor" href="<?php echo e(url('cart')); ?>" class="z-40 absolute top-12 ltr:right-2 rtl:left-2 block bg-white dark:bg-bgdark p-2 leading-none rounded-full text-gray-500 dark:text-white text-base"><i class="ri ri-shopping-cart-2-line"></i></a>
                                    ...
                                    <div class="product-box box">
                                        ...
                                        <div class="product-image">
                                            <a href="<?php echo e(url('products-details')); ?>" class="image">
                                            <img class="mx-auto rounded-sm" src="<?php echo e(asset('build/assets/img/ecommerce/products/9.png')); ?>" alt="img">
                                            </a>
                                            <div class="product-icons">
                                            <a aria-label="anchor" href="<?php echo e(url('wishlist')); ?>" class="z-40 absolute top-2 ltr:right-2 rtl:left-2 block bg-white dark:bg-bgdark p-2 leading-none rounded-full text-gray-500 dark:text-white text-base"><i class="ri ri-heart-line"></i></a>
                                            <a aria-label="anchor" href="<?php echo e(url('cart')); ?>" class="z-40 absolute top-12 ltr:right-2 rtl:left-2 block bg-white dark:bg-bgdark p-2 leading-none rounded-full text-gray-500 dark:text-white text-base"><i class="ri ri-shopping-cart-2-line"></i></a>
                                    ...
                                    <div class="product-box box">
                                        ...
                                        <div class="product-image">
                                            <a href="<?php echo e(url('products-details')); ?>" class="image">
                                            <img class="mx-auto rounded-sm" src="<?php echo e(asset('build/assets/img/ecommerce/products/8.png')); ?>" alt="img">
                                            </a>
                                            <div class="product-icons">
                                            <a aria-label="anchor" href="<?php echo e(url('wishlist')); ?>" class="z-40 absolute top-2 ltr:right-2 rtl:left-2 block bg-white dark:bg-bgdark p-2 leading-none rounded-full text-gray-500 dark:text-white text-base"><i class="ri ri-heart-line"></i></a>
                                            <a aria-label="anchor" href="<?php echo e(url('cart')); ?>" class="z-40 absolute top-12 ltr:right-2 rtl:left-2 block bg-white dark:bg-bgdark p-2 leading-none rounded-full text-gray-500 dark:text-white text-base"><i class="ri ri-shopping-cart-2-line"></i></a>
                                    ...
                                    <div class="product-box box">
                                        ...
                                        <div class="product-image">
                                            <a href="<?php echo e(url('products-details')); ?>" class="image">
                                            <img class="mx-auto rounded-sm" src="<?php echo e(asset('build/assets/img/ecommerce/products/10.png')); ?>" alt="img">
                                            </a>
                                            <div class="product-icons">
                                            <a aria-label="anchor" href="<?php echo e(url('wishlist')); ?>" class="z-40 absolute top-2 ltr:right-2 rtl:left-2 block bg-white dark:bg-bgdark p-2 leading-none rounded-full text-gray-500 dark:text-white text-base"><i class="ri ri-heart-line"></i></a>
                                            <a aria-label="anchor" href="<?php echo e(url('cart')); ?>" class="z-40 absolute top-12 ltr:right-2 rtl:left-2 block bg-white dark:bg-bgdark p-2 leading-none rounded-full text-gray-500 dark:text-white text-base"><i class="ri ri-shopping-cart-2-line"></i></a>
                                    ...
                                    <div class="product-box box">
                                        ...
                                        <div class="product-image">
                                            <a href="<?php echo e(url('products-details')); ?>" class="image">
                                            <img class="mx-auto rounded-sm" src="<?php echo e(asset('build/assets/img/ecommerce/products/11.png')); ?>" alt="img">
                                            </a>
                                            <div class="product-icons">
                                            <a aria-label="anchor" href="<?php echo e(url('wishlist')); ?>" class="z-40 absolute top-2 ltr:right-2 rtl:left-2 block bg-white dark:bg-bgdark p-2 leading-none rounded-full text-gray-500 dark:text-white text-base"><i class="ri ri-heart-line"></i></a>
                                            <a aria-label="anchor" href="<?php echo e(url('cart')); ?>" class="z-40 absolute top-12 ltr:right-2 rtl:left-2 block bg-white dark:bg-bgdark p-2 leading-none rounded-full text-gray-500 dark:text-white text-base"><i class="ri ri-shopping-cart-2-line"></i></a>
                                    ...
                                    <div class="product-box box">
                                        ...
                                        <div class="product-image">
                                            <a href="<?php echo e(url('products-details')); ?>" class="image">
                                            <img class="mx-auto rounded-sm" src="<?php echo e(asset('build/assets/img/ecommerce/products/12.png')); ?>" alt="img">
                                            </a>
                                            <div class="product-icons">
                                            <a aria-label="anchor" href="<?php echo e(url('wishlist')); ?>" class="z-40 absolute top-2 ltr:right-2 rtl:left-2 block bg-white dark:bg-bgdark p-2 leading-none rounded-full text-gray-500 dark:text-white text-base"><i class="ri ri-heart-line"></i></a>
                                            <a aria-label="anchor" href="<?php echo e(url('cart')); ?>" class="z-40 absolute top-12 ltr:right-2 rtl:left-2 block bg-white dark:bg-bgdark p-2 leading-none rounded-full text-gray-500 dark:text-white text-base"><i class="ri ri-shopping-cart-2-line"></i></a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\projects\my-projects\laravel\vite\synto\synto-laravel\synto\resources\views/pages/products.blade.php ENDPATH**/ ?>