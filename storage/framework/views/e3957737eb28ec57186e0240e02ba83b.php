                            ...
                            <div class="col-span-12 xxl:col-span-9">
                                ...
                                <div class="col-span-12 xxxl:col-span-8">
                                    ...
                                    <div class="p-6">
                                        ...
                                        <a class="p-0 font-semibold text-primary text-sm flex" href="<?php echo e(url('blog-details')); ?>">
                                    ...
                                    <div class="box-footer bg-transparent">
                                        ...
                                        <div class="flex items-center space-x-3 rtl:space-x-reverse">
                                            <div class="flex">
                                            <img class="avatar avatar-sm ring-0 rounded-full" src="<?php echo e(asset('build/assets/img/users/1.jpg')); ?>"
                                                alt="avatar">
                                            </div>
                                            <div>
                                ...
                                <div class="col-span-12 xxxl:col-span-4">
                                    <div class="box">
                                    <div class="p-6">
                                        <img class="w-full rounded-sm" src="<?php echo e(asset('build/assets/img/gallery/3.jpg')); ?>" alt="Image Description">
                                        <div class="box-body px-0 pb-0">
                                ...
                                <div class="col-span-12 xxxl:col-span-6">
                                    ...
                                    <div class="sm:flex sm:flex-row">
                                        <img class="sm:w-1/4 rounded-sm" src="<?php echo e(asset('build/assets/img/gallery/9.jpg')); ?>" alt="Image Description">
                                ...
                                <div class="col-span-12 xxxl:col-span-6">
                                    ...
                                    <div class="sm:flex flex-row">
                                        ...
                                        <img class="sm:w-1/4 rounded-sm" src="<?php echo e(asset('build/assets/img/gallery/7.jpg')); ?>" alt="Image Description">
                                    </div>
                                    </div>
                                </div>
                                <div class="col-span-12 xxxl:col-span-4">
                                ...
                                <div class="col-span-12 xxxl:col-span-4">
                                    <div class="box">
                                    <div class="p-6">
                                        <img class="w-full rounded-sm" src="<?php echo e(asset('build/assets/img/gallery/2.jpg')); ?>" alt="Image Description">
                                        <div class="box-body px-0 pb-0">
                                ...
                                <div class="col-span-12 xxxl:col-span-4">
                                    <div class="box">
                                    <div class="p-6">
                                        <img class="w-full rounded-sm" src="<?php echo e(asset('build/assets/img/gallery/1.jpg')); ?>" alt="Image Description">
                                        <div class="box-body px-0 pb-0">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\projects\my-projects\laravel\vite\synto\synto-laravel\synto\resources\views/pages/blog.blade.php ENDPATH**/ ?>