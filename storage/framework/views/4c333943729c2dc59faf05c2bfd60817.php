                                ...
                                <div class="col-span-12">
                                        ...
                                        <div class=" block ltr:ml-auto rtl:mr-auto my-auto">
                                                ...
                                                <div id="hs-medium-modal" class="hs-overlay hidden ti-modal">
                                                    <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out md:!max-w-2xl md:w-full m-3 md:mx-auto">
                                                        ...
                                                        <form action="<?php echo e(route('ESTB.religion.store')); ?>" method="post">
                                                            <?php echo csrf_field(); ?>
                                                            <div class="ti-modal-body">
                                                                <div class="max-w-sm space-y-3">
                                                                    ...
                                                                    <?php if($errors->has('religion_name')): ?>
                                                                        <div class="text-red-700"><?php echo e($errors->first('religion_name')); ?></div>
                                                                    <?php endif; ?>
                                            ...
                                            <tr class="">
                                                ...
                                                <div class="flex space-x-3 rtl:space-x-reverse w-full min-w-[200px]">
                                                    <div class="block w-full my-auto">
                                                       <?php echo e($religion->religion_name); ?>

                                                    </div>
                                                </div>
                                                </td>
                                                <td><span><?php echo e($religion->status); ?></span></td>
                                                
                                                <td class="font-medium space-x-2 rtl:space-x-reverse">
                                                <div class="hs-tooltip ti-main-tooltip">
                                                            <a href="<?php echo e(route('ESTB.religion.castecategory',$religion->id)); ?>"
                                                ...
                                                <div class="hs-tooltip ti-main-tooltip">
                                                    <button data-hs-overlay="#religion_edit_modal<?php echo e($i); ?>" id="btn<?php echo e($i); ?>" btn-val=<?php echo e($i); ?>
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16"><path d="M16.7574 2.99666L14.7574 4.99666H5V18.9967H19V9.2393L21 7.2393V19.9967C21 20.5489 20.5523 20.9967 20 20.9967H4C3.44772 20.9967 3 20.5489 3 19.9967V3.99666C3 3.44438 3.44772 2.99666 4 2.99666H16.7574ZM20.4853 2.09717L21.8995 3.51138L12.7071 12.7038L11.2954 12.7062L11.2929 11.2896L20.4853 2.09717Z"></path></svg>
                                                        ...
                                                        <div id="religion_edit_modal<?php echo e($i); ?>" class="hs-overlay hidden ti-modal">
                                                            <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out md:!max-w-2xl md:w-full m-3 md:mx-auto">
                                                                <div class="ti-modal-content">
                                                                <div class="ti-modal-header">
                                                                    <h3 class="ti-modal-title">
                                                                    ...
                                                                    <?php if(($errors->has('edit_religion_name'))): ?>
                                                                        <script>
                                                                            //alert(387);
                                                                ...
                                                                <form  action="<?php echo e(route('ESTB.religion.update',$religion->id)); ?>" method="post">
                                                                    <?php echo csrf_field(); ?>
                                                                    <?php echo method_field('patch'); ?>
                                                                    <div class="ti-modal-body">

                                                                       <input type='hidden' name='religion_modal_no' class='religion_modal_no' value=<?php echo e(old('religion_modal_no')); ?>/>
                                                                        <div class="max-w-sm space-y-3">
                                                                            <label for="with-corner-hint" class="ti-form-label">Religion Name : </label>
                                                                            <input type="text" name="edit_religion_name" class="ti-form-input" placeholder="Religion name" value="<?php echo e($religion->religion_name); ?>">
                                                                            <?php if($errors->has('edit_religion_name')): ?>
                                                                                <div class="text-red-700"><?php echo e($errors->first('edit_religion_name')); ?></div>
                                                                            <?php endif; ?>
                                                                            <div id="religionNameError" class="error text-red-700"></div>
                                                                        </div>
                                                                        
                                                                        <?php if($religion->status == 'inactive'): ?>
                                                                        <br/>
                                                                            <div class="flex">
                                                ...
                                                <div class="hs-tooltip ti-main-tooltip">
                                                <form action="<?php echo e(route('ESTB.religion.destroy',$religion->id)); ?>" method="post">
                                    ...
                                    <div class="box-footer">
                                        ...
                                        <div class="sm:flex items-center">
                                            <div class="">
                                                showing <?php echo e($religions->firstItem()); ?> to <?php echo e($religions->lastItem()); ?> of <?php echo e($religions->total()); ?>

                                            </div>
                                            <div class="ltr:ml-auto rtl:mr-auto">
                                                <nav class="flex justify-center items-center space-x-2 rtl:space-x-reverse">
                                                    <a class="text-gray-500 hover:text-primary e py-1 px-2 leading-none inline-flex items-center gap-2 rounded-sm" href="<?php echo e($religions->previousPageUrl()); ?>">
                                                    ...
                                                    <?php for($page = 1; $page<= $number_of_page; $page++): ?>
                                                        <?php if($page == $url_page): ?>
                                                            <a class="bg-primary text-white py-1 px-2 leading-none inline-flex items-center text-sm font-medium rounded-sm" href="<?php echo e($religions->url($page)); ?>" aria-current="page"><?php echo e($page); ?></a>
                                                        <?php else: ?>
                                                                <a class="text-gray-500 hover:text-primary e py-1 px-2 leading-none inline-flex items-center text-sm font-medium rounded-sm" href="<?php echo e($religions->url($page)); ?>"><?php echo e($page); ?></a>
                                                        <?php endif; ?>
                                                    <?php endfor; ?>
                                                    ...
                                                    <a class="text-gray-500 hover:text-primary e py-1 px-2 leading-none inline-flex items-center gap-2 rounded-sm" href="<?php echo e($religions->nextPageUrl()); ?> ">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\laravel Apps\gitoffice\resources\views/ESTB/religion/index.blade.php ENDPATH**/ ?>