                                    ...
                                    <div class="col-span-12 lg:col-span-5">
                                        ...
                                        <div class="box-body">
                                            ...
                                            <li class="px-0 pt-2 pb-0 ti-list-group border-0 text-gray-800 dark:text-white">
                                                <a href="javascript:void(0);" class="flex  justify-between items-center w-full">
                                                <div class="flex space-x-3 rtl:space-x-reverse w-full">
                                                    <img class="avatar avatar-sm rounded-sm" src="<?php echo e(asset('build/assets/img/users/10.jpg')); ?>" alt="Image Description">
                                                    <div class="flex w-full">
                                                    <div class="block my-auto">
                                                        <p class="block text-sm font-semibold text-gray-800 hover:text-gray-900 my-auto  dark:text-white dark:hover:text-gray-200">
                                                        Charlie Davieson</p>
                                    ...
                                    <div class="box-body p-0">
                                        ...
                                        <table class="ti-custom-table ti-custom-table-head">
                                            ...
                                            <tr>
                                                <td class="leading-none !text-gray-800 dark:!text-white">
                                                <div class="flex space-x-3 rtl:space-x-reverse text-start">
                                                    <img class="avatar avatar-sm rounded-sm" src="<?php echo e(asset('build/assets/img/logos/1.png')); ?>" alt="Image Description">
                                                    <div class="block my-auto">
                                            ...
                                            <tr>
                                                <td class="leading-none !text-gray-800 dark:!text-white">
                                                <div class="flex space-x-3 rtl:space-x-reverse text-start">
                                                    <img class="avatar avatar-sm rounded-sm" src="<?php echo e(asset('build/assets/img/logos/8.png')); ?>" alt="Image Description">
                                                    <div class="block my-auto">
...
<?php $__env->startSection('scripts'); ?>
        ...
        <!-- INDEX JS -->
        <?php echo app('Illuminate\Foundation\Vite')('resources/assets/js/index-9.js'); ?>


<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\projects\my-projects\laravel\vite\synto\synto-laravel\synto\resources\views/pages/index9.blade.php ENDPATH**/ ?>