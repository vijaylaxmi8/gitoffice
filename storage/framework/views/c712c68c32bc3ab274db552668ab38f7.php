                                                ...
                                                <div id="grievance_add" class="hs-overlay hidden ti-modal">
                                                    <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out md:!max-w-2xl md:w-full m-3 md:mx-auto">
                                                        <div class="ti-modal-content">
                                                            ...
                                                            <form action="<?php echo e(route('HOD.grievancecategory.store')); ?>" method="post">
                                                                <?php echo csrf_field(); ?>
                                                    ...
                                                    <?php $__empty_1 = true; $__currentLoopData = $grievience_category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                        <tr class="">
                                                            ...
                                                            <td class="font-medium space-x-2 rtl:space-x-reverse">
                                                                    ...
                                                                    <div id="gcategory_edit_modal<?php echo e($i); ?>" class="hs-overlay hidden ti-modal">
                                                                        <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out lg:!max-w-4xl lg:w-full m-3 md:mx-auto">
                                                                            ...
                                                                            <div class="ti-modal-header">
                                                                                ...
                                                                                <form action="<?php echo e(route('HOD.grievancecategory.update',$gc->id)); ?>" method="post">
                                                                                    <?php echo csrf_field(); ?>
                                                                                    ...
                                                                                    <div class="ti-modal-body">
                                                                                        <div class="grid lg:grid-cols-2 gap-2 space-y-2 lg:space-y-0">
                                                                                            ...
                                                                                            <div class="max-w-sm space-y-3 pb-6">
                                                                                                <label for="" class="ti-form-label font-bold">Grievance User:<span class="text-red-500">*</span></label>
                                                                                                <select class="ti-form-select" name="user_id">
                                                                ...
                                                                <div class="hs-tooltip ti-main-tooltip">
                                                                    <form action="<?php echo e(route('HOD.grievancecategory.destroy',$gc->id)); ?>" method="post">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.components.HOD.master-hod', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\laravel Apps\gitoffice\resources\views/HOD/grievancecategory.blade.php ENDPATH**/ ?>