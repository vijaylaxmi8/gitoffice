                            ...
                            <div class="grid grid-cols-12 gap-x-5">
                                ...
                                <div class="col-span-12 md:col-span-6 xxl:col-span-3">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="flex-1">
                                            <p class="text-sm font-bold">SEMINAR/WEBINAR</p>
                                            <div class="flex justify-between items-center">
                                ...
                                <div class="col-span-12 md:col-span-6 xxl:col-span-3">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <span class=" text-gray-500 dark:text-white/70 text-xs">Both UG and PG</span>
                                        </div>
                                        </div>
                                    </div>
                                    </div>
                                ...
                                <div class="col-span-12 md:col-span-6 xxl:col-span-3">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="flex-1">
                                            <p class="text-sm font-bold">EXPERT TALK</p>
                                            <div class="flex justify-between items-center">
                                            <h5 class="mb-0 text-2xl font-semibold text-gray-800 dark:text-white">100</h5>
                                            <span class="text-success badge bg-success/20 rounded-sm p-1"><i
                                                ...
                                                <div class="flex-1">
                                                    ...
                                                    <div class="flex justify-between items-center">
                                                        <div class="flex flex-col">
                                                            <h5 class="mb-0 text-2xl font-semibold text-gray-800 dark:text-white"><?php echo e($teaching_activity_attendee); ?></h5>
                                                            <a class="flex items-center font-semibold text-primary hover:text-primary dark:text-primary truncate" href="<?php echo e(route('egov.Teaching.activityattended')); ?>">
                                                                Attended
                                                            </a>
                                                        </div>
                                                        <div class="flex flex-col">
                                                            <h5 class="mb-0 text-2xl font-semibold text-gray-800 dark:text-white"><?php echo e($teaching_activity_conducteds); ?></h5>
                                                            <a class="flex items-center font-semibold text-primary hover:text-primary dark:text-primary truncate" href="<?php echo e(route('egov.Teaching.activityconducted')); ?>">
                                                                Conducted
                                                            </a>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="flex-1">
                                                    ...
                                                    <div class="flex justify-between items-center">
                                                        <div class="flex flex-col">
                                                            ...
                                                            <a class="flex items-center font-semibold text-primary hover:text-primary dark:text-primary truncate" href="<?php echo e(route('egov.NonTeaching.attended')); ?>">
                                                                Attended
                                                            </a>
                                                        </div>
                                                        <div class="flex flex-col">
                                                            <h5 class="mb-0 text-2xl font-semibold text-gray-800 dark:text-white"><?php echo e($professional_activity_conducteds); ?></h5>
                                                            <a class="flex items-center font-semibold text-primary hover:text-primary dark:text-primary truncate" href="<?php echo e(route('egov.NonTeaching.conducted')); ?>">
                                                                Conducted
                                                            </a>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="flex-1">
                                                    ...
                                                    <div class="flex justify-between items-center">
                                                        <div class="flex flex-col">
                                                            ...
                                                            <a class="flex items-center font-semibold text-primary hover:text-primary dark:text-primary truncate" href="<?php echo e(route('egov.Teaching.research.conferenceattended')); ?>">
                                                                Attended
                                                            </a>
                                                        </div>
                                                        <div class="flex flex-col">
                                                            <h5 class="mb-0 text-2xl font-semibold text-gray-800 dark:text-white"><?php echo e($conferences_conducted); ?></h5>
                                                            <a class="flex items-center font-semibold text-primary hover:text-primary dark:text-primary truncate" href="<?php echo e(route('egov.Teaching.research.conferenceconducted')); ?>">
                                                                Conducted
                                                            </a>
                                                        </div>
                                                    </div>
                                ...
                                <div class="col-span-12 md:col-span-6 xxl:col-span-3">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <a class="flex  items-center font-semibold text-primary hover:text-primary dark:text-primary truncate" href="<?php echo e(route('egov.Teaching.research.publication')); ?>">
                                                 view
                                            </a>
                                        </div>
                                        </div>
