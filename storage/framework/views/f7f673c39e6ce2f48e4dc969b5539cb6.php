                            ...
                            <div class="grid grid-cols-12">
                                ...
                                <div class="box mb-0 border-0 shadow-none bg-transparent">
                                    ...
                                    <div class="swiper mySwiper2">
                                        ...
                                        <div class="swiper-slide">
                                            <img alt="product-image-1" src="<?php echo e(asset('build/assets/img/ecommerce/product-details/1.png')); ?>">
                                        </div>
                                        <div class="swiper-slide">
                                            <img alt="product-image-2" src="<?php echo e(asset('build/assets/img/ecommerce/product-details/2.png')); ?>">
                                        </div>
                                        <div class="swiper-slide">
                                            <img alt="product-image-3" src="<?php echo e(asset('build/assets/img/ecommerce/product-details/3.png')); ?>">
                                        </div>
                                        <div class="swiper-slide">
                                            <img alt="product-image-4" src="<?php echo e(asset('build/assets/img/ecommerce/product-details/4.png')); ?>">
                                        </div>
                                        <div class="swiper-slide">
                                            <img alt="product-image-5" src="<?php echo e(asset('build/assets/img/ecommerce/product-details/5.png')); ?>">
                                        </div>
                                        <div class="swiper-slide">
                                            <img alt="product-image-6" src="<?php echo e(asset('build/assets/img/ecommerce/product-details/6.png')); ?>">
                                        </div>
                                        <div class="swiper-slide">
                                            <img alt="product-image-7" src="<?php echo e(asset('build/assets/img/ecommerce/product-details/7.png')); ?>">
                                        </div>
                                        <div class="swiper-slide">
                                            <img alt="product-image-8" src="<?php echo e(asset('build/assets/img/ecommerce/product-details/8.png')); ?>">
                                        </div>
                                        </div>
                                    ...
                                    <div class="swiper mySwiper">
                                        ...
                                        <div class="swiper-slide">
                                            <img alt="product-image-1" src="<?php echo e(asset('build/assets/img/ecommerce/product-details/2.png')); ?>">
                                        </div>
                                        <div class="swiper-slide">
                                            <img alt="product-image-1" src="<?php echo e(asset('build/assets/img/ecommerce/product-details/3.png')); ?>">
                                        </div>
                                        <div class="swiper-slide">
                                            <img alt="product-image-1" src="<?php echo e(asset('build/assets/img/ecommerce/product-details/4.png')); ?>">
                                        </div>
                                        <div class="swiper-slide">
                                            <img alt="product-image-1" src="<?php echo e(asset('build/assets/img/ecommerce/product-details/5.png')); ?>">
                                        </div>
                                        <div class="swiper-slide">
                                            <img alt="product-image-1" src="<?php echo e(asset('build/assets/img/ecommerce/product-details/6.png')); ?>">
                                        </div>
                                        <div class="swiper-slide">
                                            <img alt="product-image-1" src="<?php echo e(asset('build/assets/img/ecommerce/product-details/7.png')); ?>">
                                        </div>
                                        <div class="swiper-slide">
                                            <img alt="product-image-1" src="<?php echo e(asset('build/assets/img/ecommerce/product-details/8.png')); ?>">
                                        </div>
                                        </div>
                                    </div>
                                    </div>
                                ...
                                <div class="box mb-0 border-0 shadow-none bg-transparent">
                                    ...
                                    <div class="space-y-5">
                                        ...
                                        <a href="<?php echo e(url('wishlist')); ?>" class="ti-btn ti-btn-ghost-primary"><i class="ri-heart-2-line"></i>Add To
                                        Favourites</a>
                                ...
                                <div class="box shadow-none border-0 mb-0">
                                    ...
                                    <div class="box shadow-none">
                                        ...
                                        <div class="flex space-x-3 rtl:space-x-reverse">
                                            ...
                                            <img src="<?php echo e(asset('build/assets/img/ecommerce/product-details/6.png')); ?>" class="avatar rounded-sm"
                                            alt="Product-image">
                                        </div>
                                        <div class="flex space-x-3 rtl:space-x-reverse">
                                        ...
                                        <div>
                                            <a href="<?php echo e(url('cart')); ?>" class="w-full ti-btn ti-btn-primary">Add To Cart</a>
                                            <a href="<?php echo e(url('checkout')); ?>" class="w-full ti-btn ti-btn-outline ti-btn-outline-primary">Buy Now</a>
                                        </div>
                                        </div>
                                    </div>
                                    ...
                                    <div id="product-spec-content-4" class="hidden" role="tabpanel">
                                        ...
                                        <div class="box">
                                            ...
                                            <div class="sm:flex justify-between">
                                                ...
                                                <div class="flex items-center space-x-3 rtl:space-x-reverse">
                                                    ...
                                                    src="<?php echo e(asset('build/assets/img/users/2.jpg')); ?>" alt="avatar">
                                                    <div>
                                            ...
                                            <p class="my-2 text-gray-500 dark:text-white/70 text-xs">Very nice ! On the other hand,
                                                ...
                                                demoralized.</p>
                                            <img src="<?php echo e(asset('build/assets/img/ecommerce/product-details/6.png')); ?>"
                                                class="avatar rounded-sm p-2 border border-gray-200 dark:border-white/10"
                                                alt="Product-image">
                                            <img src="<?php echo e(asset('build/assets/img/ecommerce/product-details/2.png')); ?>"
                                                class="avatar rounded-sm p-2 border border-gray-200 dark:border-white/10"
                                                alt="Product-image">
                                            <img src="<?php echo e(asset('build/assets/img/ecommerce/product-details/5.png')); ?>"
                                                class="avatar rounded-sm p-2 border border-gray-200 dark:border-white/10"
                                                alt="Product-image">
                                            </div>
                                        ...
                                        <div class="box">
                                            ...
                                            <div class="sm:flex justify-between">
                                                ...
                                                <div class="flex items-center space-x-3 rtl:space-x-reverse">
                                                    <img class="avatar avatar-sm !w-8 !h-8 ring-0 rounded-full"
                                                    src="<?php echo e(asset('build/assets/img/users/5.jpg')); ?>" alt="avatar">
                                                    <div>
                                            ...
                                            <p class="my-2 text-gray-500 dark:text-white/70 text-xs">Very nice ! On the other hand,
                                                ...
                                                denounce with righteous indignation and dislike men who are so beguiled and
                                                demoralized.</p>
                                            <img src="<?php echo e(asset('build/assets/img/ecommerce/product-details/3.png')); ?>"
                                                class="avatar rounded-sm p-2 border border-gray-200 dark:border-white/10"
                                                alt="product-image">
                                            </div>
                                            <div class="box-footer p-3 flex">
                            ...
                            <div class="col-span-12 xxl:col-span-3">
                                ...
                                <div class="box-body p-0">
                                    ...
                                    <li class="ti-list-group border-0 text-gray-800 dark:text-white">
                                        <a href="<?php echo e(url('products')); ?>" class="w-full">
                                        <div class="flex space-x-3 rtl:space-x-reverse w-full">
                                            <img src="<?php echo e(asset('build/assets/img/ecommerce/products/1.png')); ?>"
                                    ...
                                    <li class="ti-list-group border-0 text-gray-800 dark:text-white">
                                        <a href="<?php echo e(url('products')); ?>" class="w-full">
                                        <div class="flex space-x-3 rtl:space-x-reverse w-full">
                                            <img src="<?php echo e(asset('build/assets/img/ecommerce/products/2.png')); ?>"
                                            class="avatar avatar-lg rounded-sm border border-gray-200 dark:border-white/10 p-1"
                                            alt="product-image">
                                            <div class="w-full my-auto">
                                            <div class="flex">
                                    ...
                                    <li class="ti-list-group border-0 text-gray-800 dark:text-white">
                                        <a href="<?php echo e(url('products')); ?>" class="w-full">
                                        <div class="flex space-x-3 rtl:space-x-reverse w-full">
                                            <img src="<?php echo e(asset('build/assets/img/ecommerce/products/3.png')); ?>"
                                            class="avatar avatar-lg rounded-sm border border-gray-200 dark:border-white/10 p-1"
                                            alt="product-image">
                                            <div class="w-full my-auto">
                                            <div class="flex">
                                    ...
                                    <li class="ti-list-group border-0 text-gray-800 dark:text-white">
                                        <a href="<?php echo e(url('products')); ?>" class="w-full">
                                        <div class="flex space-x-3 rtl:space-x-reverse w-full">
                                            <img src="<?php echo e(asset('build/assets/img/ecommerce/products/4.png')); ?>"
                                            class="avatar avatar-lg rounded-sm border border-gray-200 dark:border-white/10 p-1"
                                            alt="product-image">
                                            <div class="w-full my-auto">
                                            <div class="flex">
                                    ...
                                    <li class="ti-list-group border-0 text-gray-800 dark:text-white">
                                        <a href="<?php echo e(url('products')); ?>" class="w-full">
                                        <div class="flex space-x-3 rtl:space-x-reverse w-full">
                                            <img src="<?php echo e(asset('build/assets/img/ecommerce/products/5.png')); ?>"
                                            class="avatar avatar-lg rounded-sm border border-gray-200 dark:border-white/10 p-1"
                                            alt="product-image">
                                            <div class="w-full my-auto">
                                            <div class="flex">
                                ...
                                <div class="box-footer">
                                    <a href="<?php echo e(url('products')); ?>" class="ti-btn ti-btn-primary py-1 w-full">Shop Now</a>
                                </div>
                                </div>
                            </div>
                            </div>
...
<?php $__env->startSection('scripts'); ?>
        ...
        <!-- RATING JS -->
        <script src="<?php echo e(asset('build/assets/libs/rater-js/index.js')); ?>"></script>

        <!-- PRODUCTS JS -->
        <?php echo app('Illuminate\Foundation\Vite')('resources/assets/js/product.js'); ?>


<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\projects\my-projects\laravel\vite\synto\synto-laravel\synto\resources\views/pages/products-details.blade.php ENDPATH**/ ?>