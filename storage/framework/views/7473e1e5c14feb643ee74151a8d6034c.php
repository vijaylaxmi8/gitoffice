                                ...
                                <div class="box">
                                                        ...
                                                        <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out lg:!max-w-4xl lg:w-full m-3 lg:mx-auto">
                                                            <div class="ti-modal-content">
                                                                <div class="ti-modal-header">
                                                                    ...
                                                                    <?php if(($errors->has('payscale_title'))||($errors->has('basepay'))||($errors->has('maxpay'))||($errors->has('agp'))||($errors->has('da'))||($errors->has('hra'))||($errors->has('cca'))||($errors->has('wef'))): ?>
                                                                        <script>
                                                                            //alert(1);
                                                                ...
                                                                <div class="ti-modal-body">
                                                                    <form action="<?php echo e(route('ESTB.payscales.teaching.store')); ?>" method="post">
                                                                        <?php echo csrf_field(); ?>
                                                                            ...
                                                                            <div class="max-w-sm space-y-3 pb-6">
                                                                                ...
                                                                                <?php if($errors->has('payscale_title')): ?>
                                                                                    <div class="text-red-700"><?php echo e($errors->first('payscale_title')); ?></div>
                                                                                <?php endif; ?>
                                                                            ...
                                                                            <div class="max-w-sm space-y-3 pb-6">
                                                                                ...
                                                                                <?php if($errors->has('basepay')): ?>
                                                                                    <div class="text-red-700"><?php echo e($errors->first('basepay')); ?></div>
                                                                                <?php endif; ?>
                                                                            ...
                                                                            <div class="max-w-sm space-y-3 pb-6">
                                                                                ...
                                                                                <?php if($errors->has('maxpay')): ?>
                                                                                    <div class="text-red-700"><?php echo e($errors->first('maxpay')); ?></div>
                                                                                <?php endif; ?>
                                                                            ...
                                                                            <div class="space-y-2">
                                                                                ...
                                                                                <?php $__currentLoopData = $design; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $des): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                        ...
                                                                                        <div class="flex">
                                                                                            <?php if($des->emp_type == "Teaching"): ?>
                                                                                            
                                                                                            <input type="radio" name="designations_id"  value="<?php echo e($des->id); ?>" class="ti-form-radio mt-0.5 hs-checkbox-group-1">
                                                                            ...
                                                                            <div class="max-w-sm space-y-3 pb-6">
                                                                                ...
                                                                                <?php if($errors->has('agp')): ?>
                                                                                    <div class="text-red-700"><?php echo e($errors->first('agp')); ?></div>
                                                                                <?php endif; ?>
                                                                            ...
                                                                            <div class="max-w-sm space-y-3 pb-6">
                                                                                ...
                                                                                <?php if($errors->has('da')): ?>
                                                                                    <div class="text-red-700"><?php echo e($errors->first('da')); ?></div>
                                                                                <?php endif; ?>
                                                                            ...
                                                                            <div class="max-w-sm space-y-3 pb-6">
                                                                                ...
                                                                                <?php if($errors->has('hra')): ?>
                                                                                    <div class="text-red-700"><?php echo e($errors->first('hra')); ?></div>
                                                                                <?php endif; ?>
                                                                            ...
                                                                            <div class="max-w-sm space-y-3 pb-6">
                                                                                ...
                                                                                <?php if($errors->has('cca')): ?>
                                                                                    <div class="text-red-700"><?php echo e($errors->first('cca')); ?></div>
                                                                                <?php endif; ?>
                                    ...
                                    <div class="box-body">
                                        ...
                                        <table id="teachingpaytable" class="ti-custom-table ti-custom-table-head whitespace-nowrap">
                                            ...
                                            <?php
                                                $i = 1;
                                            ?>
                                            <?php $__empty_1 = true; $__currentLoopData = $teaching_payscale; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            ...
                                            <tr class="bg-red-700">
                                                ...
                                                <div class="flex space-x-3 rtl:space-x-reverse w-full min-w-[200px]">
                                                    <div class="block w-full my-auto">
                                                        <?php echo e($tp->payscale_title); ?>

                                                    </div>
                                                </div>
                                                </td>
                                                <td><span><?php echo e($tp->basepay); ?></span></td>
                                                <td><span><?php echo e($tp->maxpay); ?></span></td>
                                                <td><span>
                                                   
                                                    <?php if($tp->designations->status=='active'): ?>
                                                    <?php echo e($tp->designations->design_name); ?>

                                                    <?php endif; ?>
                                            </span></td>
                                                <td><span>Rs.<?php echo e($tp->agp); ?></span></td>
                                                <td><span><?php echo e($tp->da); ?></span> %</td>
                                                <td><span><?php echo e($tp->hra); ?></span> %</td>
                                                <td><span>Rs.<?php echo e($tp->cca); ?></span></td>
                                                <td><span><?php echo e($tp->status); ?></span></td>
                                                                                         
                                                <td class="font-medium space-x-2 rtl:space-x-reverse">
                                                <div class="hs-tooltip ti-main-tooltip">
                                                    <button data-hs-overlay="#teaching_payscale_edit_modal<?php echo e($i); ?>" id="btn<?php echo e($i); ?>" btn-val=<?php echo e($i); ?>
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16"><path d="M16.7574 2.99666L14.7574 4.99666H5V18.9967H19V9.2393L21 7.2393V19.9967C21 20.5489 20.5523 20.9967 20 20.9967H4C3.44772 20.9967 3 20.5489 3 19.9967V3.99666C3 3.44438 3.44772 2.99666 4 2.99666H16.7574ZM20.4853 2.09717L21.8995 3.51138L12.7071 12.7038L11.2954 12.7062L11.2929 11.2896L20.4853 2.09717Z"></path></svg>
                                                        ...
                                                        <div id="teaching_payscale_edit_modal<?php echo e($i); ?>" class="hs-overlay hidden ti-modal">
                                                            <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out lg:!max-w-4xl lg:w-full m-3 lg:!mx-auto">
                                                                <div class="ti-modal-content">
                                                                    <div class="ti-modal-header">
                                                                        <h3 class="ti-modal-title">
                                                                        ...
                                                                        <button type="button" class="hs-dropdown-toggle ti-modal-close-btn"
                                                                        data-hs-overlay="#teaching_payscale_edit_modal<?php echo e($i); ?>">
                                                                        <span class="sr-only">Close</span>
                                                                        <svg class="w-3.5 h-3.5" width="8" height="8" viewBox="0 0 8 8" fill="none"
                                                                            xmlns="http://www.w3.org/2000/svg">
                                                                            <path
                                                                        ...
                                                                        <?php if(($errors->has('edit_payscale_title'))||($errors->has('edit_basepay'))||($errors->has('edit_maxpay'))||($errors->has('edit_agp'))||($errors->has('edit_da'))||($errors->has('edit_hra'))||($errors->has('edit_cca'))||($errors->has('edit_wef'))||($errors->has('edit_closedon'))): ?>
                                                                            <script>
                                                                                //alert(387);
                                                                    ...
                                                                    <form  action="<?php echo e(route('ESTB.payscales.teaching.update',$tp->id)); ?>" method="post">
                                                                    <?php echo csrf_field(); ?>
                                                                    <?php echo method_field('patch'); ?>
                                                                        <div class="ti-modal-body grid lg:grid-cols-2 gap-6 space-y-4 lg:space-y-0">
                                                                            ...
                                                                            <div class="max-w-sm space-y-3 pb-6">
                                                                                <label for="with-corner-hint" class="ti-form-label font-bold">Payscale Name : </label>
                                                                                <input type="text" name="edit_payscale_title" class="ti-form-input" value="<?php echo e($tp->payscale_title); ?>" placeholder="Payscale Name">
                                                                                <?php if($errors->has('edit_payscale_title')): ?>
                                                                                    <div class="text-red-700"><?php echo e($errors->first('edit_payscale_title')); ?></div>
                                                                                <?php endif; ?>
                                                                            </div>
                                                                            <div class="max-w-sm space-y-3 pb-6">
                                                                                <label for="with-corner-hint" class="ti-form-label font-bold">Base Pay : </label>
                                                                                <input type="text" name="edit_basepay" value="<?php echo e($tp->basepay); ?>" class="ti-form-input" placeholder="Base Pay">
                                                                                <?php if($errors->has('edit_basepay')): ?>
                                                                                    <div class="text-red-700"><?php echo e($errors->first('edit_basepay')); ?></div>
                                                                                <?php endif; ?>
                                                                            </div>
                                                                            <div class="max-w-sm space-y-3 pb-6">
                                                                                <label for="with-corner-hint" class="ti-form-label font-bold">Max Pay : </label>
                                                                                <input type="text" name="edit_maxpay" value="<?php echo e($tp->maxpay); ?>" class="ti-form-input" placeholder="Max Pay">
                                                                                <?php if($errors->has('edit_maxpay')): ?>
                                                                                    <div class="text-red-700"><?php echo e($errors->first('edit_maxpay')); ?></div>
                                                                                <?php endif; ?>
                                                                            </div>
                                                                            <br/>
                                                                            <label for="" class="ti-form-label font-bold">Designations Applicable for :</label>
                                                                                ...
                                                                                <div class=" gap-x-8 max-w-md space-y-3 pb-6">
                                                                                    <?php $__currentLoopData = $design; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $des): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                        <?php
                                                                                            $checked="";
                                                                                        ?>
                                                                                        <?php if($tp->designations_id==$des->id): ?>
                                                                                                <?php
                                                                                                    $checked="checked";
                                                                                                    ?>
                                                                                                <?php endif; ?>
                                                                                        <div class="flex">
                                                                                            <?php if($des->emp_type == "Teaching"): ?>
                                                                                            <br/>
                                                                                            <input required type="radio" name="designations_id"  value="<?php echo e($des->id); ?>" <?php echo e($checked); ?> class="ti-form-radio mt-0.5 hs-checkbox-group-1">
                                                                                            <label for="hs-checkbox-group-1" class="text-sm text-gray-500 ltr:ml-2 rtl:mr-2 dark:text-white/70"><?php echo e($des->design_name); ?></label>
                                                                                            <?php endif; ?>
                                                                                        </div>
                                                                            ...
                                                                            <div class="max-w-sm space-y-3 pb-6">
                                                                                <label for="with-corner-hint" class="ti-form-label font-bold">AGP : </label>
                                                                                <input type="text" name="edit_agp" value="<?php echo e($tp->agp); ?>" class="ti-form-input" placeholder="AGP">
                                                                                <?php if($errors->has('edit_agp')): ?>
                                                                                    <div class="text-red-700"><?php echo e($errors->first('edit_agp')); ?></div>
                                                                                <?php endif; ?>
                                                                            </div>
                                                                            <div class="max-w-sm space-y-3 pb-6">
                                                                                <label for="with-corner-hint" class="ti-form-label font-bold">DA : </label>
                                                                                <input type="text" name="edit_da" value="<?php echo e($tp->da); ?>" class="ti-form-input" placeholder="DA">
                                                                                <?php if($errors->has('edit_da')): ?>
                                                                                    <div class="text-red-700"><?php echo e($errors->first('edit_da')); ?></div>
                                                                                <?php endif; ?>
                                                                            </div>
                                                                            <div class="max-w-sm space-y-3 pb-6">
                                                                                <label for="with-corner-hint" class="ti-form-label font-bold">HRA : </label>
                                                                                <input type="text" name="edit_hra" value="<?php echo e($tp->hra); ?>" class="ti-form-input" placeholder="HRA">
                                                                                <?php if($errors->has('edit_hra')): ?>
                                                                                    <div class="text-red-700"><?php echo e($errors->first('edit_hra')); ?></div>
                                                                                <?php endif; ?>
                                                                            </div>
                                                                            <div class="max-w-sm space-y-3 pb-6">
                                                                                <label for="with-corner-hint" class="ti-form-label font-bold">CCA : </label>
                                                                                <input type="text" name="edit_cca" value="<?php echo e($tp->cca); ?>" class="ti-form-input" placeholder="CCA">
                                                                                <?php if($errors->has('edit_cca')): ?>
                                                                                    <div class="text-red-700"><?php echo e($errors->first('edit_cca')); ?></div>
                                                                                <?php endif; ?>
                                                                            </div>
                                                                            <div class="flex shadow-sm max-w-sm space-y-3 pb-6"> 
                                                                                <div class="grid lg:grid-cols-2 space-y-4 lg:space-y-0">
                                                                                    ...
                                                                                    <input type="text" name="edit_wef" value="<?php echo e($tp->wef); ?>"
                                                                                        class="ti-form-input rounded-l-none focus:z-10 flatpickr-input date"
                                                                                         placeholder="Choose date" readonly>
                                                                                    <?php if($errors->has('edit_wef')): ?>
                                                                                        <div class="text-red-700"><?php echo e($errors->first('edit_wef')); ?></div>
                                                                                    <?php endif; ?>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="flex shadow-sm max-w-sm space-y-3 pb-6"> 
                                                                                <div class="grid lg:grid-cols-2 space-y-4 lg:space-y-0">
                                                                                    ...
                                                                                    <input type="text" name="edit_closedon"
                                                                                        class="ti-form-input rounded-l-none focus:z-10 flatpickr-input date"
                                                                                         placeholder="Choose date" value="<?php echo e($tp->closedon); ?>">
                                                                                    <?php if($errors->has('edit_closedon')): ?>
                                                                                        <div class="text-red-700"><?php echo e($errors->first('edit_closedon')); ?></div>
                                                                                    <?php endif; ?>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                ...
                                                <div class="hs-tooltip ti-main-tooltip">
                                                <form action="<?php echo e(route('ESTB.payscales.teaching.destory',$tp->id)); ?>" method="post">
                                    ...
                                    <div class="box-footer">
                                        ...
                                        <div class="sm:flex items-center">
                                            <div class="">
                                                showing <?php echo e($teaching_payscale->firstItem()); ?> to <?php echo e($teaching_payscale->lastItem()); ?> of <?php echo e($teaching_payscale->total()); ?>

                                            </div>
                                            <div class="ltr:ml-auto rtl:mr-auto">
                                                <nav class="flex justify-center items-center space-x-2 rtl:space-x-reverse">
                                                    <a class="text-gray-500 hover:text-primary e py-1 px-2 leading-none inline-flex items-center gap-2 rounded-sm" href="<?php echo e($teaching_payscale->previousPageUrl()); ?>">
                                                    ...
                                                    <?php for($page = 1; $page<= $number_of_page; $page++): ?>
                                                        <?php if($page == $url_page): ?>
                                                            <a class="bg-primary text-white py-1 px-2 leading-none inline-flex items-center text-sm font-medium rounded-sm" href="<?php echo e($teaching_payscale->url($page)); ?>" aria-current="page"><?php echo e($page); ?></a>
                                                        <?php else: ?>
                                                                <a class="text-gray-500 hover:text-primary e py-1 px-2 leading-none inline-flex items-center text-sm font-medium rounded-sm" href="<?php echo e($teaching_payscale->url($page)); ?>"><?php echo e($page); ?></a>
                                                        <?php endif; ?>
                                                    <?php endfor; ?>
                                                    ...
                                                    <a class="text-gray-500 hover:text-primary e py-1 px-2 leading-none inline-flex items-center gap-2 rounded-sm" href="<?php echo e($teaching_payscale->nextPageUrl()); ?> ">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\laravel Apps\gitoffice\resources\views/ESTB/payscales/teaching/index.blade.php ENDPATH**/ ?>