                                    ...
                                    <div>
                                        <div class="flex justify-between items-center">
                                            ...
                                            <a class="text-sm text-primary decoration-2 hover:underline font-medium"
                                                href="<?php echo e(url('forgot_password')); ?>">Forgot password?</a>
                                        </div>
                                        <div class="relative">
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'py-2 px-3 inline-flex justify-center items-center gap-2 rounded-sm border border-transparent font-semibold bg-primary text-white hover:bg-primary focus:outline-none focus:ring-0 focus:ring-primary focus:ring-offset-0 transition-all text-sm dark:focus:ring-offset-white/10']); ?>Sign
                                        in <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.custom-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\laravel Apps\gitoffice\resources\views/auth/login.blade.php ENDPATH**/ ?>