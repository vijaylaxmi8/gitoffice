                            ...
                            <div class="grid grid-cols-12 gap-x-5">
                                ...
                                <div class="col-span-12 md:col-span-6 xxl:col-span-3">
                                    ...
                                    <div class="box-header justify-between flex">
                                        ...
                                        <div>
                                            <a class="flex  items-center font-semibold text-primary hover:text-primary dark:text-primary truncate" href="<?php echo e(route('Principaloffice.poevents.index')); ?>">
                                                View All
                                            </a>
                                        </div>
                                    </div>
                                                                ...
                                                                <div class="flex-1">
                                                                    <a href="javascript:void(0);">
                                                                        ...
                                                                        <p class="mb-0 text-xs leading-none text-gray-500 dark:text-white/70"><?php echo e(\Carbon\Carbon::parse($event->start_date)->format('h:i A')); ?><span
                                                                            ...
                                                                            <br>
                                                                            <!--<p class="badge bg-danger/10 ltr:ml-2 rtl:mr-2 py-1 text-xs text-black rounded-sm"><?php echo e($event->location); ?></p>-->
                                                                        </p>
                                                                    </a>
                                ...
                                <div class="col-span-12 md:col-span-6 xxl:col-span-3">
                                    <div class="box" style="height: 450px; overflow-y: auto;">
                                        <div class="box-header justify-between flex">
                                            ...
                                            <div>
                                                <a class="flex  items-center font-semibold text-primary hover:text-primary dark:text-primary truncate" href="<?php echo e(route('Principaloffice.ponotice.index')); ?>">
                                                    View All
                                                </a>
                                            </div>
                                        </div>
                                        <div class="box-body">
                                            ...
                                            <?php $__currentLoopData = $dept_notice; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dn): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php $__env->startSection('scripts'); ?>
        ...
        <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css" integrity="sha384-B4gt1jrGC7Jh4AgTPSdUtOBvfO8sh+Wy6pRmaTjWTd1AaI0MueG4Lw7oUOmFItQ"
        crossorigin="anonymous">
        <script src="https://code.jquery.com/jquery-3.5.1.slim.min.js" integrity="sha384-DfXdz2htPH0lsSSs5nCTpuj/zy4C+OGpamoFVy38MVBnE+IbbVYUew+OrCXaRkfj" crossorigin="anonymous"></script>
        <script src="https://cdn.jsdelivr.net/npm/@popperjs/core@2.5.3/dist/umd/popper.min.js" integrity="sha384-dfWqIuHUofP6CpVqIgKcwcp1QB1XPhL1Mp4uHuLWAfQHaU5of9y6bC2C5K8++1Q" crossorigin="anonymous"></script>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.components.Principaloffice.master-poffice', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\laravel Apps\gitoffice\resources\views/Principaloffice/podashboard.blade.php ENDPATH**/ ?>