                                            ...
                                            <tbody>
                                                ...
                                                <?php $__currentLoopData = $general_achievements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $achive): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr class="">
                                                        ...
                                                        <td><span><?php echo e($achive->fname . ' ' . $achive->mname . ' ' . $achive->lname); ?></span></td>
                                                        <td><span><?php echo e($achive->dept_shortname); ?></span></td>
                                                        <td><span><?php echo e($achive->award); ?></span></td>
                                                        <td><span><?php echo e($achive->year); ?></span></td>
                                                        <td><span><?php echo e($achive->details); ?></span></td>
                                                    </tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.components.Deanrnd.master-deanrnd', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\laravel Apps\gitoffice\resources\views//Deanrnd/Teaching/research/achivements.blade.php ENDPATH**/ ?>