                                        ...
                                        <div class=" block ltr:ml-auto rtl:mr-auto my-auto">
                                                ...
                                                <div id="hs-medium-modal" class="hs-overlay hidden ti-modal">
                                                    <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out md:!max-w-2xl md:w-full m-3 md:mx-auto">
                                                        ...
                                                        <form action="<?php echo e(route('ESTB.renumerations.store')); ?>" method="post">
                                                            <?php echo csrf_field(); ?>
                                                            <div class="ti-modal-body">
                                                                ...
                                                                <div class="max-w-sm space-y-3">
                                                                    ...
                                                                    <?php if($errors->has('activity')): ?>
                                                                        <div class="text-red-700"><?php echo e($errors->first('activity')); ?></div>
                                                                    <?php endif; ?>
                                    ...
                                    <div class="box-body">
                                        ...
                                        <table id="renumtable" class="ti-custom-table ti-custom-table-head whitespace-nowrap">
                                            ...
                                            <?php
                                                $i = 1;
                                            ?>
                                            <?php $__empty_1 = true; $__currentLoopData = $renumerations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $renumeration): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            ...
                                            <tr class="bg-red-700">
                                                ...
                                                <div class="flex space-x-3 rtl:space-x-reverse w-full min-w-[200px]">
                                                    <div class="block w-full my-auto">
                                                        <?php echo e($renumeration->activity); ?>

                                                    </div>
                                                </div>
                                                </td>
                                                <td><span><?php echo e($renumeration->level); ?></span></td>
                                                <td><span><?php echo e($renumeration->status); ?></span></td>
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16"><path d="M16.7574 2.99666L14.7574 4.99666H5V18.9967H19V9.2393L21 7.2393V19.9967C21 20.5489 20.5523 20.9967 20 20.9967H4C3.44772 20.9967 3 20.5489 3 19.9967V3.99666C3 3.44438 3.44772 2.99666 4 2.99666H16.7574ZM20.4853 2.09717L21.8995 3.51138L12.7071 12.7038L11.2954 12.7062L11.2929 11.2896L20.4853 2.09717Z"></path></svg>
                                                        ...
                                                        <div id="design_edit_modal<?php echo e($i); ?>" class="hs-overlay hidden ti-modal">
                                                            <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out md:!max-w-2xl md:w-full m-3 md:mx-auto">
                                                                ...
                                                                <form  action="<?php echo e(route('ESTB.renumerations.update',$renumeration->id)); ?>" method="post">
                                                                    <?php echo csrf_field(); ?>
                                                                    ...
                                                                    <div class="ti-modal-body">
                                                                        ...
                                                                        <div class="max-w-sm space-y-3">
                                                                            <label for="with-corner-hint" class="ti-form-label font-bold">Renumeration Activity : </label>
                                                                            <input type="text" name="edit_activity" class="ti-form-input" placeholder="Renumaration Activity" value="<?php echo e($renumeration->activity); ?>">
                                                                            <?php if($errors->has('edit_activity')): ?>
                                                                                <div class="text-red-700"><?php echo e($errors->first('edit_activity')); ?></div>
                                                                            <?php endif; ?>
                                                                            <div id="activityNameError" class="error text-red-700"></div>
                                                                        </div>
                                                                        <div class="max-w-sm space-y-3">
                                                                            ...
                                                                            <select class="ti-form-select" name="level">
                                                                                ...
                                                                                <option value="UG" <?php echo e(($renumeration->level == "UG")?'selected':''); ?>>UG</option>
                                                                                <option value="PG" <?php echo e(($renumeration->level == "PG")?'selected':''); ?>>PG</option>
                                                                            </select>
                                                                            <?php if($errors->has('level')): ?>
                                                                                <div class="text-red-700"><?php echo e($errors->first('level')); ?></div>
                                                                            <?php endif; ?>
                                                ...
                                                <div class="hs-tooltip ti-main-tooltip">
                                                <form action="<?php echo e(route('ESTB.renumerations.destroy',$renumeration->id)); ?>" method="post">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\laravel Apps\gitoffice\resources\views/ESTB/renumerations/index.blade.php ENDPATH**/ ?>