                    ...
                    <div class="content">
                        ...
                        <div class="main-content">
                            ...
                            <div class="xxl:col-span-3 md:col-span-6 col-span-12">
                                <div class="box">
                                <img src="<?php echo e(asset('build/assets/img/media/1.jpg')); ?>" class="box-img-top rounded-t-sm" alt="...">
                                <div class="box-body">
                            ...
                            <div class="xxl:col-span-3 md:col-span-6 col-span-12">
                                <div class="box">
                                <img src="<?php echo e(asset('build/assets/img/media/2.jpg')); ?>" class="box-img-top rounded-t-sm" alt="...">
                                <div class="box-body">
                            ...
                            <div class="xxl:col-span-3 md:col-span-6 col-span-12">
                                <div class="box">
                                <img src="<?php echo e(asset('build/assets/img/media/3.jpg')); ?>" class="box-img-top rounded-t-sm" alt="...">
                            ...
                            <div class="xxl:col-span-6 col-span-12">
                                ...
                                <div class="box">
                                    <div class="box-body">
                                    <img src="<?php echo e(asset('build/assets/img/media/4.jpg')); ?>" class="rounded-sm mb-4" alt="...">
                                ...
                                <div class="box">
                                    <div class="box-body">
                                    <img src="<?php echo e(asset('build/assets/img/media/5.jpg')); ?>" class="rounded-sm mb-4" alt="...">
                                ...
                                <div class="box">
                                    <div class="box-body">
                                    <img src="<?php echo e(asset('build/assets/img/media/6.jpg')); ?>" class="rounded-sm mb-4" alt="...">
                            ...
                            <div class="xxl:col-span-9 col-span-12">
                                ...
                                <div class="xxl:col-span-4 col-span-12">
                                    ...
                                    <div class="box-body">
                                        <div class="mb-2">
                                        <img src="<?php echo e(asset('build/assets/img/users/15.jpg')); ?>" class="avatar avatar-sm rounded-sm" alt="Image Description">
                                        </div>
                                ...
                                <div class="xxl:col-span-4 col-span-12">
                                    ...
                                    <div class="box-body">
                                        <div class="mb-2">
                                        <img src="<?php echo e(asset('build/assets/img/users/3.jpg')); ?>" class="avatar avatar-sm rounded-sm" alt="Image Description">
                                        </div>
                                ...
                                <div class="xxl:col-span-4 col-span-12">
                                    ...
                                    <div class="box-body">
                                        <div class="mb-2">
                                        <img src="<?php echo e(asset('build/assets/img/users/11.jpg')); ?>" class="avatar avatar-sm rounded-sm" alt="Image Description">
                                        </div>
                            ...
                            <div class="xxl:col-span-3 col-span-12">
                                ...
                                <div class="box-header">
                                    ...
                                    <div class="ltr:mr-2 rtl:ml-2">
                                        <img src="<?php echo e(asset('build/assets/img/users/11.jpg')); ?>" class="avatar rounded-full" alt="Image Description">
                                    </div>
                                    <div class="">
                            ...
                            <div class="xxl:col-span-3 col-span-12">
                                ...
                                <div class="box-footer">
                                    ...
                                    <img src="<?php echo e(asset('build/assets/img/users/12.jpg')); ?>" class="avatar w-6 h-6 rounded-full ltr:mr-2 rtl:ml-2" alt="Image Description">
                            ...
                            <div class="xxl:col-span-3 col-span-12">
                                ...
                                <div class="box-body pt-1">
                                    <img src="<?php echo e(asset('build/assets/img/users/5.jpg')); ?>" class="avatar avatar-lg rounded-full ltr:mr-2 rtl:ml-2 mb-2" alt="Image Description">
                            ...
                            <div class="xxl:col-span-2 col-span-12">
                                <div class="box">
                                <div class="box-body">
                                    <img src="<?php echo e(asset('build/assets/img/media/7.jpg')); ?>" class="rounded-sm mb-4 w-full" alt="...">
                            ...
                            <div class="xxl:col-span-2 col-span-12">
                                <div class="box">
                                <div class="box-body">
                                    <img src="<?php echo e(asset('build/assets/img/media/8.jpg')); ?>" class="rounded-sm mb-4 w-full" alt="...">
                            ...
                            <div class="xxl:col-span-2 col-span-12">
                                <div class="box">
                                <div class="box-body">
                                    <img src="<?php echo e(asset('build/assets/img/media/9.jpg')); ?>" class="rounded-sm mb-4 w-full" alt="...">
                            ...
                            <div class="xxl:col-span-3 col-span-12">
                                ...
                                <div class="box-header">
                                    ...
                                    <img src="<?php echo e(asset('build/assets/img/users/12.jpg')); ?>" class="avatar rounded-full ltr:mr-6 rtl:ml-6" alt="Image Description">
                            ...
                            <div class="xxl:col-span-4 col-span-12">
                                <div class="box">
                                <img src="<?php echo e(asset('build/assets/img/media/10.jpg')); ?>" class="box-img-top rounded-t-sm" alt="...">
                                <div class="box-body">
                            ...
                            <div class="xxl:col-span-4 col-span-12">
                                ...
                                <img src="<?php echo e(asset('build/assets/img/media/11.jpg')); ?>" class="box-img-bottom rounded-b-sm" alt="...">
                                </div>
                            </div>
                            <div class="xxl:col-span-4 col-span-12">
                                <div class="box">
                                ...
                                <img src="<?php echo e(asset('build/assets/img/media/12.jpg')); ?>" class="" alt="...">
                                <div class="box-body">
                                    <p class="text-[0.813rem] mb-0"><small class="text-sm">Last updated 3 mins
                                        ago</small></p>
                                </div>
                            ...
                            <div class="xxl:col-span-4 col-span-12">
                                ...
                                <img src="<?php echo e(asset('build/assets/img/media/13.jpg')); ?>" class="" alt="...">
                                <div class="box-footer">
                                    <p class="text-[0.813rem] mb-0"><small class="text-sm">Last updated 3 mins
                                        ago</small></p>
                                </div>
                            ...
                            <div class="xxl:col-span-4 col-span-12">
                                <div class="box">
                                <img src="<?php echo e(asset('build/assets/img/media/14.jpg')); ?>" class="box-img-top rounded-t-sm" alt="...">
                                <div class="box-header">
                                    <div class="box-title">Image caps are widely used in Blog's</div>
                                </div>
                                <div class="box-body">
                            ...
                            <div class="xxl:col-span-4 col-span-12">
                                ...
                                <img src="<?php echo e(asset('build/assets/img/media/15.jpg')); ?>" class="box-img-bottom rounded-b-sm" alt="...">
                                </div>
                            </div>
                            </div>
                            <!-- End::row-6 -->
                            ...
                            <div class="grid grid-cols-12 gap-x-6">
                                <div class="xxl:col-span-4 col-span-12">
                                    <div class="box overlay-box">
                                        <img src="<?php echo e(asset('build/assets/img/media/16.jpg')); ?>" class="box-img" alt="...">
                                ...
                                <div class="xxl:col-span-4 col-span-12">
                                    <div class="box overlay-box">
                                        <img src="<?php echo e(asset('build/assets/img/media/17.jpg')); ?>" class="box-img" alt="...">
                                ...
                                <div class="xxl:col-span-4 col-span-12">
                                    <div class="box bg-dark overlay-box">
                                        <img src="<?php echo e(asset('build/assets/img/media/18.jpg')); ?>" class="box-img" alt="...">
                                        <div class="box-img-overlay flex flex-col p-0">
                                            <div class="box-header">
                                                <div class="box-title text-white">
                                                    Image Overlays Are Awesome!
                                    ...
                                    <div class="box">
                                        <div class="grid grid-cols-12 gap-0">
                                            <div class="col-span-12 md:col-span-4">
                                                <img src="<?php echo e(asset('build/assets/img/media/19.jpg')); ?>" class="img-fluid ltr:rounded-l-sm rtl:rounded-r-sm h-full w-full" alt="...">
                                            </div>
                                ...
                                <div class="xxl:col-span-4 col-span-12">
                                    <div class="box">
                                        <div class="grid grid-cols-12 gap-0">
                                            ...
                                            <div class="col-span-12 md:col-span-4">
                                                <img src="<?php echo e(asset('build/assets/img/media/20.jpg')); ?>" class="img-fluid ltr:rounded-r-sm rtl:rounded-l-sm h-full w-full" alt="...">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="xxl:col-span-4 col-span-12">
                                    <div class="box">
                                        <div class="grid grid-cols-12 gap-0">
                                            ...
                                            <div class="col-span-12 md:col-span-4">
                                                <img src="<?php echo e(asset('build/assets/img/media/21.jpg')); ?>" class="img-fluid ltr:rounded-r-sm rtl:rounded-l-sm h-full w-full" alt="...">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="grid grid-cols-12 gap-x-6">
                                <div class="xxl:col-span-3 col-span-12">
                                    <div class="box !bg-primary text-white">
                                        <div class="box-body">
                                            <div class="flex items-center w-full">
                                                <div class="ltr:mr-2 rtl:ml-2">
                                                <img src="<?php echo e(asset('build/assets/img/users/11.jpg')); ?>" class="avatar rounded-full ring-0" alt="Image Description">
                                                </div>
                                                <div class="">
                                                    <div class="text-base font-semibold">Adam Smith</div>
                                ...
                                <div class="xxl:col-span-3 col-span-12">
                                    <div class="box !bg-secondary text-white">
                                        ...
                                        <div class="flex items-center w-full">
                                            <div class="ltr:mr-2 rtl:ml-2">
                                                <img src="<?php echo e(asset('build/assets/img/users/12.jpg')); ?>" class="avatar rounded-full ring-0" alt="Image Description">
                                            </div>
                                            <div class="">
                                ...
                                <div class="xxl:col-span-3 col-span-12">
                                    <div class="box !bg-warning text-white">
                                        <div class="box-body">
                                            <div class="flex items-center w-full">
                                                <div class="ltr:mr-2 rtl:ml-2">
                                                <img src="<?php echo e(asset('build/assets/img/users/1.jpg')); ?>" class="avatar rounded-full ring-0" alt="Image Description">
                                                </div>
                                                <div class="">
                                ...
                                <div class="xxl:col-span-3 col-span-12">
                                    <div class="box !bg-success text-white">
                                        <div class="box-body">
                                            <div class="flex items-center w-full">
                                                <div class="ltr:mr-2 rtl:ml-2">
                                                <img src="<?php echo e(asset('build/assets/img/users/5.jpg')); ?>" class="avatar rounded-full ring-0" alt="Image Description">
                                                </div>
                                                <div class="">
                                ...
                                <div class="xxl:col-span-3 col-span-12">
                                    <div class="box !bg-danger text-white">
                                        <div class="box-body">
                                            <div class="flex items-center w-full">
                                                <div class="ltr:mr-2 rtl:ml-2">
                                                <img src="<?php echo e(asset('build/assets/img/users/14.jpg')); ?>" class="avatar rounded-full ring-0" alt="Image Description">
                                                </div>
                                                <div class="">
                                ...
                                <div class="xxl:col-span-3 col-span-12">
                                    <div class="box !bg-light">
                                        <div class="box-body">
                                            <div class="flex items-center w-full">
                                            <div class="ltr:mr-2 rtl:ml-2">
                                                <img src="<?php echo e(asset('build/assets/img/users/13.jpg')); ?>" class="avatar rounded-full ring-0" alt="Image Description">
                                            </div>
                                                <div class="">
                                ...
                                <div class="xxl:col-span-3 col-span-12">
                                    <div class="box !bg-dark text-white">
                                        <div class="box-body">
                                            <div class="flex items-center w-full">
                                            <div class="ltr:mr-2 rtl:ml-2">
                                                <img src="<?php echo e(asset('build/assets/img/users/16.jpg')); ?>" class="avatar rounded-full ring-0" alt="Image Description">
                                            </div>
                                                <div class="">
                                ...
                                <div class="xxl:col-span-3 col-span-12">
                                    <div class="box border !border-primary">
                                        <div class="box-body">
                                            ...
                                            <img class="avatar avatar-xs rounded-full" src="<?php echo e(asset('build/assets/img/users/1.jpg')); ?>" alt="Image Description">
                                            <img class="avatar avatar-xs rounded-full" src="<?php echo e(asset('build/assets/img/users/4.jpg')); ?>" alt="Image Description">
                                            <img class="avatar avatar-xs rounded-full" src="<?php echo e(asset('build/assets/img/users/2.jpg')); ?>" alt="Image Description">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="xxl:col-span-3 col-span-12">
                                    <div class="box border !border-warning">
                                        <div class="box-body">
                                            ...
                                            <img class="avatar avatar-xs rounded-full" src="<?php echo e(asset('build/assets/img/users/1.jpg')); ?>" alt="Image Description">
                                            <img class="avatar avatar-xs rounded-full" src="<?php echo e(asset('build/assets/img/users/4.jpg')); ?>" alt="Image Description">
                                            <img class="avatar avatar-xs rounded-full" src="<?php echo e(asset('build/assets/img/users/12.jpg')); ?>" alt="Image Description">
                                            <img class="avatar avatar-xs rounded-full" src="<?php echo e(asset('build/assets/img/users/10.jpg')); ?>" alt="Image Description">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="xxl:col-span-3 col-span-12">
                                    <div class="box border !border-success">
                                        <div class="box-body">
                                            ...
                                            <div class="flex -space-x-2 rtl:space-x-reverse">
                                            <img class="avatar avatar-xs rounded-full" src="<?php echo e(asset('build/assets/img/users/6.jpg')); ?>" alt="Image Description">
                                            <img class="avatar avatar-xs rounded-full" src="<?php echo e(asset('build/assets/img/users/9.jpg')); ?>" alt="Image Description">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="xxl:col-span-3 col-span-12">
                                    <div class="box border border-gray-200 dark:border-white/10">
                                        <div class="box-body">
                                            ...
                                            <div class="flex -space-x-2 rtl:space-x-reverse">
                                            <img class="avatar avatar-xs rounded-full" src="<?php echo e(asset('build/assets/img/users/6.jpg')); ?>" alt="Image Description">
                                            <img class="avatar avatar-xs rounded-full" src="<?php echo e(asset('build/assets/img/users/5.jpg')); ?>" alt="Image Description">
                                            <img class="avatar avatar-xs rounded-full" src="<?php echo e(asset('build/assets/img/users/9.jpg')); ?>" alt="Image Description">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="xxl:col-span-3 col-span-12">
                                    <div class="box border border-dark">
                                        <div class="box-body">
                                            ...
                                            <img class="avatar avatar-xs rounded-full" src="<?php echo e(asset('build/assets/img/users/5.jpg')); ?>" alt="Image Description">
                                            <img class="avatar avatar-xs rounded-full" src="<?php echo e(asset('build/assets/img/users/9.jpg')); ?>" alt="Image Description">
                                            <img class="avatar avatar-xs rounded-full" src="<?php echo e(asset('build/assets/img/users/15.jpg')); ?>" alt="Image Description">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="grid grid-cols-12 gap-x-6">
                                <div class="col-span-12">
                                    <div class="grid border rounded-sm shadow-sm divide-y overflow-hidden sm:flex sm:divide-y-0 sm:divide-x sm:rtl:divide-x-reverse dark:border-gray-700 dark:shadow-black/[0.05] dark:divide-gray-600">
                                        ...
                                        <img class="w-full h-auto rounded-t-sm ltr:sm:rounded-tr-none rtl:sm:rounded-tl-none" src="<?php echo e(asset('build/assets/img/media/22.jpg')); ?>" alt="Image Description">
                                    ...
                                    <div class="mb-0 box rounded-none border-0 flex flex-col flex-[1_0_0%]">
                                    <img class="w-full h-auto" src="<?php echo e(asset('build/assets/img/media/23.jpg')); ?>" alt="Image Description">
                                    <div class="box-body flex-1">
                                    ...
                                    <div class="mb-0 box rounded-none border-0 flex flex-col flex-[1_0_0%]">
                                    <img class="w-full h-auto ltr:sm:rounded-tr-sm rtl:sm:rounded-tl-sm" src="<?php echo e(asset('build/assets/img/media/24.jpg')); ?>" alt="Image Description">
                                    <div class="box-body flex-1">
                            ...
                            <div class="grid grid-cols-12 gap-x-6">
                                        ...
                                        <div class="xxl:col-span-5 col-span-12">
                                            ...
                                            <div class="box border !border-info">
                                                ...
                                                <div class="box-body">
                                                    <div class="flex items-center">
                                                        <div class="ltr:mr-3 rtl:ml-3">
                                                            <img src="<?php echo e(asset('build/assets/img/users/8.jpg')); ?>" class="avatar avatar-lg  rounded-sm" alt="Image Description">
                                                        </div>
                                                        <div>
                                        ...
                                        <div class="xxl:col-span-7 col-span-12">
                                            <div class="box">
                                                ...
                                                <div class="grid grid-cols-12 gap-0">
                                                    ...
                                                    <div class="col-span-12 md:col-span-4">
                                                        <img src="<?php echo e(asset('build/assets/img/media/21.jpg')); ?>" class="img-fluid ltr:rounded-r-sm rtl:rounded-l-sm h-full" alt="...">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="xxl:col-span-3 col-span-12">
                                    <div class="box">
                                        <a aria-label="anchor" href="javascript:void(0);" class="box-anchor"></a>
                                        <img src="<?php echo e(asset('build/assets/img/media/25.jpg')); ?>" class="box-img-top rounded-t-sm" alt="...">
                                        <div class="box-body">
                            ...
                            <div class="grid grid-cols-12 gap-x-6">
                                <div class="col-span-12">
                                    <div class="grid md:grid-cols-4 grid-cols-1 gap-x-6">
                                        <div class="box">
                                            <img src="<?php echo e(asset('build/assets/img/media/26.jpg')); ?>" class="box-img-top rounded-t-sm" alt="...">
                                            <div class="box-body">
                                        ...
                                        <div class="box">
                                            <img src="<?php echo e(asset('build/assets/img/media/27.jpg')); ?>" class="box-img-top rounded-t-sm" alt="...">
                                            <div class="box-body">
                                        ...
                                        <div class="box">
                                            <img src="<?php echo e(asset('build/assets/img/media/28.jpg')); ?>" class="box-img-top rounded-t-sm" alt="...">
                                            <div class="box-body">
                                                <h6 class="text-base box-title font-semibold">Most tropical areas are suitable</h6>
                                                <p class="text-[0.813rem]"> If you are going to use a passage of Lorem Ipsum, you need to be sure there
                                                    isn't anything embarrassing hidden in the middle of text.</p>
                                        ...
                                        <div class="box">
                                            <img src="<?php echo e(asset('build/assets/img/media/29.jpg')); ?>" class="box-img-top rounded-t-sm" alt="...">
                                            <div class="box-body">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\projects\my-projects\laravel\vite\synto\synto-laravel\synto\resources\views/pages/cards.blade.php ENDPATH**/ ?>