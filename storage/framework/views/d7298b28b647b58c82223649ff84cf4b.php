                    ...
                    <div class="content">
                        ...
                        <div class="main-content">
                            ...
                            <div class="col-span-12 xxl:col-span-9">
                                ...
                                <div class="box-body space-y-2 p-0">
                                    ...
                                    <div class="col-span-12 md:col-span-2">
                                        ...
                                        <span class="payment-sec">
                                            <span class="block">
                                            <img src="<?php echo e(asset('build/assets/img/payment-cards/1.png')); ?>" alt="payment-img"
                                    ...
                                    <div class="col-span-12 md:col-span-2">
                                        ...
                                        <span class="payment-sec">
                                            <span class="block">
                                            <img src="<?php echo e(asset('build/assets/img/payment-cards/2.png')); ?>" alt="payment-img"
                                                class="avatar avatar-lg shadow-none !ring-transparent rounded-sm mx-auto">
                                            </span>
                                    ...
                                    <div class="col-span-12 md:col-span-2">
                                        ...
                                        <span class="payment-sec">
                                            <span class="block">
                                            <img src="<?php echo e(asset('build/assets/img/payment-cards/3.png')); ?>" alt="payment-img"
                                                class="avatar avatar-lg shadow-none !ring-transparent rounded-sm mx-auto">
                                            </span>
                                    ...
                                    <div class="col-span-12 md:col-span-2">
                                        ...
                                        <span class="payment-sec">
                                            <span class="block">
                                            <img src="<?php echo e(asset('build/assets/img/payment-cards/4.png')); ?>" alt="payment-img"
                                                class="avatar avatar-lg shadow-none !ring-transparent rounded-sm mx-auto">
                                            </span>
                                    ...
                                    <div class="col-span-12 md:col-span-2">
                                        ...
                                        <span class="payment-sec">
                                            <span class="block">
                                            <img src="<?php echo e(asset('build/assets/img/payment-cards/5.png')); ?>" alt="payment-img"
                                                class="avatar avatar-lg shadow-none !ring-transparent rounded-sm mx-auto">
                                            </span>
                                    ...
                                    <div class="col-span-12 md:col-span-2">
                                        ...
                                        <span class="payment-sec">
                                            <span class="block">
                                            <img src="<?php echo e(asset('build/assets/img/payment-cards/6.png')); ?>" alt="payment-img"
                                                class="avatar avatar-lg shadow-none !ring-transparent rounded-sm mx-auto">
                                            </span>
                                    ...
                                    <div class="col-span-12 md:col-span-2">
                                        ...
                                        <span class="payment-sec">
                                            <span class="block">
                                            <img src="<?php echo e(asset('build/assets/img/payment-cards/7.png')); ?>" alt="payment-img"
                                                class="avatar avatar-lg shadow-none !ring-transparent rounded-sm mx-auto">
                                            </span>
                                    ...
                                    <div class="col-span-12 md:col-span-2">
                                        ...
                                        <span class="payment-sec">
                                            <span class="block">
                                            <img src="<?php echo e(asset('build/assets/img/payment-cards/8.png')); ?>" alt="payment-img"
                                                class="avatar avatar-lg shadow-none !ring-transparent rounded-sm mx-auto">
                                            </span>
                                    ...
                                    <div class="col-span-12 md:col-span-2">
                                        ...
                                        <span class="payment-sec">
                                            <span class="block">
                                            <img src="<?php echo e(asset('build/assets/img/payment-cards/9.png')); ?>" alt="payment-img"
                                                class="avatar avatar-lg shadow-none !ring-transparent rounded-sm mx-auto">
                                            </span>
                                    ...
                                    <div class="col-span-12 md:col-span-2">
                                        ...
                                        <span class="payment-sec">
                                            <span class="block">
                                            <img src="<?php echo e(asset('build/assets/img/payment-cards/10.png')); ?>" alt="payment-img"
                                                class="avatar avatar-lg shadow-none !ring-transparent rounded-sm mx-auto">
                                            </span>
                                    ...
                                    <div class="col-span-12 md:col-span-2">
                                        ...
                                        <span class="payment-sec">
                                            <span class="block">
                                            <img src="<?php echo e(asset('build/assets/img/payment-cards/11.png')); ?>" alt="payment-img"
                                                class="avatar avatar-lg shadow-none !ring-transparent rounded-sm mx-auto">
                                            </span>
                                    ...
                                    <div class="col-span-12 md:col-span-2">
                                        ...
                                        <span class="payment-sec">
                                            <span class="block">
                                            <img src="<?php echo e(asset('build/assets/img/payment-cards/12.png')); ?>" alt="payment-img"
                                                class="avatar avatar-lg shadow-none !ring-transparent rounded-sm mx-auto">
                                            </span>
                                ...
                                <a href="<?php echo e(url('cart')); ?>" class="ti-btn ti-btn-secondary m-0"><i class="ri-arrow-left-line"></i> Back to cart</a>
                            ...
                            <div class="col-span-12 xxl:col-span-3">
                                ...
                                <div class="box-body px-0 space-y-5">
                                    ...
                                    <div class="flex items-center">
                                        <img
                                        class="inline-block flex-shrink-0 h-[3.875rem] w-[3.875rem] rounded-sm p-2 border dark:border-white/10 bg-gray-100 dark:bg-black/20"
                                        src="<?php echo e(asset('build/assets/img/ecommerce/products/7.png')); ?>" alt="Image Description">
                                        <div class="ltr:ml-4 rtl:mr-4 space-y-1">
                            ...
                            <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out h-[calc(100%-3.5rem)] min-h-[calc(100%-3.5rem)] flex items-center !max-w-2xl">
                                ...
                                <div class="ti-modal-body !p-6">
                                    ...
                                    <div class="mb-5">
                                        <img src="<?php echo e(asset('build/assets/img/png-images/13.png')); ?>" alt="" class="mx-auto">
                                    </div>
                                    <div class="text-center">
                                        ...
                                        <a href="<?php echo e(url('order-details')); ?>" class="ti-btn ti-btn-secondary mt-4">Track Your Order</a>
                                    </div>
                                    </div>
                                </div>
                                </div>
...
<?php $__env->startSection('scripts'); ?>
        ...
        <!-- CHECK-OUT JS -->
        <?php echo app('Illuminate\Foundation\Vite')('resources/assets/js/checkout.js'); ?>


<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\projects\my-projects\laravel\vite\synto\synto-laravel\synto\resources\views/pages/checkout.blade.php ENDPATH**/ ?>