                            ...
                            <div class="col-span-12">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="mx-auto relative">
                                        ...
                                        <img src="<?php echo e(asset('build/assets/img/users/1.jpg')); ?>" class="rounded-full" alt="timeline-img">
                                        </div>
                                    </div>
                                    ...
                                    <div class="mx-auto relative">
                                        ...
                                        <div
                                        class="avatar avatar-xs absolute top-0 rounded-full bg-gray-200 shadow text-center ltr:-left-[4px] rtl:-right-[4px]">
                                        <img src="<?php echo e(asset('build/assets/img/users/3.jpg')); ?>" class="rounded-full" alt="timeline-img">
                                        </div>
                                    </div>
                                    <div class="flex w-full pb-8">
                                        <div class="ltr:ml-5 rtl:mr-5 rounded-sm ltr:mr-auto rtl:ml-auto my-auto w-full space-y-3">
                                    ...
                                    <div class="mx-auto relative">
                                        ...
                                        <div
                                        class="avatar avatar-xs absolute top-0 rounded-full bg-gray-200 shadow text-center ltr:-left-[4px] rtl:-right-[4px]">
                                        <img src="<?php echo e(asset('build/assets/img/users/2.jpg')); ?>" class="rounded-full" alt="timeline-img">
                                        </div>
                                    </div>
                                    <div class="flex w-full pb-8">
                                        <div class="ltr:ml-5 rtl:mr-5 rounded-sm ltr:mr-auto rtl:ml-auto my-auto w-full space-y-3">
                                        ...
                                        <div><img src="<?php echo e(asset('build/assets/img/gallery/2.jpg')); ?>" class="avatar avatar-lg rounded-sm" alt="profile-img">
                                        </div>
                                        </div>
                                    </div>
                                    </div>
                                    ...
                                    <div class="mx-auto relative">
                                        ...
                                        <div
                                        class="avatar avatar-xs absolute top-0 rounded-full bg-gray-200 shadow text-center ltr:-left-[4px] rtl:-right-[4px]">
                                        <img src="<?php echo e(asset('build/assets/img/users/15.jpg')); ?>" class="rounded-full" alt="timeline-img">
                                        </div>
                                    </div>
                                    <div class="flex w-full pb-8">
                                        <div class="ltr:ml-5 rtl:mr-5 rounded-sm ltr:mr-auto rtl:ml-auto my-auto w-full space-y-3">
                                        ...
                                        <div class="space-y-3">
                                            ...
                                            <img src="<?php echo e(asset('build/assets/img/gallery/5.jpg')); ?>" class="avatar avatar-lg rounded-sm" alt="profile-img">
                                        </div>
                                        </div>
                                    </div>
                                    </div>
                                    ...
                                    <div class="mx-auto relative">
                                        ...
                                        <div
                                        class="avatar avatar-xs absolute top-0 rounded-full bg-gray-200 shadow text-center ltr:-left-[4px] rtl:-right-[4px]">
                                        <img src="<?php echo e(asset('build/assets/img/users/21.jpg')); ?>" class="rounded-full" alt="timeline-img">
                                        </div>
                                    </div>
                                    <div class="flex w-full pb-8">
                                        <div class="ltr:ml-5 rtl:mr-5 rounded-sm ltr:mr-auto rtl:ml-auto my-auto w-full space-y-3">
                                        ...
                                        <div class="timeline-left">
                                            ...
                                            <div class="box">
                                                ...
                                                <div class="sm:space-y-0 space-y-2 sm:flex items-center justify-between">
                                                    ...
                                                    <div class="flex">
                                                        <img class="avatar avatar-sm ring-0 rounded-full" src="<?php echo e(asset('build/assets/img/users/2.jpg')); ?>" alt="avatar">
                                                    </div>
                                                    <div>
                                        ...
                                        <div class="timeline-right">
                                            ...
                                            <div class="box">
                                                ...
                                                <div class="sm:space-y-0 space-y-2 sm:flex items-center justify-between">
                                                    <div class="sm:flex items-center sm:space-x-3 space-x-0 sm:space-y-0 space-y-2 rtl:space-x-reverse">
                                                    <div class="flex">
                                                        <img class="avatar avatar-sm ring-0 rounded-full" src="<?php echo e(asset('build/assets/img/users/1.jpg')); ?>" alt="avatar">
                                                    </div>
                                                    <div>
                                                        <p class="text-slate-700 font-semibold text-sm dark:text-white">
                                                        Anderson Itumay
                                        ...
                                        <div class="timeline-left">
                                            ...
                                            <div class="box">
                                                ...
                                                <div class="sm:space-y-0 space-y-2 sm:flex items-center justify-between">
                                                    <div class="sm:flex items-center sm:space-x-3 space-x-0 sm:space-y-0 space-y-2 rtl:space-x-reverse">
                                                    <div class="flex">
                                                        <img class="avatar avatar-sm ring-0 rounded-full" src="<?php echo e(asset('build/assets/img/users/21.jpg')); ?>" alt="avatar">
                                                    </div>
                                                    <div>
                                                        <p class="text-slate-700 font-semibold text-sm dark:text-white">
                                                        Harvey Mattos
                                        ...
                                        <div class="timeline-right">
                                            ...
                                            <div class="box">
                                                ...
                                                <div class="sm:space-y-0 space-y-2 sm:flex items-center justify-between">
                                                    <div class="sm:flex items-center sm:space-x-3 space-x-0 sm:space-y-0 space-y-2 rtl:space-x-reverse">
                                                    <div class="flex">
                                                        <img class="avatar ring-0 rounded-full" src="<?php echo e(asset('build/assets/img/users/15.jpg')); ?>" alt="avatar">
                                                    </div>
                                                    <div>
                                                        <p class="text-slate-700 font-semibold text-sm dark:text-white">
                                                        Anesthesia
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\projects\my-projects\laravel\vite\synto\synto-laravel\synto\resources\views/pages/timeline.blade.php ENDPATH**/ ?>