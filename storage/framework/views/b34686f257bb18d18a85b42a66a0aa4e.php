                                ...
                                <div class="box">
                                                        ...
                                                        <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out md:!max-w-2xl md:w-full m-3 md:mx-auto">
                                                            ...
                                                            <div class="ti-modal-header">
                                                                ...
                                                                <div class="ti-modal-body">
                                                                    <form action="<?php echo e(route('ESTB.designations.store')); ?>" method="post">
                                                                        <?php echo csrf_field(); ?>
                                                                        ...
                                                                        <div class="max-w-sm space-y-3 pb-6">
                                                                            ...
                                                                            <?php if($errors->has('design_name')): ?>
                                                                                <div class="text-red-700"><?php echo e($errors->first('design_name')); ?></div>
                                                                            <?php endif; ?>
                                    ...
                                    <div class="box-body">
                                        ...
                                        <table id="designations_table" class="ti-custom-table ti-custom-table-head whitespace-nowrap">
                                            ...
                                            <?php $__empty_1 = true; $__currentLoopData = $designation; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $design): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                ...
                                                <tr class="bg-red-700">
                                                    ...
                                                    <div class="flex space-x-3 rtl:space-x-reverse w-full min-w-[200px]">
                                                        <div class="block w-full my-auto">
                                                            <?php echo e($design->design_name); ?>

                                                        </div>
                                                    </div>
                                                    </td>
                                                    <td><span><?php echo e(($design->isadditional == 0)? 'No':'Yes'); ?></span></td>
                                                    <td><span><?php echo e($design->isvacational); ?></span></td>
                                                    <td><span><?php echo e(($design->emp_type=="Teaching")?'Teaching':'Non-Teaching'); ?></span></td>
                                                    <td><span><?php echo e($design->status); ?></span></td>
                                                                                            
                                                    <td class="font-medium space-x-2 rtl:space-x-reverse">
                                                    <div class="hs-tooltip ti-main-tooltip">
                                                        <button data-hs-overlay="#design_edit_modal<?php echo e($i); ?>" id="btn<?php echo e($i); ?>" btn-val=<?php echo e($i); ?>
                                                            ...
                                                            <div id="design_edit_modal<?php echo e($i); ?>" class="hs-overlay hidden ti-modal">
                                                                <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out lg:!max-w-4xl lg:w-full m-3 lg:!mx-auto">
                                                                    ...
                                                                    <div class="ti-modal-header">
                                                                        ...
                                                                        <button type="button" class="hs-dropdown-toggle ti-modal-close-btn"
                                                                            data-hs-overlay="#design_edit_modal<?php echo e($i); ?>">
                                                                            <span class="sr-only">Close</span>
                                                                            <svg class="w-3.5 h-3.5" width="8" height="8" viewBox="0 0 8 8" fill="none"
                                                                                xmlns="http://www.w3.org/2000/svg">
                                                                                <path
                                                                        ...
                                                                        <?php if(($errors->has('design_name'))||($errors->has('edit_isadditional'))||($errors->has('edit_isvacational'))||($errors->has('edit_emp_type'))): ?>
                                                                            <script>
                                                                                //alert(1);
                                                                                $(window).on('load', function() {
                                                                                    //alert(249)
                                                                    ...
                                                                    <form  action="<?php echo e(route('ESTB.designations.update',$design->id)); ?>" method="post">
                                                                        <?php echo csrf_field(); ?>
                                                                        ...
                                                                        <div class="ti-modal-body">
                                                                            ...
                                                                            <div class="max-w-sm space-y-3 pb-6">
                                                                                ...
                                                                                <input type="text" name="edit_design_name" class="ti-form-input designationname" placeholder="Designation name" value="<?php echo e($design->design_name); ?>">
                                                                                <?php if($errors->has('design_name')): ?>
                                                                                    <div class="text-red-700"><?php echo e($errors->first('design_name')); ?></div>
                                                                                <?php endif; ?>
                                                                                <div id="designNameError" class="error text-red-700"></div>
                                                                            ...
                                                                            <div class="max-w-sm space-y-3 pb-6">
                                                                                <input type="radio" name="edit_isadditional" class="pr-4 ti-form-radio"  value="1"  <?php echo e(($design->isadditional == 1)?'checked':''); ?>>
                                                                                <label for="isadditional1" class="text-sm text-gray-500 ltr:ml-2 rtl:mr-2 dark:text-white/70 pr-4 font-bold"> Yes</label>
                                                                            
                                                                                <input type="radio" name="edit_isadditional" class="pr-4 ti-form-radio"  value="0"  <?php echo e(($design->isadditional == 0)?'checked':''); ?>>
                                                                                <label for="isadditional2" class="text-sm text-gray-500 ltr:ml-2 rtl:mr-2 dark:text-white/70 pr-4 font-bold"> No</label>
                                                                            </div>
                                                                            <br/>
                                                                            <label for="with-corner-hint" class="ti-form-label font-bold">Is Vacational ?</label>
                                                                            <div class="flex pb-6">
                                                                                ...
                                                                                <input type="radio" name="edit_isvacational" class="ti-form-radio"  value="Vacational"  <?php echo e(($design->isvacational == 'Vacational')? 'checked':''); ?>>
                                                                                <label for="isvacational1" class="text-sm text-gray-500 ltr:ml-2 rtl:mr-2 dark:text-white/70 pr-4 font-bold" > Vacational</label>
                                                                                <input type="radio" name="edit_isvacational" class="ti-form-radio"  value="Non-vacational"  <?php echo e(($design->isvacational == 'Non-Vacational')? 'checked':''); ?>>
                                                                            ...
                                                                            <label for="with-corner-hint" class="ti-form-label">This designation is applicable for employee type ?</label>
                                                                                <div class="max-w-sm space-y-3 pb-6">
                                                                                    ...
                                                                                    <input type="radio" name="edit_emp_type" class="ti-form-radio"  value="Non-Teaching" <?php echo e(($design->emp_type == "Non-Teaching")?'checked':''); ?>>
                                                                                    ...
                                                                                    <input type="radio" name="edit_emp_type" class="ti-form-radio" value="Teaching"  <?php echo e($design->emp_type== "Teaching"?'checked':''); ?>>
                                                                                    <label for="hs-radio-group-2" class="text-sm text-gray-500 ltr:ml-2 rtl:mr-2 dark:text-white/70"> Teaching Employees</label>
                                                                                </div>
                                                                                

                                                                            <?php if($design->status == 'inactive'): ?>
                                                                            <br/>
                                                                                <div class="flex pb-6">
                                                    ...
                                                    <div class="hs-tooltip ti-main-tooltip">
                                                    <form action="<?php echo e(route('ESTB.designations.destroy',$design->id)); ?>" method="post">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\laravel Apps\gitoffice\resources\views/ESTB/designations/index.blade.php ENDPATH**/ ?>