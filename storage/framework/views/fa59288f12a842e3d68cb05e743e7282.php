...
<?php $__env->startSection('content'); ?>
                    ...
                    <div class="content relative">
                        ...
                        <div class="flex relative before:bg-primary/80 before:absolute before:w-full before:h-full">
                            <img src="<?php echo e(asset('build/assets/img/png-images/14.jpg')); ?>" alt="" class="h-[400px] w-full rounded-sm" id="profile-img2">
                        </div>
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="mt-5">
                                        ...
                                        <div class="grid sm:grid-cols-12 gap-x-6">
                                            <label class="col-span-3 my-auto ti-form-label whitespace-nowrap">Full Name:</label>
                                            <input type="text" class="col-span-9 ti-form-input" placeholder="Enter Full Name">
                                        </div>
                                        <div class="grid sm:grid-cols-12 gap-x-6">
                                            <label class="col-span-3 my-auto ti-form-label whitespace-nowrap">Email ID:</label>
                                            <input type="email" class="col-span-9 ti-form-input" placeholder="Enter Email Id">
                                        </div>
                                        <div class="grid sm:grid-cols-12 gap-x-6">
                                            <label class="col-span-3 my-auto ti-form-label whitespace-nowrap">Phone No:</label>
                                            <input type="number" class="col-span-9 ti-form-input" placeholder="Enter Phone No">
                                        </div>
                                        <div class="grid sm:grid-cols-12 gap-x-6">
                                            <label class="col-span-3 my-auto ti-form-label whitespace-nowrap">Message:</label>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\projects\laravel\vite\synto\synto\resources\views/pages/contactus.blade.php ENDPATH**/ ?>