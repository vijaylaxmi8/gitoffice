                ...
                <div class="lg:col-span-6 col-span-12 hidden lg:block relative">
                    <div class="cover relative w-full h-full z-[1] p-10">
                        <a href="<?php echo e(url('index')); ?>" class="header- logo">
                            <img src="<?php echo e(asset('build/assets/img/brand-logos/desktop-dark.png')); ?>" alt="logo"
                                ...
                                <div class="p-4 sm:p-7">
                                    <div class="text-center">
                                        ...
                                        <p class="mt-3 text-sm text-gray-600 dark:text-white/70">
                                            ...
                                            <a class="text-primary decoration-2 hover:underline font-medium" href="<?php echo e(url('signup')); ?>">
                                                Sign up here
                                            </a>
                                        </p>
                                    </div>
                                    ...
                                    <div class="mt-5">
                                        <button type="button"
                                            ...
                                            <img src="<?php echo e(asset('build/assets/img/authentication/social/1.png')); ?>" class="w-4 h-4"
                                                alt="google-img">
                                            Sign in with Google
                                        </button>
                                                ...
                                                <div>
                                                    <div class="flex justify-between items-center">
                                                        ...
                                                        <a class="text-sm text-primary decoration-2 hover:underline font-medium"
                                                            href="<?php echo e(url('forgot')); ?>">Forgot password?</a>
                                                    </div>
                                                    <div class="relative">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.custom-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\projects\my-projects\laravel\vite\synto\synto-laravel\synto\resources\views/pages/signin-cover2.blade.php ENDPATH**/ ?>