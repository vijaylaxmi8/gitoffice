...
<?php $__env->startSection('content'); ?>
                    ...
                    <div class="content relative">
                        ...
                        <div class="flex relative before:bg-primary/80 before:absolute before:w-full before:h-full">
                            <img src="<?php echo e(asset('build/assets/img/png-images/14.jpg')); ?>" alt="" class="h-[500px] w-full rounded-sm" id="profile-img2">
                        </div>
                        ...
                        <div class="main-content sm:-mt-32 -mt-16">
                            ...
                            <div class="box">
                                ...
                                <div class="grid xl:grid-cols-2 gap-6">
                                    <div>
                                    <img class="rounded-sm" src="<?php echo e(asset('build/assets/img/gallery/10.jpg')); ?>" alt="">
                                    </div>
                                    <div class="space-y-3">
                            ...
                            <div class="box">
                                ...
                                <div class="grid xl:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                    <img class="rounded-sm" src="<?php echo e(asset('build/assets/img/gallery/9.jpg')); ?>" alt="">
                                    </div>
                                </div>
                                </div>
                            </div>
                            ...
                            <div class="box bg-transparent border-0 shadow-none">
                                ...
                                <div class="sm:grid sm:space-y-0 space-y-6 grid-cols-12 gap-6">
                                    ...
                                    <div class="box mb-0">
                                        ...
                                        <div class="mx-auto">
                                            <img alt="service-img" src="<?php echo e(asset('build/assets/img/png-images/3.png')); ?>">
                                        </div>
                                    ...
                                    <div class="box mb-0">
                                        <div class="box-body space-y-3 text-center">
                                        <div class="mx-auto">
                                            <img alt="service-img" src="<?php echo e(asset('build/assets/img/png-images/4.png')); ?>">
                                        </div>
                                    ...
                                    <div class="box mb-0">
                                        <div class="box-body space-y-3 text-center">
                                        <div class="mx-auto">
                                            <img alt="service-img" src="<?php echo e(asset('build/assets/img/png-images/6.png')); ?>">
                                        </div>
                                    ...
                                    <div class="box mb-0">
                                        <div class="box-body space-y-3 text-center">
                                        <div class="mx-auto">
                                            <img alt="service-img" src="<?php echo e(asset('build/assets/img/png-images/5.png')); ?>">
                                        </div>
                                ...
                                <div class="swiper about-swipe2">
                                    ...
                                    <div class="swiper-slide">
                                        ...
                                        <div class="box-body">
                                            ...
                                            <a class="flex my-auto ">
                                            <img alt="testimonial" src="<?php echo e(asset('build/assets/img/users/5.jpg')); ?>" class="avatar avatar-sm !rounded-full">
                                            <div class="ltr:pl-4 rtl:pr-4 my-auto">
                                    ...
                                    <div class="swiper-slide">
                                        ...
                                        <div class="box-body">
                                            ...
                                            <a class="flex my-auto ">
                                            <img alt="testimonial" src="<?php echo e(asset('build/assets/img/users/15.jpg')); ?>" class="avatar avatar-sm !rounded-full">
                                            <div class="ltr:pl-4 rtl:pr-4 my-auto">
...
<?php $__env->startSection('scripts'); ?>
        ...
        <!-- ABOUT JS -->
        <?php echo app('Illuminate\Foundation\Vite')('resources/assets/js/about.js'); ?>


<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\projects\my-projects\laravel\vite\synto\synto-laravel\synto\resources\views/pages/about.blade.php ENDPATH**/ ?>