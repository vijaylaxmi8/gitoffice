                        ...
                        <div class="main-content">
                            ...
                            <div class="grid grid-cols-12 gap-x-6">
                                <div class="col-span-12 xl:col-span-4">
                                    ...
                                    <div class="box-body space-x-2 rtl:space-x-reverse sm:space-x-6 space-y-2 last:xl:space-x-0">
                                        ...
                                        <img class="avatar avatar-sm rounded-full" src="<?php echo e(asset('build/assets/img/users/1.jpg')); ?>" alt="Image Description">
                                        <img class="avatar rounded-full" src="<?php echo e(asset('build/assets/img/users/1.jpg')); ?>" alt="Image Description">
                                        <img class="avatar avatar-lg rounded-full" src="<?php echo e(asset('build/assets/img/users/1.jpg')); ?>" alt="Image Description">
                                    </div>
                                    </div>
                                </div>
                                <div class="col-span-12 xl:col-span-4">
                                    ...
                                    <div class="box-body space-x-2 rtl:space-x-reverse sm:space-x-6 space-y-2 last:xl:space-x-0">
                                        <img class="rounded-sm avatar avatar-xs" src="<?php echo e(asset('build/assets/img/users/1.jpg')); ?>" alt="Image Description">
                                        <img class="rounded-sm avatar avatar-sm" src="<?php echo e(asset('build/assets/img/users/1.jpg')); ?>" alt="Image Description">
                                        <img class="rounded-sm avatar" src="<?php echo e(asset('build/assets/img/users/1.jpg')); ?>" alt="Image Description">
                                        <img class="rounded-sm avatar avatar-lg" src="<?php echo e(asset('build/assets/img/users/1.jpg')); ?>" alt="Image Description">
                                    </div>
                                    </div>
                                </div>
                                <div class="col-span-12 xl:col-span-4">
                                    ...
                                    <div class="box-body space-x-2 rtl:space-x-reverse sm:space-x-6 space-y-2 last:xl:space-x-0">
                                        <img class="avatar avatar-xs rounded-sm" src="<?php echo e(asset('build/assets/img/users/1.jpg')); ?>" alt="Image Description">
                                        <img class="avatar avatar-sm rounded-sm" src="<?php echo e(asset('build/assets/img/users/1.jpg')); ?>" alt="Image Description">
                                        <img class="avatar rounded-sm" src="<?php echo e(asset('build/assets/img/users/1.jpg')); ?>" alt="Image Description">
                                        <img class="avatar avatar-lg rounded-sm" src="<?php echo e(asset('build/assets/img/users/1.jpg')); ?>" alt="Image Description">
                                    </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-12 gap-x-6">
                                ...
                                <div class="col-span-12 xl:col-span-4">
                                    ...
                                    <div class="box-body space-x-2 rtl:space-x-reverse sm:space-x-6 space-y-2 last:xl:space-x-0">
                                        <div class="relative inline-block">
                                        <img class="avatar rounded-sm avatar-xs" src="<?php echo e(asset('build/assets/img/users/1.jpg')); ?>" alt="Image Description">
                                        <span
                                        ...
                                        <div class="relative inline-block">
                                        <img class="avatar rounded-sm avatar-sm" src="<?php echo e(asset('build/assets/img/users/1.jpg')); ?>" alt="Image Description">
                                        <span
                                        ...
                                        <div class="relative inline-block">
                                        <img class="avatar rounded-sm avatar-lg" src="<?php echo e(asset('build/assets/img/users/1.jpg')); ?>" alt="Image Description">
                                        <span
                            ...
                            <div class="grid grid-cols-12 gap-x-6">
                                <div class="col-span-12 xl:col-span-4">
                                    ...
                                    <div class="box-body space-x-2 rtl:space-x-reverse sm:space-x-6 space-y-2 last:xl:space-x-0 overflow-hidden">
                            ...
                            <div class="grid grid-cols-12 gap-x-6">
                                <div class="col-span-12 xl:col-span-4">
                                    ...
                                    <div class="box-body space-x-2 rtl:space-x-reverse sm:space-x-6 space-y-2 last:xl:space-x-0">
                                        ...
                                        <img src="<?php echo e(asset('build/assets/img/users/21.jpg')); ?>" alt="userimg">
                                        </span>
                            ...
                            <div class="grid grid-cols-12 gap-x-6">
                                <div class="col-span-12 xl:col-span-6">
                                    ...
                                    <div class="box-body">
                                        <div class="sm:grid gap-10 space-y-4 sm:space-y-0 sm:items-end">
                                        <div class="flex -space-x-2 rtl:space-x-reverse">
                                            ...
                                            <img class="avatar avatar-xs rounded-full" src="<?php echo e(asset('build/assets/img/users/3.jpg')); ?>" alt="Image Description">
                                        </div>
                                        <div class="flex -space-x-2 rtl:space-x-reverse">
                                            <img class="avatar avatar-sm rounded-full" src="<?php echo e(asset('build/assets/img/users/1.jpg')); ?>" alt="Image Description">
                                            <img class="avatar avatar-sm rounded-full" src="<?php echo e(asset('build/assets/img/users/4.jpg')); ?>" alt="Image Description">
                                            <img class="avatar avatar-sm rounded-full" src="<?php echo e(asset('build/assets/img/users/2.jpg')); ?>" alt="Image Description">
                                            <img class="avatar avatar-sm rounded-full" src="<?php echo e(asset('build/assets/img/users/3.jpg')); ?>" alt="Image Description">
                                        </div>
                                        <div class="flex -space-x-2 rtl:space-x-reverse">
                                            <img class="avatar rounded-full" src="<?php echo e(asset('build/assets/img/users/1.jpg')); ?>" alt="Image Description">
                                            <img class="avatar rounded-full" src="<?php echo e(asset('build/assets/img/users/4.jpg')); ?>" alt="Image Description">
                                            <img class="avatar rounded-full" src="<?php echo e(asset('build/assets/img/users/2.jpg')); ?>" alt="Image Description">
                                            <img class="avatar rounded-full" src="<?php echo e(asset('build/assets/img/users/3.jpg')); ?>" alt="Image Description">
                                        </div>
                                        <div class="flex -space-x-2 rtl:space-x-reverse">
                                            <img class="avatar avatar-lg rounded-full" src="<?php echo e(asset('build/assets/img/users/1.jpg')); ?>" alt="Image Description">
                                            <img class="avatar avatar-lg rounded-full" src="<?php echo e(asset('build/assets/img/users/4.jpg')); ?>" alt="Image Description">
                                            <img class="avatar avatar-lg rounded-full" src="<?php echo e(asset('build/assets/img/users/2.jpg')); ?>" alt="Image Description">
                                            <img class="avatar avatar-lg rounded-full" src="<?php echo e(asset('build/assets/img/users/3.jpg')); ?>" alt="Image Description">
                                        </div>
                                        </div>
                                    </div>
                                    </div>
                            ...
                            <div class="grid grid-cols-12 gap-x-6">
                                <div class="col-span-12 xxl:col-span-6">
                                    ...
                                    <div class="box-body">
                                        <div class="sm:grid gap-10 space-y-4 sm:space-y-0 sm:items-end">
                                        <div class="sm:grid xxl:!grid-cols-8 md:!grid-cols-11 sm:grid-cols-7 grid-cols-4 gap-4 space-y-4 sm:space-y-0">
                                            <img
                                            class="avatar rounded-full"
                                            src="<?php echo e(asset('build/assets/img/users/1.jpg')); ?>" alt="Image Description">
                                            <img
                                            class="avatar rounded-full"
                                            src="<?php echo e(asset('build/assets/img/users/4.jpg')); ?>" alt="Image Description">
                                            <img
                                            class="avatar rounded-full"
                                            src="<?php echo e(asset('build/assets/img/users/6.jpg')); ?>" alt="Image Description">
                                            <img
                                            class="avatar rounded-full"
                                            src="<?php echo e(asset('build/assets/img/users/5.jpg')); ?>" alt="Image Description">
                                            <img
                                            class="avatar rounded-full"
                                            src="<?php echo e(asset('build/assets/img/users/7.jpg')); ?>" alt="Image Description">
                                            <img
                                            class="avatar rounded-full"
                                            src="<?php echo e(asset('build/assets/img/users/2.jpg')); ?>" alt="Image Description">
                                            <img
                                            class="avatar rounded-full"
                                            src="<?php echo e(asset('build/assets/img/users/9.jpg')); ?>" alt="Image Description">
                                            <img
                                                class="avatar rounded-full"
                                                src="<?php echo e(asset('build/assets/img/users/1.jpg')); ?>" alt="Image Description">
                                            <img
                                ...
                                <div class="col-span-12 xxl:col-span-3">
                                    ...
                                    <div class="box-body overflow-auto">
                                        <div class="flex -space-x-2 rtl:space-x-reverse">
                                        <img class="inline-block h-[2.875rem] w-[2.875rem] rounded-full ring-2 ring-white" src="<?php echo e(asset('build/assets/img/users/1.jpg')); ?>" alt="Image Description">
                                        <img class="inline-block h-[2.875rem] w-[2.875rem] rounded-full ring-2 ring-white" src="<?php echo e(asset('build/assets/img/users/2.jpg')); ?>" alt="Image Description">
                                        <img class="inline-block h-[2.875rem] w-[2.875rem] rounded-full ring-2 ring-white" src="<?php echo e(asset('build/assets/img/users/3.jpg')); ?>" alt="Image Description">
                                        <img class="inline-block h-[2.875rem] w-[2.875rem] rounded-full ring-2 ring-white" src="<?php echo e(asset('build/assets/img/users/5.jpg')); ?>" alt="Image Description">
                                        <img class="inline-block h-[2.875rem] w-[2.875rem] rounded-full ring-2 ring-white" src="<?php echo e(asset('build/assets/img/users/8.jpg')); ?>" alt="Image Description">
                                        <img class="hidden sm:inline-block h-[2.875rem] w-[2.875rem] rounded-full ring-2 ring-white" src="<?php echo e(asset('build/assets/img/users/4.jpg')); ?>" alt="Image Description">
                                        <img class="hidden sm:inline-block h-[2.875rem] w-[2.875rem] rounded-full ring-2 ring-white" src="<?php echo e(asset('build/assets/img/users/6.jpg')); ?>" alt="Image Description">
                                        <img class="hidden sm:inline-block h-[2.875rem] w-[2.875rem] rounded-full ring-2 ring-white" src="<?php echo e(asset('build/assets/img/users/7.jpg')); ?>" alt="Image Description">
                                        </div>
                                    </div>
                                    </div>
                                </div>
                                <div class="col-span-12 xxl:col-span-3">
                                    ...
                                    <div class="box-body">
                                        <div class="flex -space-x-2 rtl:space-x-reverse">
                                        <img class="inline-block h-[2.875rem] w-[2.875rem] rounded-full ring-2 ring-white" src="<?php echo e(asset('build/assets/img/users/8.jpg')); ?>" alt="Image Description">
                                        <img class="inline-block h-[2.875rem] w-[2.875rem] rounded-full ring-2 ring-white" src="<?php echo e(asset('build/assets/img/users/4.jpg')); ?>" alt="Image Description">
                                        <img class="inline-block h-[2.875rem] w-[2.875rem] rounded-full ring-2 ring-white" src="<?php echo e(asset('build/assets/img/users/6.jpg')); ?>" alt="Image Description">
                                        <img class="inline-block h-[2.875rem] w-[2.875rem] rounded-full ring-2 ring-white" src="<?php echo e(asset('build/assets/img/users/7.jpg')); ?>" alt="Image Description">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\projects\laravel\vite\synto\synto-final\synto\resources\views/pages/avatars.blade.php ENDPATH**/ ?>