                                                        ...
                                                        <?php if(!isset($export) || !$export): ?>
                                                            <td>
                                                                <div class="hs-tooltip ti-main-tooltip">
                                                                    <a  href="<?php echo e(Storage::url('Uploads/Research/Book_Chapters/' . $book->document)); ?>" class="m-0 hs-tooltip-toggle relative w-8 h-8 ti-btn rounded-full p-0 transition-none focus:outline-none ti-btn-soft-primary" target="_blank" <?php echo e($book->document); ?>>
...
<?php $__env->startSection('scripts'); ?>
        ...
        <script>
            $(document).ready(function () {
                var dataTable = new DataTable('#book_chapter_table');
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.components.HOD.master-hod', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\laravel Apps\gitoffice\resources\views//HOD/Teaching/research/hodbookchap.blade.php ENDPATH**/ ?>