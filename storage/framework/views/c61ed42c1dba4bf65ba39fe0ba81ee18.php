                ...
                <div class="main-sidebar " id="sidebar-scroll">
                    ...
                    <nav class="main-menu-container nav nav-pills flex-column sub-open">
                        ...
                        <ul class="main-menu">
                            ...
                            <!-- End::slide__category -->
                            <li class="slide">
                                <a href="<?php echo e(url('/Teaching/dashboard')); ?>" class="side-menu__item">
                            ...
                            <li class="slide">
                                <a href="<?php echo e(url('/Teaching/departments')); ?>" class="side-menu__item">
                            ...
                            <li class="slide">
                                <a href="<?php echo e(url('/Teaching/designations')); ?>" class="side-menu__item">
                            ...
                            <li class="slide">
                                <a href="<?php echo e(url('/Teaching/associations')); ?>" class="side-menu__item">
                            ...
                            <!--for construction -->
                            <li class="slide">
                                <a href="<?php echo e(url('/Teaching/construction')); ?>" class="side-menu__item">
                            ...
                            <!---->
                             ...
                             <li class="slide">
                                <a href="<?php echo e(url('/Teaching/leaves')); ?>" class="side-menu__item">
                            ...
                            <li class="slide">
                                <a href="<?php echo e(url('/Teaching/professionalactivities')); ?>" class="side-menu__item">
                            ...
                            <li class="slide  has-sub">
                                ...
                                <ul class="slide-menu child1">
                                    <li class="slide"><a href="<?php echo e(url('/Teaching/research/conferenceactivities')); ?>" class="side-menu__item">Conference</a></li>
                                    <li class="slide"><a href="<?php echo e(url('/Teaching/research/publications')); ?>" class="side-menu__item">Publication</a></li>
                                    <li class="slide"><a href="<?php echo e(url('/Teaching/research/bookchapaters')); ?>" class="side-menu__item">Book and Chapters</a></li>
                                    <li class="slide"><a href="<?php echo e(url('/Teaching/research/fundingconsultancy')); ?>" class="side-menu__item">Funding and Consultancy</a></li>
                                    <li class="slide"><a href="<?php echo e(url('/Teaching/research/patentcopyrights')); ?>" class="side-menu__item">Copyrights and Patents</a></li>
                                    <li class="slide"><a href="<?php echo e(url('/Teaching/research/achievement')); ?>" class="side-menu__item">Achievement</a></li>
                                    <li class="slide"><a href="<?php echo e(url('/Teaching/research/revieweditor')); ?>" class="side-menu__item">Reviewer/Editor</a></li>
                                </ul>
                            </li>
            ...
            </aside><?php /**PATH F:\laravel Apps\gitoffice\resources\views/layouts/components/staff/sidebar-teaching.blade.php ENDPATH**/ ?>