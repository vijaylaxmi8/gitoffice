                            ...
                            <div class="grid grid-cols-12 gap-x-5">
                                    ...
                                    <div class="col-span-12 xl:col-span-4">
                                        ...
                                        <div class="box-body">
                                            ...
                                            <li class="px-0 pt-0 ti-list-group border-0 text-gray-800 dark:text-white w-full">
                                                <div class="">
                                                <a href="<?php echo e(url('profile')); ?>" class="flex items-center space-x-3 rtl:space-x-reverse">
                                                ...
                                                <a aria-label="anchor" href="<?php echo e(url('contacts')); ?>" class="text-gray-500 dark:text-white/70">
                                                    <i class="ri-heart-line text-base hover:text-danger"></i>
                                                </a>
                                                <a aria-label="anchor" href="<?php echo e(url('contacts')); ?>" class="text-gray-500 dark:text-white/70 rtl:rotate-180 inline-flex">
                                            ...
                                            <li class="px-0 ti-list-group border-0 text-gray-800 dark:text-white w-full">
                                                ...
                                                <div class="ltr:ml-auto rtl:mr-auto space-x-2 rtl:space-x-reverse ">
                                                <a aria-label="anchor" href="<?php echo e(url('contacts')); ?>" class="text-danger">
                                            ...
                                            <li class="px-0 ti-list-group border-0 text-gray-800 dark:text-white w-full">
                                                <div class="">
                                                <a href="<?php echo e(url('profile')); ?>" class="flex items-center space-x-3 rtl:space-x-reverse">
                                                    <img class="avatar avatar-sm rounded-sm" src="<?php echo e(asset('build/assets/img/users/12.jpg')); ?>"
                                                    alt="Image Description">
                                                    <div class="flex">
                                                    <div class="block my-auto">
                                                        <p
                                            ...
                                            <li class="px-0 ti-list-group border-0 text-gray-800 dark:text-white w-full">
                                                <div class="">
                                                <a href="<?php echo e(url('profile')); ?>" class="flex items-center space-x-3 rtl:space-x-reverse">
                                                    <img class="avatar avatar-sm rounded-sm" src="<?php echo e(asset('build/assets/img/users/15.jpg')); ?>"
                                                    alt="Image Description">
                                                    <div class="flex">
                                                    <div class="block my-auto">
                                                        <p
                                ...
                                <div class="col-span-12 xxl:col-span-3">
                                    ...
                                    <div class="block absolute w-full h-full before:bg-primary/70 before:absolute before:w-full before:h-full">
                                        <img src="<?php echo e(asset('build/assets/img/png-images/16.png')); ?>" alt="" class="w-full xxl:h-full sm:h-auto h-full">
                                    </div>
                                    ...
                                    <div class="box-body">
                                        ...
                                        <li class="ti-list-group mb-6 border-0 p-0 w-full">
                                            ...
                                            <div class="flex-1">
                                                ...
                                                <div class="flex -space-x-2 rtl:space-x-reverse">
                                                    <img class="inline-block avatar w-6 h-6 rounded-full" src="<?php echo e(asset('build/assets/img/users/8.jpg')); ?>"
                                                    alt="Image Description">
                                                    <img class="inline-block avatar w-6 h-6 rounded-full" src="<?php echo e(asset('build/assets/img/users/4.jpg')); ?>"
                                                    alt="Image Description">
                                                    <img class="inline-block avatar w-6 h-6 rounded-full" src="<?php echo e(asset('build/assets/img/users/6.jpg')); ?>"
                                                    alt="Image Description">
                                                    <img class="inline-block avatar w-6 h-6 rounded-full" src="<?php echo e(asset('build/assets/img/users/7.jpg')); ?>"
                                                    alt="Image Description">
                                                </div>
                                        ...
                                        <li class="ti-list-group mb-6 border-0 p-0 w-full">
                                            ...
                                            <div class="flex-1">
                                                ...
                                                <div class="flex -space-x-2 rtl:space-x-reverse">
                                                    ...
                                                    <img class="inline-block avatar w-6 h-6 rounded-full" src="<?php echo e(asset('build/assets/img/users/4.jpg')); ?>"
                                                    alt="Image Description">
                                                    <img class="inline-block avatar w-6 h-6 rounded-full" src="<?php echo e(asset('build/assets/img/users/21.jpg')); ?>"
                                                    alt="Image Description">
                                                </div>
                                                <span class="text-gray-500 dark:text-white/70 flex text-xs"><i
                                                    class="ri-time-line ltr:mr-1 rtl:ml-1 my-auto "></i>10-04-23</span>
                                        ...
                                        <li class="ti-list-group mb-0 border-0 p-0 w-full">
                                            ...
                                            <div class="flex-1">
                                                ...
                                                <div class="flex items-center justify-between">
                                                <div class="flex -space-x-2 rtl:space-x-reverse">
                                                    <img class="inline-block avatar w-6 h-6 rounded-full" src="<?php echo e(asset('build/assets/img/users/8.jpg')); ?>" alt="Image Description">
                                                    <img class="inline-block avatar w-6 h-6 rounded-full" src="<?php echo e(asset('build/assets/img/users/4.jpg')); ?>" alt="Image Description">
                                                    <img class="inline-block avatar w-6 h-6 rounded-full" src="<?php echo e(asset('build/assets/img/users/21.jpg')); ?>" alt="Image Description">
                                                </div>
                            ...
                            <div class="grid grid-cols-12 gap-x-5">
                                <div class="col-span-12 md:col-span-6 xxl:col-span-3">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <li class="p-0 mb-5 ti-list-group border-0 text-gray-800 dark:text-white w-full">
                                            ...
                                            <a href="<?php echo e(url('chat')); ?>" class="ltr:mr-2 rtl:ml-2 avatar rounded-full">
                                                <img src="<?php echo e(asset('build/assets/img/users/17.jpg')); ?>" alt="img" class="rounded-full">
                                            </a>
                                            <div class="flex justify-between relative w-full">
                                                <a aria-label="anchor" href="<?php echo e(url('chat')); ?>" class="absolute h-full w-full inset-0"></a>
                                                <div class="">
                                        ...
                                        <li class="p-0 mb-5 ti-list-group border-0 text-gray-800 dark:text-white w-full">
                                            <div class="flex items-start w-full">
                                            <a href="<?php echo e(url('chat')); ?>" class="ltr:mr-2 rtl:ml-2 avatar rounded-full">
                                                <img src="<?php echo e(asset('build/assets/img/users/2.jpg')); ?>" alt="img" class="rounded-full">
                                            </a>
                                            <div class="flex justify-between relative w-full">
                                                <a aria-label="anchor" href="<?php echo e(url('chat')); ?>" class="absolute h-full w-full inset-0"></a>
                                                <div class="">
                                        ...
                                        <li class="p-0 mb-5 ti-list-group border-0 text-gray-800 dark:text-white w-full">
                                            <div class="flex items-start w-full">
                                            <a href="<?php echo e(url('chat')); ?>" class="ltr:mr-2 rtl:ml-2 avatar rounded-full">
                                                <img src="<?php echo e(asset('build/assets/img/users/21.jpg')); ?>" alt="img" class="rounded-full">
                                            </a>
                                            <div class="flex justify-between relative w-full">
                                                <a aria-label="anchor" href="<?php echo e(url('chat')); ?>" class="absolute h-full w-full inset-0"></a>
                                                <div class="">
                                        ...
                                        <li class="p-0 mb-5 ti-list-group border-0 text-gray-800 dark:text-white w-full">
                                            <div class="flex items-start w-full">
                                            <a href="<?php echo e(url('chat')); ?>" class="ltr:mr-2 rtl:ml-2 avatar rounded-full">
                                                <img src="<?php echo e(asset('build/assets/img/users/11.jpg')); ?>" alt="img" class="rounded-full">
                                            </a>
                                            <div class="flex justify-between relative w-full">
                                                <a aria-label="anchor" href="<?php echo e(url('chat')); ?>" class="absolute h-full w-full inset-0"></a>
                                                <div class="">
                                        ...
                                        <li class="p-0 mb-0 ti-list-group border-0 text-gray-800 dark:text-white w-full">
                                            <div class="flex items-start w-full">
                                            <a href="<?php echo e(url('chat')); ?>" class="ltr:mr-2 rtl:ml-2 avatar rounded-full">
                                                <img src="<?php echo e(asset('build/assets/img/users/3.jpg')); ?>" alt="img" class="rounded-full">
                                            </a>
                                            <div class="flex justify-between relative w-full">
                                                <a aria-label="anchor" href="<?php echo e(url('chat')); ?>" class="absolute h-full w-full inset-0"></a>
                                                <div class="">
                                ...
                                <div class="col-span-12 md:col-span-6 xxl:col-span-3">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <a href="javascript:void(0);">
                                            <img class="avatar avatar-sm rounded-full" src="<?php echo e(asset('build/assets/img/users/12.jpg')); ?>" alt="Image Description">
                                        </a>
                                        <a href="javascript:void(0);">
...
<?php $__env->startSection('scripts'); ?>
        ...
        <!-- INDEX JS -->
        <?php echo app('Illuminate\Foundation\Vite')('resources/assets/js/index-10.js'); ?>
        

<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\projects\my-projects\laravel\vite\synto\synto-laravel\synto\resources\views/pages/index10.blade.php ENDPATH**/ ?>