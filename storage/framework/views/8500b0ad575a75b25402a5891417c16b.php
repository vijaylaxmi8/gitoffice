                                            ...
                                            <form>
                                                <div class="grid gap-y-4">
                                                    ...
                                                    <a href="<?php echo e(url('index')); ?>"
                                                        class="py-2 px-3 inline-flex justify-center items-center gap-2 rounded-sm border border-transparent font-semibold bg-primary text-white hover:bg-primary focus:outline-none focus:ring-0 focus:ring-primary focus:ring-offset-0 transition-all text-sm dark:focus:ring-offset-white/10">Confirm</a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.custom-master2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\projects\my-projects\laravel\vite\synto\synto-laravel\synto\resources\views/pages/verification-cover2.blade.php ENDPATH**/ ?>