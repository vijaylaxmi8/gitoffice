...
<?php $__env->startSection('scripts'); ?>
        ...
        <!-- ECHARTS JS -->
        <script src="<?php echo e(asset('build/assets/libs/echarts/echarts.min.js')); ?>"></script>

        <!-- INTERNAL ECHARTS JS -->
        <?php echo app('Illuminate\Foundation\Vite')('resources/assets/js/echarts.js'); ?>


<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\projects\my-projects\laravel\vite\synto\synto-laravel\synto\resources\views/pages/echartjs.blade.php ENDPATH**/ ?>