...
<?php $__env->startSection('scripts'); ?>
        ...
        <script src="<?php echo e(asset('build/assets/apexcharts-stock-prices.js')); ?>"></script>

        <!-- INTERNAL APEX LINE CHART JS  -->
        <?php echo app('Illuminate\Foundation\Vite')('resources/assets/js/apexchart.js'); ?>

        
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\projects\my-projects\laravel\vite\synto\synto-laravel\synto\resources\views/pages/apex-charts.blade.php ENDPATH**/ ?>