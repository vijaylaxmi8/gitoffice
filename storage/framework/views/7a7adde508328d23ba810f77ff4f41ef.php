                ...
                <div class="main-sidebar " id="sidebar-scroll">
                    ...
                    <nav class="main-menu-container nav nav-pills flex-column sub-open">
                        ...
                        <ul class="main-menu">
                            ...
                            <!-- End::slide__category -->
                            <li class="slide">
                                <a href="<?php echo e(url('/Non-Teaching/dashboard')); ?>" class="side-menu__item">
                            ...
                            <li class="slide">
                                <a href="<?php echo e(url('/Non-Teaching/departments')); ?>" class="side-menu__item">
                            ...
                            <li class="slide">
                                <a href="<?php echo e(url('/Non-Teaching/designations')); ?>" class="side-menu__item">
                            ...
                            <li class="slide">
                                <a href="<?php echo e(url('/Non-Teaching/associations')); ?>" class="side-menu__item">
                             ...
                             <li class="slide">
                                <a href="<?php echo e(url('Non-Teaching/construction')); ?>" class="side-menu__item">
                            ...
                            <li class="slide">
                                <a href="<?php echo e(url('/Non-Teaching/professionalactivities')); ?>" class="side-menu__item">
            ...
            </aside><?php /**PATH F:\laravel Apps\gitoffice\resources\views/layouts/components/staff/sidebar-nonteaching.blade.php ENDPATH**/ ?>