                        ...
                        <div class="main-content">
                            ...
                            <div class="grid grid-cols-12 gap-x-5">
                                    ...
                                    <div class="col-span-12 xl:col-span-4">
                                        ...
                                        <div class="box-body">
                                            ...
                                            <li class="px-0 pt-0 ti-list-group border-0 text-gray-800 dark:text-white w-full">
                                                ...
                                                <a aria-label="anchor" href="contacts.php" class="text-gray-500 dark:text-white/70">
                                                    <i class="ri-heart-line text-base hover:text-danger"></i>
                                                </a>
                                                <a aria-label="anchor" href="contacts.php" class="text-gray-500 dark:text-white/70 rtl:rotate-180 inline-flex">
                                            ...
                                            <li class="px-0 ti-list-group border-0 text-gray-800 dark:text-white w-full">
                                                ...
                                                <div class="ltr:ml-auto rtl:mr-auto space-x-2 rtl:space-x-reverse ">
                                                <a aria-label="anchor" href="contacts.php" class="text-danger">
                                ...
                                <div class="col-span-12 xxl:col-span-3">
                                    ...
                                    <div class="block absolute h-full before:bg-primary/70 before:absolute before:w-full before:h-full">
                            ...
                            <div class="col-span-12 md:col-span-6 xxl:col-span-3">
                                ...
                                <div class="box-body">
                                    ...
                                    <li class="p-0 mb-5 ti-list-group border-0 text-gray-800 dark:text-white w-full">
                                        ...
                                        <a href="chat.php" class="ltr:mr-2 rtl:ml-2 avatar rounded-full">
                                        ...
                                        <div class="flex justify-between relative w-full">
                                            <a aria-label="anchor" href="chat.php" class="absolute h-full w-full inset-0"></a>
                                            <div class="">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\projects\laravel\vite\synto\synto\resources\views/pages/index10.blade.php ENDPATH**/ ?>