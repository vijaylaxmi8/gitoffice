                                                    ...
                                                    <div id="add_notice" class="hs-overlay hidden ti-modal">
                                                        <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out lg:!max-w-4xl lg:w-full m-3 md:mx-auto">
                                                            <div class="ti-modal-content">
                                                                ...
                                                                <form action="<?php echo e(route('HOD.notice.store')); ?>" method="post">
                                                                    <?php echo csrf_field(); ?>
                                                        ...
                                                        <?php $__empty_1 = true; $__currentLoopData = $dept_notice; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dn): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                            <tr class="">
                                                                ...
                                                                <div class="hs-tooltip ti-main-tooltip">
                                                                    <button data-hs-overlay="#notice_edit_modal<?php echo e($i); ?>"
                                                                    ...
                                                                    <div id="notice_edit_modal<?php echo e($i); ?>" class="hs-overlay hidden ti-modal">
                                                                        <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out lg:!max-w-4xl lg:w-full m-3 md:mx-auto">
                                                                            <div class="ti-modal-content">
                                                                                ...
                                                                                <form action="<?php echo e(route('HOD.notice.update',$dn->id)); ?>" method="post">
                                                                                    <?php echo csrf_field(); ?>
                                                                                    ...
                                                                                    <div class="ti-modal-body">
                                                                                        <div class="grid lg:grid-cols-2 gap-1 space-y-2 lg:space-y-0">
                                                                                            <div class="max-w-sm space-y-3 pb-6">
                                                                                                <label for="with-corner-hint" class="ti-form-label font-bold">Title:<span class="text-red-500">*</span></label>
                                                                                                <input type="text" name="title" class="ti-form-input" placeholder="Title" value="<?php echo e($dn->title); ?>">
                                                                                            </div>
                                                                                            <div class="max-w-sm space-y-3 pb-6">
                                                                                                <label for="" class="ti-form-label font-bold">Description:<span class="text-red-500">*</span></label>
                                                                                                <input type="text" name="description" class="ti-form-input po_location" placeholder="Description" value="<?php echo e($dn->description); ?>">
                                                                ...
                                                                <div class="hs-tooltip ti-main-tooltip">
                                                                    <form action="<?php echo e(route('HOD.notice.destroy',$dn->id)); ?>" method="post">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.components.HOD.master-hod', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\laravel Apps\gitoffice\resources\views/HOD/notice.blade.php ENDPATH**/ ?>