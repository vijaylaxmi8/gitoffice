                                        ...
                                        <div class="box-body">
                                            <div class="flex space-x-4 rtl:space-x-reverse">
                                                <div class="flex items-center justify-center ecommerce-icon px-0">
                                                    <span class="rounded p-4 bg-primary/10">
                                                        <svg xmlns="http://www.w3.org/2000/svg" class="fill-white" height="24px"
                                                        ...
                                                        <div class="flex items-center">
                                                            <div class="leading-none">
                                                                <img class="avatar avatar-sm rounded-sm"
                                                                    src="<?php echo e(asset('build/assets/img/ecommerce/jpg/1.jpg')); ?>" alt="image">
                                                            </div>
                                                ...
                                                <li class="p-0 mb-5 ti-list-group border-0 text-gray-800 dark:text-white">
                                                    <a href="javascript:void(0);" class="w-full">
                                                        <div class="flex items-center">
                                                            <div class="leading-none">
                                                                <img class="avatar avatar-sm rounded-sm"
                                                                    src="<?php echo e(asset('build/assets/img/ecommerce/jpg/2.jpg')); ?>" alt="image">
                                                            </div>
                                                            <div class="flex-auto ltr:ml-2 rtl:mr-2">
                                                ...
                                                <li class="p-0 mb-5 ti-list-group border-0 text-gray-800 dark:text-white">
                                                    <a href="javascript:void(0);" class="w-full">
                                                        <div class="flex items-center">
                                                            <div class="leading-none">
                                                                <img class="avatar avatar-sm rounded-sm"
                                                                    src="<?php echo e(asset('build/assets/img/ecommerce/jpg/3.jpg')); ?>" alt="image">
                                                            </div>
                                                            <div class="flex-auto ltr:ml-2 rtl:mr-2">
                                                ...
                                                <li class="p-0 mb-5 ti-list-group border-0 text-gray-800 dark:text-white">
                                                    <a href="javascript:void(0);" class="w-full">
                                                        <div class="flex items-center">
                                                            <div class="leading-none">
                                                                <img class="avatar avatar-sm rounded-sm"
                                                                    src="<?php echo e(asset('build/assets/img/ecommerce/jpg/4.jpg')); ?>" alt="image">
                                                            </div>
                                                            <div class="flex-auto ltr:ml-2 rtl:mr-2">
                                                ...
                                                <li class="p-0 mb-5 ti-list-group border-0 text-gray-800 dark:text-white">
                                                    <a href="javascript:void(0);" class="w-full">
                                                        <div class="flex items-center">
                                                            <div class="leading-none">
                                                                <img class="avatar avatar-sm rounded-sm"
                                                                    src="<?php echo e(asset('build/assets/img/ecommerce/jpg/5.jpg')); ?>" alt="image">
                                                            </div>
                                                            <div class="flex-auto ltr:ml-2 rtl:mr-2">
                                                ...
                                                <li class="p-0 ti-list-group border-0 text-gray-800 dark:text-white">
                                                    <a href="javascript:void(0);" class="w-full">
                                                        <div class="flex items-center">
                                                            <div class="leading-none">
                                                                <img class="avatar avatar-sm rounded-sm"
                                                                    src="<?php echo e(asset('build/assets/img/ecommerce/jpg/6.jpg')); ?>" alt="image">
                                                            </div>
                                                            <div class="flex-auto ltr:ml-2 rtl:mr-2">
                                                        ...
                                                        <div class="flex items-center justify-between">
                                                            <div class="flex items-top justify-center">
                                                                <div class="ltr:mr-2 rtl:ml-2">
                                                                    <img src="<?php echo e(asset('build/assets/img/users/4.jpg')); ?>" alt="Image Description"
                                                ...
                                                <li class="p-0 mb-5 ti-list-group border-0 text-gray-800 dark:text-white">
                                                    <a href="javascript:void(0);" class="w-full">
                                                        <div class="flex items-center justify-between">
                                                            <div class="flex items-top justify-center">
                                                                <div class="ltr:mr-2 rtl:ml-2">
                                                                    <img src="<?php echo e(asset('build/assets/img/users/15.jpg')); ?>" alt="Image Description"
                                                                        class="avatar avatar-sm rounded-full">
                                                                </div>
                                                                <div>
                                                ...
                                                <li class="p-0 mb-5 ti-list-group border-0 text-gray-800 dark:text-white">
                                                    <a href="javascript:void(0);" class="w-full">
                                                        <div class="flex items-center justify-between">
                                                            <div class="flex items-top justify-center">
                                                                <div class="ltr:mr-2 rtl:ml-2">
                                                                    <img src="<?php echo e(asset('build/assets/img/users/5.jpg')); ?>" alt="Image Description"
                                                                        class="avatar avatar-sm rounded-full">
                                                                </div>
                                                                <div>
                                                ...
                                                <li class="p-0 mb-5 ti-list-group border-0 text-gray-800 dark:text-white">
                                                    <a href="javascript:void(0);" class="w-full">
                                                        <div class="flex items-center justify-between">
                                                            <div class="flex items-top justify-center">
                                                                <div class="ltr:mr-2 rtl:ml-2">
                                                                    <img src="<?php echo e(asset('build/assets/img/users/3.jpg')); ?>" alt="Image Description"
                                                                        class="avatar avatar-sm rounded-full">
                                                                </div>
                                                                <div>
                                                ...
                                                <li class="p-0 mb-5 ti-list-group border-0 text-gray-800 dark:text-white">
                                                    <a href="javascript:void(0);" class="w-full">
                                                        <div class="flex items-center justify-between">
                                                            <div class="flex items-top justify-center">
                                                                <div class="ltr:mr-2 rtl:ml-2">
                                                                    <img src="<?php echo e(asset('build/assets/img/users/2.jpg')); ?>" alt="Image Description"
                                                                        class="avatar avatar-sm rounded-full">
                                                                </div>
                                                                <div>
                                                ...
                                                <li class="p-0 mb-0 ti-list-group border-0 text-gray-800 dark:text-white">
                                                    <a href="javascript:void(0);" class="w-full">
                                                        <div class="flex items-center justify-between">
                                                            <div class="flex items-top justify-center">
                                                                <div class="ltr:mr-2 rtl:ml-2">
                                                                    <img src="<?php echo e(asset('build/assets/img/users/12.jpg')); ?>" alt="Image Description"
                                                                        class="avatar avatar-sm rounded-full">
                                                                </div>
                                                                <div>
                                                    ...
                                                    <table class="ti-custom-table ti-custom-table-head">
                                                        <tbody>
                                                            <tr>
                                                                        ...
                                                                        <div class="leading-none">
                                                                            <div class="relative inline-block">
                                                                                <img class="avatar avatar-xs rounded-full"
                                                                                    src="<?php echo e(asset('build/assets/img/users/1.jpg')); ?>"
                                                                ...
                                                                <td class="min-w-[100px]">
                                                                    <img class="avatar avatar-xs rounded-sm"
                                                                        src="<?php echo e(asset('build/assets/img/ecommerce/products/1.png')); ?>"
                                                                        alt="Image Description">
                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="flex items-center space-x-2 rtl:space-x-reverse">
                                                                        <div class="leading-none">
                                                                            <div class="relative inline-block">
                                                                                <img class="avatar avatar-xs rounded-full"
                                                                                    src="<?php echo e(asset('build/assets/img/users/10.jpg')); ?>"
                                                                                    alt="Image Description">
                                                                                <span
                                                                                    class="absolute bottom-0 ltr:right-0 rtl:left-0 block h-1.5 w-1.5 rounded-full ring-2 ring-white bg-green-400"></span>
                                                                            </div>
                                                                ...
                                                                <td>
                                                                    <img class="avatar avatar-xs rounded-sm"
                                                                        src="<?php echo e(asset('build/assets/img/ecommerce/products/2.png')); ?>"
                                                                        alt="Image Description">
                                                                </td>
                                                                <td class="rtl:rotate-180">
                                                                    <a aria-label="anchor"  href="javascript:void(0);">
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="flex items-center space-x-2 rtl:space-x-reverse">
                                                                        <div class="leading-none">
                                                                            <div class="relative inline-block">
                                                                                <img class="avatar avatar-xs rounded-full"
                                                                                    src="<?php echo e(asset('build/assets/img/users/12.jpg')); ?>"
                                                                                    alt="Image Description">
                                                                                <span
                                                                                    class="absolute bottom-0 ltr:right-0 rtl:left-0 block h-1.5 w-1.5 rounded-full ring-2 ring-white bg-green-400"></span>
                                                                            </div>
                                                                ...
                                                                <td>
                                                                    <img class="avatar avatar-xs rounded-sm"
                                                                        src="<?php echo e(asset('build/assets/img/ecommerce/products/3.png')); ?>"
                                                                        alt="Image Description">
                                                                </td>
                                                                <td class="rtl:rotate-180">
                                                                    <a aria-label="anchor" href="javascript:void(0);">
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="flex items-center space-x-2 rtl:space-x-reverse">
                                                                        <div class="leading-none">
                                                                            <div class="relative inline-block">
                                                                                <img class="avatar avatar-xs rounded-full"
                                                                                    src="<?php echo e(asset('build/assets/img/users/5.jpg')); ?>"
                                                                                    alt="Image Description">
                                                                                <span
                                                                                    class="absolute bottom-0 ltr:right-0 rtl:left-0 block h-1.5 w-1.5 rounded-full ring-2 ring-white bg-green-400"></span>
                                                                            </div>
                                                                ...
                                                                <td>
                                                                    <img class="avatar avatar-xs rounded-sm"
                                                                        src="<?php echo e(asset('build/assets/img/ecommerce/products/4.png')); ?>"
                                                                        alt="Image Description">
                                                                </td>
                                                                <td class="rtl:rotate-180">
                                                                    <a aria-label="anchor" href="javascript:void(0);">
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="flex items-center space-x-2 rtl:space-x-reverse">
                                                                        <div class="leading-none">
                                                                            <div class="relative inline-block">
                                                                                <img class="avatar avatar-xs rounded-full"
                                                                                    src="<?php echo e(asset('build/assets/img/users/14.jpg')); ?>"
                                                                                    alt="Image Description">
                                                                                <span
                                                                                    class="absolute bottom-0 ltr:right-0 rtl:left-0 block h-1.5 w-1.5 rounded-full ring-2 ring-white bg-green-400"></span>
                                                                            </div>
                                                                ...
                                                                <td>
                                                                    <img class="avatar avatar-xs rounded-sm"
                                                                        src="<?php echo e(asset('build/assets/img/ecommerce/products/5.png')); ?>"
                                                                        alt="Image Description">
                                                                </td>
                                                                <td class="rtl:rotate-180">
                                                                    <a aria-label="anchor" href="javascript:void(0);">
                                                    ...
                                                    <table class="ti-custom-table ti-custom-table-head">
                                                        <tbody>
                                                            <tr>
                                                                <td class="min-w-[200px]">
                                                                    <div class="flex items-center space-x-2 rtl:space-x-reverse">
                                                                        <div class="leading-none">
                                                                            <div class="relative inline-block">
                                                                                <img class="avatar avatar-xs rounded-full"
                                                                                    src="<?php echo e(asset('build/assets/img/users/2.jpg')); ?>"
                                                                                    alt="Image Description">
                                                                                <span
                                                                ...
                                                                <td class="min-w-[100px]">
                                                                    <img class="avatar avatar-xs rounded-sm"
                                                                        src="<?php echo e(asset('build/assets/img/ecommerce/products/6.png')); ?>"
                                                                        alt="Image Description">
                                                                </td>
                                                                <td class="rtl:rotate-180">
                                                                    <a aria-label="anchor" href="javascript:void(0);">
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="flex items-center space-x-2 rtl:space-x-reverse">
                                                                        <div class="leading-none">
                                                                            <div class="relative inline-block">
                                                                                <img class="avatar avatar-xs rounded-full"
                                                                                    src="<?php echo e(asset('build/assets/img/users/13.jpg')); ?>"
                                                                                    alt="Image Description">
                                                                                <span
                                                                                    class="absolute bottom-0 ltr:right-0 rtl:left-0 block h-1.5 w-1.5 rounded-full ring-2 ring-white bg-gray-400"></span>
                                                                            </div>
                                                                ...
                                                                <td>
                                                                    <img class="avatar avatar-xs rounded-sm"
                                                                        src="<?php echo e(asset('build/assets/img/ecommerce/products/7.png')); ?>"
                                                                        alt="Image Description">
                                                                </td>
                                                                <td class="rtl:rotate-180">
                                                                    <a aria-label="anchor" href="javascript:void(0);">
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="flex items-center space-x-2 rtl:space-x-reverse">
                                                                        <div class="leading-none">
                                                                            <div class="relative inline-block">
                                                                                <img class="avatar avatar-xs rounded-full"
                                                                                    src="<?php echo e(asset('build/assets/img/users/7.jpg')); ?>"
                                                                                    alt="Image Description">
                                                                                <span
                                                                                    class="absolute bottom-0 ltr:right-0 rtl:left-0 block h-1.5 w-1.5 rounded-full ring-2 ring-white bg-green-400"></span>
                                                                            </div>
                                                                ...
                                                                <td>
                                                                    <img class="avatar avatar-xs rounded-sm"
                                                                        src="<?php echo e(asset('build/assets/img/ecommerce/products/8.png')); ?>"
                                                                        alt="Image Description">
                                                                </td>
                                                                <td class="rtl:rotate-180">
                                                                    <a aria-label="anchor" href="javascript:void(0);">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <img class="avatar avatar-xs rounded-sm"
                                                                        src="<?php echo e(asset('build/assets/img/ecommerce/products/9.png')); ?>"
                                                                        alt="Image Description">
                                                                </td>
                                                                <td class="rtl:rotate-180">
                                                                    <a aria-label="anchor" href="javascript:void(0);">
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="flex items-center space-x-2 rtl:space-x-reverse">
                                                                        <div class="leading-none">
                                                                            <div class="relative inline-block">
                                                                                <img class="avatar avatar-xs rounded-full"
                                                                                    src="<?php echo e(asset('build/assets/img/users/15.jpg')); ?>"
                                                                                    alt="Image Description">
                                                                                <span
                                                                                    class="absolute bottom-0 ltr:right-0 rtl:left-0 block h-1.5 w-1.5 rounded-full ring-2 ring-white bg-green-400"></span>
                                                                            </div>
                                                                ...
                                                                <td>
                                                                    <img class="avatar avatar-xs rounded-sm"
                                                                        src="<?php echo e(asset('build/assets/img/ecommerce/products/10.png')); ?>"
                                                                        alt="Image Description">
                                                                </td>
                                                                <td class="rtl:rotate-180">
                                                                    <a aria-label="anchor" href="javascript:void(0);">
                                                    ...
                                                    <table class="ti-custom-table ti-custom-table-head">
                                                        <tbody>
                                                            <tr>
                                                                <td class="min-w-[200px]">
                                                                    <div class="flex items-center space-x-2 rtl:space-x-reverse">
                                                                        <div class="leading-none">
                                                                            <div class="relative inline-block">
                                                                                <img class="avatar avatar-xs rounded-full"
                                                                                    src="<?php echo e(asset('build/assets/img/users/6.jpg')); ?>"
                                                                                    alt="Image Description">
                                                                                <span
                                                                                    class="absolute bottom-0 ltr:right-0 rtl:left-0 block h-1.5 w-1.5 rounded-full ring-2 ring-white bg-green-400"></span>
                                                                            </div>
                                                                ...
                                                                <td class="min-w-[100px]">
                                                                    <img class="avatar avatar-xs rounded-sm"
                                                                        src="<?php echo e(asset('build/assets/img/ecommerce/products/11.png')); ?>"
                                                                        alt="Image Description">
                                                                </td>
                                                                <td class="rtl:rotate-180">
                                                                    <a aria-label="anchor" href="javascript:void(0);">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <img class="avatar avatar-xs rounded-sm"
                                                                        src="<?php echo e(asset('build/assets/img/ecommerce/products/12.png')); ?>"
                                                                        alt="Image Description">
                                                                </td>
                                                                <td class="rtl:rotate-180">
                                                                    <a aria-label="anchor" href="javascript:void(0);">
                                                                ...
                                                                <td>
                                                                    <div class="flex items-center space-x-2 rtl:space-x-reverse">
                                                                        <div class="leading-none">
                                                                            <div class="relative inline-block">
                                                                                <img class="avatar avatar-xs rounded-full"
                                                                                    src="<?php echo e(asset('build/assets/img/users/16.jpg')); ?>"
                                                                                    alt="Image Description">
                                                                                <span
                                                                                    class="absolute bottom-0 ltr:right-0 rtl:left-0 block h-1.5 w-1.5 rounded-full ring-2 ring-white bg-green-400"></span>
                                                                            </div>
                                                                ...
                                                                <td>
                                                                    <div class="flex items-center space-x-2 rtl:space-x-reverse">
                                                                        <div class="leading-none">
                                                                            <div class="relative inline-block">
                                                                                <img class="avatar avatar-xs rounded-full"
                                                                                    src="<?php echo e(asset('build/assets/img/users/3.jpg')); ?>"
                                                                                    alt="Image Description">
                                                                                <span
                                                                                    class="absolute bottom-0 ltr:right-0 rtl:left-0 block h-1.5 w-1.5 rounded-full ring-2 ring-white bg-green-400"></span>
                                                                            </div>
                                                                ...
                                                                <td>
                                                                    <div class="flex items-center space-x-2 rtl:space-x-reverse">
                                                                        <div class="leading-none">
                                                                            <div class="relative inline-block">
                                                                                <img class="avatar avatar-xs rounded-full"
                                                                                    src="<?php echo e(asset('build/assets/img/users/9.jpg')); ?>"
                                                                                    alt="Image Description">
                                                                                <span
                                                                                    class="absolute bottom-0 ltr:right-0 rtl:left-0 block h-1.5 w-1.5 rounded-full ring-2 ring-white bg-gray-400"></span>
                                                                            </div>
                                                ...
                                                <table class="ti-custom-table ti-custom-table-head">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td><a href="<?php echo e(url('invoice')); ?>">#14008268610</a></td>
                                                            <td>
                                                                $199.99
                                                            </td>
                                                            <td>Online</td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><a href="<?php echo e(url('invoice')); ?>">#31408224782</a></td>
                                                            <td>
                                                                $1,299.99
                                                            </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><a href="<?php echo e(url('invoice')); ?>">#92065567861</a></td>
                                                            <td>
                                                                $99.99
                                                            </td>
                                                            <td>Cash On Delivery</td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><a href="<?php echo e(url('invoice')); ?>">#31652851650</a></td>
                                                            <td>
                                                                $79.00
                                                            </td>
                                                            <td>Online</td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><a href="<?php echo e(url('invoice')); ?>">#23518898764</a></td>
                                                            <td>
                                                                $199.99
                                                            </td>
                                                            <td>Cash On Delivery</td>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <!-- INDEX JS -->
    <?php echo app('Illuminate\Foundation\Vite')('resources/assets/js/index-2.js'); ?>


<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\projects\laravel\vite\synto\synto-final\synto\resources\views/pages/index2.blade.php ENDPATH**/ ?>