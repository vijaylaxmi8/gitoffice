                        ...
                        <div class="main-content">
                            ...
                            <div class="col-span-12 xl:col-span-9">
                                ...
                                <div class="box-body p-0">
                                    ...
                                    <table class="ti-custom-table ti-custom-table-head">
                                        ...
                                        <tr class="cart-box">
                                            <td class="flex">
                                            <img class="avatar avatar-lg rounded-sm bg-gray-100 dark:bg-black/20 p-1" src="<?php echo e(asset('build/assets/img/ecommerce/products/1.png')); ?>" alt="Image Description">
                                            ...
                                            <div class="hs-tooltip ti-main-tooltip">
                                                <a href="<?php echo e(url('wishlist')); ?>" class="hs-tooltip-toggle w-10 h-10 ti-btn rounded-full p-0 transition-none focus:outline-none ti-btn-soft-primary">
                                        ...
                                        <tr class="cart-box">
                                            <td class="flex">
                                            <img class="avatar avatar-lg rounded-sm bg-gray-100 dark:bg-black/20 p-1" src="<?php echo e(asset('build/assets/img/ecommerce/products/7.png')); ?>" alt="Image Description">
                                            <div class="ltr:ml-3 rtl:mr-3">
                                        ...
                                        <tr class="cart-box">
                                            <td class="flex">
                                            <img class="avatar avatar-lg rounded-sm bg-gray-100 dark:bg-black/20 p-1" src="<?php echo e(asset('build/assets/img/ecommerce/products/10.png')); ?>" alt="Image Description">
                                            <div class="ltr:ml-3 rtl:mr-3">
                                        ...
                                        <tr class="cart-box">
                                            <td class="flex">
                                            <img class="avatar avatar-lg rounded-sm bg-gray-100 dark:bg-black/20 p-1" src="<?php echo e(asset('build/assets/img/ecommerce/products/5.png')); ?>" alt="Image Description">
                                            <div class="ltr:ml-3 rtl:mr-3">
                                        ...
                                        <tr class="cart-box">
                                            <td class="flex">
                                            <img class="avatar avatar-lg rounded-sm bg-gray-100 dark:bg-black/20 p-1" src="<?php echo e(asset('build/assets/img/ecommerce/products/4.png')); ?>" alt="Image Description">
                                            <div class="ltr:ml-3 rtl:mr-3">
                                        ...
                                        <tr class="cart-box">
                                            <td class="flex">
                                            <img class="avatar avatar-lg rounded-sm bg-gray-100 dark:bg-black/20 p-1" src="<?php echo e(asset('build/assets/img/ecommerce/products/2.png')); ?>" alt="Image Description">
                                            <div class="ltr:ml-3 rtl:mr-3">
                                ...
                                <div class="box-body">
                                    ...
                                    <img src="<?php echo e(asset('build/assets/img/ecommerce/1.png')); ?>" class="mx-auto w-1/2 h-1/2" alt="Image Description">
                            ...
                            <div class="col-span-12 xl:col-span-3">
                                ...
                                <div class="box-footer">
                                    <a href="<?php echo e(url('checkout')); ?>" class="w-full ti-btn p-2 ti-btn-primary">
                                    <i class="ti ti-arrow-right"></i>Check Out
                                    </a>
                                    <a href="<?php echo e(url('products')); ?>" class="ti-btn p-2 ti-btn-secondary w-full"><i class="ti ti-arrow-left rtl:rotate-180"></i>Continue Shopping
                                    </a>
                                </div>
                                </div>
                            </div>
...
<?php $__env->startSection('scripts'); ?>
        ...
        <!-- CART JS -->
        <?php echo app('Illuminate\Foundation\Vite')('resources/assets/js/cart.js'); ?>
        

<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\projects\my-projects\laravel\vite\synto\synto-laravel\synto\resources\views/pages/cart.blade.php ENDPATH**/ ?>