                    ...
                    <div class="content">
                        ...
                        <div class="main-content">
                            ...
                            <div class="col-span-12 xxl:col-span-9">
                                <div class="box">
                                <div class="p-6">
                                    <img class="w-full h-auto rounded-sm" src="<?php echo e(asset('build/assets/img/gallery/8.jpg')); ?>" alt="Image Description">
                                    ...
                                    <div class="md:flex justify-between mb-5 space-y-2 md:space-y-0">
                                        ...
                                        <div class="flex items-center space-x-3 rtl:space-x-reverse">
                                            <img class="avatar avatar-sm !w-8 !h-8 ring-0 rounded-full" src="<?php echo e(asset('build/assets/img/users/1.jpg')); ?>" alt="avatar">
                                            <div>
                                    ...
                                    <div>
                                        ...
                                        <img class="avatar avatar-sm rounded-full hidden sm:flex" src="<?php echo e(asset('build/assets/img/users/7.jpg')); ?>" alt="Image Description">
                                        <img class="avatar avatar-sm rounded-full hidden sm:flex" src="<?php echo e(asset('build/assets/img/users/2.jpg')); ?>" alt="Image Description">
                                        <img class="avatar avatar-sm rounded-full hidden sm:flex" src="<?php echo e(asset('build/assets/img/users/9.jpg')); ?>" alt="Image Description">
                            ...
                            <div class="col-span-12 xxl:col-span-3">
                                ...
                                <div class="box-body p-0">
                                    ...
                                    <div class="swiper-wrapper">
                                        ...
                                        <div class="rtl:dir-rtl">
                                            <img src="<?php echo e(asset('build/assets/img/gallery/4.jpg')); ?>" alt="image">
                                            ...
                                            <div class="flex items-center">
                                                <img src="<?php echo e(asset('build/assets/img/users/15.jpg')); ?>" alt="" class="shadow-none ring-transparent avatar avatar-sm !rounded-full ltr:mr-2 rtl:ml-2">
                                        ...
                                        <div class="swiper-slide">
                                        <div class="rtl:dir-rtl">
                                            <img src="<?php echo e(asset('build/assets/img/gallery/5.jpg')); ?>" alt="image">
                                            <div class="blog-caption text-start">
                                            <p class="mb-2 text-xs">The agency has a diverse workforce of just under 18,000 civil servants, and
                                                works with many more U.S.</p>
                                            <h6 class="text-base font-semibold mb-2">N.A.S.A</h6>
                                        ...
                                        <div class="swiper-slide">
                                        <div class="rtl:dir-rtl">
                                            <img src="<?php echo e(asset('build/assets/img/gallery/6.jpg')); ?>" alt="image">
                                            <div class="blog-caption text-start">
                                            <p class="mb-2 text-xs">The agency has a diverse workforce of just under 18,000 civil servants, and
                                                works with many more U.S.</p>
                                            <h6 class="text-base font-semibold mb-2">N.A.S.A</h6>
                                ...
                                <div class="box-body">
                                    ...
                                    <a href="javascript:void(0);" class="space-x-3 flex rtl:space-x-reverse">
                                        <img src="<?php echo e(asset('build/assets/img/gallery/7.jpg')); ?>" class="avatar avatar-lg rounded-sm ring-0" alt="Image Description">
                                    ...
                                    <a href="javascript:void(0);" class="space-x-3 flex rtl:space-x-reverse">
                                        <img src="<?php echo e(asset('build/assets/img/gallery/9.jpg')); ?>" class="avatar avatar-lg rounded-sm ring-0" alt="Image Description">
                                        <div class="space-y-1 my-auto">
                                        <h3 class="font-semibold text-sm">Lorem ipsum dolor sit amet consectetur adipisicing elit.</h3>
                                    ...
                                    <li class="ti-list-group px-0 border-0 text-gray-800 dark:text-white">
                                    <a href="javascript:void(0);" class="space-x-3 flex rtl:space-x-reverse">
                                        <img src="<?php echo e(asset('build/assets/img/gallery/8.jpg')); ?>" class="avatar avatar-lg rounded-sm ring-0" alt="Image Description">
                                        <div class="space-y-1 my-auto">
                                        <h3 class="font-semibold text-sm">Lorem ipsum dolor sit amet consectetur adipisicing elit.</h3>
                                    ...
                                    <li class="ti-list-group px-0 border-0 text-gray-800 dark:text-white">
                                    <a href="javascript:void(0);" class="space-x-3 flex rtl:space-x-reverse">
                                        <img src="<?php echo e(asset('build/assets/img/gallery/3.jpg')); ?>" class="avatar avatar-lg rounded-sm ring-0" alt="Image Description">
                                        <div class="space-y-1 my-auto">
                                        <h3 class="font-semibold text-sm">Lorem ipsum dolor sit amet consectetur adipisicing elit.</h3>
                                    ...
                                    <li class="ti-list-group px-0 border-0 text-gray-800 dark:text-white">
                                    <a href="javascript:void(0);" class="space-x-3 flex rtl:space-x-reverse">
                                        <img src="<?php echo e(asset('build/assets/img/gallery/2.jpg')); ?>" class="avatar avatar-lg rounded-sm ring-0" alt="Image Description">
                                        <div class="space-y-1 my-auto">
                                        <h3 class="font-semibold text-sm">Lorem ipsum dolor sit amet consectetur adipisicing elit.</h3>
                                        <p class="flex space-x-2 rtl:space-x-reverse text-gray-500 dark:text-white/70 text-xs"><i class="ri ri-calendar-line text-xs"></i><span>l day ago</span></p>
                                        </div>
...
<?php $__env->startSection('scripts'); ?>
        ...
        <?php echo app('Illuminate\Foundation\Vite')('resources/assets/js/blog.js'); ?>
        

<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\projects\my-projects\laravel\vite\synto\synto-laravel\synto\resources\views/pages/blog-details.blade.php ENDPATH**/ ?>