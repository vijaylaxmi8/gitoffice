                            ...
                            <div class="block justify-between page-header sm:flex">
                                ...
                                <ol class="flex items-center whitespace-nowrap min-w-0">
                                    ...
                                    <a class="flex items-center font-semibold text-primary hover:text-primary dark:text-primary truncate" href="javascript:void(0);">
                                        My Dashboard-tickets <?php echo e($ticket->attachment); ?>
                                    ...
                                    <div class="box">
                                        ...
                                        <div class="table-bordered table-auto rounded-sm ti-striped-table ti-custom-table-head overflow-auto">
                                            ...
                                            <tr class="">
                                                ...
                                                <th scope="col" class="dark:text-white/80"><?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('feild details','feild details'));?></th>
