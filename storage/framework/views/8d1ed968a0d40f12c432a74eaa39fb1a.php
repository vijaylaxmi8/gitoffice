                                                    ...
                                                    <div id="hs-medium-modal" class="hs-overlay hidden ti-modal">
                                                        <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out md:!max-w-2xl md:w-full m-3 md:mx-auto">
                                                            <div class="ti-modal-content">
                                                                ...
                                                                <form action="<?php echo e(route('ESTB.leaves.holiday_rhlist.store')); ?>" method="post">
                                                                    <?php echo csrf_field(); ?>
                                                                    <div class="ti-modal-body">
                                                                        <div class="max-w-sm space-y-3 pb-6">
                                                                            ...
                                                                            <?php if($errors->has('year')): ?>
                                                                                <div class="text-red-700"><?php echo e($errors->first('year')); ?></div>
                                                                            <?php endif; ?>
                                                                        ...
                                                                        <div class="max-w-sm space-y-3 pb-6">
                                                                            ...
                                                                            <?php if($errors->has('day')): ?>
                                                                                <div class="text-red-700"><?php echo e($errors->first('day')); ?></div>
                                                                            <?php endif; ?>
                                                                        ...
                                                                        <div class="max-w-sm space-y-3 pb-6">
                                                                            ...
                                                                            <?php if($errors->has('type')): ?>
                                                                                <div class="text-red-700"><?php echo e($errors->first('type')); ?></div>
                                                                            <?php endif; ?>
                                        ...
                                        <div class="box-body">
                                            <div class="table-bordered rounded-sm ti-striped-table ti-custom-table-head overflow-auto">
                                                <table id="holidayrh" class="ti-custom-table ti-custom-table-head whitespace-nowrap">
                                                    ...
                                                    ?>
                                                    <tbody class="">
                                                            <?php $__empty_1 = true; $__currentLoopData = $holidayrh; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $holiday): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                                <tr class="">
                                                                                    
                                                                    <td><span><?php echo e($i++); ?></span></td>
                                                                    <td><span><?php echo e($holiday->year); ?></span></td>
                                                                    <td><span><?php echo e($holiday->title); ?></span></td>
                                                                    <td><span><?php echo e(\Carbon\Carbon::parse($holiday->start)->format('d-M-Y')); ?></span></td>  
                                                                    <td><span><?php echo e($holiday->day); ?></span></td>
                                                                    <td><span><?php echo e($holiday->type); ?></span></td>
                                                                    <td class="font-medium space-x-2 rtl:space-x-reverse">
                                                                        <div class="hs-tooltip ti-main-tooltip">
                                                                            <button data-hs-overlay="#holidayrhedit_modal<?php echo e($i); ?>"
                                                                            ...
                                                                            <div id="holidayrhedit_modal<?php echo e($i); ?>" class="hs-overlay hidden ti-modal">
                                                                                <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out md:!max-w-2xl md:w-full m-3 md:mx-auto">
                                                                                    <div class="ti-modal-content">
                                                                                        <div class="ti-modal-header">
                                                                                            <h3 class="ti-modal-title">
                                                                                            ...
                                                                                            <button type="button" class="hs-dropdown-toggle ti-modal-close-btn"
                                                                                                data-hs-overlay="#holidayrhedit_modal<?php echo e($i); ?>">
                                                                                                <span class="sr-only">Close</span>
                                                                                                <svg class="w-3.5 h-3.5" width="8" height="8" viewBox="0 0 8 8" fill="none"
                                                                                                    xmlns="http://www.w3.org/2000/svg">
                                                                                                <path
                                                                                        ...
                                                                                        <form  action="<?php echo e(route('ESTB.leaves.holiday_rhlist.update',$holiday->id)); ?>" method="post">
                                                                                            <?php echo csrf_field(); ?>
                                                                                            <?php echo method_field('patch'); ?>
                                                                                            <div class="ti-modal-body">
                                                                                                <div class="max-w-sm space-y-3 pb-6">
                                                                                                    <label for="yearInput" class="ti-form-label">Year: </label>
                                                                                                    <input type="text" maxlength="4" class="ti-form-input yearInput" name="year" required placeholder="Year" value="<?php echo e($holiday->year); ?>">
                                                                                            
                                                                                                </div>
                                                                                                <div class="max-w-sm space-y-3 pb-6">
                                                                                                    <label for="with-corner-hint" class="ti-form-label font-bold">Title: </label>
                                                                                                    <input type="text" name="title" class="ti-form-input" required placeholder="Title" value="<?php echo e($holiday->title); ?>">
                                                                                                ...
                                                                                                <div class="max-w-sm space-y-3 pb-6">
                                                                                                    ...
                                                                                                    <div class="px-4 inline-flex items-center min-w-fit ltr:rounded-l-sm rtl:rounded-r-sm border ltr:border-r-0 rtl:border-l-0 border-gray-200 bg-gray-50 dark:bg-black/20 dark:border-white/10">
                                                                                                        ...
                                                                                                        <input type="date" name="start"
                                                                                                                class="ti-form-input rounded-l-none focus:z-10 flatpickr-input date"
                                                                                                                required placeholder="Choose date" value="<?php echo e($holiday->start); ?>">
                                                                                                </div>
                                                                                                <div class="max-w-sm space-y-3 pb-6">
                                                                                                    <label for="with-corner-hint" class="ti-form-label font-bold">Day: </label>
                                                                                                    <input type="text" name="day" class="ti-form-input" required placeholder="Day" value="<?php echo e($holiday->day); ?>">
                                                                                                ...
                                                                                                <div class="max-w-sm space-y-3 pb-6">
                                                                                                    <label for="" class="ti-form-label font-bold">Type:</label>
                                                                                                        <select class="ti-form-select type" name="type" required>
                                                                                                            <option value="#">Choose Type</option>
                                                                                                            <option value="Holiday"<?php echo e($holiday->type=='Holiday'? 'selected':''); ?>>Holiday</option>
                                                                                                            <option value="RH"<?php echo e($holiday->type=='RH'? 'selected':''); ?>>RH</option>
                                                                                                        </select>  
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="ti-modal-footer">
                                                                        ...
                                                                        <div class="hs-tooltip ti-main-tooltip">
                                                                            <form action="<?php echo e(route('ESTB.leaves.holiday_rhlist.destroy',$holiday->id)); ?>" method="post">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\laravel Apps\gitoffice\resources\views/ESTB/leaves/holiday_rhlist/index.blade.php ENDPATH**/ ?>