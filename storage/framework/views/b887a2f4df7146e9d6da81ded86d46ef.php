                    ...
                    <div class="content">
                        ...
                        <div class="main-content">
                            ...
                            <div class="box-header sm:flex sm:justify-between space-y-3 sm:space-y-0">
                                ...
                                <a href="<?php echo e(url('add-product')); ?>" class="ti-btn ti-btn-primary m-0 py-2"><i class="ri ri-add-line"></i>Add
                                Product</a>
                            </div>
                            <div class="box-body">
                                ...
                                <table class="ti-custom-table ti-custom-table-head edit-table">
                                    ...
                                    <tr class="product-list">
                                        ...
                                        <div class="flex items-center h-5 product-checkbox justify-center">
                                            <input id="product-check-1" type="checkbox" class="border-gray-500 ti-form-checkbox">
                                        ...
                                        <a aria-label="anchor" href="<?php echo e(url('products-details')); ?>"
                                            class="w-8 h-8 ti-btn rounded-full p-0 transition-none focus:outline-none ti-btn-soft-warning">
                                            <i class="ti ti-eye"></i>
                                        </a>
                                        <a aria-label="anchor" href="<?php echo e(url('edit-product')); ?>"
                                    ...
                                    <tr class="product-list">
                                        <td class="">
                                        <div class="flex items-center h-5 product-checkbox justify-center">
                                            <input id="product-check-2" type="checkbox" class="border-gray-500 ti-form-checkbox">
                                        ...
                                        <div class="flex space-x-3 rtl:space-x-reverse">
                                            <img class="avatar avatar-sm rounded-sm bg-gray-100 dark:bg-black/20 p-1"
                                            src="<?php echo e(asset('build/assets/img/ecommerce/products/16.png')); ?>" alt="Image Description">
                                            <span
                                    ...
                                    <tr class="product-list">
                                        <td class="">
                                        <div class="flex items-center h-5 product-checkbox justify-center">
                                            <input id="product-check-3" type="checkbox" class="border-gray-500 ti-form-checkbox">
                                        ...
                                        <div class="flex space-x-3 rtl:space-x-reverse">
                                            <img class="avatar avatar-sm rounded-sm bg-gray-100 dark:bg-black/20 p-1"
                                            src="<?php echo e(asset('build/assets/img/ecommerce/products/18.png')); ?>" alt="Image Description">
                                            <span
                                    ...
                                    <tr class="product-list">
                                        <td class="">
                                        <div class="flex items-center h-5 product-checkbox justify-center">
                                            <input id="product-check-4" type="checkbox" class="border-gray-500 ti-form-checkbox">
                                        ...
                                        <div class="flex space-x-3 rtl:space-x-reverse">
                                            <img class="avatar avatar-sm rounded-sm bg-gray-100 dark:bg-black/20 p-1"
                                            src="<?php echo e(asset('build/assets/img/ecommerce/products/11.png')); ?>" alt="Image Description">
                                            <span
                                    ...
                                    <tr class="product-list">
                                        <td class="">
                                        <div class="flex items-center h-5 product-checkbox justify-center">
                                            <input id="product-check-5" type="checkbox" class="border-gray-500 ti-form-checkbox">
                                    ...
                                    <tr class="product-list">
                                        <td class="">
                                        <div class="flex items-center h-5 product-checkbox justify-center">
                                            <input id="product-check-6" type="checkbox" class="border-gray-500 ti-form-checkbox">
                                        ...
                                        <div class="flex space-x-3 rtl:space-x-reverse">
                                            <img class="avatar avatar-sm rounded-sm bg-gray-100 dark:bg-black/20 p-1"
                                            src="<?php echo e(asset('build/assets/img/ecommerce/products/19.png')); ?>" alt="Image Description">
                                            <span
                                    ...
                                    <tr class="product-list">
                                        <td class="">
                                        <div class="flex items-center h-5 product-checkbox justify-center">
                                            <input id="product-check-7" type="checkbox" class="border-gray-500 ti-form-checkbox">
                                    ...
                                    <tr class="product-list">
                                        <td class="">
                                        <div class="flex items-center h-5 product-checkbox justify-center">
                                            <input id="product-check-8" type="checkbox" class="border-gray-500 ti-form-checkbox">
                                        ...
                                        <div class="flex space-x-3 rtl:space-x-reverse">
                                            <img class="avatar avatar-sm rounded-sm bg-gray-100 dark:bg-black/20 p-1"
                                            src="<?php echo e(asset('build/assets/img/ecommerce/products/8.png')); ?>" alt="Image Description">
                                            <span
                                    ...
                                    <tr class="product-list">
                                        <td class="">
                                        <div class="flex items-center h-5 product-checkbox justify-center">
                                            <input id="product-check-9" type="checkbox" class="border-gray-500 ti-form-checkbox">
                                        ...
                                        <div class="flex space-x-3 rtl:space-x-reverse">
                                            <img class="avatar avatar-sm rounded-sm bg-gray-100 dark:bg-black/20 p-1"
                                            src="<?php echo e(asset('build/assets/img/ecommerce/products/10.png')); ?>" alt="Image Description">
                                            <span
...
<?php $__env->startSection('scripts'); ?>
        ...
        <!-- EDIT PRODUCT JS -->
        <?php echo app('Illuminate\Foundation\Vite')('resources/assets/js/product-list.js'); ?>
        

<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\projects\my-projects\laravel\vite\synto\synto-laravel\synto\resources\views/pages/product-list.blade.php ENDPATH**/ ?>