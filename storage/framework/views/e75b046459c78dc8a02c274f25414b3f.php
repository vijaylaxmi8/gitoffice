        ...
        <div id="hs-overlay-switcher" class="hs-overlay hidden ti-offcanvas ti-offcanvas-right" tabindex="-1">
            ...
            <a class="ti-btn ti-btn-primary" href="https://1.envato.market/MGEaN">Try Now</a>
            <a class="ti-btn ti-btn-secondary" href="https://1.envato.market/MGEaN">Our Protfolio</a>
            <a id="reset-all" class="ti-btn ti-btn-danger" href="javascript:void(0);">Reset</a>
            </div>
        </div>
<?php /**PATH E:\projects\laravel\vite\synto\synto\resources\views/layouts/components/landing-switcher.blade.php ENDPATH**/ ?>