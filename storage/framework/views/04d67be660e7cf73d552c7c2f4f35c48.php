                                ...
                                <div class="col-span-12 md:col-span-6 xxl:col-span-3">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <h5 class="mb-0 text-2xl font-semibold text-gray-800 dark:text-white"><?php echo e($totalemployee); ?></h5>
                                ...
                                <div class="col-span-12 md:col-span-6 xxl:col-span-3">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <div class="flex justify-between items-center">
                                            <h5 class="mb-0 text-2xl font-semibold text-gray-800 dark:text-white"><?php echo e($teachingstaff); ?></h5>
                                            <span class="text-success badge bg-success/20 rounded-sm p-1"><i
                                ...
                                <div class="col-span-12 md:col-span-6 xxl:col-span-3">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <div class="flex justify-between items-center">
                                            <h5 class="mb-0 text-2xl font-semibold text-gray-800 dark:text-white"><?php echo e($nonteachingstaff); ?></h5>
                            ...
                            <div class="grid grid-cols-12 gap-x-5">
                                ...
                                <div class="col-span-12 md:col-span-6 xxl:col-span-3">
                                    ...
                                    <div class="box-header justify-between flex">
                                        ...
                                        <div>
                                            <a class="flex  items-center font-semibold text-primary hover:text-primary dark:text-primary truncate" href="<?php echo e(route('HOD.event.index')); ?>">
                                                View All
                                            </a>
                                        </div>
                                    </div>
                                    <div class="box-body">
                                        <div class="overflow-x-auto">
                                            <ul class="list-unstyled timeline-widget mb-0">
                                                <?php $__currentLoopData = $deptevent; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="col-span-12 md:col-span-6 xxl:col-span-3">
                                    <div class="box" style="height: 450px; overflow-y: auto;">
                                        ...
                                        <div class="box-body">
                                            ...
                                            <?php $__currentLoopData = $deptnotice; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dn): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <div class="flex-1">
                                                    ...
                                                    <div class="flex justify-between items-center">
                                                        <div class="flex flex-col">
                                                            ...
                                                            <a class="flex items-center font-semibold text-primary hover:text-primary dark:text-primary truncate" href="<?php echo e(route('HOD.Teaching.hodactivityattended')); ?>">
                                                                Attended
                                                            </a>
                                                        </div>
                                                        <div class="flex flex-col">
                                                            <h5 class="mb-0 text-2xl font-semibold text-gray-800 dark:text-white"><?php echo e($professional_activity_conducteds); ?></h5>
                                                            <a class="flex items-center font-semibold text-primary hover:text-primary dark:text-primary truncate" href="<?php echo e(route('HOD.Teaching.hodactivityconducted')); ?>">
                                                                Conducted
                                                            </a>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="box-body">
                                            <div class="flex">
                                                ...
                                                <div class="flex-1">
                                                    ...
                                                    <div class="flex justify-between items-center">
                                                        <div class="flex flex-col">
                                                            <h5 class="mb-0 text-2xl font-semibold text-gray-800 dark:text-white"><?php echo e($ntactivity_attendee); ?></h5>
                                                            <a class="flex items-center font-semibold text-primary hover:text-primary dark:text-primary truncate" href="<?php echo e(route('HOD.NonTeaching.hodattended')); ?>">
                                                                Attended
                                                            </a>
                                                        </div>
                                                        <div class="flex flex-col">
                                                            <h5 class="mb-0 text-2xl font-semibold text-gray-800 dark:text-white"><?php echo e($nt_activity_conducteds); ?></h5>
                                                            <a class="flex items-center font-semibold text-primary hover:text-primary dark:text-primary truncate" href="<?php echo e(route('HOD.NonTeaching.hodconducted')); ?>">
                                                                Conducted
                                                            </a>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="flex-1">
                                                    ...
                                                    <div class="flex justify-between items-center">
                                                        <div class="flex flex-col">
                                                            ...
                                                            <a class="flex items-center font-semibold text-primary hover:text-primary dark:text-primary truncate" href="<?php echo e(route('HOD.Teaching.research.hodconferenceattended')); ?>">
                                                                Attended
                                                            </a>
                                                        </div>
                                                        <div class="flex flex-col">
                                                            <h5 class="mb-0 text-2xl font-semibold text-gray-800 dark:text-white"><?php echo e($conferences_conducted); ?></h5>
                                                            <a class="flex items-center font-semibold text-primary hover:text-primary dark:text-primary truncate" href="<?php echo e(route('HOD.Teaching.research.hodconferenceconducted')); ?>">
                                                                Conducted
                                                            </a>
                                                        </div>
                                                    </div>
                                ...
                                <div class="col-span-12 md:col-span-6 xxl:col-span-3">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <a class="flex  items-center font-semibold text-primary hover:text-primary dark:text-primary truncate" href="<?php echo e(route('HOD.Teaching.research.hodpublication')); ?>">
                                                 view
                                            </a>
                                        </div>
                                        </div>
                                ...
                                <div class="col-span-12 md:col-span-6 xxl:col-span-3">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <a class="flex  items-center font-semibold text-primary hover:text-primary dark:text-primary truncate" href="<?php echo e(route('HOD.Teaching.research.hodfundedproject')); ?>">
                                                 view
                                            </a>
                                        </div>
                                        </div>
                                ...
                                <div class="col-span-12 md:col-span-6 xxl:col-span-3">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <a class="flex  items-center font-semibold text-primary hover:text-primary dark:text-primary truncate" href="<?php echo e(route('HOD.Teaching.research.hodpatents')); ?>">
                                                 view
                                            </a>
                                        </div>
                                        </div>
                                ...
                                <div class="col-span-12 md:col-span-6 xxl:col-span-3">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <a class="flex  items-center font-semibold text-primary hover:text-primary dark:text-primary truncate" href="<?php echo e(route('HOD.Teaching.research.hodcopyrights')); ?>">
                                                 view
                                            </a>
                                        </div>
                                        </div>
                                ...
                                <div class="col-span-12 md:col-span-6 xxl:col-span-3">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <a class="flex  items-center font-semibold text-primary hover:text-primary dark:text-primary truncate" href="<?php echo e(route('HOD.Teaching.research.hodachivements')); ?>">
                                                 view
                                            </a>
                                        </div>
                                        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.components.HOD.master-hod', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\laravel Apps\gitoffice\resources\views/HOD/dashboard.blade.php ENDPATH**/ ?>