                            ...
                            <div class="col-span-12 xxl:col-span-3">
                                ...
                                <div class="box-body">
                                    ...
                                    <li class="ti-list-group pt-0 px-0 border-0 text-gray-800 dark:text-white">
                                        ...
                                        <img src="<?php echo e(asset('build/assets/img/gallery/7.jpg')); ?>" class="avatar avatar-lg rounded-sm ring-0"
                                    ...
                                    <li class="ti-list-group px-0 border-0 text-gray-800 dark:text-white">
                                        <div class="space-x-3 flex w-full rtl:space-x-reverse">
                                        <img src="<?php echo e(asset('build/assets/img/gallery/9.jpg')); ?>" class="avatar avatar-lg rounded-sm ring-0"
                                            alt="Image Description">
                                        <div class="flex justify-between w-full">
                                            <div class="space-y-1 my-auto">
                                            <h3 class="font-semibold text-sm">Lorem ipsum dolor sit amet consectetur adipisicing elit.
                                    ...
                                    <li class="ti-list-group px-0 border-0 text-gray-800 dark:text-white">
                                        <div class="space-x-3 flex w-full rtl:space-x-reverse">
                                        <img src="<?php echo e(asset('build/assets/img/gallery/8.jpg')); ?>" class="avatar avatar-lg rounded-sm ring-0"
                                            alt="Image Description">
                                        <div class="flex justify-between w-full">
                                            <div class="space-y-1 my-auto">
                                            <h3 class="font-semibold text-sm">Lorem ipsum dolor sit amet consectetur adipisicing elit.
                                    ...
                                    <li class="ti-list-group px-0 border-0 text-gray-800 dark:text-white">
                                        <div class="space-x-3 flex w-full rtl:space-x-reverse">
                                        <img src="<?php echo e(asset('build/assets/img/gallery/3.jpg')); ?>" class="avatar avatar-lg rounded-sm ring-0"
                                            alt="Image Description">
                                        <div class="flex justify-between w-full">
                                            <div class="space-y-1 my-auto">
                                            <h3 class="font-semibold text-sm">Lorem ipsum dolor sit amet consectetur adipisicing elit.
                                    ...
                                    <li class="ti-list-group px-0 border-0 text-gray-800 dark:text-white">
                                        <div class="space-x-3 flex w-full rtl:space-x-reverse">
                                        <img src="<?php echo e(asset('build/assets/img/gallery/2.jpg')); ?>" class="avatar avatar-lg rounded-sm ring-0"
                                            alt="Image Description">
                                        <div class="flex justify-between w-full">
                                            <div class="space-y-1 my-auto">
                                            <h3 class="font-semibold text-sm">Lorem ipsum dolor sit amet consectetur adipisicing elit.
                                ...
                                <div class="box">
                                <div class="box-body">
                                    <h3 class="font-semibold text-base text-primary">Subscribe For More Blog's</h3>
...
<?php $__env->startSection('scripts'); ?>
        ...
        <!-- BLOG EDIT JS -->
        <?php echo app('Illuminate\Foundation\Vite')('resources/assets/js/blog-edit.js'); ?>

        
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\projects\laravel\vite\synto\synto\resources\views/pages/blog-edit.blade.php ENDPATH**/ ?>