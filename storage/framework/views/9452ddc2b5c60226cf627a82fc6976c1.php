                            ...
                            <div class="grid grid-cols-12 gap-x-5">
                                <div class="col-span-12 md:col-span-6 xxl:col-span-3">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="flex-1">
                                            <p class="text-sm font-bold">Research Scholars</p>
                                            <div class="flex justify-between items-center">
                                            <h5 class="mb-0 text-2xl font-semibold text-gray-800 dark:text-white"><?php echo e($researchscholarscount); ?></h5>
                                ...
                                <div class="col-span-12 md:col-span-6 xxl:col-span-3">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="flex-1">
                                            <p class="text-sm font-bold">Research Activities</p>
                                            <div class="flex justify-between items-center">
                                            <h5 class="mb-0 text-2xl font-semibold text-gray-800 dark:text-white"><?php echo e($totalresearchCount); ?></h5>
                                            
                                            </div>
                                            <a class="flex  items-center font-semibold text-primary hover:text-primary dark:text-primary truncate" href="<?php echo e(route('Deanrnd.dashboard')); ?>">
                                                 view
                                            </a>
                                        </div>
                                        </div>
                                ...
                                <div class="col-span-12 md:col-span-6 xxl:col-span-3">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="flex-1">
                                            <p class="text-sm font-bold">GIT Sponsored Events</p>
                                            <div class="flex justify-between items-center">
                                            <h5 class="mb-0 text-2xl font-semibold text-gray-800 dark:text-white"><?php echo e($gitsponsoredevents); ?></h5>
                                ...
                                <div class="col-span-12 md:col-span-6 xxl:col-span-3">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="flex-1">
                                            <p class="text-sm font-bold">Grants Received</p>
                                            <div class="flex justify-between items-center">
                                            <h5 class="mb-0 text-2xl font-semibold text-gray-800 dark:text-white"><?php echo e($totalFundsReceived); ?></h5>
                                            
                                            </div>
                                            <a class="flex  items-center font-semibold text-primary hover:text-primary dark:text-primary truncate" href="<?php echo e(route('Deanrnd.Teaching.research.fundedproject')); ?>">
                                                 view
                                            </a>
                                        </div>
                                        </div>
                                                ...
                                                <div class="flex-1">
                                                    ...
                                                    <div class="flex justify-between items-center">
                                                        <div class="flex flex-col">
                                                            <h5 class="mb-0 text-2xl font-semibold text-gray-800 dark:text-white"><?php echo e($teaching_activity_attended); ?></h5>
                                                            <a class="flex items-center font-semibold text-primary hover:text-primary dark:text-primary truncate" href="<?php echo e(route('Deanrnd.Teaching.activityattended')); ?>">
                                                                Attended
                                                            </a>
                                                        </div>
                                                        <div class="flex flex-col">
                                                            <h5 class="mb-0 text-2xl font-semibold text-gray-800 dark:text-white"><?php echo e($teaching_activity_conducted); ?></h5>
                                                            <a class="flex items-center font-semibold text-primary hover:text-primary dark:text-primary truncate" href="<?php echo e(route('Deanrnd.Teaching.activityconducted')); ?>">
                                                                Conducted
                                                            </a>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="box-body">
                                            <div class="flex">
                                                ...
                                                <div class="flex-1">
                                                    ...
                                                    <div class="flex justify-between items-center">
                                                        <div class="flex flex-col">
                                                            <h5 class="mb-0 text-2xl font-semibold text-gray-800 dark:text-white"><?php echo e($professional_activity_attendee); ?></h5>
                                                            <a class="flex items-center font-semibold text-primary hover:text-primary dark:text-primary truncate" href="<?php echo e(route('Deanrnd.NonTeaching')); ?>">
                                                                Attended
                                                            </a>
                                                        </div>
                                                        <div class="flex flex-col">
                                                            <h5 class="mb-0 text-2xl font-semibold text-gray-800 dark:text-white"><?php echo e($professional_activity_conducteds); ?></h5>
                                                            <a class="flex items-center font-semibold text-primary hover:text-primary dark:text-primary truncate" href="<?php echo e(route('Deanrnd.NonTeaching.conducted')); ?>">
                                                                Conducted
                                                            </a>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="box-body">
                                            <div class="flex">
                                                ...
                                                <div class="flex-1">
                                                    ...
                                                    <div class="flex justify-between items-center">
                                                        <div class="flex flex-col">
                                                            <h5 class="mb-0 text-2xl font-semibold text-gray-800 dark:text-white"><?php echo e($conferences_attendees); ?></h5>
                                                            <a class="flex items-center font-semibold text-primary hover:text-primary dark:text-primary truncate" href="<?php echo e(route('Deanrnd.Teaching.research.conferenceattended')); ?>">
                                                                Attended
                                                            </a>
                                                        </div>
                                                        <div class="flex flex-col">
                                                            <h5 class="mb-0 text-2xl font-semibold text-gray-800 dark:text-white"><?php echo e($conferences_conducted); ?></h5>
                                                            <a class="flex items-center font-semibold text-primary hover:text-primary dark:text-primary truncate" href="<?php echo e(route('Deanrnd.Teaching.research.conferenceconducted')); ?>">
                                                                Conducted
                                                            </a>
                                                        </div>
                                                    </div>
                                ...
                                <div class="col-span-12 md:col-span-6 xxl:col-span-3">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <div class="flex justify-between items-center">
                                                <h5 class="mb-0 text-2xl font-semibold text-gray-800 dark:text-white"><?php echo e($publication); ?></h5>
                                            </div>
                                            <a class="flex  items-center font-semibold text-primary hover:text-primary dark:text-primary truncate" href="<?php echo e(route('Deanrnd.Teaching.research.publication')); ?>">
                                                 view
                                            </a>
                                        </div>
                                        </div>
                                ...
                                <div class="col-span-12 md:col-span-6 xxl:col-span-3">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <a class="flex  items-center font-semibold text-primary hover:text-primary dark:text-primary truncate" href="<?php echo e(route('Deanrnd.Teaching.research.patents')); ?>">
                                                 view
                                            </a>
                                        </div>
                                        </div>
                                ...
                                <div class="col-span-12 md:col-span-6 xxl:col-span-3">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <a class="flex  items-center font-semibold text-primary hover:text-primary dark:text-primary truncate" href="<?php echo e(route('Deanrnd.Teaching.research.copyrights')); ?>">
                                                 view
                                            </a>
                                        </div>
                                        </div>
                                ...
                                <div class="col-span-12 md:col-span-6 xxl:col-span-3">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <a class="flex  items-center font-semibold text-primary hover:text-primary dark:text-primary truncate" href="<?php echo e(route('Deanrnd.Teaching.research.achivements')); ?>">
                                                 view
                                            </a>
                                        </div>
                                        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.components.Deanrnd.master-deanrnd', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\laravel Apps\gitoffice\resources\views/Deanrnd/dashboard.blade.php ENDPATH**/ ?>