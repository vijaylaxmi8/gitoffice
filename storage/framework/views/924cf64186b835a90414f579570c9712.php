            ...
            <nav class="main-header" aria-label="Global">
                ...
                <div class="header-right !ml-0">
                    ...
                    <div class="flex space-x-3 rtl:space-x-reverse">
                        <a href="javascript:void(0);" class="ti-btn w-[6.375rem] ti-btn-dark m-0 p-2">Sign
                        Up</a>
                        <a href="javascript:void(0);" class="ti-btn w-[6.375rem] m-0 p-2 ti-btn-primary">Get Started</a>
        ...
        </header><?php /**PATH E:\projects\laravel\vite\synto\synto\resources\views/layouts/components/landing-header.blade.php ENDPATH**/ ?>