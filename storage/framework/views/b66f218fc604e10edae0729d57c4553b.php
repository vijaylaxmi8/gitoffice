                                        ...
                                        <div class="box-header">
                                            <div class="flex">
                                                ...
                                                <div class=" block ltr:ml-auto rtl:mr-auto my-auto">
                                                    <button type="button" id="notice_btn"  class="hs-dropdown-toggle ti-btn ti-btn-primary" data-hs-overlay="#add_notice">
                                                            ...
                                                            <div class="ti-modal-content">
                                                                <div class="ti-modal-header">
                                                                    ...
                                                                    <svg class="w-3.5 h-3.5" width="8" height="8" viewBox="0 0 8 8" fill="none"
                                                                      ...
                                                                      <?php if((($errors->has('title'))||($errors->has('description'))||($errors->has('date'))||($errors->has('staff_type')))): ?>
                                                                            <script>
                                                                ...
                                                                <form action="<?php echo e(route('Principaloffice.ponotice.store')); ?>" method="post">
                                                                    <?php echo csrf_field(); ?>
                                                                            ...
                                                                            <div class="max-w-sm space-y-3 pb-6">
                                                                                ...
                                                                                <input type="text" name="description" class="ti-form-input po_noticedescription" placeholder="Description">
                                                                                 <?php if($errors->has('description')): ?>
                                                                                    <div class="text-red-700"><?php echo e($errors->first('description')); ?></div>
                                                                                <?php endif; ?>
                                                                    ...
                                                                    <div class="ti-modal-footer">
                                                                        ...
                                                                        <input type="submit" id="principaloffice_notice_store_add_btn" class="ti-btn  bg-primary text-white hover:bg-primary  focus:ring-primary  dark:focus:ring-offset-white/10" value="Add"/>
                                                ...
                                                <table id="notice_table" class="ti-custom-table ti-custom-table-head whitespace-nowrap">
                                                    ...
                                                    <tbody class="">
                                                        <?php
                                                            $i = 1;
                                                        ?>
                                                        <?php $__empty_1 = true; $__currentLoopData = $dept_notice; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dn): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                            <tr class="">
                                                                <td><span><?php echo e($i++); ?></span></td>
                                                                <td><span><?php echo e($dn->title); ?></span></td>
                                                                <td><span><?php echo e($dn->description); ?></span></td>
                                                                <td><span><?php echo e(\Carbon\Carbon::parse($dn->date)->format('d-M-Y')); ?></span></td>
                                                                <td><span><?php echo e($dn->staff_type); ?></span></td>
                                                                <td>
                                                                    <?php $__currentLoopData = $dn->department; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $department): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                ...
                                                                <div class="hs-tooltip ti-main-tooltip">
                                                                    <button data-hs-overlay="#notice_edit_modal<?php echo e($i); ?>"  id="btn<?php echo e($i); ?>" btn-val=<?php echo e($i); ?>

                                                                        class="hs-dropdown-toggle  m-0 hs-tooltip-toggle relative w-8 h-8 ti-btn rounded-full p-0 transition-none focus:outline-none ti-btn-soft-secondary notice_edit_modal_click">
                                                                    ...
                                                                    <div id="notice_edit_modal<?php echo e($i); ?>" class="hs-overlay hidden ti-modal">
                                                                        <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out lg:!max-w-4xl lg:w-full m-3 md:mx-auto">
                                                                            <div class="ti-modal-content">
                                                                                <div class="ti-modal-header">
                                                                                    <h3 class="ti-modal-title">
                                                                                    ...
                                                                                    <button type="button" class="hs-dropdown-toggle ti-modal-close-btn"
                                                                                       ...
                                                                                       <?php if((($errors->has('e_title'))||($errors->has('e_description'))||($errors->has('e_date'))||($errors->has('e_staff_type')))): ?>
                                                                                            <script>
                                                                                                $(window).on('load', function() {
                                                                                ...
                                                                                <form action="<?php echo e(route('Principaloffice.ponotice.update',$dn->id)); ?>" method="post">
                                                                                    <?php echo csrf_field(); ?>
                                                                                    <?php echo method_field('patch'); ?>
                                                                                    <div class="ti-modal-body">
                                                                                     <input type='hidden' name='notice_modal_no' class='notice_modal_no' value=<?php echo e(old('notice_modal_no')); ?>/>
                                                                                        <div class="grid lg:grid-cols-2 gap-1 space-y-2 lg:space-y-0">
                                                                                            <div class="max-w-sm space-y-3 pb-6">
                                                                                                <label for="with-corner-hint" class="ti-form-label font-bold">Title:<span class="text-red-500">*</span></label>
                                                                                                <input type="text" name="e_title" class="ti-form-input" placeholder="Title" value="<?php echo e($dn->title); ?>">
                                                                                            ...
                                                                                            <div class="max-w-sm space-y-3 pb-6">
                                                                                                <label for="" class="ti-form-label font-bold">Description:<span class="text-red-500">*</span></label>
                                                                                                <input type="text" name="e_description" class="ti-form-input po_location" placeholder="Description" value="<?php echo e($dn->description); ?>">
                                                                                                <?php if($errors->has('e_description')): ?>
                                                                                                    <div class="text-red-700"><?php echo e($errors->first('e_description')); ?></div>
                                                                                                <?php endif; ?>
                                                                                        ...
                                                                                        <div class="grid lg:grid-cols-2 gap-1 space-y-2 lg:space-y-0">
                                                                                            <div class="flex max-w-sm space-y-3 pb-6">
                                                                                                ...
                                                                                                <input type="date" name="e_date"
                                                                                                    class="ti-form-input rounded-l-none focus:z-10 flatpickr-input date"
                                                                                                        placeholder="Choose date" value="<?php echo e($dn->date); ?>">
                                                                                            ...
                                                                                            <div class="max-w-sm space-y-3 pb-6">
                                                                                                <label for="" class="ti-form-label font-bold">Employee Type:<span class="text-red-500">*</span></label>
                                                                                                <select class="ti-form-select" name="e_staff_type">
                                                                                                    <option  value="#">Choose One</option>
                                                                                                    <option  value="Teaching" <?php echo e(($dn->staff_type=='Teaching'? 'selected':'')); ?>>Teaching</option>
                                                                                                    <option value="Non-Teaching" <?php echo e(($dn->staff_type=='Non-Teaching'? 'selected':'')); ?>>Non-Teaching</option>
                                                                                                    <option value="All" <?php echo e(($dn->staff_type=='All'? 'selected':'')); ?>>All</option>
                                                                                    ...
                                                                                    <div class="ti-modal-footer">
                                                                                        <button type="button"
                                                                                        class="hs-dropdown-toggle ti-btn ti-border font-medium bg-white text-gray-700 shadow-sm align-middle hover:bg-gray-50 focus:ring-offset-white focus:ring-primary dark:bg-bgdark dark:hover:bg-black/20 dark:border-white/10 dark:text-white/70 dark:hover:text-white dark:focus:ring-offset-white/10"
                                                                                        data-hs-overlay="#notice_edit_modal<?php echo e($i); ?>">
                                                                                        Close
                                                                                        </button>
                                                                ...
                                                                <div class="hs-tooltip ti-main-tooltip">
                                                                    <form action="<?php echo e(route('Principaloffice.ponotice.destroy',$dn->id)); ?>" method="post">
        ...
        <script>
            $(document).ready(function(){
               ...
               new DataTable('#notice_table');
                ...
                $(document).on('click','.notice_edit_modal_click',function(){
                    //var 
                    var notice_modal_no = $(this).attr("btn-val");
                    
                    //alert($(this).find('.caste_edit_modal_no').val());
                    $('.notice_modal_no').val(event_modal_no); 
                });

                $(document).on('click','#principaloffice_notice_store_add_btn',function(e){
                    //alert(123)
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.components.Principaloffice.master-poffice', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\laravel Apps\gitoffice\resources\views/Principaloffice/ponotice.blade.php ENDPATH**/ ?>