                                                    ...
                                                    <ul>
                                                            ...
                                                            <a href="javascript:void(0);" class="w-full">
                                                                <div class="flex items-center">
                                                                    <img class="avatar avatar-sm rounded-full"
                                                                        src="<?php echo e(asset('build/assets/img/users/9.jpg')); ?>" alt="image">
                                                        ...
                                                        <li class="p-0 mb-6 ti-list-group border-0 text-gray-800 dark:text-white w-full">
                                                            <a href="javascript:void(0);" class="w-full">
                                                                <div class="flex items-center">
                                                                    <img class="avatar avatar-sm rounded-full"
                                                                        src="<?php echo e(asset('build/assets/img/users/2.jpg')); ?>" alt="image">
                                                                    <div class="flex-auto ltr:ml-2 rtl:mr-2">
                                                                        <p
                                                                            class="text-sm font-semibold mb-0 text-gray-800 dark:text-white">
                                                                            Nasiha</p>
                                                        ...
                                                        <li class="p-0 mb-6 ti-list-group border-0 text-gray-800 dark:text-white w-full">
                                                            <a href="javascript:void(0);" class="w-full">
                                                                <div class="flex items-center">
                                                                    <img class="avatar avatar-sm rounded-full"
                                                                        src="<?php echo e(asset('build/assets/img/users/4.jpg')); ?>" alt="image">
                                                                    <div class="flex-auto ltr:ml-2 rtl:mr-2">
                                                        ...
                                                        <li class="p-0 mb-6 ti-list-group border-0 text-gray-800 dark:text-white w-full">
                                                            <a href="javascript:void(0);" class="w-full">
                                                                <div class="flex items-center">
                                                                    <img class="avatar avatar-sm rounded-full"
                                                                        src="<?php echo e(asset('build/assets/img/users/14.jpg')); ?>" alt="image">
                                                                    <div class="flex-auto ltr:ml-2 rtl:mr-2">
                                                        ...
                                                        <li class="p-0 mb-0 ti-list-group border-0 text-gray-800 dark:text-white w-full">
                                                            <a href="javascript:void(0);" class="w-full">
                                                                <div class="flex items-center">
                                                                    <img class="avatar avatar-sm rounded-full"
                                                                        src="<?php echo e(asset('build/assets/img/users/16.jpg')); ?>" alt="image">
                                                                    <div class="flex-auto ltr:ml-2 rtl:mr-2">
                                    ...
                                    <div class="box">
                                        ...
                                        <div class="box-body p-0">
                                            <div class="grid md:grid-cols-3  xxl:grid-cols-5">
                                                ...
                                                <div class="p-4 ltr:md:border-r rtl:md:border-l xxl:border-b-0 border-b border-gray-200 dark:border-white/10">
                                                    <div class="flex items-start mb-6">
                                                        <img src="<?php echo e(asset('build/assets/img/users/21.jpg')); ?>" alt=""
                                                            class="avatar avatar-sm rounded-full ltr:mr-2 rtl:ml-2 leading-none">
                                                        <div class="flex-auto">
                                                            <div class="recent-recruiter">
                                                    ...
                                                    <tbody>
                                                            ...
                                                            <td>
                                                                <div class="flex items-center">
                                                                    <div class="ltr:mr-2 rtl:ml-2 leading-none">
                                                                        <img src="<?php echo e(asset('build/assets/img/flags/10.png')); ?>" alt=""
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="flex items-center">
                                                                    <div class="ltr:mr-2 rtl:ml-2 leading-none">
                                                                        <img src="<?php echo e(asset('build/assets/img/flags/3.png')); ?>" alt=""
                                                                            class="avatar avatar-xs rounded-full">
                                                                    </div>
                                                                    <div>
                                                                        <span class="text-sm font-semibold">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="flex items-center">
                                                                    <div class="ltr:mr-2 rtl:ml-2 leading-none">
                                                                        <img src="<?php echo e(asset('build/assets/img/flags/2.png')); ?>" alt=""
                                                                            class="avatar avatar-xs rounded-full">
                                                                    </div>
                                                                    <div>
                                                                        <span class="text-sm font-semibold">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="flex items-center">
                                                                    <div class="ltr:mr-2 rtl:ml-2 leading-none">
                                                                        <img src="<?php echo e(asset('build/assets/img/flags/4.png')); ?>" alt=""
                                                                            class="avatar avatar-xs rounded-full">
                                                                    </div>
                                                                    <div>
                                                                        <span class="text-sm font-semibold">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="flex items-center">
                                                                    <div class="ltr:mr-2 rtl:ml-2 leading-none">
                                                                        <img src="<?php echo e(asset('build/assets/img/flags/1.png')); ?>" alt=""
                                                                            class="avatar avatar-xs rounded-full">
                                                                    </div>
                                                                    <div>
                                                                        <span class="text-sm font-semibold">
                                                                ...
                                                                <div class="flex items-center">
                                                                    <div class="ltr:mr-2 rtl:ml-2">
                                                                        <span
                                                                            ...
                                                                            <img src="<?php echo e(asset('build/assets/img/logos/4.png')); ?>" alt="">
                                                                        </span>
                                                                    </div>
                                                                    <div>
                                                            ...
                                                            <td>
                                                                <div class="flex items-center">
                                                                    <div class="ltr:mr-2 rtl:ml-2">
                                                                        <span
                                                                            class="avatar avatar-sm">
                                                                            <img src="<?php echo e(asset('build/assets/img/logos/10.png')); ?>" alt="">
                                                                        </span>
                                                                    </div>
                                                                    <div>
                                                            ...
                                                            <td>
                                                                <div class="flex items-center">
                                                                    <div class="ltr:mr-2 rtl:ml-2">
                                                                        <span
                                                                            class="avatar avatar-sm">
                                                                            <img src="<?php echo e(asset('build/assets/img/logos/8.png')); ?>" alt="">
                                                                        </span>
                                                                    </div>
                                                                    <div>
                                                            ...
                                                            <td>
                                                                <div class="flex items-center">
                                                                    <div class="ltr:mr-2 rtl:ml-2">
                                                                        <span
                                                                            class="avatar avatar-sm">
                                                                            <img src="<?php echo e(asset('build/assets/img/logos/1.png')); ?>" alt="">
                                                                        </span>
                                                                    </div>
                                                                    <div>
                                                            ...
                                                            <td>
                                                                <div class="flex items-center">
                                                                    <div class="ltr:mr-2 rtl:ml-2">
                                                                        <span
                                                                            class="avatar avatar-sm">
                                                                            <img src="<?php echo e(asset('build/assets/img/logos/6.png')); ?>" alt="">
                                                                        </span>
                                                                    </div>
                                                                    <div>
                                                ...
                                                <table class="ti-custom-table ti-custom-table-head">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                                <div class="flex align-items-center font-semibold min-w-[180px]">
                                                                    <img src="<?php echo e(asset('build/assets/img/users/4.jpg')); ?>"
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="flex align-items-center font-semibold min-w-[180px]">
                                                                    <img src="<?php echo e(asset('build/assets/img/users/15.jpg')); ?>"
                                                                        class="avatar avatar-xs ltr:mr-2 rtl:ml-2 rounded-full"
                                                                        alt="">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="flex align-items-center font-semibold min-w-[180px]">
                                                                    <img src="<?php echo e(asset('build/assets/img/users/11.jpg')); ?>"
                                                                        class="avatar avatar-xs ltr:mr-2 rtl:ml-2 rounded-full"
                                                                        alt="">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="flex align-items-center font-semibold min-w-[180px]">
                                                                    <img src="<?php echo e(asset('build/assets/img/users/8.jpg')); ?>"
                                                                        class="avatar avatar-xs ltr:mr-2 rtl:ml-2 rounded-full"
                                                                        alt="">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="flex align-items-center font-semibold min-w-[180px]">
                                                                    <img src="<?php echo e(asset('build/assets/img/users/16.jpg')); ?>"
                                                                        class="avatar avatar-xs ltr:mr-2 rtl:ml-2 rounded-full"
                                                                        alt="">
                                                                    <span class="my-auto text-sm">Andrew Garfield </span>
                                                                </div>
...
<?php $__env->startSection('scripts'); ?>
        ...
        <!-- INDEX JS -->
        <?php echo app('Illuminate\Foundation\Vite')('resources/assets/js/index-4.js'); ?>


<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\projects\my-projects\laravel\vite\synto\synto-laravel\synto\resources\views/pages/index4.blade.php ENDPATH**/ ?>