                                    ...
                                    <div class="box-body p-0">
                                        <div id="profile-settings-1" role="tabpanel" aria-labelledby="profile-settings-item-1">
                                            <div class="box border-0 shadow-none mb-0">
                                                ...
                                                <div class="box-body">
                                                    <div>
                                                        <form action="<?php echo e(route('ESTB.staff.update',$staff->id)); ?>" method="post">
                                                            <?php echo csrf_field(); ?>
                                                            ...
                                                            <div class="grid lg:grid-cols-3 gap-3 space-y-2 lg:space-y-0 pb-4">
                                                                <div class="space-y-2 ">
                                                                    ...
                                                                    <input type="text" name="fname" id="fname" class="my-auto ti-form-input" placeholder="Firstname" value="<?php echo e($staff->fname); ?>">
                                                                </div>
                                                                <div class="space-y-2">
                                                                    <label class="ti-form-label mb-0 font-bold">Middle Name</label>
                                                                    <input type="text" name="mname" class="my-auto ti-form-input" placeholder="Middle Name" value="<?php echo e($staff->mname); ?>">
                                                                </div>
                                                                <div class="space-y-2">
                                                                    <label class="ti-form-label mb-0 font-bold">Last Name</label>
                                                                    <input type="text" name="lname" id="lname" class="my-auto ti-form-input" placeholder="Lastname" value="<?php echo e($staff->lname); ?>">
                                                                </div>
                                                            </div>
                                                            <div class="grid lg:grid-cols-3 gap-3 space-y-2 lg:space-y-0 pb-4">
                                                                <div class="space-y-2">
                                                                <label class="ti-form-label mb-0 font-bold">Employee Type</label>
                                                                    <select class="ti-form-select" name="employee_type" id="employee_type">
                                                                        ...
                                                                        <option value="Non-Teaching" <?php echo e($staff->latest_employee_type[0]->employee_type == "Non-Teaching"?'selected':''); ?>>Non-Teaching</option>
                                                                    </select>
                                                                </div>
                                                                <div class="space-y-2">
                                                                    <label class="ti-form-label mb-0 font-bold">Email</label>
                                                                    <div class="flex rounded-sm">
                                                                        <input type="text" name="email" id="email_id"  class="my-auto ti-form-input" placeholder="youremail" value="<?php echo e($user->email); ?>">
                                                            ...
                                                            <div class="grid lg:grid-cols-2 gap-2 space-y-2 lg:space-y-0 pb-4"> 
                                                                ...
                                                                <div class="space-y-2">
                                                                    ...
                                                                    <div class="space-y-2">
                                                                        ...
                                                                        <input type="text" name="date_of_increment" value="<?php echo e($staff->date_of_increment); ?>" class="ti-form-input flatpickr-input date" id=""
                                                                            placeholder="Choose date" readonly>
                                                                    </div>
                                                                    <div class="space-y-2">
                                                                        ...
                                                                        <select class="ti-form-select" name="bloodgroup">
                                                                            ...
                                                                            <option value="A+" <?php echo e($staff->bloodgroup == "A+"?'selected':''); ?>>A + (Positive)</option>
                                                                            <option value="A-" <?php echo e($staff->bloodgroup == "A-"?'selected':''); ?> >A - (Negetive)</option>
                                                                            <option value="B+" <?php echo e($staff->bloodgroup == "B+"?'selected':''); ?>>B + (Positive)</option>
                                                                            <option value="B-" <?php echo e($staff->bloodgroup == "B-"?'selected':''); ?>>B - (Negetive)</option>
                                                                            <option value="AB+" <?php echo e($staff->bloodgroup == "AB+"?'selected':''); ?>>AB + (Positive)</option>
                                                                            <option value="AB-" <?php echo e($staff->bloodgroup == "AB-"?'selected':''); ?>>AB - (Negetive)</option>
                                                                            <option value="O+" <?php echo e($staff->bloodgroup == "O+"?'selected':''); ?>>O + (Positive)</option>
                                                                            <option value="O-" <?php echo e($staff->bloodgroup == "O-"?'selected':''); ?>>O - (Negetive)</option>
                                                                        </select>
                                                                    </div>
                                                                    <div class="space-y-2">
                                                                        <label class="ti-form-label mb-0 font-bold">PAN Card No:</label>
                                                                        <input type="text" name="pan_card" class="my-auto ti-form-input"
                                                                            placeholder="XXXXX XXXXX" value="<?php echo e($staff->pan_card); ?>">
                                                                    </div>
                                                                    <div class="space-y-2">
                                                                        <label class="ti-form-label mb-0 font-bold">Adhar Card No:</label>
                                                                        <input type="text" name="adhar_card" class="my-auto ti-form-input"
                                                                            placeholder="XXXX-XXXX-XXXX-XXXX" value="<?php echo e($staff->adhar_card); ?>">
                                                                    </div>
                                                                    <div class="space-y-2">
                                                                        <label class="ti-form-label mb-0 font-bold">Contact No:</label>
                                                                        <input type="text" name="contactno" value="<?php echo e($staff->contactno); ?>" class="my-auto ti-form-input"
                                                            ...
                                                            <div class="grid lg:grid-cols-2 gap-2 space-y-2 lg:space-y-0 pb-4"> 
                                                                ...
                                                                <div class="space-y-2" id="VTU_id">
                                                                    ...
                                                                    <input type="text" name="vtu_id" class="my-auto ti-form-input" value="<?php echo e($staff->vtu_id); ?>"
                                                                        placeholder="VTU ID">
                                                                </div>
                                                                <?php if($staff->latest_employee_type()->first()->employee_type=="Non-Teaching"): ?>
                                                                <div class="space-y-2" id="ESI_no">
                                                                    <label class="ti-form-label mb-0 font-bold">ESI No:</label>
                                                                    <input type="text" name="esi_no" class="my-auto ti-form-input" value="<?php echo e($staff->esi_no); ?>"
                                                                        placeholder="ESI no">
                                                                </div>
                                                                <div class="space-y-2" id="UN_no">
                                                                    <label class="ti-form-label mb-0 font-bold">UN No:</label>
                                                                    <input type="text" name="un_no" class="my-auto ti-form-input" value="<?php echo e($staff->un_no); ?>"
                                                                        placeholder="Un No">
                                                                </div>
                                                                <?php endif; ?>
                                                            </div>
                                                            <div class="my-5">
                                                                <div class="space-y-2">
                                                                    ...
                                                                    <input type="text" name="local_address" class="my-auto ti-form-input" value="<?php echo e($staff->local_address); ?>" placeholder="Local Address">
                                                                </div>
                                                            </div>
                                                            <div class="my-5">
                                                                <div class="space-y-2">
