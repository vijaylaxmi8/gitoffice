                                ...
                                <div class="col-span-12">
                                    ...
                                    <div class="box-header">
                                        ...
                                        <h5 class="box-title my-auto">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-building-church" width="32" height="32" viewBox="0 0 24 24" stroke-width="1.5" stroke="#2c3e50" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                              ...
                                              Caste & Category List for the religion  <b style="color:red;font-size:18px"><?php echo e($religion->religion_name); ?></b></h5>
                                                    ...
                                                    <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out md:!max-w-2xl md:w-full m-3 md:mx-auto">
                                                        ...
                                                        <div class="ti-modal-header">
                                                            <h3 class="ti-modal-title">
                                                                ...
                                                                Add a Caste & Category <b style="color:red"><?php echo e($religion->religion_name); ?> </b>Religion
                                                            </h3>
                                                            ...
                                                            <?php if(($errors->has('caste_name'))||($errors->has('subcastes_name'))||($errors->has('category'))||($errors->has('category_no'))): ?>
                                                                <script>
                                                                    //alert(1);
                                                        ...
                                                        <form action="<?php echo e(route('ESTB.religion.castecategory.store',$religion->id)); ?>" data-remote="true"  method="post">
                                                            <?php echo csrf_field(); ?>
                                                            <div class="ti-modal-body">
                                                               <input type="hidden" name="religion_id" value="<?php echo e($religion->id); ?>">
                                                                <div class="max-w-sm space-y-3 pb-6">
                                                                    ...
                                                                    <input type="text" id="castename" name="caste_name" id="caste_name" class="ti-form-input <?php echo e($errors->has('caste_name')? 'border-red-500':''); ?>" placeholder="Caste Name" value=<?php echo e(old('caste_name')); ?>>
                                                                    <?php if($errors->has('caste_name')): ?>
                                                                            <div class="text-red-700"><?php echo e($errors->first('caste_name')); ?></div>
                                                                    <?php endif; ?>
                                                                ...
                                                                <div class="max-w-sm space-y-3 pb-6">
                                                                    ...
                                                                    <input type="text" id="subcastename" name="subcastes_name" class="ti-form-input <?php echo e($errors->has('subcastes_name')? 'border-red-500':''); ?>" placeholder="Subcaste Name" value=<?php echo e(old('subcastes_name')); ?>>
                                                                    <?php if($errors->has('subcastes_name')): ?>
                                                                            <div class="text-red-700"><?php echo e($errors->first('subcastes_name')); ?></div>
                                                                    <?php endif; ?>
                                                                ...
                                                                <div class="max-w-sm space-y-3 pb-6">
                                                                    ...
                                                                    <input type="text" id="categoryname" name="category" class="ti-form-input <?php echo e($errors->has('category')? 'border-red-500':''); ?>" placeholder="Category Name" value=<?php echo e(old('category')); ?>>
                                                                ...
                                                                <div class="max-w-sm space-y-3 pb-6">
                                                                    ...
                                                                    <input type="text" id="categoryno" name="category_no" class="ti-form-input <?php echo e($errors->has('category_no')? 'border-red-500':''); ?>" placeholder="Category No." value=<?php echo e(old('category_no')); ?>>
                                                                    <?php if($errors->has('category_no')): ?>
                                                                            <div class="text-red-700"><?php echo e($errors->first('category_no')); ?></div>
                                                                    <?php endif; ?>
                                    ...
                                    <div class="box-body">
                                        <div class="table-bordered rounded-sm ti-custom-table-head overflow-auto">
                                            <a class="flex items-center font-semibold text-primary hover:text-primary dark:text-primary truncate" href="<?php echo e(route('ESTB.religion')); ?>">
                                        ...
                                        <table id="castecategory_table" class="ti-custom-table ti-striped-table  ti-custom-table-head whitespace-nowrap">
                                            ...
                                            <tr class="">
                                                ...
                                                <div class="flex space-x-3 rtl:space-x-reverse w-full min-w-[200px]">
                                                    <div class="block w-full my-auto">
                                                       <?php echo e($caste->subcastes_name); ?>
                                                ...
                                                <div class="flex space-x-3 rtl:space-x-reverse w-full min-w-[200px]">
                                                    <div class="block w-full my-auto">
                                                       <?php echo e($caste->category_no); ?>

                                                    </div>
                                                </div>
                                                </td>
                                                <td><span><?php echo e($caste->status); ?></span></td>
                                                
                                                <td class="font-medium space-x-2 rtl:space-x-reverse">
                                                <div class="hs-tooltip ti-main-tooltip">
                                                    <button data-hs-overlay="#caste_edit_modal<?php echo e($i); ?>" id="btn<?php echo e($i); ?>" btn-val=<?php echo e($i); ?>
                                                    ...
                                                    <span
                                                        ...
                                                        <div id="caste_edit_modal<?php echo e($i); ?>" class="hs-overlay hidden ti-modal">
                                                            ...
                                                            <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out md:!max-w-2xl md:w-full m-3 md:mx-auto">
                                                                ...
                                                                <div class="ti-modal-header">
                                                                    ...
                                                                    <button type="button" class="hs-dropdown-toggle ti-modal-close-btn"
                                                                    data-hs-overlay="#caste_edit_modal<?php echo e($i); ?>">
                                                                    <span class="sr-only">Close</span>
                                                                    <svg class="w-3.5 h-3.5" width="8" height="8" viewBox="0 0 8 8" fill="none"
                                                                        xmlns="http://www.w3.org/2000/svg">
                                                                        <path
                                                                    ...
                                                                    <?php if(($errors->has('e_caste_name'))||($errors->has('e_subcaste_name'))||($errors->has('e_category'))||($errors->has('e_category_no'))): ?>
                                                                        <script>
                                                                            //alert(387);
                                                                ...
                                                                <form  action="<?php echo e(route('ESTB.religion.castecategory.update',[$religion->id,$caste->id])); ?>" method="post">
                                                                    ...
                                                                    <div class="ti-modal-body pb-6">
                                                                        ...
                                                                        <div class="max-w-sm space-y-3 pb-6">
                                                                            <label for="with-corner-hint" class="ti-form-label font-bold">Caste Name : </label>
                                                                            <input type="text" name="e_caste_name" class="ti-form-input" placeholder="caste_name" value="<?php echo e($caste->caste_name); ?>">
                                                                            <?php if($errors->has('e_caste_name')): ?>
                                                                                <div class="text-red-700"><?php echo e($errors->first('e_caste_name')); ?></div>
                                                                            <?php endif; ?>
                                                                            <div id="casteNameError" class="error text-red-700"></div>
                                                                        </div>
                                                                        <div class="max-w-sm space-y-3 pb-6">
                                                                            <label for="with-corner-hint" class="ti-form-label font-bold">Subcaste Name : </label>
                                                                            <input type="text" name="e_subcastes_name" class="ti-form-input" placeholder="subcastes_name" value="<?php echo e($caste->subcastes_name); ?>">
                                                                            <?php if($errors->has('e_subcastes_name')): ?>
                                                                                <div class="text-red-700"><?php echo e($errors->first('e_subcastes_name')); ?></div>
                                                                            <?php endif; ?>
                                                                            <div id="subcasteNameError" class="error text-red-700"></div>
                                                                        </div>
                                                                        <div class="max-w-sm space-y-3 pb-6">
                                                                            <label for="with-corner-hint" class="ti-form-label font-bold">Category Name : </label>
                                                                            <input type="text" name="e_category" class="ti-form-input" placeholder="category" value="<?php echo e($caste->category); ?>">
                                                                        ...
                                                                        <div class="max-w-sm space-y-3 pb-6">
                                                                            <label for="with-corner-hint" class="ti-form-label font-bold">Category No. : </label>
                                                                            <input type="text" name="e_category_no" class="ti-form-input" placeholder="category no " value="<?php echo e($caste->category_no); ?>">
                                                                            <?php if($errors->has('e_category_no')): ?>
                                                                                <div class="text-red-700"><?php echo e($errors->first('e_category_no')); ?></div>
                                                                            <?php endif; ?>
                                                                            <div id="categoryNoError" class="error text-red-700"></div>
                                                                        </div>
                                                ...
                                                <div class="hs-tooltip ti-main-tooltip">
                                                <form action="<?php echo e(route('ESTB.religion.castecategory.destroy',[$religion->id, $caste->id])); ?>" method="post">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\laravel Apps\gitoffice\resources\views/ESTB/castecategory/index.blade.php ENDPATH**/ ?>