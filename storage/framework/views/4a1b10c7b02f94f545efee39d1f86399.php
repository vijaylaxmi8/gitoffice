                  ...
                  <div class="content">
                        ...
                        <div class="main-content">
                              ...
                              <div class="block justify-between page-header sm:flex">
                                    <div>
                                          <h3 class="text-gray-700 hover:text-gray-900 text-2xl font-medium"> Sales Dashboard</h3>
                                    </div>
                              ...
                              <div class="grid grid-cols-12 gap-x-5">
                                    ...
                                    <div class="box-body">
                                          ...
                                          <div class="flex space-x-3 rtl:space-x-reverse">
                                                ...
                                                <h6 class="text-lg font-medium text-gray-800 mb-2 my-auto">Total Revenue</h6>
                                          </div>
                                          ...
                                          <div class="mt-2">
                                          <h2 class="text-2xl font-semibold text-gray-800">$26,35,262</h2>
                                    ...
                                    <div class="box-body">
                                          ...
                                          <div class="flex space-x-3 rtl:space-x-reverse">
                                                ...
                                                <h6 class="text-lg font-medium text-gray-800 mb-2 my-auto">Total Sales</h6>
                                          </div>
                                          <span class="badge bg-secondary/10 text-secondary py-1 ltr:ml-auto rtl:mr-auto !my-auto"><i
                                                class="ti ti-trending-up"></i> 1.8%</span>
                                          </div>
                                          <div class="mt-2">
                                          <h2 class="text-2xl font-semibold text-gray-800">$56,35,262</h2>
                                          <p class="text-xs text-gray-400 ">in last week</p>
                                          </div>
                                    </div>
                                    </div>
                                    ...
                                    <div class="box-body">
                                          ...
                                          <div class="flex space-x-3 rtl:space-x-reverse">
                                                ...
                                                <h6 class="text-lg font-medium text-gray-800 mb-2 my-auto">Total Products</h6>
                                          </div>
                                          <span class="badge bg-warning/10 text-warning py-1 ltr:ml-auto rtl:mr-auto !my-auto"><i
                                                class="ti ti-trending-down"></i> 1.8%</span>
                                          </div>
                                          <div class="mt-2">
                                          <h2 class="text-2xl font-semibold text-gray-800">$4,262</h2>
                                          <p class="text-xs text-gray-400 ">in last week</p>
                                          </div>
                                    </div>
                                    </div>
                                    ...
                                    <div class="box-body">
                                          ...
                                          <div class="flex space-x-3 rtl:space-x-reverse">
                                                ...
                                                <h6 class="text-lg font-medium text-gray-800 mb-2 my-auto">Total Expenses</h6>
                                          </div>
                                          <span class="badge bg-success/10 text-success py-1 ltr:ml-auto rtl:mr-auto !my-auto"><i
                                                class="ti ti-trending-up"></i> 1.2%</span>
                                          </div>
                                          <div class="mt-2">
                                          <h2 class="text-2xl font-semibold text-gray-800">$35,262</h2>
                                          <p class="text-xs text-gray-400 ">in last week</p>
                                          </div>
                                    </div>
                                    </div>
                              ...
                              <div class="grid grid-cols-12 gap-x-5">
                                    ...
                                    <div class="box-body">
                                          ...
                                          <li>
                                                ...
                                                <span
                                                class="text-2xl text-gray-800 font-semibold ltr:mr-2 rtl:ml-2 pointer-events-none">$9.65K</span>
                                          ...
                                          <li>
                                                ...
                                                <span class="flex items-center">
                                                <span
                                                class="text-2xl text-gray-800 font-semibold ltr:mr-2 rtl:ml-2 pointer-events-none">$3.75K</span>
                                    ...
                                    <div class="box-body">
                                          ...
                                          <li class="px-0 pt-0 ti-list-group border-0 text-gray-800">
                                                ...
                                                <img class="avatar avatar-sm rounded-sm" src="<?php echo e(asset('build/assets/img/users/2.jpg')); ?>"
                                          ...
                                          <li class="px-0 pt-3 ti-list-group border-0 text-gray-800">
                                                <a href="javascript:void(0);" class="flex  justify-between items-center w-full">
                                                <div class="flex space-x-3 rtl:space-x-reverse w-full">
                                                <img class="avatar avatar-sm rounded-sm" src="<?php echo e(asset('build/assets/img/users/3.jpg')); ?>"
                                                alt="Image Description">
                                                <div class="flex w-full">
                                                <div class="block my-auto">
                                                      <p
                                          ...
                                          <li class="px-0 pt-3 ti-list-group border-0 text-gray-800">
                                                <a href="javascript:void(0);" class="flex  justify-between items-center w-full">
                                                <div class="flex space-x-3 rtl:space-x-reverse w-full">
                                                <img class="avatar avatar-sm rounded-sm" src="<?php echo e(asset('build/assets/img/users/4.jpg')); ?>"
                                                alt="Image Description">
                                                <div class="flex w-full">
                                                <div class="block my-auto">
                                                      <p
                                          ...
                                          <li class="px-0 pt-3 ti-list-group border-0 text-gray-800">
                                                <a href="javascript:void(0);" class="flex  justify-between items-center w-full">
                                                <div class="flex space-x-3 rtl:space-x-reverse w-full">
                                                <img class="avatar avatar-sm rounded-sm" src="<?php echo e(asset('build/assets/img/users/5.jpg')); ?>"
                                                alt="Image Description">
                                                <div class="flex w-full">
                                                <div class="block my-auto">
                                                      <p
                                          ...
                                          <li class="px-0 pt-3 ti-list-group border-0 text-gray-800">
                                                <a href="javascript:void(0);" class="flex  justify-between items-center w-full">
                                                <div class="flex space-x-3 rtl:space-x-reverse w-full">
                                                <img class="avatar avatar-sm rounded-sm" src="<?php echo e(asset('build/assets/img/users/6.jpg')); ?>"
                                                alt="Image Description">
                                                <div class="flex w-full">
                                                <div class="block my-auto">
                                                      <p
                                          ...
                                          <li class="px-0 pt-3 pb-0 ti-list-group border-0 text-gray-800">
                                                <a href="javascript:void(0);" class="flex  justify-between items-center w-full">
                                                <div class="flex space-x-3 rtl:space-x-reverse w-full">
                                                <img class="avatar avatar-sm rounded-sm" src="<?php echo e(asset('build/assets/img/users/10.jpg')); ?>"
                                                alt="Image Description">
                                                <div class="flex w-full">
                                                <div class="block my-auto">
                                                      <p
                                    ...
                                    <div class="box-body pb-0 px-0">
                                          <div class="sales-value relative border-b border-gray-200 pb-6">
                                          ...
                                          <div class="p-5 ltr:border-r rtl:border-l border-gray-200">
                                                ...
                                                <p class="text-gray-800 text-2xl font-medium">567</p>
                                          ...
                                          <div class="p-5">
                                                ...
                                                <div class="text-center">
                                                <p class="text-gray-800 text-2xl font-medium">$11,197</p>
                              ...
                              <div class="grid grid-cols-12 gap-x-5">
                                    ...
                                    <div class="box-body">
                                          ...
                                          <li class="p-0 mb-6 ti-list-group border-0 text-gray-800">
                                                ...
                                                <img class="avatar avatar-sm rounded-full" src="<?php echo e(asset('build/assets/img/ecommerce/jpg/1.jpg')); ?>"
                                                      alt="image">
                                                </div>
                                                <div class="flex-auto ltr:ml-2 rtl:mr-2">
                                                <p class="text-sm font-semibold mb-0">Smart Phone</p>
                                                <p class="text-xs text-gray-400 mb-0 !font-normal">Mobiles</p>
                                                </div>
                                                <div class="block text-end">
                                                <span class="text-sm text-success font-semibold">$199.99</span>
                                                <p class="text-xs text-gray-400 !font-normal"><i
                                          ...
                                          <li class="p-0 mb-6 ti-list-group border-0 text-gray-800">
                                                ...
                                                <div class="flex items-center">
                                                <div class="leading-none">
                                                <img class="avatar avatar-sm rounded-full" src="<?php echo e(asset('build/assets/img/ecommerce/jpg/2.jpg')); ?>"
                                                      alt="image">
                                                </div>
                                                <div class="flex-auto ltr:ml-2 rtl:mr-2">
                                                <p class="text-sm font-semibold mb-0">White Headphones</p>
                                                <p class="text-xs text-gray-400 mb-0 !font-normal">Music</p>
                                                </div>
                                                <div class="block text-end">
                                          ...
                                          <li class="p-0 mb-6 ti-list-group border-0 text-gray-800">
                                                ...
                                                <div class="flex items-center">
                                                <div class="leading-none">
                                                <img class="avatar avatar-sm rounded-full" src="<?php echo e(asset('build/assets/img/ecommerce/jpg/3.jpg')); ?>"
                                                      alt="image">
                                                </div>
                                                <div class="flex-auto ltr:ml-2 rtl:mr-2">
                                                <p class="text-sm font-semibold mb-0">Stop Watch</p>
                                                <p class="text-xs text-gray-400 mb-0 !font-normal">Electronics</p>
                                                </div>
                                                <div class="block text-end">
                                          ...
                                          <li class="p-0 mb-6 ti-list-group border-0 text-gray-800">
                                                ...
                                                <div class="flex items-center">
                                                <div class="leading-none">
                                                <img class="avatar avatar-sm rounded-full" src="<?php echo e(asset('build/assets/img/ecommerce/jpg/4.jpg')); ?>"
                                                      alt="image">
                                                </div>
                                                <div class="flex-auto ltr:ml-2 rtl:mr-2">
                                          ...
                                          <li class="p-0 mb-6 ti-list-group border-0 text-gray-800">
                                                ...
                                                <div class="flex items-center">
                                                <div class="leading-none">
                                                <img class="avatar avatar-sm rounded-full" src="<?php echo e(asset('build/assets/img/ecommerce/jpg/6.jpg')); ?>"
                                                      alt="image">
                                                </div>
                                                <div class="flex-auto ltr:ml-2 rtl:mr-2">
                                                <p class="text-sm font-semibold mb-0">Kids shoes</p>
                                                <p class="text-xs text-gray-400 mb-0 !font-normal">Clothing</p>
                                                </div>
                                                <div class="block text-end">
                                          ...
                                          <li class="p-0 mb-0 ti-list-group border-0 text-gray-800">
                                                ...
                                                <div class="flex items-center">
                                                <div class="leading-none">
                                                <img class="avatar avatar-sm rounded-full" src="<?php echo e(asset('build/assets/img/ecommerce/jpg/5.jpg')); ?>"
                                                      alt="image">
                                                </div>
                                                <div class="flex-auto ltr:ml-2 rtl:mr-2">
                                                <p class="text-sm font-semibold mb-0">Photo Frame</p>
                                                <p class="text-xs text-gray-400 mb-0 !font-normal">Furniture</p>
                                                </div>
                                                <div class="block text-end">
                                    ...
                                    <div class="box-body p-0">
                                          ...
                                          <table class="ti-custom-table ti-custom-table-head">
                                                ...
                                                <tbody>
                                                <tr>
                                                <td class="leading-none !text-gray-800 !p-[0.65rem] min-w-[180px] truncate">
                                                <img src="<?php echo e(asset('build/assets/img/ecommerce/products/13.png')); ?>"
                                                      class="avatar avatar-sm p-2 rounded-full bg-gray-100 ltr:mr-2 rtl:ml-2"
                                                ...
                                                <tr>
                                                <td class="leading-none !text-gray-800 !p-[0.65rem] min-w-[180px] truncate">
                                                <img src="<?php echo e(asset('build/assets/img/ecommerce/products/14.png')); ?>"
                                                      class="avatar avatar-sm p-2 rounded-full bg-gray-100 ltr:mr-2 rtl:ml-2"
                                                ...
                                                <tr>
                                                <td class="leading-none !text-gray-800 !p-[0.65rem] min-w-[180px] truncate">
                                                <img src="<?php echo e(asset('build/assets/img/ecommerce/products/15.png')); ?>"
                                                      class="avatar avatar-sm p-2 rounded-full bg-gray-100 ltr:mr-2 rtl:ml-2"
                                                ...
                                                <tr>
                                                <td class="leading-none !text-gray-800 !p-[0.65rem] min-w-[180px] truncate">
                                                <img src="<?php echo e(asset('build/assets/img/ecommerce/products/16.png')); ?>"
                                                      class="avatar avatar-sm p-2 rounded-full bg-gray-100 ltr:mr-2 rtl:ml-2"
                                                ...
                                                <tr>
                                                <td class="leading-none !text-gray-800 !p-[0.65rem] min-w-[180px] truncate">
                                                <img src="<?php echo e(asset('build/assets/img/ecommerce/products/17.png')); ?>"
                                                      class="avatar avatar-sm p-2 rounded-full bg-gray-100 ltr:mr-2 rtl:ml-2"
                                                ...
                                                <tr>
                                                <td class="leading-none !text-gray-800 !p-[0.65rem] min-w-[180px] truncate">
                                                <img src="<?php echo e(asset('build/assets/img/ecommerce/products/18.png')); ?>"
                                                      class="avatar avatar-sm p-2 rounded-full bg-gray-100 ltr:mr-2 rtl:ml-2"
                              ...
                              <div class="grid grid-cols-12 gap-x-6">
                                    ...
                                    <div class="box-body">
                                          ...
                                          <table class="ti-custom-table ti-custom-table-head whitespace-nowrap">
                                                ...
                                                <td>
                                                <div class="flex space-x-3 rtl:space-x-reverse w-full">
                                                      <img class="avatar rounded-sm bg-gray-100 p-2"
                                                      src="<?php echo e(asset('build/assets/img/ecommerce/products/1.png')); ?>" alt="Image Description">
                                                      <div class="block w-full my-auto">
                                                      <span
                                                            class="block text-sm font-semibold text-gray-800 min-w-[180px] truncate">Black
                                                            Heals For Women</span>
                                                      <span class="block text-xs text-gray-400 !font-normal">#2343</span>
                                                      </div>
                                                </div>
                                                </td>
                                                ...
                                                <div class="flex space-x-3 rtl:space-x-reverse text-start">
                                                      ...
                                                      <p class="block text-sm font-semibold my-auto text-gray-800">Socrates
                                                            Itumay</p>
                                                      <span
                                                            class="block text-xs text-gray-400 !font-normal my-auto">socratesitumay@gmail.com</span>
                                                      </div>
                                                </div>
                                                </td>
                                                <td>10-12-2022</td>
                                                ...
                                                <div class="flex space-x-3 rtl:space-x-reverse w-full">
                                                      <img class="avatar rounded-sm bg-gray-100 p-2"
                                                      src="<?php echo e(asset('build/assets/img/ecommerce/products/2.png')); ?>" alt="Image Description">
                                                      <div class="block w-full my-auto">
                                                      <span
                                                            class="block text-sm font-semibold text-gray-800 min-w-[180px] truncate">White
                                                            Tshirt</span>
                                                      <span class="block text-xs text-gray-400 !font-normal">#5655</span>
                                                      </div>
                                                </div>
                                                </td>
                                                ...
                                                <div class="flex space-x-3 rtl:space-x-reverse text-start">
                                                      ...
                                                      alt="Image Description">
                                                      <div class="block my-auto">
                                                      <p class="block text-sm font-semibold my-auto text-gray-800">
                                                            Json Taylor</p>
                                                      <span
                                                            class="block text-xs text-gray-400 !font-normal my-auto">jsontaylor2416@gmail.com</span>
                                                      </div>
                                                </div>
                                                </td>
                                                <td>11-12-2022</td>
                                                ...
                                                <div class="flex space-x-3 rtl:space-x-reverse w-full">
                                                      <img class="avatar rounded-sm bg-gray-100 p-2"
                                                      src="<?php echo e(asset('build/assets/img/ecommerce/products/3.png')); ?>" alt="Image Description">
                                                      <div class="block w-full my-auto">
                                                      <span
                                                            class="block text-sm font-semibold text-gray-800 min-w-[180px] truncate">Jacket
                                                            For Men</span>
                                                      <span class="block text-xs text-gray-400 !font-normal">#15245</span>
                                                      </div>
                                                </div>
                                                </td>
                                                ...
                                                <div class="flex space-x-3 rtl:space-x-reverse text-start">
                                                      ...
                                                      <p class="block text-sm font-semibold my-auto text-gray-800">
                                                            Suzika Stallone</p>
                                                      <span
                                                            class="block text-xs text-gray-400 !font-normal my-auto">suzikastallone3214@gmail.com</span>
                                                      </div>
                                                </div>
                                                </td>
                                                <td>12-12-2022</td>
                                                ...
                                                <div class="flex space-x-3 rtl:space-x-reverse w-full">
                                                      <img class="avatar rounded-sm bg-gray-100 p-2"
                                                      src="<?php echo e(asset('build/assets/img/ecommerce/products/4.png')); ?>" alt="Image Description">
                                                      <div class="block w-full my-auto">
                                                      <span
                                                            class="block text-sm font-semibold text-gray-800 min-w-[180px] truncate">Airpods</span>
                                                      <span class="block text-xs text-gray-400 !font-normal">#45415</span>
                                                      </div>
                                                </div>
                                                </td>
                                                ...
                                                <div class="flex space-x-3 rtl:space-x-reverse text-start">
                                                      ...
                                                      <p class="block text-sm font-semibold my-auto text-gray-800">
                                                            Selena Deoyl</p>
                                                      <span
                                                            class="block text-xs text-gray-400 !font-normal my-auto">selenadeoyl114@gmail.com</span>
                                                      </div>
                                                </div>
                                                </td>
                                                <td>12-12-2022</td>
                                                ...
                                                <div class="flex space-x-3 rtl:space-x-reverse w-full">
                                                      <img class="avatar rounded-sm bg-gray-100 p-2"
                                                      src="<?php echo e(asset('build/assets/img/ecommerce/products/5.png')); ?>" alt="Image Description">
                                                      <div class="block w-full my-auto">
                                                      <span
                                                            class="block text-sm font-semibold text-gray-800 min-w-[180px] truncate">Jasmine
                                                            Fragrance</span>
                                                      <span class="block text-xs text-gray-400 !font-normal">#35656</span>
                                                      </div>
                                                </div>
                                                </td>
                                                ...
                                                <td>
                                                <div class="flex space-x-3 rtl:space-x-reverse text-start">
                                                      <img class="avatar avatar-sm rounded-sm" src="<?php echo e(asset('build/assets/img/users/9.jpg')); ?>"
                                                      alt="Image Description">
                                                      <div class="block my-auto">
                                                      <p class="block text-sm font-semibold my-auto text-gray-800">
                                                            Roman Killon</p>
                                                      <span
                                                            class="block text-xs text-gray-400 !font-normal my-auto">romankillon143@gmail.com</span>
                                                      </div>
                                                </div>
                                                </td>
                                                <td>13-12-2022</td>
                                                ...
                                                <div class="flex space-x-3 rtl:space-x-reverse w-full">
                                                      <img class="avatar rounded-sm bg-gray-100 p-2"
                                                      src="<?php echo e(asset('build/assets/img/ecommerce/products/6.png')); ?>" alt="Image Description">
                                                      <div class="block w-full my-auto">
                                                      <span
                                                            class="block text-sm font-semibold text-gray-800 min-w-[180px] truncate">Smart
                                                            Watch</span>
                                                      <span class="block text-xs text-gray-400 !font-normal">#622545</span>
                                                      </div>
                                                </div>
                                                </td>
                                                ...
                                                <div class="flex space-x-3 rtl:space-x-reverse text-start">
                                                      ...
                                                      <p class="block text-sm font-semibold my-auto text-gray-800">
                                                            Charlie Davieson</p>
                                                      <span
                                                            class="block text-xs text-gray-400 !font-normal my-auto">charliedavieson@gmail.com</span>
                                                      </div>
                                                </div>
                                                </td>
                                                <td>13-12-2022</td>
...
<?php $__env->startSection('scripts'); ?>
            ...
            <!-- INDEX JS -->
            <?php echo app('Illuminate\Foundation\Vite')('resources/assets/js/index.js'); ?>

        
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\laravel Apps\gitoffice\resources\views/pages/index.blade.php ENDPATH**/ ?>