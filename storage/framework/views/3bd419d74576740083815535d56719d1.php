                                                ...
                                                <li class="p-0 mb-6 ti-list-group border-0 text-gray-800 dark:text-white">
                                                    <a href="javascript:void(0);" class="w-full">
                                                        <div class="flex items-center justify-between">
                                                            <div class="flex items-center">
                                                                <div class="ltr:mr-2 rtl:ml-2">
                                                                    <img src="<?php echo e(asset('build/assets/img/crypto-currencies/round-outline/Bitcoin.svg')); ?>"
                                                ...
                                                <li class="p-0 mb-6 ti-list-group border-0 text-gray-800 dark:text-white">
                                                    <a href="javascript:void(0);" class="w-full">
                                                        <div class="flex items-center justify-between">
                                                            <div class="flex items-center">
                                                                <div class="ltr:mr-2 rtl:ml-2">
                                                                    <img src="<?php echo e(asset('build/assets/img/crypto-currencies/round-outline/Ethereum.svg')); ?>"
                                                                        alt="" class="avatar w-9 h-9">
                                                                </div>
                                                                <div>
                                                ...
                                                <li class="p-0 mb-6 ti-list-group border-0 text-gray-800 dark:text-white">
                                                    <a href="javascript:void(0);" class="w-full">
                                                        <div class="flex items-center justify-between">
                                                            <div class="flex items-center">
                                                                <div class="ltr:mr-2 rtl:ml-2">
                                                                    <img src="<?php echo e(asset('build/assets/img/crypto-currencies/round-outline/Dash.svg')); ?>"
                                                                        alt="" class="avatar w-9 h-9">
                                                                </div>
                                                                <div>
                                                ...
                                                <li class="p-0 mb-6 ti-list-group border-0 text-gray-800 dark:text-white">
                                                    <a href="javascript:void(0);" class="w-full">
                                                        <div class="flex items-center justify-between">
                                                            <div class="flex items-center">
                                                                <div class="ltr:mr-2 rtl:ml-2">
                                                                    <img src="<?php echo e(asset('build/assets/img/crypto-currencies/round-outline/Bytecoin.svg')); ?>"
                                                                        alt="" class="avatar w-9 h-9">
                                                                </div>
                                                                <div>
                                                ...
                                                <li class="p-0 mb-6 ti-list-group border-0 text-gray-800 dark:text-white">
                                                    <a href="javascript:void(0);" class="w-full">
                                                        <div class="flex items-center justify-between">
                                                            <div class="flex items-center">
                                                                <div class="ltr:mr-2 rtl:ml-2">
                                                                    <img src="<?php echo e(asset('build/assets/img/crypto-currencies/round-outline/Golem.svg')); ?>"
                                                                        alt="" class="avatar w-9 h-9">
                                                                </div>
                                                                <div>
                                                ...
                                                <li class="p-0 mb-6 ti-list-group border-0 text-gray-800 dark:text-white">
                                                    <a href="javascript:void(0);" class="w-full">
                                                        <div class="flex items-center justify-between">
                                                            <div class="flex items-center">
                                                                <div class="ltr:mr-2 rtl:ml-2">
                                                                    <img src="<?php echo e(asset('build/assets/img/crypto-currencies/round-outline/Siacoin.svg')); ?>"
                                                                        alt="" class="avatar w-9 h-9">
                                                                </div>
                                                                <div>
                                                ...
                                                <li class="p-0 mb-0 ti-list-group border-0 text-gray-800 dark:text-white">
                                                    <a href="javascript:void(0);" class="w-full">
                                                        <div class="flex items-center justify-between">
                                                            <div class="flex items-center">
                                                                <div class="ltr:mr-2 rtl:ml-2">
                                                                    <img src="<?php echo e(asset('build/assets/img/crypto-currencies/round-outline/Monero.svg')); ?>"
                                                                        alt="" class="avatar w-9 h-9">
                                                                </div>
                                                                <div>
                                                            ...
                                                            <td>
                                                                <div class="flex items-center">
                                                                    <div class="leading-none">
                                                                        <span
                                                                            class="avatar avatar-sm rounded-full ltr:mr-2 rtl:ml-2 p-2 bg-gray-100 dark:bg-black/20">
                                                                            <img src="<?php echo e(asset('build/assets/img/crypto-currencies/regular/Ethereum.svg')); ?>"
                                                                                alt="">
                                                                        </span>
                                                                    </div>
                                                                    <div class="items-center">
                                                            ...
                                                            <td>
                                                                <div class="flex items-center">
                                                                    <div class="leading-none">
                                                                        <span
                                                                            class="avatar avatar-sm rounded-full ltr:mr-2 rtl:ml-2 p-2 bg-gray-100 dark:bg-black/20">
                                                                            <img src="<?php echo e(asset('build/assets/img/crypto-currencies/regular/litecoin.svg')); ?>"
                                                                                alt="">
                                                                        </span>
                                                                    </div>
                                                                    <div class="items-center">
                                                            ...
                                                            <td>
                                                                <div class="flex items-center">
                                                                    <div class="leading-none">
                                                                        <span
                                                                            class="avatar avatar-sm rounded-full ltr:mr-2 rtl:ml-2 p-2 bg-gray-100 dark:bg-black/20">
                                                                            <img src="<?php echo e(asset('build/assets/img/crypto-currencies/regular/Dash.svg')); ?>"
                                                                                alt="">
                                                                        </span>
                                                                    </div>
                                                                    <div class="items-center">
                                                            ...
                                                            <td>
                                                                <div class="flex items-center">
                                                                    <div class="leading-none">
                                                                        <span
                                                                            class="avatar avatar-sm rounded-full ltr:mr-2 rtl:ml-2 p-2 bg-gray-100 dark:bg-black/20">
                                                                            <img src="<?php echo e(asset('build/assets/img/crypto-currencies/regular/Golem.svg')); ?>"
                                                                                alt="">
                                                                        </span>
                                                                    </div>
                                                                    <div class="items-center">
                                        ...
                                        <div class="box-body">
                                            <ul class="flex flex-col">
                                                ...
                                                <li class="mb-4 p-0 ti-list-group border-0 text-gray-800 dark:text-white">
                                                    <div class="sm:flex items-center w-full">
                                                        <div class="ltr:mr-2 rtl:ml-2 leading-none min-w-[40px]">
                                                            <img src="<?php echo e(asset('build/assets/img/users/8.jpg')); ?>" alt=""
                                                                class="avatar avatar-sm rounded-full bg-gray-100 dark:bg-black/20">
                                                        </div>
                                                        <div class="sm:flex items-center justify-between w-full">
                                                            <div>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="leading-none flex items-center">
                                                                    <img class="avatar  w-5 h-5 rounded-full"
                                                                        src="<?php echo e(asset('build/assets/img/crypto-currencies/regular/Ethereum.svg')); ?>"
                                                                        alt="">- ETH
                                                                </div>
                                                            </td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="leading-none flex items-center">
                                                                    <img class="avatar  w-5 h-5 rounded-full"
                                                                        src="<?php echo e(asset('build/assets/img/crypto-currencies/regular/Dash.svg')); ?>"
                                                                        alt=""> - DASH
                                                                </div>
                                                            </td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="leading-none flex items-center">
                                                                    <img class="avatar  w-5 h-5 rounded-full"
                                                                        src="<?php echo e(asset('build/assets/img/crypto-currencies/regular/Ripple.svg')); ?>"
                                                                        alt="">- XRP
                                                                </div>
                                                            </td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="leading-none flex items-center">
                                                                    <img class="avatar  w-5 h-5 rounded-full"
                                                                        src="<?php echo e(asset('build/assets/img/crypto-currencies/regular/IOTA.svg')); ?>"
                                                                        alt="">- IOTA
                                                                </div>
                                                            </td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="leading-none flex items-center">
                                                                    <img class="avatar  w-5 h-5 rounded-full"
                                                                        src="<?php echo e(asset('build/assets/img/crypto-currencies/regular/Neo.svg')); ?>"
                                                                        alt=""> - NEO
                                                                </div>
                                                            </td>
                                                            <td>
...
<?php $__env->startSection('scripts'); ?>
        ...
        <!-- INDEX JS -->
        <?php echo app('Illuminate\Foundation\Vite')('resources/assets/js/index-3.js'); ?>


<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\projects\my-projects\laravel\vite\synto\synto-laravel\synto\resources\views/pages/index3.blade.php ENDPATH**/ ?>