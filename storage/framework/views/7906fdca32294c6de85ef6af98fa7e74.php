            ...
            <header class="header custom-sticky !top-0 !w-full">
                        ...
                        <div class="header-profile hs-dropdown ti-dropdown" data-hs-dropdown-placement="bottom-right">
                            <button id="dropdown-profile" type="button"
                                ...
                                <img class="inline-block rounded-full ring-2 ring-white dark:ring-white/10"
                                    src="<?php echo e(asset('build/assets/img/users/avtar1.jpg')); ?>" alt="Image Description">
                            </button>
                            ...
                            <div class="ti-dropdown-header !bg-primary flex">
                                ...
                                <img class="avatar shadow-none rounded-full !ring-transparent"
                                    src="<?php echo e(asset('build/assets/img/users/avtar1.jpg')); ?>" alt="profile-img">
                                </div>
                                <div>
                                <p class="ti-dropdown-header-title !text-white"><?php echo e(Auth::user()->role); ?></p>
                                    
                                </div>
                            </div>
                            <div class="mt-2 ti-dropdown-divider">
                                <a href="<?php echo e(url('#')); ?>" class="ti-dropdown-item">
                                    <!-- pofile logo-->
                                ...
                                <!--code for seperate page change password-->
                                <a href="<?php echo e(route('logout')); ?>" class="ti-dropdown-item">
                                    <!-- logout logo-->
             ...
             <?php /**PATH F:\laravel Apps\gitoffice\resources\views/layouts/components/header.blade.php ENDPATH**/ ?>