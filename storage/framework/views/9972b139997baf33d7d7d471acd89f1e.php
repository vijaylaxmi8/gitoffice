            ...
            <div class="grid grid-cols-12 gap-6 w-full">
                <div class="lg:col-span-5 col-span-12 hidden lg:block relative  bg-primary/20">
                    <div class="relative w-full h-full z-[1]">
                        <div class="authentication-page justify-center w-full max-w-7xl mx-auto">
                            <img src="<?php echo e(asset('build/assets/img/authentication/4.png')); ?>" alt="logo" class="mx-auto xxl:h-[500px]">
                        </div >
                    </div>
                </div>
                <div class="lg:col-span-7 col-span-12">
                    <div class="authentication-page w-full">
                        <!-- ========== MAIN CONTENT ========== -->
                        <main id="content"  class="w-full sm:max-w-5xl p-6">
                            <div class="mt-7">
                                <div class="p-0 md:p-7">
                                    <div class="text-center">
                                        <h1 class="block text-2xl sm:text-5xl font-bold text-gray-800 dark:text-white">Under Construction</h1>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.custom-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\projects\my-projects\laravel\vite\synto\synto-laravel\synto\resources\views/pages/construction.blade.php ENDPATH**/ ?>