            ...
            <aside class="app-sidebar" id="sidebar">
                <div class="container mx-auto lg:p-6 !p-0">
                    ...
                    <nav class="main-menu-container nav nav-pills flex-column sub-open">
                        ...
                        <a href="<?php echo e(url('signup')); ?>" class="ti-btn w-[6.375rem] ti-btn-dark m-0 p-2">Sign
                            Up</a>
                        <a href="<?php echo e(url('signup')); ?>" class="ti-btn w-[6.375rem] m-0 p-2 ti-btn-primary">Get Started</a>
            ...
            </aside><?php /**PATH E:\projects\my-projects\laravel\vite\synto\synto-laravel\synto\resources\views/layouts/components/landing-sidebar.blade.php ENDPATH**/ ?>