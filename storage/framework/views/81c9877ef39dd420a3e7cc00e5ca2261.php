                                        ...
                                        <div class="col-span-12">
                                            ...
                                            <div class="grid grid-cols-12 gap-x-6">
                                                <div class="md:!col-span-4 col-span-12">
                                                    <div class="box">
                                                        <img src="<?php echo e(asset('build/assets/img/nft-images/1.png')); ?>" class="box-img-top rounded-sm h-[380px]"
                                                            alt="...">
                                                        ...
                                                        <div class="box-body nft-auction-time text-white p-4">
                                                            ...
                                                            <div class="flex items-center mb-4">
                                                                <div class="ltr:mr-2 rtl:ml-2 leading-none">
                                                                    <img src="<?php echo e(asset('build/assets/img/users/10.jpg')); ?>" alt=""
                                                            ...
                                                            <div class="flex flex-wrap items-center justify-between">
                                                                <div>
                                                                    ...
                                                                    <div class="flex flex-wrap items-center leading-none">
                                                                        <img src="<?php echo e(asset('build/assets/img/crypto-currencies/square-color/Bitcoin.svg')); ?>"
                                                                            alt=""
                                                ...
                                                <div class="md:!col-span-4 col-span-12">
                                                    <div class="box">
                                                        <img src="<?php echo e(asset('build/assets/img/nft-images/2.png')); ?>" class="box-img-top rounded-sm h-[380px]"
                                                            alt="...">
                                                        <div class="flex align-center justify-between nft-like-section w-full px-4">
                                                            <div class="flex-auto">
                                                                <button type="button"
                                                        ...
                                                        <div class="box-body nft-auction-time text-white p-4">
                                                            ...
                                                            <div class="flex items-center mb-4">
                                                                <div class="ltr:mr-2 rtl:ml-2 leading-none">
                                                                    <img src="<?php echo e(asset('build/assets/img/users/5.jpg')); ?>" alt=""
                                                ...
                                                <div class="md:!col-span-4 col-span-12">
                                                    <div class="box">
                                                        <img src="<?php echo e(asset('build/assets/img/nft-images/3.png')); ?>" class="box-img-top rounded-sm h-[380px]"
                                                            alt="...">
                                                        <div class="flex align-center justify-between nft-like-section w-full px-4">
                                                            <div class="flex-auto">
                                                                <button type="button"
                                                        ...
                                                        <div class="box-body nft-auction-time text-white p-4">
                                                            ...
                                                            <div class="flex items-center mb-4">
                                                                <div class="ltr:mr-2 rtl:ml-2 leading-none">
                                                                    <img src="<?php echo e(asset('build/assets/img/users/7.jpg')); ?>" alt=""
                                                                        class="avatar avatar-sm ring-transparent rounded-full">
                                                                </div>
                                                                <div>
                                                    ...
                                                    <ul class="flex flex-col">
                                                            ...
                                                            <a href="javascript:void(0);" class="w-full">
                                                                <div class="flex items-center justify-between">
                                                                    <div class="flex items-center">
                                                                        <img src="<?php echo e(asset('build/assets/img/nft-images/8.png')); ?>" alt="" class="rounded-sm ltr:mr-2 rtl:ml-2 leading-none nft-img">
                                                                        <div>
                                                                    ...
                                                                    <div class="text-end">
                                                                        ...
                                                                        <p class="mb-0 font-semibold flex items-center"><span
                                                                                class="avatar w-6 h-6 p-1 !ring-transparent"><img
                                                                                    src="<?php echo e(asset('build/assets/img/crypto-currencies/regular/Bitcoin.svg')); ?>"
                                                                                    alt=""></span>1.75BTC</p>
                                                                    </div>
                                                                </div>
                                                            </a>
                                                        ...
                                                        <li class="ti-list-group py-4 border-t-0 border-x-0 text-gray-800 dark:text-white dark:border-white/10">
                                                            <a href="javascript:void(0);" class="w-full">
                                                                <div class="flex items-center justify-between">
                                                                    <div class="flex items-center">
                                                                        <img src="<?php echo e(asset('build/assets/img/nft-images/15.png')); ?>" alt="" class="rounded-sm ltr:mr-2 rtl:ml-2 leading-none nft-img">
                                                                        <div>
                                                        ...
                                                        <li class="ti-list-group py-4 border-t-0 border-x-0 text-gray-800 dark:text-white dark:border-white/10">
                                                            <a href="javascript:void(0);" class="w-full">
                                                                <div class="flex items-center justify-between">
                                                                    <div class="flex items-center">
                                                                        <img src="<?php echo e(asset('build/assets/img/nft-images/14.png')); ?>" alt="" class="rounded-sm ltr:mr-2 rtl:ml-2 leading-none nft-img">
                                                                        <div>
                                                        ...
                                                        <li class="ti-list-group py-4 border-t-0 border-x-0 text-gray-800 dark:text-white dark:border-white/10">
                                                            <a href="javascript:void(0);" class="w-full">
                                                                <div class="flex items-center justify-between">
                                                                    <div class="flex items-center">
                                                                        <img src="<?php echo e(asset('build/assets/img/nft-images/2.png')); ?>" alt="" class="rounded-sm ltr:mr-2 rtl:ml-2 leading-none nft-img">
                                                                        <div>
                                                        ...
                                                        <li class="ti-list-group py-4 border-t-0 border-x-0 text-gray-800 dark:text-white dark:border-white/10">
                                                            <a href="javascript:void(0);" class="w-full">
                                                                <div class="flex items-center justify-between">
                                                                    <div class="flex items-center">
                                                                        <img src="<?php echo e(asset('build/assets/img/nft-images/10.png')); ?>" alt="" class="rounded-sm ltr:mr-2 rtl:ml-2 leading-none nft-img">
                                                                        <div>
                                                        ...
                                                        <li class="ti-list-group py-4 border-t-0 border-x-0 text-gray-800 dark:text-white dark:border-white/10">
                                                            <a href="javascript:void(0);" class="w-full">
                                                                <div class="flex items-center justify-between">
                                                                    <div class="flex items-center">
                                                                        <img src="<?php echo e(asset('build/assets/img/nft-images/12.png')); ?>" alt="" class="rounded-sm ltr:mr-2 rtl:ml-2 leading-none nft-img">
                                                                        <div>
                                                        ...
                                                        <li class="ti-list-group py-4 border-0 text-gray-800 dark:text-white">
                                                            <a href="javascript:void(0);" class="w-full">
                                                                <div class="flex items-center justify-between">
                                                                    <div class="flex items-center">
                                                                        <img src="<?php echo e(asset('build/assets/img/nft-images/4.png')); ?>" alt="" class="rounded-sm ltr:mr-2 rtl:ml-2 leading-none nft-img">
                                                                        <div>
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="ltr:mr-3 rtl:ml-3">
                                                            <span class="avatar avatar-sm rounded-full p-2 bg-gray-100 dark:bg-black/20">
                                                                <img src="<?php echo e(asset('build/assets/img/crypto-currencies/regular/Bitcoin.svg')); ?>" alt="">
                                                            </span>
                                                        </div>
                                                ...
                                                <table class="ti-custom-table ti-custom-table-head whitespace-nowrap">
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                                <div class="flex items-center min-w-[180px]">
                                                                    <img src="<?php echo e(asset('build/assets/img/users/4.jpg')); ?>" alt=""
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="flex items-center min-w-[180px]">
                                                                    <img src="<?php echo e(asset('build/assets/img/users/15.jpg')); ?>" alt=""
                                                                        class="avatar avatar-sm rounded-full ltr:mr-2 rtl:ml-2">
                                                                    <div class="items-center">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="flex items-center min-w-[180px]">
                                                                    <img src="<?php echo e(asset('build/assets/img/users/12.jpg')); ?>" alt=""
                                                                        class="avatar avatar-sm rounded-full ltr:mr-2 rtl:ml-2">
                                                                    <div class="items-center">
                                                    ...
                                                    <div class="box-body">
                                                        <div class="grid grid-cols-12 gap-2">
                                                            <div class="col-span-6">
                                                                <img src="<?php echo e(asset('build/assets/img/nft-images/4.png')); ?>" alt=""
                                                                    class="nft-featuredcollect-image">
                                                            </div>
                                                            <div class="col-span-6">
                                                                <img src="<?php echo e(asset('build/assets/img/nft-images/5.png')); ?>" alt=""
                                                                    class="nft-featuredcollect-image">
                                                            </div>
                                                            <div class="col-span-6">
                                                                <img src="<?php echo e(asset('build/assets/img/nft-images/6.png')); ?>" alt=""
                                                                    class="nft-featuredcollect-image">
                                                            </div>
                                                            <div class="col-span-6">
                                                                <img src="<?php echo e(asset('build/assets/img/nft-images/7.png')); ?>" alt=""
                                                                    class="nft-featuredcollect-image">
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="swiper-slide">
                                                <div class="box">
                                                    <div class="box-body">
                                                        <div class="grid grid-cols-12 gap-2">
                                                            <div class="col-span-6">
                                                                <img src="<?php echo e(asset('build/assets/img/nft-images/8.png')); ?>" alt=""
                                                                    class="nft-featuredcollect-image">
                                                            </div>
                                                            <div class="col-span-6">
                                                                <img src="<?php echo e(asset('build/assets/img/nft-images/9.png')); ?>" alt=""
                                                                    class="nft-featuredcollect-image">
                                                            </div>
                                                            <div class="col-span-6">
                                                                <img src="<?php echo e(asset('build/assets/img/nft-images/10.png')); ?>" alt=""
                                                                    class="nft-featuredcollect-image">
                                                            </div>
                                                            <div class="col-span-6">
                                                                <img src="<?php echo e(asset('build/assets/img/nft-images/11.png')); ?>" alt=""
                                                                    class="nft-featuredcollect-image">
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="box">
                                                    <div class="box-body">
                                                        <div class="grid grid-cols-12 gap-2">
                                                            ...
                                                            <div class="col-span-6">
                                                                <img src="<?php echo e(asset('build/assets/img/nft-images/15.png')); ?>" alt=""
                                                                    class="nft-featuredcollect-image">
                                                            </div>
                                                            <div class="col-span-6">
                                                                <img src="<?php echo e(asset('build/assets/img/nft-images/15.png')); ?>" alt=""
                                                            ...
                                                            <div class="col-span-6">
                                                                <img src="<?php echo e(asset('build/assets/img/nft-images/14.png')); ?>" alt=""
                                                                    class="nft-featuredcollect-image">
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="box-body">
                                                <div class="flex items-start justify-between mb-3">
                                                    <div class="flex-grow">
                                                        ...
                                                        <h6 class="text-2xl mb-4 text-gray-800 dark:text-white">$23,773.09</h6>
                                                    </div>
                                                    <span
                                                ...
                                                <div class="flex items-center justify-between mb-4">
                                                    <h6 class="text-lg mb-0 text-gray-800 dark:text-white">1,107</h6>
                                                ...
                                                <table class="ti-custom-table ti-custom-table-head whitespace-nowrap">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td><span class="text-sm font-semibold text-primary">#1</span></td>
                                                            <td>
                                                                <div class="flex items-center">
                                                                    <div class="ltr:mr-2 rtl:ml-2 leading-none">
                                                                        <img src="<?php echo e(asset('build/assets/img/crypto-currencies/regular/Bitcoin.svg')); ?>"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><span class="text-sm font-semibold text-primary">#2</span></td>
                                                            <td>
                                                                <div class="flex items-center">
                                                                    <div class="ltr:mr-2 rtl:ml-2 leading-none">
                                                                        <img src="<?php echo e(asset('build/assets/img/crypto-currencies/regular/Bitcoin.svg')); ?>"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><span class="text-sm font-semibold text-primary">#3</span></td>
                                                            <td>
                                                                <div class="flex items-center">
                                                                    <div class="ltr:mr-2 rtl:ml-2 leading-none">
                                                                        <img src="<?php echo e(asset('build/assets/img/crypto-currencies/regular/Bitcoin.svg')); ?>"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><span class="text-sm font-semibold text-primary">#4</span></td>
                                                            <td>
                                                                <div class="flex items-center">
                                                                    <div class="ltr:mr-2 rtl:ml-2 leading-none">
                                                                        <img src="<?php echo e(asset('build/assets/img/crypto-currencies/regular/Bitcoin.svg')); ?>"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><span class="text-sm font-semibold text-primary">#5</span></td>
                                                            <td>
                                                                <div class="flex items-center">
                                                                    <div class="ltr:mr-2 rtl:ml-2 leading-none">
                                                                        <img src="<?php echo e(asset('build/assets/img/crypto-currencies/regular/Bitcoin.svg')); ?>"
...
<?php $__env->startSection('scripts'); ?>
        ...
        <!-- INDEX JS -->
        <?php echo app('Illuminate\Foundation\Vite')('resources/assets/js/index-5.js'); ?>


<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\projects\laravel\vite\synto\synto-final\synto\resources\views/pages/index5.blade.php ENDPATH**/ ?>