                            ...
                            <div class="grid grid-cols-12 gap-x-6">
                                <div class="col-span-12">
                                                ...
                                                <div id="hs-medium-modal" class="hs-overlay hidden ti-modal">
                                                    <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out md:!max-w-2xl md:w-full m-3 md:mx-auto">
                                                        ...
                                                        <div class="ti-modal-header">
                                                            ...
                                                            <?php if(($errors->has('asso_name'))): ?>
                                                                <script>
                                                                    // alert(1);
                                                                    $(window).on('load', function() {
                                                                       
                                                                        //alert(97);
                                                                        //$('#grid grid-cols-12 gap-x-6').trigger('click');
                                                                        $('#association_add_btn').trigger("click");

                                                                    }); 
                                                                </script>
                                                            <?php endif; ?>
                                                        </div>
                                                        <form id="association_form" action="<?php echo e(route('ESTB.associations.store')); ?>" method="post" onsubmit="return validateForm()">
                                                            <?php echo csrf_field(); ?>
                                                            <div class="ti-modal-body">
                                                               
                                                                <div class="max-w-sm space-y-3 pb-6">
                                                                    <label for="with-corner-hint" class="ti-form-label">Association Name : </label>
                                                                    <input type="text" name="asso_name" class="ti-form-input" placeholder="Association name">
                                                                    <?php if($errors->has('asso_name')): ?>
                                                                        <div class="text-red-700"><?php echo e($errors->first('asso_name')); ?></div>
                                                                    <?php endif; ?>
                                                                    <div id="assoNameError" class="error text-red-700"></div>
                                                                </div>
                                    ...
                                    <div class="box-body">
                                        ...
                                        <table id="association_table" class="ti-custom-table ti-custom-table-head whitespace-nowrap">
                                            <thead class="bg-gray-50 dark:bg-black/20">
                                            <tr class="">
                                                <th scope="col" class="dark:text-white/80">S.no</th>
                                                <th scope="col" class="dark:text-white/80">Association Name</th>
                                            ...
                                            <?php
                                                $i = 1;
                                            ?>
                                            <?php $__empty_1 = true; $__currentLoopData = $association; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $asso): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            ...
                                            <tr class="">
                                                ...
                                                <div class="flex space-x-3 rtl:space-x-reverse w-full min-w-[200px]">
                                                    <div class="block w-full my-auto">
                                                        <?php echo e($asso->asso_name); ?>

                                                    </div>
                                                </div>
                                                </td>
                                                <td><span><?php echo e($asso->status); ?></span></td>
                                                
                                                <td class="font-medium space-x-2 rtl:space-x-reverse">
                                                <div class="hs-tooltip ti-main-tooltip">
                                                    <button data-hs-overlay="#asso_edit_modal<?php echo e($i); ?>" id="btn<?php echo e($i); ?>" btn-val=<?php echo e($i); ?>

                                                    class="hs-dropdown-toggle  m-0 hs-tooltip-toggle relative w-8 h-8 ti-btn rounded-full p-0 transition-none focus:outline-none ti-btn-soft-secondary asso_edit_modal_click">
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16"><path d="M16.7574 2.99666L14.7574 4.99666H5V18.9967H19V9.2393L21 7.2393V19.9967C21 20.5489 20.5523 20.9967 20 20.9967H4C3.44772 20.9967 3 20.5489 3 19.9967V3.99666C3 3.44438 3.44772 2.99666 4 2.99666H16.7574ZM20.4853 2.09717L21.8995 3.51138L12.7071 12.7038L11.2954 12.7062L11.2929 11.2896L20.4853 2.09717Z"></path></svg>
                                                        ...
                                                        <div id="asso_edit_modal<?php echo e($i); ?>" class="hs-overlay hidden ti-modal">
                                                            <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out md:!max-w-2xl md:w-full m-3 md:mx-auto">
                                                                <div class="ti-modal-content">
                                                                <div class="ti-modal-header">
                                                                    <h3 class="ti-modal-title">
                                                                    ...
                                                                    <?php if(($errors->has('edit_asso_name'))||($errors->has('edit_status'))): ?>
                                                                        <script>
                                                                            //alert(200);
                                                                ...
                                                                <form  action="<?php echo e(route('ESTB.associations.update',$asso->id)); ?>" method="post">
                                                                    <?php echo csrf_field(); ?>
                                                                    ...
                                                                    <div class="ti-modal-body">
                                                                        ...
                                                                        <div class="max-w-sm space-y-3 pb-6">
                                                                            <label for="with-corner-hint" class="ti-form-label">Association Name : </label>
                                                                            <input type="text" name="edit_asso_name" class="ti-form-input" placeholder="Association name" value="<?php echo e($asso->asso_name); ?>">
                                                                            <?php if($errors->has('edit_asso_name')): ?>
                                                                                <div class="text-red-700"><?php echo e($errors->first('edit_asso_name')); ?></div>
                                                                            <?php endif; ?>
                                                                            <div id="assoNameError" class="error text-red-700"></div>
                                                                        </div>
                                                                        
                                                                        <?php if($asso->status == 'inactive'): ?>
                                                                        <br/>
                                                                            <div class="flex">
                                                                                <input type="radio" name="edit_status" class="ti-form-radio" id="hs-radio-group-2" value="active">
                                                ...
                                                <div class="hs-tooltip ti-main-tooltip">
                                                <form action="<?php echo e(route('ESTB.associations.destroy',$asso->id)); ?>" method="post">
                                            ...
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                                <p class="text-dark"><b>No Associations Added.</b></p>
                                            <?php endif; ?>
                                            </tbody>
                                        </table>
                                        </div>
...
<?php $__env->startSection('scripts'); ?>
        ...
        <script>
            $(document).ready(function(){
               ...
               new DataTable('#association_table');


                $(document).on('click','.asso_edit_modal_click',function(){
                    //var 
                ...
                // Association Frontend Validation
                $(document).on('click','#association_store_add_btn',function(e){
                    ...
                    if(assoName == ''){
                        $('#assoNameError').text('Title is missing');
                        flag = true;
                    }else if (!/^[a-zA-Z\s]+$/.test(assoName.trim())){
                        $('#assoNameError').text('Please fill the correct value');
                        flag = true;
                    }
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\laravel Apps\gitoffice\resources\views/ESTB/associations/index.blade.php ENDPATH**/ ?>