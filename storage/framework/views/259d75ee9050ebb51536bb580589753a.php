                    ...
                    <div class="content">
                        ...
                        <div class="main-content">
                            ...
                            <div class="block justify-between page-header sm:flex">
                                <div>
                                    <h3 class="text-gray-700 hover:text-gray-900 dark:text-white dark:hover:text-white text-2xl font-medium"> DataTable</h3>
                                </div>
...
<?php $__env->startSection('scripts'); ?>
        ...
        <!-- XLXS JS -->
        <script src="<?php echo e(asset('build/assets/libs/xlsx/xlsx.full.min.js')); ?>"></script>

        <!-- JSPDF JS -->
        <script src="<?php echo e(asset('build/assets/libs/jspdf/jspdf.umd.min.js')); ?>"></script>
        <script src="<?php echo e(asset('build/assets/libs/jspdf-autotable/jspdf.plugin.autotable.min.js')); ?>"></script>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\projects\laravel\vite\synto\synto\resources\views/pages/datatables.blade.php ENDPATH**/ ?>