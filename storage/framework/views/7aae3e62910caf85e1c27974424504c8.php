...
<html lang="en" dir="ltr" data-nav-layout="vertical" class="light" data-header-styles="light" data-menu-styles="dark">
	...
	<body class="">
		...
		<div class="page">
            ...
            <!-- SIDEBAR -->
            <?php echo $__env->make('layouts.components.Principaloffice.pofficesidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH F:\laravel Apps\gitoffice\resources\views/layouts/components/Principaloffice/master-poffice.blade.php ENDPATH**/ ?>