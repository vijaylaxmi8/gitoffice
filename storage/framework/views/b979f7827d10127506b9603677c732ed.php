                    ...
                    <div class="ti-modal-content">
                        <div class="ti-modal-header">
                            <h3 class="ti-modal-title">
                                ...
                                Change Designation And Payscale of <span class="text-red-400"><?php echo e($staff->fname.' '.$staff->mname.' '.$staff->lname); ?></span>
                            </h3>
                        ...
                        <form action="<?php echo e(route('ESTB.staff.designationpayscale.update',$staff->id)); ?>" method="post">
                            <?php echo csrf_field(); ?>
                                    ...
                                    <div class="grid lg:grid-cols-1 gap-2 space-y-2 lg:space-y-0">
                                        <div class="space-y-2 pr-4">
                                            <label class="ti-form-label mb-0 font-bold">Pay Type</label>
                                                ...
                                                <?php endif; ?>
                                                <?php if(count($staff->latestntpayscale)>0 || count($staff->latestteaching_payscale)>0 ): ?>
                                                    <input type="hidden" class="" name="old_pay_type" value="Payscale"/>
                                                <?php endif; ?>
                                                <?php if(count($staff->latestfixedntpay)>0 ||  count($staff->latest_consolidated_teaching_pay)>0): ?>
                                                    <input type="hidden" class="" name="old_pay_type" value="Fixed"/>
                                                <?php endif; ?>
                                        
                                            
                                            <div class="flex gap-x-6">
                                                <?php if($staff->latest_employee_type[0]->employee_type == "Non-Teaching"): ?>
                                                    <div class="flex" id="Consolidated">
                                                        <input type="radio" name="pay_type" value="Consolidated"  <?php echo e(count($staff->latestntcpayscale)>0?'checked':''); ?> class="ti-form-radio" id="hs-radio-group-1 pay_type">
                                                        <label for="hs-radio-group-1" class="text-sm text-gray-500 ltr:ml-2 rtl:mr-2 dark:text-white/70">Consolidated</label>
                                                    </div>
                                                <?php endif; ?>
                                                <input type="hidden" class="" id="change_payscale_employee_type" value="<?php echo e($staff->latest_employee_type[0]->employee_type); ?>"/>
                                                <div class="flex">
                                                    <input type="radio" name="pay_type" value="Payscale"  id="Payscale" <?php echo e(count($staff->latestntpayscale)>0 ||  count($staff->latestteaching_payscale)>0?'checked':''); ?> class="ti-form-radio" id="hs-radio-group-2 pay_type">
                                        ...
                                        <?php if($staff->latest_employee_type[0]->employee_type=='Teaching'): ?>
                                                ...
                                                <?php if(count($staff->latest_consolidated_teaching_pay)>0): ?>
                                                    <div class="space-y-2" id="teahing_consolidated_pay_div"> <!--Fixed pay div-->
                                                        ...
                                                        <input type="text" name="pay" class="ti-form-input" value="<?php echo e($staff->latest_consolidated_teaching_pay[0]->pay); ?>"/>
                                                    </div>
                                                <?php else: ?>
                                                <?php if(count($staff->latestteaching_payscale)>0): ?>
                                                    <div class="space-y-2" id="t_payscale_div">
                                                        <label class="ti-form-label mb-0 font-bold">Payscale</label>
                                                            <select class="ti-form-select" name="payscales_id" id="teaching_payscales_id">
                                                                <?php $__currentLoopData = $payscales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payscale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                
                                                                    <option value="<?php echo e($payscale->id); ?>" <?php echo e(($payscale->id == $staff->latestteaching_payscale[0]->id ? 'selected':'')); ?> ><?php echo e($payscale->payscale_title.'-'.$payscale->basepay.'-'.$payscale->maxpay.'-'.$payscale->agp); ?></option>
                                        ...
                                        <?php else: ?>
                                                ...
                                                <div class="space-y-2" id="nt_payscale_div">
                                                    ...
                                                    <div class="space-y-2" id="payscalelevel">
                                                        ...
                                                        <select class="ti-form-select" name="payscale_level" id="payscale_level">
                                                            ...
                                                            <option value="1" <?php echo e($staff->latestntpayscale[0]->pivot->level==1? "selected":""); ?>>Increment Level-1</option>
                                                            <option value="2" <?php echo e($staff->latestntpayscale[0]->pivot->level==2? "selected":""); ?>>Increment Level-2</option>
                                            ...
                                            <?php endif; ?>
                                            <?php if(count($staff->latestfixedntpay) >0): ?> <!-- For displaying th consolidated pay for non teaching staff-->
                    ...
                    <?php $__currentLoopData = $staff->designations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $designation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($designation->isadditional == 0 ): ?> <!--For working with regular designations-->
                            ...
                            <tr class="<?php echo e($designation->pivot->status =='inactive'?'bg-gray-200':''); ?>">
                                ...
                                <td rowspan=<?php echo e($rowcount); ?>>
                                    <?php if($designation->pivot->end_date == null): ?>
                                        ...
                                        <button class="hs-dropdown-toggle  m-0 hs-tooltip-toggle relative w-8 h-8 ti-btn rounded-full p-0 transition-none focus:outline-none ti-btn-soft-secondary"
                                            data-hs-overlay="#edit_designation<?php echo e($i); ?>">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16"><path d="M16.7574 2.99666L14.7574 4.99666H5V18.9967H19V9.2393L21 7.2393V19.9967C21 20.5489 20.5523 20.9967 20 20.9967H4C3.44772 20.9967 3 20.5489 3 19.9967V3.99666C3 3.44438 3.44772 2.99666 4 2.99666H16.7574ZM20.4853 2.09717L21.8995 3.51138L12.7071 12.7038L11.2954 12.7062L11.2929 11.2896L20.4853 2.09717Z"></path></svg>
                                            <span
                                        ...
                                        <div id="edit_designation<?php echo e($i); ?>" class="hs-overlay hidden ti-modal">
                                            <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out md:!max-w-2xl md:w-full m-3 md:mx-auto">
                                                <div class="ti-modal-content">
                                                    <div class="ti-modal-header">
                                                        <h3 class="ti-modal-title">
                                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16"><path d="M16.7574 2.99666L14.7574 4.99666H5V18.9967H19V9.2393L21 7.2393V19.9967C21 20.5489 20.5523 20.9967 20 20.9967H4C3.44772 20.9967 3 20.5489 3 19.9967V3.99666C3 3.44438 3.44772 2.99666 4 2.99666H16.7574ZM20.4853 2.09717L21.8995 3.51138L12.7071 12.7038L11.2954 12.7062L11.2929 11.2896L20.4853 2.09717Z"></path></svg>
                                                            Edit Designation of <span class="text-red-400"><?php echo e($staff->fname.' '.$staff->mname.' '.$staff->lname); ?></span>
                                                        </h3>
                                                        <button type="button" class="hs-dropdown-toggle ti-modal-close-btn"
                                                            data-hs-overlay="#edit_designation<?php echo e($i); ?>">
                                                            <span class="sr-only">Close</span>
                                                    ...
                                                    <form  action="<?php echo e(route('ESTB.staff.designation.currentupdate',[$staff->id,$designation->id])); ?>" method="post">
                                                        <?php echo csrf_field(); ?>
                                                        <?php echo method_field('patch'); ?>
                                                        <div class="ti-modal-body">
                                                            <?php if($designation->pivot->status == 'inactive'): ?>
                                                                <br/>
                                                                <div class="flex">
                                                            ...
                                                            <?php else: ?> 
                                                                <div class="grid lg:grid-cols-1 gap-1 space-y-2 lg:space-y-0">
                                                                    <div class="space-y-2">
                                                                        ...
                                                                        <select class="ti-form-select" name="designations_id">
                                                                            <?php $__currentLoopData = $designations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $design): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                <option value="<?php echo e($design->id); ?>" <?php echo e(($design->id==$designation->id?'selected':'')); ?>><?php echo e($design->design_name); ?></option>
                                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                        </select>
                                                                    </div>
                                                                </div> 
                                                                <div class="grid lg:grid-cols-2 gap-2 space-y-2 lg:space-y-0">
                                                                    ...
                                                                    <div class="space-y-2">
                                                                        <label for="" class="ti-form-label mb-0 font-bold">Reason</label>
                                                                        <input type="text" name="reason" class="ti-form-input" value="<?php echo e($designation->pivot->reason); ?>"/>
                                                                    </div>
                                                                </div>
                                                                <div class="grid lg:grid-cols-2 gap-2 space-y-2 lg:space-y-0">
                                                                    <div class="space-y-2">
                                        ...
                                        <?php if($designation->pivot->status == 'active' && ($difference->y ==0 && $difference->m <= 1)): ?>
                                            <div class="hs-tooltip ti-main-tooltip">
                                                <form action="<?php echo e(route('ESTB.staff.designation.currentdestroy',[$staff->id,$designation->id])); ?>" method="post">
                                        ...
                                        <?php else: ?>
                                            <?php if($payscale->pivot->end_date==null|| ($payscale->pivot->end_date>$designation->pivot->start_date )): ?>
                                                <tr class="<?php echo e($payscale->pivot->status =='inactive'?'bg-gray-200':''); ?>"> 
                                                    ...
                                                    <td>
                                                        <?php if($payscale->pivot->end_date == null): ?>
                                                                    <!--Edit modal for staff Payscale teaching-->
                                                            <button class="hs-dropdown-toggle  m-0 hs-tooltip-toggle relative w-8 h-8 ti-btn rounded-full p-0 transition-none focus:outline-none ti-btn-soft-secondary"
                                                                data-hs-overlay="#edit_teaching_payscale<?php echo e($i); ?>">
                                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16"><path d="M16.7574 2.99666L14.7574 4.99666H5V18.9967H19V9.2393L21 7.2393V19.9967C21 20.5489 20.5523 20.9967 20 20.9967H4C3.44772 20.9967 3 20.5489 3 19.9967V3.99666C3 3.44438 3.44772 2.99666 4 2.99666H16.7574ZM20.4853 2.09717L21.8995 3.51138L12.7071 12.7038L11.2954 12.7062L11.2929 11.2896L20.4853 2.09717Z"></path></svg>
                                                                <span
                                                                            class="hs-tooltip-content ti-main-tooltip-content py-1 px-2 bg-gray-900 text-xs font-medium text-white shadow-sm dark:bg-slate-700"
                                                                            role="tooltip">
                                                            ...
                                                            <div id="edit_teaching_payscale<?php echo e($i); ?>" class="hs-overlay hidden ti-modal">
                                                                <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out md:!max-w-2xl md:w-full m-3 md:mx-auto">
                                                                    <div class="ti-modal-content">
                                                                        <div class="ti-modal-header">
                                                                            <h3 class="ti-modal-title">
                                                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16"><path d="M16.7574 2.99666L14.7574 4.99666H5V18.9967H19V9.2393L21 7.2393V19.9967C21 20.5489 20.5523 20.9967 20 20.9967H4C3.44772 20.9967 3 20.5489 3 19.9967V3.99666C3 3.44438 3.44772 2.99666 4 2.99666H16.7574ZM20.4853 2.09717L21.8995 3.51138L12.7071 12.7038L11.2954 12.7062L11.2929 11.2896L20.4853 2.09717Z"></path></svg>
                                                                                Edit Payscale of <span class="text-red-400"><?php echo e($staff->fname.' '.$staff->mname.' '.$staff->lname); ?></span>
                                                                            </h3>
                                                                            <button type="button" class="hs-dropdown-toggle ti-modal-close-btn"
                                                                                data-hs-overlay="#edit_teaching_payscale<?php echo e($i); ?>">
                                                                                <span class="sr-only">Close</span>
                                                                        ...
                                                                        <form  action="<?php echo e(route('ESTB.staff.payscale.update',[$staff->id,$payscale->id])); ?>" method="post">
                                                                            <?php echo csrf_field(); ?>
                                                                            <?php echo method_field('patch'); ?>
                                                                            <div class="ti-modal-body">
                                                                                    ...
                                                                                    <div class="grid lg:grid-cols-1 gap-1 space-y-2 lg:space-y-0">
                                                                                        ...
                                                                                        <div class="space-y-2">
                                                                                            ...
                                                                                            <?php if($staff->latest_employee_type[0]->employee_type=='Teaching'): ?>
                                                                                                ...
                                                                                                <?php endif; ?>
                                                                                                <?php if($staff->latestteaching_payscale!=null): ?>
                                                                                                    <div class="space-y-2" id="edi_teaching_payscale_div">
                                                                                                        <label class="ti-form-label mb-0 font-bold">Payscale</label>
                                                                                                        <select class="ti-form-select" name="payscales_id">
                                                                                                            <?php $__currentLoopData = $payscales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t_payscale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                                            
                                                                                                                <option value="<?php echo e($t_payscale->id); ?>" <?php echo e(($t_payscale->id == $payscale->id ? 'selected':'')); ?>><?php echo e($t_payscale->payscale_title.'-'.$t_payscale->basepay.'-'.$t_payscale->maxpay.'-'.$t_payscale->agp); ?></option>
                                        ...
                                        <?php if($cons_teaching_pay->end_date==null|| ($cons_teaching_pay->end_date>$designation->pivot->start_date)): ?>
                                            <tr class="<?php echo e($cons_teaching_pay->status =='inactive'?'bg-gray-200':''); ?>"> 
                                                ...
                                                <td>
                                                    ...
                                                    <?php if($cons_teaching_pay->status !='inactive'): ?>
                                                        <button class="hs-dropdown-toggle  m-0 hs-tooltip-toggle relative w-8 h-8 ti-btn rounded-full p-0 transition-none focus:outline-none ti-btn-soft-secondary"
                                                        ...
                                                        <div id="edit_cons_teaching_payscale<?php echo e($i); ?>" class="hs-overlay hidden ti-modal">
                                                            <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out md:!max-w-2xl md:w-full m-3 md:mx-auto">
                                                                <div class="ti-modal-content">
                                                                    ...
                                                                    <form  action="<?php echo e(route('ESTB.staff.payscale.update',[$staff->id,$cons_teaching_pay->id])); ?>" method="post">
                                                                        <?php echo csrf_field(); ?>
                                                                        <?php echo method_field('patch'); ?>
                                                                            <div class="ti-modal-body">
                                                                                <?php if($cons_teaching_pay->status == 'inactive'): ?>
                                                                                ...
                                                                                <div class="grid lg:grid-cols-1 gap-1 space-y-2 lg:space-y-0">
                                                                                    <div id="ajax_edit_consolidated_data_populate">
                                                                                        <input type="hidden" id="emp_type_cons_teaching_pay" value="<?php echo e($staff->latest_employee_type[0]->employee_type); ?>"/>
                                                                                        <?php if($staff->latest_employee_type[0]->employee_type == "Teaching"): ?>
                                    ...
                                    <?php $__currentLoopData = $staff->ntpayscale; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ntpays): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <?php if($designation->pivot->end_date==null && ($ntpays->pivot->end_date==null ||$ntpays->pivot->start_date>=$designation->pivot->start_date)): ?>
                                            ...
                                            <tr class="<?php echo e($ntpays->pivot->status =='inactive'?'bg-gray-200':''); ?>">
                                                ...
                                                <td>
                                                    <?php if($ntpays->pivot->end_date == null): ?>
                                                        ...
                                                        <div id="edit_nonteaching_payscale<?php echo e($i); ?>" class="hs-overlay hidden ti-modal">
                                                            <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out md:!max-w-2xl md:w-full m-3 md:mx-auto">
                                                                <div class="ti-modal-content">
                                                                    <div class="ti-modal-header">
                                                                        <h3 class="ti-modal-title">
                                                                    ...
                                                                    <form  action="<?php echo e(route('ESTB.staff.payscale.update',[$staff->id,$ntpays->id])); ?>" method="post">
                                                                        <?php echo csrf_field(); ?>
                                                                        <?php echo method_field('patch'); ?>
                                                                        <div class="ti-modal-body">
                                                                            ...
                                                                            <div class="grid lg:grid-cols-1 gap-2 space-y-2 lg:space-y-0">
                                                                                ...
                                                                                <div class="flex gap-x-6">
                                                                                    <?php if($staff->latest_employee_type[0]->employee_type == "Non-Teaching"): ?>
                                                                                        <div class="flex" id="Consolidated">
                                                                                            <input type="radio" name="edit_pay_type" value="Consolidated"  <?php echo e(count($staff->latestntcpayscale)>0?'checked="checked"':''); ?> class="ti-form-radio" id="hs-radio-group-1 pay_type">
                                                                                            <label for="hs-radio-group-1" class="text-sm text-gray-500 ltr:ml-2 rtl:mr-2 dark:text-white/70">Consolidated</label>
                                                                                        </div>
                                                                                    <?php endif; ?>
                                                                                    <input type="hidden" class="" id="change_payscale_employee_type" value="<?php echo e($staff->latest_employee_type[0]->employee_type); ?>"/>
                                                                                        ...
                                                                                        <div class="space-y-2">
                                                                                            ...
                                                                                            <?php endif; ?>
                                                                                                <?php if($staff->payscales!=null): ?>
                                                                                                    <?php $__currentLoopData = $payscales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $design_ntcpaysc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                                        <?php $__currentLoopData = $design_ntcpaysc->ntcpayscales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ntcpaysc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                                            <option value="<?php echo e($ntcpaysc->id); ?>" <?php echo e(($ntcpaysc->id == $staff->latestntcpayscale[0]->pivot->ntcpayscale_id && $design_ntcpaysc->id==$designation->id? 'selected="selected"':'')); ?>><?php echo e(design_ntcpaysc->design_name.'-'.$ntcpaysc->basepay.'-'.$ntcpaysc->allowance); ?></option>
                                                                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                                                <?php endif; ?>
                                    ...
                                    <?php if($staff->ntcpayscale !=null): ?>
                                        ...
                                        <?php if($designation->pivot->end_date==null && $ntcpays->pivot->start_date>=$designation->pivot->start_date): ?>
                                            <tr class="<?php echo e($ntcpays->pivot->status =='inactive'?'bg-gray-200':''); ?>">
                                                ...
                                                <td>
                                                    <?php if($ntcpays->pivot->end_date == null): ?>
                                                        <!--Edit modal for staff Payscale non-teaching-->
                                                        <button class="hs-dropdown-toggle  m-0 hs-tooltip-toggle relative w-8 h-8 ti-btn rounded-full p-0 transition-none focus:outline-none ti-btn-soft-secondary"
                                                        ...
                                                        <div id="edit_nonteachingconso_payscale<?php echo e($i); ?>" class="hs-overlay hidden ti-modal">
                                                            <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out md:!max-w-2xl md:w-full m-3 md:mx-auto">
                                                                <div class="ti-modal-content">
                                                                    <div class="ti-modal-header">
                                                                        <h3 class="ti-modal-title">
                                                                    ...
                                                                    <form  action="<?php echo e(route('ESTB.staff.payscale.update',[$staff->id,$ntcpays->id])); ?>" method="post">
                                                                        <?php echo csrf_field(); ?>
                                                                        <?php echo method_field('patch'); ?>
                                                                        <div class="ti-modal-body">
                                                                                <?php if($ntcpays->pivot->status == 'inactive'): ?>
                                                                                <br/>
                                                                                    <div class="flex">
                                                                                        <input type="radio" name="status" class="ti-form-radio" id="hs-radio-group-2" value="active">
                                                                                        <label for="hs-radio-group-2" class="text-sm text-gray-500 ltr:ml-2 rtl:mr-2 dark:text-white/70">Make it Active</label>
                                                                    ...
                                                                    <form  action="<?php echo e(route('ESTB.staff.payscale.update',[$staff->id,$ntcpays->id])); ?>" method="post">
                                                                        ...
                                                                        <div class="ti-modal-body">
                                                                                ...
                                                                                <?php else: ?> 
                                                                                    ...
                                                                                    <div class="grid lg:grid-cols-1 gap-2 space-y-2 lg:space-y-0">
                                                                                        <div class="space-y-2 pr-4">
                                                                                            <label class="ti-form-label mb-0 font-bold">Pay Type count=<?php echo e(count($staff->ntcpayscale)); ?></label>
                                                                                            ...
                                                                                            <div class="flex gap-x-6">
                                                                                                <?php if($staff->latest_employee_type[0]->employee_type == "Non-Teaching"): ?>
                                                                                                    <div class="flex" id="Consolidated">
                                                                                                        <input type="radio" name="edit_pay_type" value="Consolidated"  <?php echo e($staff->latestntcpayscale!=null?'checked="checked"':''); ?> class="ti-form-radio" id="hs-radio-group-1 pay_type">
                                                                                                        <label for="hs-radio-group-1" class="text-sm text-gray-500 ltr:ml-2 rtl:mr-2 dark:text-white/70">Consolidated</label>
                                                                                                    </div>
                                                                                                <?php endif; ?>
                                                                                                <input type="hidden" class="" id="change_payscale_employee_type" value="<?php echo e($staff->latest_employee_type[0]->employee_type); ?>"/>
                                            ...
                                            <tr class="<?php echo e($fntp->status =='inactive'?'bg-gray-200':''); ?>">
                                                ...
                                                <td>
                                                    <?php if($fntp->end_date == null): ?>
                                                        ...
                                                        <div id="edit_fixed_nonteaching<?php echo e($i); ?>" class="hs-overlay hidden ti-modal">
                                                            <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out md:!max-w-2xl md:w-full m-3 md:mx-auto">
                                                                <div class="ti-modal-content">
                                                                    <div class="ti-modal-header">
                                                                        <h3 class="ti-modal-title">
            ...
            <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out md:!max-w-2xl md:w-full m-3 md:mx-auto">
                <div class="ti-modal-content">
                    <div class="ti-modal-header">
                        <h3 class="ti-modal-title">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16"><path d="M16.7574 2.99666L14.7574 4.99666H5V18.9967H19V9.2393L21 7.2393V19.9967C21 20.5489 20.5523 20.9967 20 20.9967H4C3.44772 20.9967 3 20.5489 3 19.9967V3.99666C3 3.44438 3.44772 2.99666 4 2.99666H16.7574ZM20.4853 2.09717L21.8995 3.51138L12.7071 12.7038L11.2954 12.7062L11.2929 11.2896L20.4853 2.09717Z"></path></svg>
                            Assign Additional Designation for <span class="text-red-400"><?php echo e($staff->fname.' '.$staff->mname.' '.$staff->lname); ?></span>
                        </h3>
                        <button type="button" class="hs-dropdown-toggle ti-modal-close-btn"
                    ...
                    <form  action="<?php echo e(route('ESTB.staff.additional_designation.create',$staff->id)); ?>" method="post">
                        <?php echo csrf_field(); ?>
                        <div class="ti-modal-body">
                            <div class="grid lg:grid-cols-2 gap-2 space-y-2 lg:space-y-0">
                                <div class="space-y-2">
                ...
                <tbody>
                    ...
                    <?php $__currentLoopData = $staff->designations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $add_designaions): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tr class="<?php echo e($add_designaions->pivot->status =='inactive'?'bg-gray-200':''); ?>">
                            <td><?php echo e($i++); ?></td>
                            <td><?php echo e($add_designaions->design_name); ?></td>
                            <td><?php echo e($add_designaions->pivot->dept_id==null?'---NA---':$dept); ?></td>
                            <td><?php echo e(\Carbon\Carbon::parse($add_designaions->pivot->start_date)->format('d-M-Y')); ?></td>
                            <td><?php echo e($add_designaions->pivot->end_date==null?'--NA--':\Carbon\Carbon::parse($add_designaions->pivot->end_date)->format('d-M-Y')); ?></td>
                            <td><span>
                                <?php
                            ...
                            <td><?php echo e($add_designaions->pivot->gcr); ?></td>
                            <td><?php echo e($add_designaions->pivot->status); ?></td>
                            <td>
                                <button class="hs-dropdown-toggle  m-0 hs-tooltip-toggle relative w-8 h-8 ti-btn rounded-full p-0 transition-none focus:outline-none ti-btn-soft-secondary"
                                ...
                                <div id="edit_additional_designation<?php echo e($i); ?>" class="hs-overlay hidden ti-modal">
                                    <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out md:!max-w-2xl md:w-full m-3 md:mx-auto">
                                        <div class="ti-modal-content">
                                            <div class="ti-modal-header">
                                                <h3 class="ti-modal-title">
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16"><path d="M16.7574 2.99666L14.7574 4.99666H5V18.9967H19V9.2393L21 7.2393V19.9967C21 20.5489 20.5523 20.9967 20 20.9967H4C3.44772 20.9967 3 20.5489 3 19.9967V3.99666C3 3.44438 3.44772 2.99666 4 2.99666H16.7574ZM20.4853 2.09717L21.8995 3.51138L12.7071 12.7038L11.2954 12.7062L11.2929 11.2896L20.4853 2.09717Z"></path></svg>
                                                    Edit Additional Designation for <span class="text-red-400"><?php echo e($staff->fname.' '.$staff->mname.' '.$staff->lname); ?></span>
                                                </h3>
                                                <button type="button" class="hs-dropdown-toggle ti-modal-close-btn"
                                                data-hs-overlay="#edit_additional_designation<?php echo e($i); ?>">
                                                <span class="sr-only">Close</span>
                                            ...
                                            <form  action="<?php echo e(route('ESTB.staff.additional_designation.update',[$staff->id, $add_designaions->pivot->id])); ?>" method="post">
                                                <?php echo csrf_field(); ?>
                                                <?php echo method_field('patch'); ?>
                                                <div class="ti-modal-body">
                                                    <div class="grid lg:grid-cols-2 gap-2 space-y-2 lg:space-y-0">
