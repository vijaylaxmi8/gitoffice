<?php $__env->startSection('styles'); ?>
        ...
        <!-- TOM SELECT CSS -->
        <link rel="stylesheet" href="<?php echo e(asset('build/assets/libs/tom-select/css/tom-select.default.min.css')); ?>">
                    ...
                    <div class="content">
                        ...
                        <div class="main-content">
                            ...
                            <div class="block justify-between page-header sm:flex">
                                <div>
                                    <h3 class="text-gray-700 hover:text-gray-900 dark:text-white dark:hover:text-white text-2xl font-medium"> Select</h3>
                                </div>
...
<?php $__env->startSection('scripts'); ?>
        ...
        <?php echo app('Illuminate\Foundation\Vite')('resources/assets/js/choices.js'); ?>


        <!-- TOM SELECT JS -->
        <script src="<?php echo e(asset('build/assets/libs/tom-select/js/tom-select.complete.min.js')); ?>"></script>
        <?php echo app('Illuminate\Foundation\Vite')('resources/assets/js/tom-select.js'); ?>

        
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\projects\laravel\vite\synto\synto\resources\views/pages/form-select.blade.php ENDPATH**/ ?>