                                                                    ...
                                                                    <div class="ti-modal-body">
                                                                        <div class="grid lg:grid-cols-2 gap-1 space-y-2 lg:space-y-0">
                                                                            <div class="max-w-sm space-y-3 pb-6">
                                                                                ...
                                                                                <input type="text" name="title" class="ti-form-input" placeholder="Title">
                                                                            </div>
                                                                            <div class="max-w-sm space-y-3 pb-6">
                                                                                <label for="" class="ti-form-label font-bold">Description:<span class="text-red-500">*</span></label>
                                                                                <input type="text" name="description" class="ti-form-input po_location" placeholder="Description">
                                                                            </div>
                                                                        </div>
                                                                        <div class="grid lg:grid-cols-2 gap-1 space-y-2 lg:space-y-0">
                                                                                    ...
                                                                                    <div class="ti-modal-body">
                                                                                        ...
                                                                                        <div class="grid lg:grid-cols-2 gap-1 space-y-2 lg:space-y-0">
                                                                                            <div class="flex max-w-sm space-y-3 pb-6 no no_fromdate">
                                                                                                ...
                                                                                                <input type="text" name="date" class="ti-form-input rounded-l-none focus:z-10 flatpickr-input  po_startdate"
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.components.Principaloffice.master-poffice', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\laravel Apps\gitoffice\resources\views/Principaloffice/ponoticeboard.blade.php ENDPATH**/ ?>