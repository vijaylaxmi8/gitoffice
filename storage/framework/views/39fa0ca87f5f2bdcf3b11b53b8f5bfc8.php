                    ...
                    <div class="ti-modal-content">
                        <div class="ti-modal-body">
                            ...
                            <div class="badge rounded-sm bg-secondary/20 text-secondary relative header-box">
                                <a href="<?php echo e(url('teams')); ?>" class="w-full my-auto items-center flex space-x-2 rtl:space-x-reverse">
                            ...
                            <div class="badge rounded-sm bg-secondary/20 text-secondary relative header-box">
                                <a href="<?php echo e(url('form-elements')); ?>" class="w-full my-auto items-center flex space-x-2 rtl:space-x-reverse">
                            ...
                            <div class="badge rounded-sm bg-secondary/20 text-secondary relative header-box">
                                <a href="<?php echo e(url('vector-maps')); ?>" class="w-full my-auto items-center flex space-x-2 rtl:space-x-reverse">
                            ...
                            <div class="badge rounded-sm bg-secondary/20 text-secondary relative header-box">
                                <a href="<?php echo e(url('widgets')); ?>" class="w-full my-auto items-center flex space-x-2 rtl:space-x-reverse">
                            ...
                            <div class="p-2 border dark:border-white/10 rounded-sm flex items-center text-gray-500 mb-1 relative header-box">
                                <a href="<?php echo e(url('notifications')); ?>" class="w-full my-auto items-center flex">
                            ...
                            <div class="p-2 border dark:border-white/10 rounded-sm flex items-center text-gray-500 mb-1 relative header-box">
                                <a href="<?php echo e(url('alerts')); ?>" class="w-full my-auto items-center flex">
                            ...
                            <div class="p-2 border dark:border-white/10 rounded-sm flex items-center text-gray-500 relative header-box">
                                <a href="<?php echo e(url('tables')); ?>" class="w-full my-auto items-center flex">
...
<?php /**PATH E:\projects\my-projects\laravel\vite\synto\synto-laravel\synto\resources\views/layouts/components/search-modal.blade.php ENDPATH**/ ?>