                ...
                <div class="main-sidebar " id="sidebar-scroll">
                    ...
                    <nav class="main-menu-container nav nav-pills flex-column sub-open">
                        ...
                        <ul class="main-menu">
                            ...
                            <!-- End::slide__category -->
                            <li class="slide">
                                <a href="<?php echo e(url('/Principaloffice/podashboard')); ?>" class="side-menu__item">
                            ...
                            <li class="slide">
                                <a href="<?php echo e(url('/Principaloffice/poevents')); ?>" class="side-menu__item">
                            ...
                            <li class="slide">
                                <a href="<?php echo e(url('/Principaloffice/ponotice')); ?>" class="side-menu__item">
            ...
            </aside><?php /**PATH F:\laravel Apps\gitoffice\resources\views/layouts/components/Principaloffice/pofficesidebar.blade.php ENDPATH**/ ?>