<?php $__env->startSection('styles'); ?>
        ...
        <!-- RANGESLIDER CSS -->
        <link rel="stylesheet" href="<?php echo e(asset('build/assets/libs/rangeslider-js/styles.min.css')); ?>">

        <!-- NOUISLIDER JS -->
        <link rel="stylesheet" href="<?php echo e(asset('build/assets/libs/nouislider/nouislider.min.css')); ?>">
...
<?php $__env->startSection('scripts'); ?>
        ...
        <!-- RANGESLIDER JS -->
        <script src="<?php echo e(asset('build/assets/libs/rangeslider-js/rangeslider-js.min.js')); ?>"></script>

        <!-- NOUISLIDER JS -->
        <script src="<?php echo e(asset('build/assets/libs/nouislider/nouislider.min.js')); ?>"></script>
        <script src="<?php echo e(asset('build/assets/libs/wnumb/wNumb.min.js')); ?>"></script>

        <!-- RANGESLIDER CUSTOM JS -->
        <?php echo app('Illuminate\Foundation\Vite')('resources/assets/js/rangeslider.js'); ?>
        

<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\projects\my-projects\laravel\vite\synto\synto-laravel\synto\resources\views/pages/rangeslider.blade.php ENDPATH**/ ?>