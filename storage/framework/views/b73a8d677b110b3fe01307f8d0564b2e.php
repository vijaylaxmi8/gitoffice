                        ...
                        <div class="main-content">
                            ...
                            <div class="col-span-12 lg:col-span-4">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="box mb-0">
                                        <img class="w-full h-auto rounded-t-sm" src="<?php echo e(asset('build/assets/img/gallery/3.jpg')); ?>" alt="Image Description">
                            ...
                            <div class="col-span-12 lg:col-span-4">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="box mb-0">
                                        ...
                                        <img class="w-full h-auto rounded-b-sm" src="<?php echo e(asset('build/assets/img/gallery/3.jpg')); ?>" alt="Image Description">
                                    </div>
                                    </div>
                                </div>
                                </div>
...
<?php $__env->startSection('scripts'); ?>
        ...
        <?php echo app('Illuminate\Foundation\Vite')('resources/assets/js/draggable.js'); ?>
        

<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\projects\my-projects\laravel\vite\synto\synto-laravel\synto\resources\views/pages/draggable.blade.php ENDPATH**/ ?>