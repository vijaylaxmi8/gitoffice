                    ...
                    <div class="content">
                        ...
                        <div class="main-content">
                            ...
                            <div class="col-span-12 lg:col-span-6">
                                <div class="box">
                                    <div class="box-header">
                                        <h5 class="box-title">Popover With Four Directions</h5>
                                    </div>
                                    <div class="box-body">
                            ...
                            <div class="col-span-12 lg:col-span-6">
                                <div class="box">
                                <div class="box-header">
                                    <h5 class="box-title">Popover With Focus event</h5>
                                </div>
                                <div class="box-body">
                            ...
                            <div class="col-span-12 lg:col-span-6">
                                <div class="box">
                                <div class="box-header">
                                    <h5 class="box-title">Popover With Hover event</h5>
                                </div>
                                <div class="box-body">
                                    <div class="flex justify-center">
                            ...
                            <div class="col-span-12 lg:col-span-6">
                                <div class="box">
                                <div class="box-header">
                                    <h5 class="box-title">Basic Tooltip </h5>
                                </div>
                                <div class="box-body">
                                    <!-- Grid -->
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\projects\my-projects\laravel\vite\synto\synto-laravel\synto\resources\views/pages/tooltip-popovers.blade.php ENDPATH**/ ?>