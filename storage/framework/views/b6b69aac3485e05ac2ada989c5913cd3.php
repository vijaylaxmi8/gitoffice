                            ...
                            <div class="col-span-12 md:col-span-6 xxl:col-span-3">   
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <h5 class="mb-0 text-2xl font-semibold text-gray-800 dark:text-white"><?php echo e(10); ?></h5>
                                    ...
                                    <div class="box-body">
                                        ...
                                        <table id="Ticketing_table" class="ti-custom-table ti-custom-table-head whitespace-nowrap">
                                            ...
                                            <tr class="">
                                                ...
                                                <th scope="col" class="dark:text-white/80"><?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('title','title'));?></th>
                                                <th scope="col" class="dark:text-white/80"><?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('description','description'));?></th>
                                                <th scope="col" class="dark:text-white/80"><?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('attachment','attachment'));?></th>
                                                <th scope="col" class="dark:text-white/80"><?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('user','user'));?></th>
                                            ...
                                            <?php if($tickets!=null): ?>
                                                ...
                                                <tr class="">
                                                    ...
                                                    <td><span><?php echo e($ticket->attachment); ?></span></td>
                                                    <td><span><?php echo e($ticket->user->email); ?></span></td>
                                                    ...
                                                    <div class="hs-tooltip ti-main-tooltip">
                                                        <button data-hs-overlay="#tickets_edit_modal<?php echo e($i); ?>"
                                                        ...
                                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16"><path d="M16.7574 2.99666L14.7574 4.99666H5V18.9967H19V9.2393L21 7.2393V19.9967C21 20.5489 20.5523 20.9967 20 20.9967H4C3.44772 20.9967 3 20.5489 3 19.9967V3.99666C3 3.44438 3.44772 2.99666 4 2.99666H16.7574ZM20.4853 2.09717L21.8995 3.51138L12.7071 12.7038L11.2954 12.7062L11.2929 11.2896L20.4853 2.09717Z"></path></svg>
                                                            ...
                                                            <div id="tickets_edit_modal<?php echo e($i); ?>" class="hs-overlay hidden ti-modal">
                                                                <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out md:!max-w-2xl md:w-full m-3 md:mx-auto">
                                                                    <div class="ti-modal-content">
                                                                    <div class="ti-modal-header">
                                                                        <h3 class="ti-modal-title">
                                                                    ...
                                                                    <form  action="<?php echo e(route('ticket.update',$ticket->id)); ?>" method="post" enctype="multipart/form-data"> 
                                                                        <?php echo csrf_field(); ?>
                                                                        ...
                                                                        <div class="ti-modal-body">
                                                                            ...
                                                                            <div class="max-w-sm space-y-3 pb-6">
                                                                                <label for="with-corner-hint" class="ti-form-label">title : </label>
                                                                                <input type="text" name="title" class="ti-form-input" required placeholder="title" value="<?php echo e($ticket->title); ?>">
                                                                            </div>
                                                                            <div class="max-w-sm space-y-3 pb-6">
                                                                                <label for="" class="ti-form-label">description : </label>
                                                                                <input type="text" name="description" class="ti-form-input" required placeholder="description" value="<?php echo e($ticket->description); ?>">
                                                                            </div>
                                                                            <div class="max-w-sm space-y-3 pb-6">
                                                                                <label for="" class="ti-form-label">user : </label>
                                                                                <input type="text" name="User" class="ti-form-input" required placeholder="User" value="<?php echo e($ticket->User->email); ?>">
                                                                            </div>
                                                                            <label for="" class="ti-form-label">attachment :</label>
                                                                            <input type="file" name="attachment" class="ti-form-input"  placeholder="attachment" value="<?php echo e($ticket->attachment); ?>">
                                                                            
                                                                            <?php if($ticket->status == 'inactive'): ?>
                                                                            <br/>
                                                                                <div class="flex">
                                                    ...
                                                    <div class="hs-tooltip ti-main-tooltip">
                                                    <form action="<?php echo e(route('ticket.destroy',$ticket->id)); ?>" method="post" enctype="multipart/form-data">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.components.Admin.adminmaster-ticketing', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\laravel Apps\gitoffice\resources\views/Admin/tickets/dashboard.blade.php ENDPATH**/ ?>