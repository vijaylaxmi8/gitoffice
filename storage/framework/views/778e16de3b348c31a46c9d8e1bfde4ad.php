                                                    ...
                                                    <div id="add_conference_activity_attended" class="hs-overlay hidden ti-modal">
                                                        <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out lg:!max-w-4xl lg:w-full m-3 md:mx-auto">
                                                            <div class="ti-modal-content">
                                                                ...
                                                                <form action="<?php echo e(route('Teaching.research.conference.attended.store')); ?>" method="post" enctype="multipart/form-data">
                                                                    <?php echo csrf_field(); ?>
                                                            ...
                                                            <tbody class="">
                                                                    ...
                                                                    <?php $__empty_1 = true; $__currentLoopData = $staff->conferences_attendee; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $act): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                                        <tr class="">
                                                                                ...
                                                                                <td><span><a href=<?php echo e(asset('Uploads/Research/Conference_Attended/'.$act->document)); ?> class='font-medium text-blue-600 dark:text-blue-500 hover:underline' target="_blank"><?php echo e($act->document); ?></a></span></td>
                                                                            ...
                                                                            <td class="font-medium space-x-2 rtl:space-x-reverse">
                                                                                    ...
                                                                                    <div id="conference_attended_edit_modal<?php echo e($i); ?>" class="hs-overlay hidden ti-modal">
                                                                                        <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out lg:!max-w-4xl lg:w-full m-3 md:mx-auto">
                                                                                            <div class="ti-modal-content">
                                                                                                ...
                                                                                                <form  action="<?php echo e(route('Teaching.research.conference.attended.update',$act->id)); ?>" enctype="multipart/form-data" method="post">
                                                                                                    <?php echo csrf_field(); ?>
                                                                                ...
                                                                                <div class="hs-tooltip ti-main-tooltip">
                                                                                <form action="<?php echo e(route('Teaching.research.conference.attended.destroy',$act->id)); ?>" method="post">
                                                    ...
                                                    <div id="add_conference_activity_conducted" class="hs-overlay hidden ti-modal">
                                                        <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out lg:!max-w-4xl lg:w-full m-3 md:mx-auto">
                                                            <div class="ti-modal-content">
                                                                ...
                                                                <form action="<?php echo e(route('Teaching.research.conference.conducted.store')); ?>" method="post" enctype="multipart/form-data">
                                                                    <?php echo csrf_field(); ?>
                                                                    <div class="ti-modal-body">
                                                                        <div class="grid lg:grid-cols-2 gap-2 space-y-2 lg:space-y-0">
                                                                            <div class="max-w-sm space-y-3 pb-6">
                                                            ...
                                                            <tbody class="">
                                                                <?php if($staff->conferences_conducted !=null): ?>
                                                                    ...
                                                                    <tr class="">
                                                                        ...
                                                                        <td><span><?php echo e($con->sponsoring_agency); ?></span></td>
                                                                        ...
                                                                        <td><span><a href=<?php echo e(asset('Uploads/Research/Conference_Conducted/'.$con->document)); ?> class='font-medium text-blue-600 dark:text-blue-500 hover:underline' target="_blank"><?php echo e($con->document); ?></a></span></td>
                                                                        ...
                                                                        <td class="font-medium space-x-2 rtl:space-x-reverse">
                                                                                ...
                                                                                <div id="conference_conducted_edit_modal<?php echo e($i); ?>" class="hs-overlay hidden ti-modal">
                                                                                    <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out lg:!max-w-4xl lg:w-full m-3 md:mx-auto">
                                                                                        <div class="ti-modal-content">
                                                                                            ...
                                                                                            <form  action="<?php echo e(route('Teaching.research.conference.conducted.update',$con->id)); ?>" enctype="multipart/form-data" method="post">
                                                                                                <?php echo csrf_field(); ?>
                                                                                                <?php echo method_field('patch'); ?>
                                                                                                <div class="ti-modal-body">
                                                                            ...
                                                                            <div class="hs-tooltip ti-main-tooltip">
                                                                                <form action="<?php echo e(route('Teaching.research.conference.conducted.destroy',$con->id)); ?>" method="post">
                                                    ...
                                                    <div id="add_publicaitons" class="hs-overlay hidden ti-modal">
                                                        <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out lg:!max-w-4xl lg:w-full m-3 md:mx-auto">
                                                            <div class="ti-modal-content">
                                                                <div class="ti-modal-header">
                                                                    ...
                                                                    <button type="button" class="hs-dropdown-toggle ti-modal-close-btn"
                                                                        ...
                                                                        <svg class="w-3.5 h-3.5" width="8" height="8" viewBox="0 0 8 8" fill="none"
                                                                         ...
                                                                         <?php if(($errors->has('level'))||($errors->has('title'))||($errors->has('date'))||($errors->has('journal'))||($errors->has('link'))||($errors->has('role'))||($errors->has('role'))): ?>
                                                                                <script>
                                                                                    // alert(1);
                                                                                    $(window).on('load', function() {
                                                                                        //if($('#horizontal-alignment-item-2').parent().find('.active')){
                                                                ...
                                                                <form  action="<?php echo e(route('Teaching.research.publication.store')); ?>" method="post" enctype="multipart/form-data">
                                                                    <?php echo csrf_field(); ?> 
                                                                    <div class="ti-modal-body">
                                                                        <div class="grid lg:grid-cols-2 gap-2 space-y-2 lg:space-y-0">
                                                                            <div class="max-w-sm space-y-3 pb-6">
                                                                    ...
                                                                    <?php if($staff->publications!=null): ?>
                                                                        <?php $__empty_1 = true; $__currentLoopData = $staff->publications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                                            <tr class="">
                                                                                ...
                                                                                <td><span><?php echo e($pub->other_level); ?></span></td>
                                                                                ...
                                                                                <td><span><a href=<?php echo e(asset('Uploads/Research/Publications/'.$pub->document)); ?> class='font-medium text-blue-600 dark:text-blue-500 hover:underline' target="_blank"><?php echo e($pub->document); ?></a></span></td>
                                                                                    <td class="font-medium space-x-2 rtl:space-x-reverse">
                                                                                        <div class="hs-tooltip ti-main-tooltip">
                                                                                                ...
                                                                                                <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out lg:!max-w-4xl lg:w-full m-3 md:mx-auto">
                                                                                                    <div class="ti-modal-content">
                                                                                                        <div class="ti-modal-header">
                                                                                                            ...
                                                                                                            <?php if((($errors->has('e_level'))||($errors->has('e_title'))||($errors->has('e_date'))||($errors->has('e_journal'))||($errors->has('e_link'))||($errors->has('e_role'))||($errors->has('e_doi_number')))): ?>
                                                                                                                <script>
                                                                                                                    window.onload=function(){
                                                                                                                    //alert('123');
                                                                                                                     document.getElementById('btn'+<?php echo e(old('modal_no')); ?>).click();
                                                                                                        ...
                                                                                                        <form action="<?php echo e(route('Teaching.research.publication.update',$pub->id)); ?>" enctype="multipart/form-data" method="post">
                                                                                                             <?php echo csrf_field(); ?>
                                                                                                            <?php echo method_field('patch'); ?>
                                                                                                            <div class="ti-modal-body">
                                                                                                                <input type='hidden' name='modal_no' class='modal_no' value=<?php echo e(old('modal_no')); ?>/>
                                                                                                                ...
                                                                                                                <div class="grid lg:grid-cols-2 gap-2 space-y-2 lg:space-y-0">
                                                                                                                    ...
                                                                                                                    <div class="max-w-sm space-y-3 pb-6" id="pub_other_level" >
                                                                                                                        <label for="" class="ti-form-label font-bold">Other Level:</label>
                                                                                                                        <input type="text" name="other_level" class="ti-form-input" placeholder="Other Level" value="<?php echo e($pub->other_level); ?>">
                                                                                                                        <?php if($errors->has('other_level')): ?>
                                                                                                                            <div class="text-red-700"><?php echo e($errors->first('other_level')); ?></div>
                                                                                                                        <?php endif; ?>
                                                                                                                        <div id="pub_other_levelError" class="error text-red-700"></div>
                                                                                        ...
                                                                                        <div class="hs-tooltip ti-main-tooltip">
                                                                                            <form action="<?php echo e(route('Teaching.research.publication.destroy',$pub->id)); ?>" method="post">
                                                    ...
                                                    <div id="add_book_chapter" class="hs-overlay hidden ti-modal">
                                                        <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out lg:!max-w-4xl lg:w-full m-3 md:mx-auto">
                                                            <div class="ti-modal-content">
                                                                ...
                                                                <form  action="<?php echo e(route('Teaching.research.book_publication.store')); ?>" method="post" enctype="multipart/form-data">
                                                                    <?php echo csrf_field(); ?>
                                                                ...
                                                                <?php if($staff->book_publications!=null): ?>
                                                                    <?php $__empty_1 = true; $__currentLoopData = $staff->book_publications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $book): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                                        <tr class="">
                                                                            ...
                                                                            <td><span><?php echo e($book->chapter_title); ?></span></td>
                                                                            <td><span><?php echo e($book->start_page_no); ?></span></td>
                                                                            <td><span><?php echo e($book->end_page_no); ?></span></td>
                                                                            ...
                                                                            <td class="font-medium space-x-2 rtl:space-x-reverse">
                                                                                            ...
                                                                                            <div id="book_edit_modal<?php echo e($i); ?>" class="hs-overlay hidden ti-modal">
                                                                                                <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out lg:!max-w-4xl lg:w-full m-3 md:mx-auto">
                                                                                                    <div class="ti-modal-content">
                                                                                                        ...
                                                                                                        <form  action="<?php echo e(route('Teaching.research.book_publication.update',$book->id)); ?>" method="post" enctype="multipart/form-data">
                                                                                                            <?php echo csrf_field(); ?>
                                                                                                            <?php echo method_field('patch'); ?>
                                                                                                           <div class="ti-modal-body">
                                                                                        ...
                                                                                        <div class="hs-tooltip ti-main-tooltip">
                                                                                            <form action="<?php echo e(route('Teaching.research.book_publication.destroy',$book->id)); ?>" method="post">
                                                    ...
                                                    <div id="add_fund" class="hs-overlay hidden ti-modal">
                                                        <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out lg:!max-w-4xl lg:w-full m-3 md:mx-auto">
                                                            <div class="ti-modal-content">
                                                                ...
                                                                <form id="fund_btn" action="<?php echo e(route('Teaching.research.funded_project.store')); ?>" method="post">
                                                                    <?php echo csrf_field(); ?>                                     
                                                                    <div class="ti-modal-body">
                                                                        <div class="grid lg:grid-cols-2 gap-2 space-y-2 lg:space-y-0">
                                                                        ...
                                                                        <?php $__empty_1 = true; $__currentLoopData = $staff->funded_project; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fund): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                                            <tr class="">
                                                                                ...
                                                                                <td class="font-medium space-x-2 rtl:space-x-reverse">
                                                                                        ...
                                                                                        <div id="fund_edit_modal<?php echo e($i); ?>" class="hs-overlay hidden ti-modal">
                                                                                            <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out lg:!max-w-4xl lg:w-full m-3 md:mx-auto">
                                                                                                <div class="ti-modal-content">
                                                                                                    ...
                                                                                                    <form  action="<?php echo e(route('Teaching.research.funded_project.update',$fund->id)); ?>" method="post">
                                                                                                        <?php echo csrf_field(); ?>
                                                                                                        <?php echo method_field('patch'); ?>
                                                                                                        <div class="ti-modal-body">
                                                                                                        <input type='hidden' name='modal_no' class='modal_no' value=<?php echo e(old('modal_no')); ?>/>
                                                                                    ...
                                                                                    <div class="hs-tooltip ti-main-tooltip">
                                                                                        <form action="<?php echo e(route('Teaching.research.funded_project.destroy',$fund->id)); ?>" method="post">
                                                    ...
                                                    <div id="add_consultancy" class="hs-overlay hidden ti-modal">
                                                        <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out lg:!max-w-4xl lg:w-full m-3 md:mx-auto">
                                                            <div class="ti-modal-content">
                                                                ...
                                                                <form  action="<?php echo e(route('Teaching.research.consultancy.store')); ?>" method="post">
                                                                        <?php echo csrf_field(); ?>
                                                            ...
                                                            <tbody class="">
                                                                <?php if($staff->consultancy !=null): ?>
                                                                        ...
                                                                        <tr class="">
                                                                                    ...
                                                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16"><path d="M16.7574 2.99666L14.7574 4.99666H5V18.9967H19V9.2393L21 7.2393V19.9967C21 20.5489 20.5523 20.9967 20 20.9967H4C3.44772 20.9967 3 20.5489 3 19.9967V3.99666C3 3.44438 3.44772 2.99666 4 2.99666H16.7574ZM20.4853 2.09717L21.8995 3.51138L12.7071 12.7038L11.2954 12.7062L11.2929 11.2896L20.4853 2.09717Z"></path></svg>
                                                                                        ...
                                                                                        <div id="consultancy_edit_modal<?php echo e($i); ?>" class="hs-overlay hidden ti-modal">
                                                                                            <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out md:!max-w-2xl md:w-full m-3 md:mx-auto">
                                                                                                ...
                                                                                                <form  action="<?php echo e(route('Teaching.research.consultancy.update',$consult->id)); ?>" method="post">
                                                                                                    <?php echo csrf_field(); ?>
                                                                                                    <?php echo method_field('patch'); ?>
                                                                                                    <div class="ti-modal-body">
                                                                                ...
                                                                                <div class="hs-tooltip ti-main-tooltip">
                                                                                <form action="<?php echo e(route('Teaching.research.consultancy.conducted.destroy',$consult->id)); ?>" method="post">
                                                    ...
                                                    <div id="add_patents" class="hs-overlay hidden ti-modal">
                                                        <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out lg:!max-w-4xl lg:w-full m-3 md:mx-auto">
                                                            <div class="ti-modal-content">
                                                                <div class="ti-modal-header">
                                                                    <h3 class="ti-modal-title">
                                                                        ...
                                                                        <button type="button" class="hs-dropdown-toggle ti-modal-close-btn"
                                                                            ...
                                                                            <?php if(($errors->has('p_appl_no'))||($errors->has('p_appl_date'))||($errors->has('p_title'))||($errors->has('p_status'))||($errors->has('p_patent_no'))||($errors->has('p_publication_no'))||($errors->has('p_publication_date'))): ?>
                                                                                    <script>
                                                                                        //alert(1);
                                                                                        $(window).on('load', function() {
                                                                                            //if($('#horizontal-alignment-item-1').parent().find('.active')){
                                                                ...
                                                                <form  action="<?php echo e(route('Teaching.research.patent.store')); ?>" method="post">
                                                                    <?php echo csrf_field(); ?> 
                                                                    <div class="ti-modal-body">
                                                                        <div class="grid lg:grid-cols-2 gap-2 space-y-2 lg:space-y-0">
                                                                                            ...
                                                                                            <div id="patents_edit_modal<?php echo e($i); ?>" class="hs-overlay hidden ti-modal">
                                                                                                <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out lg:!max-w-4xl lg:w-full m-3 md:mx-auto">
                                                                                                    <div class="ti-modal-content">
                                                                                                        ...
                                                                                                        <form  action="<?php echo e(route('Teaching.research.patent.update',$pate->id)); ?>" method="post">
                                                                                                             <?php echo csrf_field(); ?>
                                                                                                            <?php echo method_field('patch'); ?>
                                                                                                            <div class="ti-modal-body">
                                                    ...
                                                    <div id="add_copyright" class="hs-overlay hidden ti-modal">
                                                        <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out lg:!max-w-4xl lg:w-full m-3 md:mx-auto">
                                                            <div class="ti-modal-content">
                                                                ...
                                                                <form  action="<?php echo e(route('Teaching.research.copyright.store')); ?>" method="post">
                                                                    <?php echo csrf_field(); ?> 
                                                                    <div class="ti-modal-body">
                                                                        <div class="grid lg:grid-cols-2 gap-2 space-y-2 lg:space-y-0">
                                                                                            ...
                                                                                            <div id="copyright_edit_modal<?php echo e($i); ?>" class="hs-overlay hidden ti-modal">
                                                                                                <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out md:!max-w-2xl md:w-full m-3 md:mx-auto">
                                                                                                    <div class="ti-modal-content">
                                                                                                        ...
                                                                                                        <form  action="<?php echo e(route('Teaching.research.copyright.update',$copy->id)); ?>" method="post">
                                                                                                             <?php echo csrf_field(); ?>
                                                                                                            <?php echo method_field('patch'); ?>
                                                                                                            <div class="ti-modal-body">
                                                            ...
                                                            <div class="ti-modal-content">
                                                                <div class="ti-modal-header">
                                                                    ...
                                                                    <button type="button" class="hs-dropdown-toggle ti-modal-close-btn"
                                                                        ...
                                                                        <?php if(($errors->has('ga_award'))||($errors->has('ga_year'))||($errors->has('ga_details'))): ?>
                                                                                    <script>
                                                                                        //alert(1);
                                                                                        $(window).on('load', function() {
                                                                                            //if($('#horizontal-alignment-item-1').parent().find('.active')){
                                                                ...
                                                                <form  action="<?php echo e(route('Teaching.research.general_achievements.store')); ?>" method="post">
                                                                    <?php echo csrf_field(); ?>
                                                                    ...
                                                                    <?php $__empty_1 = true; $__currentLoopData = $staff->general_achievements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $achivement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                                        <tr class="">
                                                                                ...
                                                                                <td class="font-medium space-x-2 rtl:space-x-reverse">
                                                                                            ...
                                                                                            <div id="general_achievements_edit_modal<?php echo e($i); ?>" class="hs-overlay hidden ti-modal">
                                                                                                <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out md:!max-w-2xl md:w-full m-3 md:mx-auto">
                                                                                                    <div class="ti-modal-content">
                                                                                                        ...
                                                                                                        <form  action="<?php echo e(route('Teaching.research.general_achievements.update',$achivement->id)); ?>" method="post">
                                                                                                            <?php echo csrf_field(); ?>
                                                                                                            <?php echo method_field('patch'); ?>
                                                                                                            <div class="ti-modal-body">
                                                                                        ...
                                                                                        <div class="hs-tooltip ti-main-tooltip">
                                                                                            <form action="<?php echo e(route('Teaching.research.general_achievements.destroy',$achivement->id)); ?>" method="post">
                                                    ...
                                                    <div id="add_reviewer_editor" class="hs-overlay hidden ti-modal">
                                                        <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out lg:!max-w-4xl lg:w-full m-3 md:mx-auto">
                                                            <div class="ti-modal-content">
                                                                ...
                                                                <form  action="<?php echo e(route('Teaching.research.reviewer_editor.store')); ?>" method="post">
                                                                    <?php echo csrf_field(); ?> 
                                                                    <div class="ti-modal-body">
                                                                        <div class="grid lg:grid-cols-2 gap-2 space-y-2 lg:space-y-0">
                                                                            <div class="max-w-sm space-y-3 pb-6">
                                                                    ...
                                                                    <?php if($staff->reviewer_editor!=null): ?>
                                                                        <?php $__empty_1 = true; $__currentLoopData = $staff->reviewer_editor; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                                            <tr class="">
                                                                                ...
                                                                                <td>
                                                                                    <span><?php echo e($rc->other_level); ?></span>
                                                                                </td>
                                                                                ...
                                                                                <td><span><?php echo e($rc->publisher_name); ?></span></td>
                                                                                    ...
                                                                                    <td class="font-medium space-x-2 rtl:space-x-reverse">
                                                                                            ...
                                                                                            <div id="reviewer_editor_edit_modal<?php echo e($i); ?>" class="hs-overlay hidden ti-modal">
                                                                                                <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out lg:!max-w-4xl lg:w-full m-3 md:mx-auto">
                                                                                                    <div class="ti-modal-content">
                                                                                                        ...
                                                                                                        <form action="<?php echo e(route('Teaching.research.reviewer_editor.update',$rc->id)); ?>" method="post">
                                                                                                            <?php echo csrf_field(); ?>
                                                                                                            <?php echo method_field('patch'); ?>
                                                                                                            <div class="ti-modal-body">
                                                                                        ...
                                                                                        <div class="hs-tooltip ti-main-tooltip">
                                                                                            <form action="<?php echo e(route('Teaching.research.reviewer_editor.destroy',$rc->id)); ?>" method="post">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.components.staff.master-teaching', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\laravel Apps\gitoffice\resources\views/Staff/Teaching/research.blade.php ENDPATH**/ ?>