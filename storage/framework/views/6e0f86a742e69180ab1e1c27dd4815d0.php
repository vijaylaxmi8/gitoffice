                                        ...
                                        <div class="flex items-center">
                                            ...
                                            <div class="ltr:ml-3 rtl:mr-3">
                                                <label for="remember-me" class="text-sm dark:text-white">I accept the <a
                                                        ...
                                                        href="terms.php">Terms and Conditions</a></label>
                                            </div>
                                        </div>
                                        <!-- End Checkbox -->
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.custom-app2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\projects\laravel\vite\synto\synto\resources\views/pages/signup-cover.blade.php ENDPATH**/ ?>