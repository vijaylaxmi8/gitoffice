                ...
                <div class="content">
                    ...
                    <div class="main-content">
                        ...
                        <div class="block justify-between page-header sm:flex">
                            <div>
                                <h3 class="text-gray-700 hover:text-gray-900 dark:text-white dark:hover:text-white text-2xl font-medium">Welcome<span class="text-primary"> {{$staff[0]->fname.' '.$staff[0]->mname.' '.$staff[0]->lname}}</span></h3>
                            </div>
                                        ...
                                        <table class="ti-custom-table ti-custom-table-head whitespace-nowrap">
                                            ...
                                            <tbody>
                                                @php
                                                    $i=1;
                                                @endphp
                                                @foreach ($staff[0]->departments as $dept)
