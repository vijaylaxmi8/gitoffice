                                                                    ...
                                                                    @if($staff->publications!=null)
                                                                        @forelse($staff->publications as $pub)
                                                                            ...
                                                                            <tr style="@if($pub->validation_status =='invalid') background-color: #ffcccc; @elseif($pub->validation_status =='updated') background-color: #fff2cc; @elseif($pub->validation_status =='valid') background-color: #ccffcc; @endif">
                                                                                ...
                                                                                <td><span>{{$pub->publication_type}}</span></td>
                                                                                                ...
                                                                                                <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out lg:!max-w-4xl lg:w-full m-3 md:mx-auto">
                                                                                                    <div class="ti-modal-content">
                                                                                                        <div class="ti-modal-header">
                                                                                                            ...
                                                                                                            @if((($errors->has('e_level'))||($errors->has('e_other_level'))||($errors->has('e_title'))||($errors->has('e_date'))||($errors->has('e_journal'))||($errors->has('e_publication_type'))||($errors->has('e_link'))||($errors->has('e_role'))||($errors->has('e_doi_number'))||($errors->has('document'))))
                                                                                                                <script>
                                                                                                        ...
                                                                                                        <form action="{{route('Teaching.research.publications.update',$pub->id)}}" enctype="multipart/form-data" method="post">
                                                                                                            ...
                                                                                                            <div class="ti-modal-body">
                                                                                                                ...
                                                                                                                <div class="grid lg:grid-cols-2 gap-2 space-y-2 lg:space-y-0">
                                                                                                                    ...
                                                                                                                    <div class="max-w-sm space-y-3 pb-6" id="pub_other_level" >
                                                                                                                        <label for="" class="ti-form-label font-bold">Other Level:</label>
                                                                                                                        <input type="text" name="e_other_level" class="ti-form-input" placeholder="Other Level" value="{{$pub->other_level}}">
                                                                                                                        @if($errors->has('other_level'))
                                                                                                                            <div class="text-red-700">{{ $errors->first('other_level') }}</div>
                                                                                                                        @endif
                                                                                                                        <div id="pub_other_levelError" class="error text-red-700"></div>
                                                                                                                ...
                                                                                                                <div class="grid lg:grid-cols-2 gap-2 space-y-2 lg:space-y-0">
                                                                                                                    ...
                                                                                                                    <div class="max-w-sm space-y-3 pb-6">
                                                                                                                        ...
                                                                                                                        <select class="ti-form-select role" name="e_role">
                                                                                                                            ...
                                                                                                                            <option value="Corresponding-Author" {{$pub->role=='Corresponding-Author'?'selected':''}}>Corresponding-Author</option>
