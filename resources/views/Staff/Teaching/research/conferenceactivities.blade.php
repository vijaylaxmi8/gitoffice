                                                ...
                                                <div id="add_conference_activity_attended" class="hs-overlay hidden ti-modal">
                                                    <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out lg:!max-w-4xl lg:w-full m-3 md:mx-auto">
                                                        <div class="ti-modal-content">
                                                            ...
                                                            <form action="{{route('Teaching.research.conferenceactivities.attended.store')}}" method="post" enctype="multipart/form-data">
                                                                @csrf
                                                                ...
                                                                @forelse($staff->conferences_attendee as $act)
                                                                    ...
                                                                    <tr style="@if($act->validation_status =='invalid') background-color: #ffcccc; @elseif($act->validation_status =='updated') background-color: #fff2cc; @elseif($act->validation_status =='valid') background-color: #ccffcc; @endif">
                                                                        ...
                                                                        <td class="font-medium space-x-2 rtl:space-x-reverse">
                                                                                ...
                                                                                <div id="conference_attended_edit_modal{{$i}}" class="hs-overlay hidden ti-modal">
                                                                                    <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out lg:!max-w-4xl lg:w-full m-3 md:mx-auto">
                                                                                        <div class="ti-modal-content">
                                                                                            ...
                                                                                            <form  action="{{route('Teaching.research.conferenceactivities.attended.update',$act->id)}}" enctype="multipart/form-data" method="post">
                                                                                                @csrf
                                                                                                @method('patch')
                                                                                                <div class="ti-modal-body">
                                                                                                    ...
                                                                                                    <div class="grid lg:grid-cols-2 gap-1 space-y-2 lg:space-y-0">
                                                                                                        ...
                                                                                                        <div class="max-w-sm space-y-3 pb-6">
                                                                                                            ...
                                                                                                            <select  class="ti-form-input" name="edit_attended_as" required>
                                                                                                                ...
                                                                                                                <option value="Session Chair" {{$act->attended_as=='Session Chair'? 'selected':''}}>Session Chair</option>
                                                                            ...
                                                                            <div class="hs-tooltip ti-main-tooltip">
                                                                            <form action="{{ route('Teaching.research.conferenceactivities.attended.destroy',$act->id) }}" method="post">
                                                ...
                                                <div id="add_conference_activity_conducted" class="hs-overlay hidden ti-modal">
                                                    <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out lg:!max-w-4xl lg:w-full m-3 md:mx-auto">
                                                        <div class="ti-modal-content">
                                                            ...
                                                            <form action="{{route('Teaching.research.conferenceactivities.conducted.store')}}" method="post" enctype="multipart/form-data">
                                                                @csrf
                                                                <div class="ti-modal-body">
                                                                    <div class="grid lg:grid-cols-2 gap-2 space-y-2 lg:space-y-0">
                                                                        <div class="max-w-sm space-y-3 pb-6">
                                                        ...
                                                        <tbody class="">
                                                            @if($staff->conferences_conducted !=null)
                                                                ...
                                                                <tr style="@if($con->validation_status =='invalid') background-color: #ffcccc; @elseif($con->validation_status =='updated') background-color: #fff2cc; @elseif($con->validation_status =='valid') background-color: #ccffcc; @endif">
                                                                    ...
                                                                    <td>
                                                                        <span>
                                                                            {{ $con->sponsored == 'No' ? '--NA--' : $con->sponsoring_agency }}
                                                                        </span>
                                                                    </td>
                                                                    ...
                                                                    <td class="font-medium space-x-2 rtl:space-x-reverse">
                                                                        ...
                                                                        <!--Modal Ends Here-->
                                                                        <div class="hs-tooltip ti-main-tooltip">
                                                                            <a  href="{{ Storage::url('Uploads/Research/Conference_Conducted/' . $con->document) }}" class="m-0 hs-tooltip-toggle relative w-8 h-8 ti-btn rounded-full p-0 transition-none focus:outline-none ti-btn-soft-primary" target="_blank" {{$con->document}}>
                                                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16"><path d="M12.0003 3C17.3924 3 21.8784 6.87976 22.8189 12C21.8784 17.1202 17.3924 21 12.0003 21C6.60812 21 2.12215 17.1202 1.18164 12C2.12215 6.87976 6.60812 3 12.0003 3ZM12.0003 19C16.2359 19 19.8603 16.052 20.7777 12C19.8603 7.94803 16.2359 5 12.0003 5C7.7646 5 4.14022 7.94803 3.22278 12C4.14022 16.052 7.7646 19 12.0003 19ZM12.0003 16.5C9.51498 16.5 7.50026 14.4853 7.50026 12C7.50026 9.51472 9.51498 7.5 12.0003 7.5C14.4855 7.5 16.5003 9.51472 16.5003 12C16.5003 14.4853 14.4855 16.5 12.0003 16.5ZM12.0003 14.5C13.381 14.5 14.5003 13.3807 14.5003 12C14.5003 10.6193 13.381 9.5 12.0003 9.5C10.6196 9.5 9.50026 10.6193 9.50026 12C9.50026 13.3807 10.6196 14.5 12.0003 14.5Z"></path></svg>
                                                                                <span class="hs-tooltip-content ti-main-tooltip-content py-1 px-2 bg-gray-900 text-xs font-medium text-white shadow-sm" role="tooltip">
                                                                                View Document
                                                                                </span>
                                                                        ...
                                                                        <div class="hs-tooltip ti-main-tooltip">
                                                                            <form action="{{ route('Teaching.research.conferenceactivities.conducted.destroy',$con->id) }}" method="post">
