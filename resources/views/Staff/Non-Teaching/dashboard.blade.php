                    ...
                    <div class="content">
                        ...
                        <div class="main-content">
                            ...
                            <div class="block justify-between page-header sm:flex">
                                <div>
                                    <h3 class="text-gray-700 hover:text-gray-900 dark:text-white dark:hover:text-white text-2xl font-medium">Welcome <span class="text-primary">{{$staff->fname.' '.$staff->mname.' '.$staff->lname}}</h3>
                                </div>
                                ...
                                <div class="col-span-12 md:col-span-6 xxl:col-span-3">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <a class="flex  items-center font-semibold text-primary hover:text-primary dark:text-primary truncate" href="{{route('Non-Teaching.departments')}}">
                                                 view
                                            </a>
                                        </div>
                                        </div>
                                ...
                                <div class="col-span-12 md:col-span-6 xxl:col-span-3">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <a class="flex  items-center font-semibold text-primary hover:text-primary dark:text-primary truncate" href="{{route('Non-Teaching.associations')}}">
                                                 view
                                            </a>
                                        </div>
                                        </div>
                                                ...
                                                <div class="flex-1">
                                                    ...
                                                    <div class="flex justify-between items-center">
                                                        <div class="flex flex-col">
                                                            <h5 class="mb-0 text-2xl font-semibold text-gray-800 dark:text-white">{{$ntactivityattendedCount}}</h5>
                                                            <a class="flex items-center font-semibold text-primary hover:text-primary dark:text-primary truncate" href="{{route('Non-Teaching.professionalactivities')}}">
                                                             Attended
                                                            </a>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="box-body">
                                            <div class="flex">
                                                ...
                                                <div class="flex-1">
                                                    ...
                                                    <div class="flex justify-between items-center">
                                                        <div class="flex flex-col">
                                                            <h5 class="mb-0 text-2xl font-semibold text-gray-800 dark:text-white">{{$ntactivityconductedCount}}</h5>
                                                            <a class="flex items-center font-semibold text-primary hover:text-primary dark:text-primary truncate" href="{{route('Non-Teaching.professionalactivities')}}">
                                                             Conducted
                                                            </a>
                                                        </div>
                                ...
                                <div class="col-span-12 md:col-span-6 xxl:col-span-3">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            {{-- <a class="flex  items-center font-semibold text-primary hover:text-primary dark:text-primary truncate" href="{{route('Teaching.research')}}"> --}}
