                                                                        ...
                                                                        @csrf
                                                                            <div class="grid lg:grid-cols-3 gap-3 space-y-2 lg:space-y-0 pb-4">
                                                                                <div class="space-y-2 ">
                                                                                    ...
                                                                                    @if($errors->has('fname'))
                                                                                        <div class="text-red-700">{{ $errors->first('fname')}}</div>
                                                                                    @endif
                                                                                ...
                                                                                <div class="space-y-2">
                                                                                    ...
                                                                                    <input type="text" id="mname" name="mname" class="my-auto ti-form-input stmname"  placeholder="Middle Name">
                                                                                     @if($errors->has('mname'))
                                                                                        <div class="text-red-700">{{ $errors->first('mname')}}</div>
                                                                                    @endif
                                                                                ...
                                                                                <div class="space-y-2">
                                                                                    ...
                                                                                    @if($errors->has('lname'))
                                                                                        <div class="text-red-700">{{ $errors->first('lname')}}</div>
                                                                                    @endif
                                                                            ...
                                                                            <div class="grid lg:grid-cols-3 gap-3 space-y-2 lg:space-y-0 pb-4">
                                                                                ...
                                                                                <label class="ti-form-label mb-0 font-bold">Employee Type<span class="text-red-500">*</span></label>
                                                                                    ...
                                                                                    @if($errors->has('employee_type'))
                                                                                        <div class="text-red-700">{{ $errors->first('employee_type')}}</div>
                                                                                    @endif
