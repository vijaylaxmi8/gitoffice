                                                ...
                                                <div class=" block ltr:ml-auto rtl:mr-auto my-auto">
                                                    ...
                                                    <div id="hs-medium-modal" class="hs-overlay hidden ti-modal">
                                                        <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out lg:!max-w-4xl lg:w-full m-3 lg:mx-auto">
                                                            ...
                                                            <form  action="{{route('ESTB.leaves.store')}}" method="post">
                                                                @csrf
                                                            ...
                                                            <tr class="{{$lr->status =='active'?'':'bg-gray-200'}}">
                                                                ...
                                                                <td class="font-medium space-x-2 rtl:space-x-reverse">
                                                                    <div class="hs-tooltip ti-main-tooltip">
                                                                        <a href="{{route('ESTB.leave.leave_rules',$lr->id)}}"
                                                                                ...
                                                                                <div id="leave_rule_edit_modal{{$i}}" class="hs-overlay hidden ti-modal">
                                                                                    <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out lg:!max-w-4xl lg:w-full m-3 md:mx-auto">
                                                                                        ...
                                                                                        <div class="ti-modal-header">
                                                                                            <h3 class="ti-modal-title">
                                                                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16"><path d="M16.7574 2.99666L14.7574 4.99666H5V18.9967H19V9.2393L21 7.2393V19.9967C21 20.5489 20.5523 20.9967 20 20.9967H4C3.44772 20.9967 3 20.5489 3 19.9967V3.99666C3 3.44438 3.44772 2.99666 4 2.99666H16.7574ZM20.4853 2.09717L21.8995 3.51138L12.7071 12.7038L11.2954 12.7062L11.2929 11.2896L20.4853 2.09717Z"></path></svg>
                                                                                                Edit Leave Rule <b>{{$lr->longname.'['.$lr->vacation_type.']'}}</b>
                                                                                            </h3>
                                                                                            <button type="button" class="hs-dropdown-toggle ti-modal-close-btn"
                                                                                        ...
                                                                                        <form  action="{{route('ESTB.leaves.update',$lr->id)}}" method="post">
                                                                                            @csrf
                                                                                            @method('patch')
                                                                                            <div class="ti-modal-body">
                                                                                                <div class="grid lg:grid-cols-3 gap-2 space-y-2 lg:space-y-0">
                                                                                                    <div class="max-w-sm space-y-3 pb-6">
                                                                                                        ...
                                                                                                        <input type="text" name="longname" class="ti-form-input"  placeholder="Long name" value="{{$lr->longname}}">
                                                                                                    </div>
                                                                                                    <div class="max-w-sm space-y-3 pb-6">
                                                                                                        <label for="" class="ti-form-label">Short Name : </label>
                                                                                                        <input type="text" name="shortname" class="ti-form-input"  placeholder="Short name" value="{{$lr->shortname}}">
                                                                                                    </div>
                                                                                                    <div class="max-w-sm space-y-3 pb-6">
                                                                                                        <label for="with-corner-hint" class="ti-form-label font-bold">Applicable for (vacation_type)?</label>
                                                                                                        <input type="radio" name="vacation_type" class="pr-4 ml-2 ti-form-radio year1" value="Vacational"  {{($lr->vacation_type =="Vacational") ?'checked':''}}>
                                                                                                        <label for="year1" class="text-sm text-gray-500 ltr:ml-2 rtl:mr-2 dark:text-white/70"> Vacational</label>
                                                                                                        <input type="radio" name="vacation_type" class="pr-4 ml-2 ti-form-radio year2" value="Non-vacational"  {{($lr->vacation_type =="Non-vacational")?'checked':''}}>
                                                                                                        <label for="year2" class="text-sm text-gray-500 ltr:ml-2 rtl:mr-2 dark:text-white/70"> Non-vacational</label>
                                                                                                    </div>
                                                                                                </div>
                                                                                                <div class="grid lg:grid-cols-3 gap-2 space-y-2 lg:space-y-0">    
                                                                                                    ...
                                                                                                    <div class="max-w-sm space-y-3 pb-6 ">
                                                                                                        <label for="" class="ti-form-label font-bold">Maximum Entitlement: </label>
                                                                                                        <input type="text" name="max_entitlement" class="ti-form-input"  placeholder="Maximum Entitlement" value="{{$lr->max_entitlement}}">
                                                                                                    </div>
                                                                                                    <div class="max-w-sm space-y-3 pb-6">
                                                                                                        <label for="" class="ti-form-label">Min: </label>
                                                                                                        <input type="text" name="min_days" class="ti-form-input"  placeholder="Min Availment" value="{{$lr->min_days}}">
                                                                                                    </div>
                                                                                                    <div class="max-w-sm space-y-3 pb-6">
                                                                                                        <label for="" class="ti-form-label font-bold">Max : </label>
                                                                                                        <input type="text" name="max_days" class="ti-form-input"  placeholder="Max Availment" value="{{$lr->max_days}}">
                                                                                                    </div>
                                                                                                </div>
                                                                                                ...
                                                                                                <div class="grid lg:grid-cols-3 gap-2 space-y-2 lg:space-y-0">    
                                                                                                    <div class="space-y-2">
                                                                                                        ...
                                                                                                        <input type="date" name="leave_wef" class="ti-form-input flatpickr-input date"
                                                                                                            placeholder="Choose date" value="{{$lr->leave_wef}}">
                                                                                                    </div>
                                                                                                    <div class="max-w-sm space-y-3 pb-6">
                                                                                                        <label for="with-corner-hint" class="ti-form-label font-bold">Applicable for (Employee Type)?</label>
                                                                                                        <input type="radio" name="applicable_to" class="pr-4 ml-2 ti-form-radio year1" value="confirmed" {{$lr->applicable_to=='confirmed'?'checked':''}}>
                                                                                                        <label for="year1" class="text-sm text-gray-500 ltr:ml-2 rtl:mr-2 dark:text-white/70"> Confirmed</label>
                                                                                                        <input type="radio" name="applicable_to" class="pr-4 ml-2 ti-form-radio year2" value="all" {{$lr->applicable_to=='all'?'checked':''}} >
                                                                                                        <label for="year2" class="text-sm text-gray-500 ltr:ml-2 rtl:mr-2 dark:text-white/70"> All</label>
                                                                                                    </div>
                                                                                                    <div class="space-y-2">
                                                                                                        ...
                                                                                                        <input type="date" name="leave_end_date" class="ti-form-input flatpickr-input date"
                                                                                                            placeholder="Choose date" value="{{$lr->leave_end_date}}">
                                                                                                    </div>
                                                                                
                                                                                                </div>
                                                                                                @if($lr->status == 'inactive')
                                                                                                <br/>
                                                                                                    <div class="flex">
                                                                    ...
                                                                    @if($lr->status=='active')
                                                                        <div class="hs-tooltip ti-main-tooltip">
                                                                        <form action="{{ route('ESTB.leaves.destroy',$lr->id)}}" method="post">
