                    ...
                    <div class="main-content">
                            ...
                            <div class="block justify-between page-header sm:flex">
                                ...
                                <ol class="flex items-center whitespace-nowrap min-w-0">
                                    <li class="text-sm">
                                    <a class="flex items-center font-semibold text-primary hover:text-primary dark:text-primary truncate" href="{{route('ESTB.leaves.index')}}">
                                        ...
                                        <div class="box-header">
                                            <div class="flex">
                                                <h5 class="box-title my-auto">
                                                    ...
                                                    Leave Rules <b style="color:red;font-size:18px">{{$leaves->longname.' for '.$leaves->vacation_type.' staff'}} </b>
                                                </h5>
                                                            ...
                                                            <div class="ti-modal-content">
                                                                <div class="ti-modal-header">
                                                                    <h3 class="ti-modal-title">
                                                                        ...
                                                                        Add New Leave Rule <b style="color:red;font-size:18px">{{$leaves->longname.' for '.$leaves->vacation_type.' staff'}} </b>
                                                                    </h3>
                                                                ...
                                                                <form  action="{{route('ESTB.leave.leave_rules.store',$leaves->id)}}" method="post"> 
                                                                    @csrf
                                                                    <div class="ti-modal-body">
                                                                        ...
                                                                        @foreach($allleaves as $l) <!--For running the leave list-->
                                                                            @if($l->vacation_type == $leaves->vacation_type && $l->id!=$leaves->id && $l->status=='active')
                                                                                @php
                                                                                    $checked="";
                                                                                ...
                                                                                <div class="flex">
                                                                                    <div class="max-w-sm space-y-3 pb-6 ">
                                                                                        <div class="max-w-sm pb-2">
                                                                                            ...
                                                                                            <input type="checkbox" name="leavetype[]" class="pr-4 pb-4 Leave_type"  {{$checked}} value="{{$l->id}}"> {{$l->longname}} {{$wef}}
                                                                        ...
                                                                        @endforeach
                                                                        <div class="max-w-sm space-y-3 pb-6 ">
                                                                            <label class="ti-form-label mb-0 font-bold">With Effect From {{$wef}}</label>
                                                                            <input type="text" name="com_wef" class="ti-form-input flatpickr-input date"  placeholder="Choose date" value="{{$wef}}">
                                                                        </div>
                                                                    </div>
                                            ...
                                            <div class="table-bordered  rounded-sm ti-custom-table-head overflow-auto">
                                                <table id="leave_rule_table" class="ti-custom-table ti-custom-table-head whitespace-nowrap">
                                                    ...
                                                    <tbody class="">
                                                        ...
                                                        @endphp
                                                        @if($leaves!=null)
                                                            @forelse($leaves->leave_rules as $lr)
                                                    
                                                                <tr class="{{$lr->status =='active'?'':'bg-gray-200 border-white'}} ">
                                                                    <td class="{{$lr->status =='active'?'':'border-black'}}" rowspan="5">{{ $i++}}</td>
                                                                    <td class="{{$lr->status =='active'?'':'border-black'}}"> Carry Forwardable </td>
                                                                    <td><span>{{$lr->carry_forwardable}}</span></td>
                                                                    
                                                                    <td><span>{{$lr->cf_wef}}</span></td>
                                                                    <td><span>{{$lr->cf_gcr}}</span></td>
                                                                    <td><span>{{$lr->cf_closing_date}}</span></td>
                                                                    <td><span>{{$lr->cf_closing_gcr}}</span></td>
                                                                    <td><span>{{$lr->max_cf}}</span></td>
                                                                    <td rowspan="5" ><span>
                                                                        @if($lr->status=='active')
                                                                            <div class=" block ltr:ml-auto rtl:mr-auto my-auto">
                                                                                        ...
                                                                                        <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out lg:!max-w-4xl lg:w-full m-3 lg:mx-auto ">
                                                                                            ...
                                                                                            <div class="ti-modal-content">
                                                                                                <div class="ti-modal-header">
                                                                                                    <h3 class="ti-modal-title">
                                                                                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16"><path d="M16.7574 2.99666L14.7574 4.99666H5V18.9967H19V9.2393L21 7.2393V19.9967C21 20.5489 20.5523 20.9967 20 20.9967H4C3.44772 20.9967 3 20.5489 3 19.9967V3.99666C3 3.44438 3.44772 2.99666 4 2.99666H16.7574ZM20.4853 2.09717L21.8995 3.51138L12.7071 12.7038L11.2954 12.7062L11.2929 11.2896L20.4853 2.09717Z"></path></svg>
                                                                                                            Edit Leave Rule <b style="color:red;font-size:18px">{{$leaves->longname.' for '.$leaves->vacation_type.' staff'}} </b>
                                                                                                    </h3>
                                                                                                    <button type="button" class="hs-dropdown-toggle ti-modal-close-btn"
                                                                                                ...
                                                                                                <form  action="{{route('ESTB.leave.leave_rules.update',[$leaves->id,$lr->id])}}" method="post">
                                                                                                    @csrf
                                                                                                    @method('patch')
                                                                                                    <div class="ti-modal-body">
                                                                                                        <div class="grid lg:grid-cols-4 gap-2 space-y-2 lg:space-y-0">    
                                                                                                            <div class="grid-rows-2">
                                                                                                                <label for="" class="ti-form-label font-bold pr-4 ">Is Carry Forwardable?</label>
                                                                                                                <input type="radio" name="carry_forwardable" class="ti-form-radio year1" value="Yes" {{$lr->carry_forwardable =='Yes'?'checked':''}}>
                                                                                                                <label for="carry_forwardable-yes" class="text-sm text-gray-500 ltr:ml-2 rtl:mr-2 dark:text-white/70 pr-4"> Yes</label>
                                                                                                                <input type="radio" name="carry_forwardable" class="ti-form-radio year2" value="No" {{$lr->carry_forwardable =='No'?'checked':''}} >
                                                                                                                <label for="carry_forwardable-no" class="text-sm text-gray-500 ltr:ml-2 rtl:mr-2 dark:text-white/70"> No</label>
                                                                                                            </div>
                                                                                                        ...
                                                                                                        <div class="grid lg:grid-cols-4 gap-2 space-y-2 lg:space-y-0">    
                                                                                                            <div class="grid-rows-2">
                                                                                                                ...
                                                                                                                <input type="radio" name="encashable" class="pr-2 ml-2 ti-form-radio year1" value="Yes" {{$lr->encashable =='Yes'?'checked':''}}>
                                                                                                                <label class="text-sm text-gray-500 ltr:ml-3 rtl:ml-3 dark:text-white/70 font-bold">Yes</label>
                                                                                                            
                                                                                                                <input type="radio" name="encashable" class="pr-2 ml-3 ti-form-radio year2" value="No" {{$lr->encashable =='No'?'checked':''}}>
                                                                                                                <label class="text-sm text-gray-500 ltr:ml-3 rtl:mr-3 dark:text-white/70 font-bold pr-4">No</label>
                                                                                                        ...
                                                                                                        <div class="grid lg:grid-cols-4 gap-2 space-y-2 lg:space-y-0 ">    
                                                                                                            ...
                                                                                                            <div> 
                                                                                                                    <input type="radio" name="gap" class="pr-2 ml-2 ti-form-radio gap" value="Yes" {{$lr->gap =='Yes'?'checked':''}}>
                                                                                                                    <label class="text-sm text-gray-500 ltr:ml-3 rtl:ml-3 dark:text-white/70 font-bold">Yes</label>
                                                                                                                
                                                                                                                
                                                                                                                    <input type="radio" name="gap" class="pr-2 ml-3 ti-form-radio gap" value="No" {{$lr->gap =='No'?'checked':''}}>
                                                                                                                    <label class="text-sm text-gray-500 ltr:ml-3 rtl:mr-3 dark:text-white/70 font-bold pr-4">No</label>
                                                                                                                </div>
                                                                                                            </div>
                                                                                                            <div class="space-y-2 pb-6">
                                                                                                        ...
                                                                                                        <div class="grid lg:grid-cols-2 gap-2 pb-4 space-y-2 lg:space-y-0">    
                                                                                                            <div class="space-y-2  pb-4 ">
                                                                                                                <label class="ti-form-label mb-0 font-bold">Maximum times this leave can be availed </label>
                                                                                                                <input type="text" name="max_time_allowed" class="ti-form-input flatpickr-input pb-4"
                                                                                                                    placeholder="Maximum times the leave can be taken" value="{{$lr->max_time_allowed}}">
                                                                                                            </div>
                                                                                                            <div class="space-y-2  pb-4 ">
                                                                                                                <label class="ti-form-label mb-0 font-bold">Period in which Maximum times this leave can be availed</label>
                                                                                                                <select class="ti-form-select" name="period">
                                                                                                        ...
                                                                                                        @foreach($allleaves as $l) <!--For running the leave list-->
                                                                                                            @if($l->vacation_type == $leaves->vacation_type && $l->id!=$leaves->id && $l->status=='active')
                                                                                                                ...
                                                                                                                @endphp
                                                                                                                @if($leaves->combine_leave !=null)
                                                                                                                    @foreach($leaves->combine_leave as $l_combination)
                                                                                                                        <!--To make checkboxes to be checked when the value available in DB for Leave Type-->

                                                                                                                        @if($l_combination->pivot->combined_id ==$l->id && $l_combination->pivot->status=='active')
                                                                                                                            @php
                                                                                                                                $checked="checked";
                                                                                                                                $combination_type_checked=$l_combination->pivot->sandwitchable;
                                                                                                                                $wef=$l_combination->pivot->wef;
                                                                                ...
                                                                                <div class="hs-tooltip ti-main-tooltip">
                                                                                    <form action="{{ route('ESTB.leave.leave_rules.destroy',[$leaves->id,$lr->id])}}" method="post">
                                                                ...
                                                                <tr class="{{$lr->status =='active'?'':'bg-gray-200'}}">
                                                                    ...
                                                                    <td><span>{{$lr->enc_closing_date}}</span></td>
                                                                    <td><span>{{$lr->enc_closing_gcr}}</span></td>
                                                                    
                                                                    <td><span>{{$lr->max_enc}}</span></td>
                                                                </tr>
                                                                <tr class="{{$lr->status =='active'?'':'bg-gray-200'}}">
                                                                    <td> Gap between two <br/>consecutive similar leaves</td>
                                                                    <td><span>{{$lr->gap}}</span></td>
                                                                    
                                                                    <td><span>{{$lr->gap_wef}}</span></td>
                                                                    <td><span>{{$lr->gap_gcr}}</span></td>
                                                                    <td><span>{{$lr->gap_closing_date}}</span></td>
                                                                    <td><span>{{$lr->gap_closing_gcr}}</span></td>
                                                                    
                                                                    <td><span>{{$lr->min_gap}}</span></td>
                                                                </tr>
                                                                <tr class="{{$lr->status =='active'?'':'bg-gray-200'}}">
                                                                    ...
                                                                    <td></td>
                                                                    <td></td>
                                                                    <td><span>{{$lr->max_time_allowed}}</span></td>
                                                                </tr>
                                                                <tr class="{{$lr->status =='active'?'':'bg-gray-200'}}">
                                                                    ...
                                                                    <td></td>
                                                                    <td></td>
                                                                    <td><span>{{$lr->prior_intimation_days}}</span></td>
                                                                </tr>
                                                            @empty
                                                            @endforelse
                                                        @endif
                                ...
                                <div class="box">
                                    <div class="box-header">
                                        <div class="flex">
                                            <h5 class="box-title my-auto">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="32" height="32"><path d="M22 21H2V19H3V4C3 3.44772 3.44772 3 4 3H18C18.5523 3 19 3.44772 19 4V9H21V19H22V21ZM17 19H19V11H13V19H15V13H17V19ZM17 9V5H5V19H11V9H17ZM7 11H9V13H7V11ZM7 15H9V17H7V15ZM7 7H9V9H7V7Z"></path></svg> 
                                                Leave Combinations Rules <b style="color:red;font-size:18px">{{$leaves->longname.' for '.$leaves->vacation_type.' staff'}} </b>
                                            </h5>
                                        </div>
                                    </div>
                                    <div class="box-body">
                                            ...
                                            <table id="combinationleavetable" class="ti-custom-table ti-custom-table-head whitespace-nowrap ">
                                                ...
                                                <tbody class="">
                                                    ...
                                                    @php
                                                        $i = 1;
                                                    @endphp
                                                    @foreach($leaves->latest_combine_leave as $l_combination)
                                                        <tr class="{{$l_combination->status =='active'?'':'bg-gray-200 border-white'}} ">
                                                            <td>
                                                                {{$i++}}
                                                            </td>
                                                            <td>
                                                                {{$l_combination->longname}}
                                                            </td>
                                                            <td>
                                                                {{$l_combination->pivot->sandwitchable}}
                                                            </td>
                                                            <td>
                                                                {{$l_combination->pivot->wef}}
                                                            </td>
                                                            <td>
                                                                {{$l_combination->pivot->closing_wef}}
                                                            </td>    
                                                            <td>{{$l_combination->pivot->status}}</td>
                                                            <td ><span>
                                                                @if($l_combination->pivot->status=='active')
                                                                    <div class=" block ltr:ml-auto rtl:mr-auto my-auto">
                                                                        <div class="hs-tooltip ti-main-tooltip">
                                                                            <button data-hs-overlay="#leave_rule_edit_modal{{$i}}"
                                                                                class="hs-dropdown-toggle  m-0 hs-tooltip-toggle relative w-8 h-8 ti-btn rounded-full p-0 transition-none focus:outline-none ti-btn-soft-secondary">
