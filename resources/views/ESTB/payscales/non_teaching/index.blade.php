                                ...
                                <div class="col-span-12">
                                                ...
                                                <div id="hs-medium-modal" class="hs-overlay hidden ti-modal">
                                                    <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out lg:!max-w-4xl lg:w-full m-3 md:mx-auto">
                                                        ...
                                                        <div class="ti-modal-header">
                                                           ...
                                                           @if(($errors->has('title'))||($errors->has('payband'))||($errors->has('wef'))||($errors->has('gcr')))
                                                                <script>
                                                                    //alert(1);
                                                            ...
                                                            <div class="ti-modal-body">
                                                                <div class="grid lg:grid-cols-2 gap-2 space-y-2 lg:space-y-0">
                                                                    ...
                                                                    <div class="max-w-sm space-y-3 mb-6">
                                                                        ...
                                                                        @if($errors->has('payband'))
                                                                            <div class="text-red-700">{{ $errors->first('payband')}}</div>
                                                                        @endif
                                                                ...
                                                                <div class="space-y-2">
                                                                    ...
                                                                    <div class="flex">
                                                                        ...
                                                                        <input type="checkbox" id="ntdesignation" name="ntdesign[]"  value="{{$des->id}}" class="ti-form-checkbox mt-0.5" id="hs-checkbox-group-1" >
                                        ...
                                        <div class="table-bordered rounded-sm ti-custom-table-head overflow-auto table-auto" id="basic-table">
                                            <table id="ntpayscale-table" class="ti-custom-table ti-custom-table-head whitespace-nowrap" >
                                                ...
                                                <tr class="">
                                                  ...
                                                  <td> 
                                                    @foreach ($ntp->designations as $designs)
                                                    
                                                        @if($designs->pivot->status=='active')
                                                        {{$designs->design_name}}/
                                                        @endif
                                                    ...
                                                    <td><span>{{$ntp->designations[0]->pivot->gcr}}</span></td>
                                                    <td><span>{{($ntp->closedon=='NULL')?'Not Closed': $ntp->closedon}}</span></td>
                                                    <td><span>{{$ntp->status}}</span></td>
                                                                                             
                                                    <td class="font-medium space-x-2 rtl:space-x-reverse">
                                                    <div class="hs-tooltip ti-main-tooltip">
                                                        <button data-hs-overlay="#nt_kls_payscale_edit_modal{{$i}}" id="btn{{$i}}" btn-val={{$i}}
                                                        ...
                                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16"><path d="M16.7574 2.99666L14.7574 4.99666H5V18.9967H19V9.2393L21 7.2393V19.9967C21 20.5489 20.5523 20.9967 20 20.9967H4C3.44772 20.9967 3 20.5489 3 19.9967V3.99666C3 3.44438 3.44772 2.99666 4 2.99666H16.7574ZM20.4853 2.09717L21.8995 3.51138L12.7071 12.7038L11.2954 12.7062L11.2929 11.2896L20.4853 2.09717Z"></path></svg>
                                                            ...
                                                            <div id="nt_kls_payscale_edit_modal{{$i}}" class="hs-overlay hidden ti-modal">
                                                                <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out lg:!max-w-4xl lg:w-full m-3 md:mx-auto">
                                                                    <div class="ti-modal-content">
                                                                        <div class="ti-modal-header">
                                                                            <h3 class="ti-modal-title">
                                                                            ...
                                                                            <button type="button" class="hs-dropdown-toggle ti-modal-close-btn"
                                                                            data-hs-overlay="#nt_kls_payscale_edit_modal{{$i}}">
                                                                            <span class="sr-only">Close</span>
                                                                            <svg class="w-3.5 h-3.5" width="8" height="8" viewBox="0 0 8 8" fill="none"
                                                                                xmlns="http://www.w3.org/2000/svg">
                                                                                <path
                                                                        ...
                                                                        <div class="ti-modal-body">
                                                                            ...
                                                                            <div class="grid lg:grid-cols-2 gap-2 space-y-2 lg:space-y-0">
                                                                                ...
                                                                                <div class="max-w-sm space-y-3 mb-6">
                                                                                    ...
                                                                                    <input type="text" name="gcr" class="ti-form-input" placeholder="GC Resolution No" value="{{$ntp->gcr}}">
                                                                                </div>
                                                                            </div>
                                                                            <div class="grid lg:grid-cols-2 gap-2 space-y-2 lg:space-y-0">
                                                                                ...
                                                                                <div class="space-y-2 mb-6 mt-4">
                                                                                    ...
                                                                                    <div class=" gap-x-8 max-w-md space-y-3 ">
                                                                                        ...
                                                                                        @php $checked="";
                                                                                            @endphp
                                                                                                @foreach ($ntp->designations as $designs)
                                                                                                    @if($designs->design_name==$des->design_name && $designs->pivot->status=='active')
                                                                                                        @php $checked="checked";
                                                                                                        @endphp
                                                                                                    @endif
                                                                                                    @endforeach
                                                                                                    <div class="flex">
                                                                                                        ...
                                                                                                        <input type="checkbox" name="ntdesign[]"  value="{{$des->id}}" {{$checked}} class="ti-form-checkbox mt-0.5" id="hs-checkbox-group-1">
                                                                                                        <label for="hs-checkbox-group-1" class="text-sm text-gray-500 ltr:ml-2 rtl:mr-2 dark:text-white/70">{{$des->design_name}}</label>
                                                                                                    </div>
                                    ...
                                    <div class="box-footer">
                                        ...
                                        <div class="sm:flex items-center">
                                            <div class="">
                                                showing {{$non_teaching_payscale->firstItem()}} to {{$non_teaching_payscale->lastItem()}} of {{$non_teaching_payscale->total()}}
                                            </div>
                                            <div class="ltr:ml-auto rtl:mr-auto">
                                                <nav class="flex justify-center items-center space-x-2 rtl:space-x-reverse">
                                                    <a class="text-gray-500 hover:text-primary e py-1 px-2 leading-none inline-flex items-center gap-2 rounded-sm" href="{{$non_teaching_payscale->previousPageUrl()}}">
                                                    ...
                                                    @for ($page = 1; $page<= $number_of_page; $page++)
                                                        @if ($page == $url_page)
                                                            <a class="bg-primary text-white py-1 px-2 leading-none inline-flex items-center text-sm font-medium rounded-sm" href="{{$non_teaching_payscale->url($page)}}" aria-current="page">{{$page}}</a>
                                                        @else
                                                                <a class="text-gray-500 hover:text-primary e py-1 px-2 leading-none inline-flex items-center text-sm font-medium rounded-sm" href="{{$non_teaching_payscale->url($page)}}">{{$page}}</a>
                                                        @endif
                                                    @endfor
                                                    ...
                                                    <a class="text-gray-500 hover:text-primary e py-1 px-2 leading-none inline-flex items-center gap-2 rounded-sm" href="{{ $non_teaching_payscale->nextPageUrl() }} ">
                                ...
                                <div class="grid grid-cols-12 gap-x-6">
                                    <div class="col-span-12">
                                                                        ...
                                                                        <div class="space-y-2">
                                                                            ...
                                                                            @foreach ($design as $des)
                                                                                <div class="flex">
                                                                                    ...
                                                                                    <input type="checkbox" name="ntcdesign[]"  value="{{$des->id}}" class="ti-form-checkbox mt-0.5" id="hs-checkbox-group-1">
                                                                                    <label for="hs-checkbox-group-1" class="text-sm text-gray-500 ltr:ml-2 rtl:mr-2 dark:text-white/70">{{$des->design_name}}</label>
                                                                                </div>
                                                                            @endforeach
                                            ...
                                            <div class="table-bordered rounded-sm ti-custom-table-head overflow-auto table-auto">
                                                ...
                                                <table class="ti-custom-table ti-custom-table-head whitespace-nowrap">
                                                    ...
                                                    <tr class="">
                                                        ...
                                                        <td> 
                                                            @foreach ($ntcp->designations as $designs)
                                                        ...
                                                        <td><span>{{$ntcp->gcr}}</span></td>
                                                        <td><span>{{($ntcp->closedon=='NULL')?'Not Closed': $ntcp->closedon}}</span></td>
                                                        <td><span>{{$ntcp->status}}</span></td>
                                                                                                
                                                        <td class="font-medium space-x-2 rtl:space-x-reverse">
                                                        <div class="hs-tooltip ti-main-tooltip">
                                                            <button data-hs-overlay="#nt_consolidated_payscale_edit_modal{{$sno}}"
                                                            ...
                                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16"><path d="M16.7574 2.99666L14.7574 4.99666H5V18.9967H19V9.2393L21 7.2393V19.9967C21 20.5489 20.5523 20.9967 20 20.9967H4C3.44772 20.9967 3 20.5489 3 19.9967V3.99666C3 3.44438 3.44772 2.99666 4 2.99666H16.7574ZM20.4853 2.09717L21.8995 3.51138L12.7071 12.7038L11.2954 12.7062L11.2929 11.2896L20.4853 2.09717Z"></path></svg>
                                                                ...
                                                                <div id="nt_consolidated_payscale_edit_modal{{$sno}}" class="hs-overlay hidden ti-modal">
                                                                    <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out lg:!max-w-4xl lg:w-full m-3 md:mx-auto">
                                                                        <div class="ti-modal-content">
                                                                        <div class="ti-modal-header">
                                                                            <h3 class="ti-modal-title">
                                                                            ...
                                                                            <button type="button" class="hs-dropdown-toggle ti-modal-close-btn"
                                                                            data-hs-overlay="#nt_consolidated_payscale_edit_modal{{$sno}}">
                                                                            <span class="sr-only">Close</span>
                                                                            <svg class="w-3.5 h-3.5" width="8" height="8" viewBox="0 0 8 8" fill="none"
                                                                                xmlns="http://www.w3.org/2000/svg">
                                                                                <path
                                                                        ...
                                                                        <form  action="{{route('ESTB.payscales.non_teaching_consolidated.update',$ntcp->id)}}" method="post">
                                                                            ...
                                                                            <div class="ti-modal-body">
                                                                                ...
                                                                                <div class="grid lg:grid-cols-2 gap-2 space-y-2 lg:space-y-0">
                                                                                    ...
                                                                                    <div class="max-w-sm space-y-3 mb-6">
                                                                                        <label for="with-corner-hint" class="ti-form-label font-bold">GC Resolution No : </label>
                                                                                        <input type="text" name="gcr" class="ti-form-input"  placeholder="GC Resolution No" value="{{$ntcp->gcr}}">
                                                                                    </div>
                                                                                    <div class="flex shadow-sm max-w-sm space-y-3 mb-4">
                                                                                        <label for="" class="ti-form-label font-bold">Closed On :</label>
                                                                                ...
                                                                                <div class="space-y-2">
                                                                                    <div class=" gap-x-8 max-w-md space-y-3 pb-6">
                                                                                        ...
                                                                                        @endphp
                                                                                            ...
                                                                                            @if($d->design_name == $designs->design_name && $designs->pivot->status=='active')
                                                                                            @php $checked="checked";
                                                                                        @endphp
                                                                                        @endif
                                                                                        @endforeach
                                                                                                ...
                                                                                                <div class="flex">
                                                                                                    ...
                                                                                                    <input type="checkbox" name="ntdesign[]"  value="{{$d->id}}" {{$checked}} class="ti-form-checkbox mt-0.5" id="hs-checkbox-group-1">
                                                                                                    <label for="hs-checkbox-group-1" class="text-sm text-gray-500 ltr:ml-2 rtl:mr-2 dark:text-white/70">{{$d->design_name}}</label>
                                                                                                </div>
                                        ...
                                        <div class="box-footer">
                                            ...
                                            <div class="sm:flex items-center">
                                                <div class="">
                                                    showing {{$ntcps->firstItem()}} to {{$ntcps->lastItem()}} of {{$ntcps->total()}}
                                                </div>
                                                <div class="ltr:ml-auto rtl:mr-auto">
                                                    <nav class="flex justify-center items-center space-x-2 rtl:space-x-reverse">
                                                        <a class="text-gray-500 hover:text-primary e py-1 px-2 leading-none inline-flex items-center gap-2 rounded-sm" href="{{$ntcps->previousPageUrl()}}">
                                                            <span aria-hidden="true">Prev</span>
                                                            <span class="sr-only">Previous</span>
                                                        </a>
                                                        @php
                                                        ...
                                                        @for ($page = 1; $page<= $number_of_page; $page++)
                                                            @if ($page == $url_page)
                                                                <a class="bg-primary text-white py-1 px-2 leading-none inline-flex items-center text-sm font-medium rounded-sm" href="{{$ntcps->url($page)}}" aria-current="page">{{$page}}</a>
                                                            @else
                                                                    <a class="text-gray-500 hover:text-primary e py-1 px-2 leading-none inline-flex items-center text-sm font-medium rounded-sm" href="{{$ntcps->url($page)}}">{{$page}}</a>
                                                            @endif
                                                        @endfor
                                                        <!--a class="bg-primary text-white py-1 px-2 leading-none inline-flex items-center text-sm font-medium rounded-sm" href="javascript:void(0);" aria-current="page">1</a>
                                                        <a class="text-gray-500 hover:text-primary e py-1 px-2 leading-none inline-flex items-center text-sm font-medium rounded-sm" href="javascript:void(0);">2</a>
                                                        <a class="text-gray-500 hover:text-primary e py-1 px-2 leading-none inline-flex items-center text-sm font-medium rounded-sm" href="javascript:void(0);">3</a-->
                                                        <a class="text-gray-500 hover:text-primary e py-1 px-2 leading-none inline-flex items-center gap-2 rounded-sm" href="{{ $ntcps->nextPageUrl() }} ">
                                                            <span class="sr-only">Next</span>
                                                            <span aria-hidden="true">Next</span>
                                                        </a>
                                                    </nav>
