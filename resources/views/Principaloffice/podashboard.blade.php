                            ...
                            <div class="grid grid-cols-12 gap-x-5">
                                ...
                                <div class="col-span-12 md:col-span-6 xxl:col-span-3">
                                    ...
                                    <div class="box-header justify-between flex">
                                        ...
                                        <div>
                                            <a class="flex  items-center font-semibold text-primary hover:text-primary dark:text-primary truncate" href="{{route('Principaloffice.poevents.index')}}">
                                                View All
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div class="col-span-12 md:col-span-6 xxl:col-span-3">
                                    <div class="box" style="height: 450px; overflow-y: auto;">
                                        <div class="box-header justify-between flex">
                                            ...
                                            <div>
                                                <a class="flex  items-center font-semibold text-primary hover:text-primary dark:text-primary truncate" href="{{route('Principaloffice.ponotice.index')}}">
                                                    View All
                                                </a>
                                            </div>
                                        </div>
