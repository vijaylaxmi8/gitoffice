                    ...
                    <div class="responsive-headernav">
                        ...
                        <div class="header-cart hs-dropdown ti-dropdown hidden lg:block" data-hs-dropdown-placement="bottom-right">
                            ...
                            <div class="ti-dropdown-divider divide-y divide-gray-200 dark:divide-white/10">
                                ...
                                <div class="ti-dropdown-item relative header-box">
                                    <a href="{{url('cart')}}" class="flex items-center space-x-3 rtl:space-x-reverse w-full">
                                    <img loading="lazy" src="{{asset('build/assets/img/ecommerce/products/1.png')}}" alt="product-img"
                                ...
                                <div class="ti-dropdown-item relative header-box">
                                    <a href="{{url('cart')}}" class="flex items-center space-x-3 rtl:space-x-reverse w-full">
                                    <img loading="lazy" src="{{asset('build/assets/img/ecommerce/products/2.png')}}" alt="product-img"
                                        class="avatar p-2 shadow-none  shrink-0 items-center justify-center rounded-sm bg-gray-100 dark:bg-black/20 !ring-transparent">
                                    <div>
                                        <p class="text-sm font-medium text-gray-800 dark:text-white">
                                        Tshirt For Men
                                ...
                                <div class="ti-dropdown-item relative header-box">
                                    <a href="{{url('cart')}}" class="flex items-center space-x-3 rtl:space-x-reverse w-full">
                                    <img loading="lazy" src="{{asset('build/assets/img/ecommerce/products/9.png')}}" alt="product-img"
                                        class="avatar p-2 shadow-none  shrink-0 items-center justify-center rounded-sm bg-gray-100 dark:bg-black/20 !ring-transparent">
                                    <div>
                                        <p class="text-sm font-medium text-gray-800 dark:text-white">
                                ...
                                <div class="ti-dropdown-item relative header-box">
                                    <a href="{{url('cart')}}" class="flex items-center space-x-3 rtl:space-x-reverse w-full">
                                    <img loading="lazy" src="{{asset('build/assets/img/ecommerce/products/10.png')}}" alt="product-img"
                                        class="avatar p-2 shadow-none  shrink-0 items-center justify-center rounded-sm bg-gray-100 dark:bg-black/20 !ring-transparent">
                                    <div>
                                        <p class="text-sm font-medium text-gray-800 dark:text-white">
                                ...
                                <a class="w-full ti-btn ti-btn-primary p-2" href="{{url('checkout')}}">
                                    Proceed Checkout
                                </a>
                                </div>
                            </div>
                        ...
                        <div class="header-apps hs-dropdown ti-dropdown hidden md:block" data-hs-dropdown-placement="bottom-right">
                            ...
                            <div class="ti-dropdown-divider divide-y divide-gray-200 dark:divide-white/10">
                                ...
                                <a href="{{url('mail-inbox')}}" class="block pt-0 p-2 text-center rounded-sm hover:bg-gray-50 dark:hover:bg-black/20">
                                ...
                                <a href="{{url('chat')}}" class="block pt-0 p-2 text-center rounded-sm hover:bg-gray-50 dark:hover:bg-black/20">
                                ...
                                <a href="{{url('tasks')}}" class="block pt-0 p-2 text-center rounded-sm hover:bg-gray-50 dark:hover:bg-black/20">
                                ...
                                <a href="{{url('calendar')}}" class="block pt-0 p-2 text-center rounded-sm hover:bg-gray-50 dark:hover:bg-black/20">
                                ...
                                <a href="{{url('filemanager')}}" class="block pt-0 p-2 text-center rounded-sm hover:bg-gray-50 dark:hover:bg-black/20">
                                    ...
                                    <div class="text-xs font-semibold text-gray-800 dark:text-white">File Manager</div>
                                </a>
                                <a href="{{url('contacts')}}" class="block pt-0 p-2 text-center rounded-sm hover:bg-gray-50 dark:hover:bg-black/20">
                        ...
                        <div class="header-profile hs-dropdown ti-dropdown" data-hs-dropdown-placement="bottom-right">
                            ...
                            <div class="mt-2 ti-dropdown-divider">
                                <a href="{{url('profile')}}" class="ti-dropdown-item">
                                ...
                                <a href="{{url('signin')}}" class="ti-dropdown-item">
