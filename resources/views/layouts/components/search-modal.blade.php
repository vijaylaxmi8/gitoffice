                ...
                <div class="ti-modal-box">
                    <div class="ti-modal-content">
                        <div class="ti-modal-body">
                            ...
                            <div class="badge rounded-sm bg-secondary/20 text-secondary relative header-box">
                                <a href="{{url('form-elements')}}" class="w-full my-auto items-center flex space-x-2 rtl:space-x-reverse">
                            ...
                            <div class="badge rounded-sm bg-secondary/20 text-secondary relative header-box">
                                <a href="{{url('vector-maps')}}" class="w-full my-auto items-center flex space-x-2 rtl:space-x-reverse">
                            ...
                            <div class="badge rounded-sm bg-secondary/20 text-secondary relative header-box">
                                <a href="{{url('widgets')}}" class="w-full my-auto items-center flex space-x-2 rtl:space-x-reverse">
