                ...
                <div class="main-sidebar " id="sidebar-scroll">
                    ...
                    <nav class="main-menu-container nav nav-pills flex-column sub-open">
                        ...
                        <ul class="main-menu">
                            ...
                            <!-- End::slide__category -->
                            <li class="slide">
                                <a href="{{url('/Examoffice/dashboard')}}" class="side-menu__item">
                            ...
                            <li class="slide">
                                <a href="{{url('/Examoffice/grievancecategory')}}" class="side-menu__item">
                            ...
                            <li class="slide">
                                <a href="{{url('/Examoffice/grievance')}}" class="side-menu__item">
