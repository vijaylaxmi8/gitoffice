                    ...
                    <div class="content">
                        ...
                        <div class="main-content">
                            ...
                            <div class="block justify-between page-header sm:flex">
                                <div>
                                    <h3 class="text-gray-700 hover:text-gray-900 dark:text-white dark:hover:text-white text-2xl font-medium"> File Manager</h3>
                                </div>
                            ...
                            <div class="col-span-12 xxl:col-span-9">
                                ...
                                <div class="grid grid-cols-12 gap-6">
                                    ...
                                    <div class="grid grid-cols-12 gap-6">
                                        ...
                                        <div class="box mb-0">
                                            <div class="box-body">
                                            <a href="{{url('file-details')}}" class="mx-auto my-3"><img class="mx-auto" src="{{asset('build/assets/img/files/2.png')}}" alt="img"></a>
                                            </div>
                                        ...
                                        <div class="box mb-0 overflow-hidden">
                                            <div class="box-body">
                                            <a href="{{url('file-details')}}" class="mx-auto my-3"><img class="mx-auto" src="{{asset('build/assets/img/files/9.png')}}" alt="img"></a>
                                            </div>
                                            <div class="box-footer bg-transparent">
                                            <div class="flex justify-between">
                                        ...
                                        <div class="box mb-0">
                                            <div class="box-body">
                                            <a href="{{url('file-details')}}" class="mx-auto my-3"><img class="mx-auto" src="{{asset('build/assets/img/files/3.png')}}" alt="img"></a>
                                            </div>
                                            <div class="box-footer bg-transparent">
                                            <div class="flex justify-between">
                                        ...
                                        <div class="box mb-0 overflow-hidden">
                                            <div class="box-body">
                                            <a href="{{url('file-details')}}" class="mx-auto my-3"><img class="mx-auto" src="{{asset('build/assets/img/files/5.png')}}" alt="img"></a>
                                            </div>
                                            <div class="box-footer bg-transparent">
                                            <div class="flex justify-between">
                                    ...
                                    <div class="overflow-auto">
                                        ...
                                        <tbody>
                                            ...
                                            <td class="font-medium">
                                                <a class="flex items-center space-x-2 rtl:space-x-reverse" href="{{url('filemanager-list')}}">
                                                <img src="{{asset('build/assets/img/files/5.png')}}" alt="img" class="w-10">
                                            ...
                                            <td>
                                                ...
                                                <img class="inline-block h-10 w-10 rounded-full ring-2 ring-white" src="{{asset('build/assets/img/users/8.jpg')}}" alt="Image Description">
                                                <img class="inline-block h-10 w-10 rounded-full ring-2 ring-white" src="{{asset('build/assets/img/users/4.jpg')}}" alt="Image Description">
                                                <img class="inline-block h-10 w-10 rounded-full ring-2 ring-white" src="{{asset('build/assets/img/users/6.jpg')}}" alt="Image Description">
                                                <img class="inline-block h-10 w-10 rounded-full ring-2 ring-white" src="{{asset('build/assets/img/users/7.jpg')}}" alt="Image Description">
                                                <img class="inline-block h-10 w-10 rounded-full ring-2 ring-white" src="{{asset('build/assets/img/users/2.jpg')}}" alt="Image Description">
                                                </div>
                                            </td>
                                            <td class="!text-end">
                                            ...
                                            <td class="font-medium">
                                                <a class="flex items-center space-x-2 rtl:space-x-reverse" href="{{url('filemanager-list')}}">
                                                <img src="{{asset('build/assets/img/files/2.png')}}" alt="img" class="w-10">
                                                <span>Joe Black</span>
                                                </a>
                                            </td>
                                            <td>1 files</td>
                                            ...
                                            <td>
                                                <div class="flex -space-x-2 rtl:space-x-reverse">
                                                <img class="inline-block h-10 w-10 rounded-full ring-2 ring-white" src="{{asset('build/assets/img/users/1.jpg')}}" alt="Image Description">
                                                <img class="inline-block h-10 w-10 rounded-full ring-2 ring-white" src="{{asset('build/assets/img/users/8.jpg')}}" alt="Image Description">
                                                <img class="inline-block h-10 w-10 rounded-full ring-2 ring-white" src="{{asset('build/assets/img/users/4.jpg')}}" alt="Image Description">
                                                <img class="inline-block h-10 w-10 rounded-full ring-2 ring-white" src="{{asset('build/assets/img/users/6.jpg')}}" alt="Image Description">
                                                <img class="inline-block h-10 w-10 rounded-full ring-2 ring-white" src="{{asset('build/assets/img/users/7.jpg')}}" alt="Image Description">
                                            ...
                                            <td class="font-medium">
                                                <a class="flex items-center space-x-2 rtl:space-x-reverse" href="{{url('filemanager-list')}}">
                                                <img src="{{asset('build/assets/img/files/9.png')}}" alt="img" class="w-10">
                                            ...
                                            <td>
                                                ...
                                                <img class="inline-block h-10 w-10 rounded-full ring-2 ring-white" src="{{asset('build/assets/img/users/1.jpg')}}" alt="Image Description">
                                                <img class="inline-block h-10 w-10 rounded-full ring-2 ring-white" src="{{asset('build/assets/img/users/2.jpg')}}" alt="Image Description">
                                                <img class="inline-block h-10 w-10 rounded-full ring-2 ring-white" src="{{asset('build/assets/img/users/3.jpg')}}" alt="Image Description">
                                                <img class="inline-block h-10 w-10 rounded-full ring-2 ring-white" src="{{asset('build/assets/img/users/6.jpg')}}" alt="Image Description">
                                                <img class="inline-block h-10 w-10 rounded-full ring-2 ring-white" src="{{asset('build/assets/img/users/7.jpg')}}" alt="Image Description">
                                                </div>
                                            </td>
...
@section('scripts')
        ...
        <!-- FILEMANAGER JS -->
        @vite('resources/assets/js/filemanager.js')
