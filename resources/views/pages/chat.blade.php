                                                            ...
                                                            <div class="swiper-wrapper">
                                                                <div class="swiper-slide">
                                                                    <a class="relative inline-block" href="javascript:void(0);">
                                                                        <img class="avatar avatar-sm rounded-full" src="{{asset('build/assets/img/users/2.jpg')}}"
                                                                ...
                                                                <div class="swiper-slide">
                                                                    <a class="relative inline-block" href="javascript:void(0);">
                                                                        <img class="avatar avatar-sm rounded-full" src="{{asset('build/assets/img/users/3.jpg')}}"
                                                                        alt="Image Description">
                                                                        <span class="online"></span>
                                                                    </a>
                                                                </div>
                                                                <div class="swiper-slide">
                                                                    <a class="relative inline-block" href="javascript:void(0);">
                                                                        <img class="avatar avatar-sm rounded-full" src="{{asset('build/assets/img/users/4.jpg')}}"
                                                                        alt="Image Description">
                                                                        <span class="online"></span>
                                                                    </a>
                                                                </div>
                                                                <div class="swiper-slide">
                                                                    <a class="relative inline-block" href="javascript:void(0);">
                                                                        <img class="avatar avatar-sm rounded-full" src="{{asset('build/assets/img/users/19.jpg')}}"
                                                                        alt="Image Description">
                                                                        <span class="online"></span>
                                                                    </a>
                                                                </div>
                                                                <div class="swiper-slide">
                                                                    <a class="relative inline-block" href="javascript:void(0);">
                                                                        <img class="avatar avatar-sm rounded-full" src="{{asset('build/assets/img/users/18.jpg')}}"
                                                                        alt="Image Description">
                                                                        <span class="online"></span>
                                                                    </a>
                                                                </div>
                                                                <div class="swiper-slide">
                                                                    <a class="relative inline-block" href="javascript:void(0);">
                                                                        <img class="avatar avatar-sm rounded-full" src="{{asset('build/assets/img/users/17.jpg')}}"
                                                                        alt="Image Description">
                                                                        <span class="online"></span>
                                                                    </a>
                                                                </div>
                                                                <div class="swiper-slide">
                                                                    <a class="relative inline-block" href="javascript:void(0);">
                                                                        <img class="avatar avatar-sm rounded-full" src="{{asset('build/assets/img/users/16.jpg')}}"
                                                                        alt="Image Description">
                                                                        <span class="online"></span>
                                                                    </a>
                                                                </div>
                                                                <div class="swiper-slide">
                                                                    <a class="relative inline-block" href="javascript:void(0);">
                                                                        <img class="avatar avatar-sm rounded-full" src="{{asset('build/assets/img/users/15.jpg')}}"
                                                                        alt="Image Description">
                                                                        <span class="online"></span>
                                                                    </a>
                                                                </div>
                                                                <div class="swiper-slide">
                                                                    <a class="relative inline-block" href="javascript:void(0);">
                                                                        <img class="avatar avatar-sm rounded-full" src="{{asset('build/assets/img/users/14.jpg')}}"
                                                                        alt="Image Description">
                                                                        <span class="online"></span>
                                                                    </a>
                                                                </div>
                                                                <div class="swiper-slide">
                                                                    <a class="relative inline-block" href="javascript:void(0);">
                                                                        <img class="avatar avatar-sm rounded-full" src="{{asset('build/assets/img/users/13.jpg')}}"
                                                                        alt="Image Description">
                                                                        <span class="online"></span>
                                                                    </a>
                                                                </div>
                                                                <div class="swiper-slide">
                                                                    <a class="relative inline-block" href="javascript:void(0);">
                                                                        <img class="avatar avatar-sm rounded-full" src="{{asset('build/assets/img/users/12.jpg')}}"
                                                                        alt="Image Description">
                                                                        <span class="online"></span>
                                                                    </a>
                                                                </div>
                                                    ...
                                                    <div class="chat-message">
                                                        ...
                                                        <div id="messages-style-1" role="tabpanel" aria-labelledby="messages-1">
                                                            ...
                                                            <li class="ti-list-group border-0 text-gray-800 dark:text-white relative checkforactive">
                                                                ...
                                                                <div class="flex items-center space-x-3 rtl:space-x-reverse w-full">
                                                                    <div class="flex">
                                                                        ...
                                                                        <img class="rounded-full" src="{{asset('build/assets/img/users/2.jpg')}}"
                                                                            alt="Image Description">
                                                                        <span class="online"></span>
                                                                        </a>
                                                                    </div>
                                                            ...
                                                            <li class="ti-list-group border-0 text-gray-800 dark:text-white relative checkforactive">
                                                                ...
                                                                <div class="flex items-center space-x-3 rtl:space-x-reverse w-full">
                                                                    <div class="flex">
                                                                        <a class="relative inline-block avatar avatar-sm rounded-full" href="javascript:void(0);">
                                                                        <img class="rounded-full" src="{{asset('build/assets/img/users/20.jpg')}}"
                                                                            alt="Image Description">
                                                                        <span class="online"></span>
                                                                        </a>
                                                                    </div>
                                                            ...
                                                            <li class="ti-list-group border-0 text-gray-800 dark:text-white relative checkforactive">
                                                                ...
                                                                <div class="flex items-center space-x-3 rtl:space-x-reverse w-full">
                                                                    <div class="flex">
                                                                        <a class="relative inline-block avatar avatar-sm rounded-full" href="javascript:void(0);">
                                                                        <img class="rounded-full" src="{{asset('build/assets/img/users/15.jpg')}}"
                                                                            alt="Image Description">
                                                                        <span class="online"></span>
                                                                        </a>
                                                                    </div>
                                                            ...
                                                            <li class="ti-list-group border-0 text-gray-800 dark:text-white relative checkforactive">
                                                                ...
                                                                <div class="flex items-center space-x-3 rtl:space-x-reverse w-full">
                                                                    <div class="flex">
                                                                        <a class="relative inline-block avatar avatar-sm rounded-full" href="javascript:void(0);">
                                                                        <img class="rounded-full" src="{{asset('build/assets/img/users/18.jpg')}}"
                                                                            alt="Image Description">
                                                            ...
                                                            <li class="ti-list-group border-0 text-gray-800 dark:text-white relative checkforactive">
                                                                ...
                                                                <div class="flex">
                                                                    <a class="relative inline-block avatar avatar-sm rounded-full" href="javascript:void(0);">
                                                                    <img class="rounded-full" src="{{asset('build/assets/img/users/19.jpg')}}"
                                                                        alt="Image Description">
                                                                    <span class="online"></span>
                                                                    </a>
                                                                </div>
                                                            ...
                                                            <li class="ti-list-group border-0 text-gray-800 dark:text-white relative checkforactive">
                                                                ...
                                                                <div class="flex">
                                                                    <a class="relative inline-block avatar avatar-sm rounded-full" href="javascript:void(0);">
                                                                    <img class="rounded-full" src="{{asset('build/assets/img/users/16.jpg')}}"
                                                                        alt="Image Description">
                                                                    <span class="online"></span>
                                                                    </a>
                                                                </div>
                                                            ...
                                                            <li class="ti-list-group border-0 text-gray-800 dark:text-white relative checkforactive">
                                                                ...
                                                                <div class="flex">
                                                                    <a class="relative inline-block avatar avatar-sm rounded-full" href="javascript:void(0);">
                                                                    <img class="rounded-full" src="{{asset('build/assets/img/users/13.jpg')}}"
                                                                        alt="Image Description">
                                                                    <span class="offline"></span>
                                                                    </a>
                                                                </div>
                                                            ...
                                                            <li class="ti-list-group border-0 text-gray-800 dark:text-white relative checkforactive">
                                                                ...
                                                                <div class="flex">
                                                                    <a class="relative inline-block avatar avatar-sm rounded-full" href="javascript:void(0);">
                                                                    <img class="rounded-full" src="{{asset('build/assets/img/users/14.jpg')}}"
                                                                        alt="Image Description">
                                                                    <span class="offline"></span>
                                                                    </a>
                                                                </div>
                                                        ...
                                                        <div id="messages-style-2" class="hidden" role="tabpanel" aria-labelledby="messages-2">
                                                            ...
                                                            <li class="ti-list-group border-0 text-gray-800 dark:text-white relative checkforactive">
                                                                ...
                                                                <div class="flex items-center space-x-3 rtl:space-x-reverse w-full">
                                                                <div class="flex">
                                                                    <img class="avatar avatar-xs rounded-full" src="{{asset('build/assets/img/users/20.jpg')}}"
                                                                    alt="Image Description">
                                                                </div>
                                                                <div class="flex items-center justify-between w-full">
                                                                    <div class="items-center">
                                                            ...
                                                            <li class="ti-list-group border-0 text-gray-800 dark:text-white relative checkforactive">
                                                                ...
                                                                <div class="flex items-center space-x-3 rtl:space-x-reverse w-full">
                                                                <div class="flex">
                                                                    <img class="avatar avatar-xs rounded-full" src="{{asset('build/assets/img/users/18.jpg')}}"
                                                                    alt="Image Description">
                                                                </div>
                                                                <div class="flex items-center justify-between w-full">
                                                                    <div class="items-center">
                                                            ...
                                                            <li class="ti-list-group border-0 text-gray-800 dark:text-white relative checkforactive">
                                                                ...
                                                                <div class="flex items-center space-x-3 rtl:space-x-reverse w-full">
                                                                <div class="flex">
                                                                    <img class="avatar avatar-xs rounded-full" src="{{asset('build/assets/img/users/9.jpg')}}"
                                                                    alt="Image Description">
                                                                </div>
                                                                <div class="flex items-center justify-between w-full">
                                                                    <div class="items-center">
                                                            ...
                                                            <li class="ti-list-group border-0 text-gray-800 dark:text-white relative checkforactive">
                                                                ...
                                                                <div class="flex items-center space-x-3 rtl:space-x-reverse w-full">
                                                                <div class="flex">
                                                                    <img class="avatar avatar-xs rounded-full" src="{{asset('build/assets/img/users/10.jpg')}}"
                                                                    alt="Image Description">
                                                                </div>
                                                                <div class="flex items-center justify-between w-full">
                                                                    <div class="items-center">
                                                            ...
                                                            <li class="ti-list-group border-0 text-gray-800 dark:text-white relative checkforactive">
                                                                ...
                                                                <div class="flex items-center space-x-3 rtl:space-x-reverse w-full">
                                                                <div class="flex">
                                                                    <img class="avatar avatar-xs rounded-full" src="{{asset('build/assets/img/users/6.jpg')}}"
                                                                    alt="Image Description">
                                                                </div>
                                                                <div class="flex items-center justify-between w-full">
                                                                    <div class="items-center">
                                                            ...
                                                            <li class="ti-list-group border-0 text-gray-800 dark:text-white relative checkforactive">
                                                                ...
                                                                <div class="flex items-center space-x-3 rtl:space-x-reverse w-full">
                                                                <div class="flex">
                                                                    <img class="avatar avatar-xs rounded-full" src="{{asset('build/assets/img/users/8.jpg')}}"
                                                                    alt="Image Description">
                                                                </div>
                                                                <div class="flex items-center justify-between w-full">
                                                                    <div class="items-center">
                                            ...
                                            <div class="box-header bg-transparent">
                                                <div class="sm:flex justify-between">
                                                    <div class="flex items-center space-x-4 rtl:space-x-reverse">
                                                        <div class="flex">
                                                            <a class="relative inline-block" href="javascript:void(0);">
                                                                <img class="avatar avatar-sm rounded-full chatimageperson" src="{{asset('build/assets/img/users/2.jpg')}}"
                                                                alt="Image Description">
                                                    ...
                                                    <div class="flex my-auto main-chat-right-icons mt-5 sm:mt-auto">
                                                        ...
                                                        <a aria-label="anchor" class="hidden sm:flex ti-btn ti-btn-outline rounded-full p-2 border-gray-200 text-gray-500 dark:text-white/70 hover:text-gray-700 hover:bg-gray-100 hover:border-gray-200 focus:ring-gray-200  dark:hover:bg-black/30 dark:border-white/10 dark:hover:border-white/20 dark:focus:ring-white/10 dark:focus:ring-offset-white/10"
                                                ...
                                                <div class="absolute top-0 inset-x-0">
                                                    <div id="chatlist">
                                                        <div class="box-body p-8">
                                                            ...
                                                            <div class="chat-left">
                                                                <div>
                                                                <img src="{{asset('build/assets/img/users/2.jpg')}}" class="chatimageperson avatar rounded-full"
                                                                    alt="Image Description">
                                                                </div>
                                                            ...
                                                            <div class="chat-right">
                                                                ...
                                                                <div>
                                                                <img src="{{asset('build/assets/img/users/1.jpg')}}" class="avatar rounded-full" alt="Image Description">
                                                                </div>
                                                            </div>
                                                            <div class="chat-left">
                                                                <div>
                                                            ...
                                                            <div class="chat-right">
                                                                ...
                                                                <div class="chat-inner-msg flex space-y-1 space-x-3 rtl:space-x-reverse">
                                                                    <img src="{{asset('build/assets/img/gallery/3.jpg')}}" class="w-1/4 rounded-sm ltr:ml-auto rtl:mr-auto"
                                                                    alt="Image Description">
                                                                    <img src="{{asset('build/assets/img/gallery/1.jpg')}}" class="w-1/4 rounded-sm ltr:ml-auto rtl:mr-auto"
                                                                    alt="Image Description">
                                                                    <img src="{{asset('build/assets/img/gallery/4.jpg')}}" class="w-1/4 rounded-sm ltr:ml-auto rtl:mr-auto"
                                                                    alt="Image Description">
                                                                </div>
                                                                <p class="text-end text-xs text-gray-500 dark:text-white/70">
                                                                    10:35 AM
                                                        ...
                                                        <div class="space-y-4">
                                                            <div class="text-center space-y-2">
                                                                <div class="flex justify-center">
                                                                    <a class="relative inline-block" href="javascript:void(0);">
                                                                        <img class="w-24 h-24 rounded-full chatimageperson" src="{{asset('build/assets/img/users/2.jpg')}}"
                                                                        alt="Image Description">
