                                        ...
                                        <table id="achivement" class="ti-custom-table ti-custom-table-head whitespace-nowrap">
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($general_achievements as $achive)
                                                    {{-- <tr class="" @if($achive->validation_status == 'valid') style="background-color: #ccffcc; color: #006400;" @elseif($achive->validation_status =='invalid') style="background-color: #ffe6e6; color: #b30000;" @endif> --}}
                                                    ...
                                                    <tr style="@if($achive->validation_status =='invalid') background-color: #ffcccc; @elseif($achive->validation_status =='updated') background-color: #fff2cc; @elseif($achive->validation_status =='valid') background-color: #ccffcc; @endif">
                                                        ...
                                                        {{-- @if(!isset($export) || !$export)
                                                            <td class="dark:text-white/80 font-bold text-center border border-neutral-900">
                                                                <span><a href="{{ asset('Uploads/Research/Achievement/' . $achive->document) }}" class='font-medium text-blue-600 dark:text-blue-500 hover:underline' target="_blank">{{ $achive->document }}</a></span>
                                                            </td>
                                                        @endif --}}
                                                                            ...
                                                                            <div class="ti-modal-content">
                                                                                <div class="ti-modal-header">
                                                                                    <h3 class="ti-modal-title">
                                                                                        ...
                                                                                        Validate the Achievement Details
                                                                                    </h3>
                                                                                ...
                                                                                <form action="{{ route('egov.Teaching.research.achivements.update', $achive->id) }}" method="post">
                                                                                    @csrf
                                                                                    @method('patch')
