                                                        ...
                                                        @if(!isset($export) || !$export)
                                                            <td>
                                                                <div class="hs-tooltip ti-main-tooltip">
                                                                    <a  href="{{ Storage::url('Uploads/Research/Conference_Attended/' .$conference->document) }}" class="m-0 hs-tooltip-toggle relative w-8 h-8 ti-btn rounded-full p-0 transition-none focus:outline-none ti-btn-soft-primary" target="_blank" {{$conference->document}}>
                                                                            ...
                                                                            <div class="ti-modal-content">
                                                                                <div class="ti-modal-header">
                                                                                    <h3 class="ti-modal-title">
                                                                                        ...
                                                                                        Validate the Conference Attended Details
                                                                                    </h3>
                                                                                ...
                                                                                <form action="{{ route('egov.Teaching.research.conferenceattended.update', $conference->id) }}" method="post">
                                                                                    @csrf
                                                                                    @method('patch')
