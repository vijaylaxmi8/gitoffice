                                                                            ...
                                                                            <div class="ti-modal-content">
                                                                                <div class="ti-modal-header">
                                                                                    <h3 class="ti-modal-title">
                                                                                        ...
                                                                                        Validate the Professional Activity Conducted Details
                                                                                    </h3>
                                                                                ...
                                                                                <form action="{{ route('egov.NonTeaching.conducted.update', $con->id) }}" method="post">
                                                                                    @csrf
                                                                                    @method('patch')
        ...
        <script>
            $(document).ready(function(){
               ...
               new DataTable('#proconduct');
                ...
                // Function to handle Date filter Range
