                                                ...
                                                <div id="grievance_add" class="hs-overlay hidden ti-modal">
                                                    <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out md:!max-w-2xl md:w-full m-3 md:mx-auto">
                                                        <div class="ti-modal-content">
                                                            ...
                                                            <form action="{{route('HOD.grievancecategory.store')}}" method="post">
                                                                @csrf
                                            ...
                                            <table id="grievance_table" class="ti-custom-table ti-custom-table-head whitespace-nowrap">
                                                ...
                                                <tbody class="">
                                                    @php
                                                        $i = 1;
                                                    @endphp
                                                    @forelse($grievience_category as $gc)
                                                        <tr class="">
                                                            <td>{{ $i++ }}</td>
                                                            <td><span>{{$gc->category_name}}</span></td>
                                                            ...
                                                            <td class="font-medium space-x-2 rtl:space-x-reverse">
                                                                    ...
                                                                    <div id="gcategory_edit_modal{{$i}}" class="hs-overlay hidden ti-modal">
                                                                        <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out lg:!max-w-4xl lg:w-full m-3 md:mx-auto">
                                                                            ...
                                                                            <div class="ti-modal-header">
                                                                                ...
                                                                                <form action="{{route('HOD.grievancecategory.update',$gc->id)}}" method="post">
                                                                                    @csrf
                                                                                    @method('patch')
                                                                                    <div class="ti-modal-body">
                                                                                        <div class="grid lg:grid-cols-2 gap-2 space-y-2 lg:space-y-0">
                                                                                            <div class="max-w-sm space-y-3 pb-6">
                                                                                                <label for="with-corner-hint" class="ti-form-label font-bold">Category Name:<span class="text-red-500">*</span></label>
                                                                                                <input type="text" name="category_name" class="ti-form-input" placeholder="Category name" value="{{$gc->category_name}}">
                                                                                            </div>
                                                                                            <div class="max-w-sm space-y-3 pb-6">
                                                                ...
                                                                <div class="hs-tooltip ti-main-tooltip">
                                                                    <form action="{{route('HOD.grievancecategory.destroy',$gc->id)}}" method="post">
