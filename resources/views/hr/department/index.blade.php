                    ...
                    <div class="content">
                        ...
                        <div class="main-content">
                            ...
                            <div class="block justify-between page-header sm:flex">
                                <div>
                                    <h3 class="text-gray-700 hover:text-gray-900 text-2xl font-medium"> Departments</h3>
                                </div>
                                ...
                                <div id="hs-medium-modal" class="hs-overlay hidden ti-modal">
                                    <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out md:!max-w-2xl md:w-full m-3 md:mx-auto">
                                        <div class="ti-modal-content">
                                            <form method="post" action="{{route('hr.department.store')}}" >
                                            @csrf
                                                ...
                                                <div class="ti-modal-body">
                                                    ...
                                                    <div class="max-w-sm space-y-3">
                                                        ...
                                                        <input type="text" class="ti-form-input" id="input-dept-name" name="department_name" placeholder="Department Name">
                                                        
                                                    </div>
                                                    <div class="max-w-sm space-y-3">
                                                        <label for="input-short-name">Short Name: </label>
                                                        <input type="text" class="ti-form-input" id="input-short-name" name="short_name" placeholder="Short Name">
                            ...
                            <div class="grid grid-cols-12 gap-x-6">
                                <div class="col-span-12">
                                    ...
                                    <div class="box-header">
                                        <div class="flex">
                                        <h5 class="box-title my-auto">Department List</h5>
                                    ...
                                    <div class="box-body">
                                        ...
                                        <table class="ti-custom-table ti-custom-table-head whitespace-nowrap">
                                            ...
                                            <tr class="">
                                                ...
                                                <th scope="col" class="dark:text-white/80">Short Name</th>
                                            ...
                                            <tbody class="">
                                                ...
                                                @foreach ($department_master as $key => $department)
                                                
                                            <tr>
                                                <td>{{ ++$key }}</td>
                                                <td>{{ $department->dept_name}}</td>
                                                <td>{{ $department->dept_shortname}}</td>
                                                <td>{{ isset($department->created_at)? date('d-M-Y', strtotime($department->created_at)) : 'NULL'}}</td>
                                                <td>{{ isset($department->updated_at)? date('d-M-Y', strtotime($department->updated_at)) : 'NULL'}}</td>
                                                <td class="font-medium space-x-2 rtl:space-x-reverse">
                                                    ...
                                                    <div class="hs-tooltip ti-main-tooltip">
                                                        <a data-hs-overlay="#religion-edit-modal{{$key}}" href="{{ route('hr.department.edit',$department->id) }}" 
                                                        class="hs-dropdown-toggle  m-0 hs-tooltip-toggle relative w-8 h-8 ti-btn rounded-full p-0 transition-none focus:outline-none ti-btn-soft-secondary">
                                                            ...
                                                            <!--div id="religion-edit-modal{{$key}}" class="hs-overlay hidden ti-modal">
                                                                <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out md:!max-w-2xl md:w-full m-3 md:mx-auto">
                                                                    <div class="ti-modal-content">
                                                                        <form method="post" action="{{route('hr.department.update',$department->id)}}" >
                                                                        @csrf
                                                                        @method('patch')
                                                                            <div class="ti-modal-header">
                                                                                <h3 class="ti-modal-title">
                                                                                    <i class="ti ti-pencil"></i>  Edit Department
                                                                                </h3>
                                                                                <button type="button" class="hs-dropdown-toggle ti-modal-close-btn"
                                                                                data-hs-overlay="#hs-medium-modal">
                                                                                <span class="sr-only">Close</span>
                                                                            ...
                                                                            <div class="ti-modal-body">
                                                                                ...
                                                                                <div class="max-w-sm space-y-3">
                                                                                    <label for="input-short-name">Department Name: </label>
                                                                                    <input type="text" class="ti-form-input" name="department_name" placeholder="Department Name" value="{{$department->dept_name}}">
                                                                                    
                                                                                </div>
                                                                                <div class="max-w-sm space-y-3">
                                                                                    <label for="input-short-name">Short Name: </label>
                                                                                    <input type="text" class="ti-form-input" id="input-short-name" name="short_name" placeholder="Short Name" value="{{$department->dept_shortname}}">
                                                    ...
                                                    <div class="hs-tooltip ti-main-tooltip">
                                                        <form method="post" action="{{route('hr.department.destroy',$department->id)}}">
                                                            @csrf
                                                            @method('delete')
