                                ...
                                <div class="col-span-12 md:col-span-6 xxl:col-span-3">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <h5 class="mb-0 text-2xl font-semibold text-gray-800 dark:text-white">{{$researchscholarscount}}</h5>
                                ...
                                <div class="col-span-12 md:col-span-6 xxl:col-span-3">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <div class="flex justify-between items-center">
                                            <h5 class="mb-0 text-2xl font-semibold text-gray-800 dark:text-white">{{$gitsponsoredevents}}</h5>
                                                ...
                                                <div class="flex-1">
                                                    ...
                                                    <div class="flex justify-between items-center">
                                                        <div class="flex flex-col">
                                                            <h5 class="mb-0 text-2xl font-semibold text-gray-800 dark:text-white">{{$teaching_activity_attended}}</h5>
                                                            <a class="flex items-center font-semibold text-primary hover:text-primary dark:text-primary truncate" href="{{route('Deanrnd.Teaching.activityattended')}}">
                                                                Attended
                                                            </a>
                                                        </div>
                                                        <div class="flex flex-col">
                                                            <h5 class="mb-0 text-2xl font-semibold text-gray-800 dark:text-white">{{$teaching_activity_conducted}}</h5>
                                                            <a class="flex items-center font-semibold text-primary hover:text-primary dark:text-primary truncate" href="{{route('Deanrnd.Teaching.activityconducted')}}">
                                                                Conducted
                                                            </a>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="flex-1">
                                                    ...
                                                    <div class="flex justify-between items-center">
                                                        <div class="flex flex-col">
                                                            ...
                                                            <a class="flex items-center font-semibold text-primary hover:text-primary dark:text-primary truncate" href="{{route('Deanrnd.NonTeaching')}}">
                                                                Attended
                                                            </a>
                                                        </div>
                                                        <div class="flex flex-col">
                                                            <h5 class="mb-0 text-2xl font-semibold text-gray-800 dark:text-white">{{$professional_activity_conducteds}}</h5>
                                                            <a class="flex items-center font-semibold text-primary hover:text-primary dark:text-primary truncate" href="{{route('Deanrnd.NonTeaching.conducted')}}">
                                                                Conducted
                                                            </a>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="flex-1">
                                                    ...
                                                    <div class="flex justify-between items-center">
                                                        <div class="flex flex-col">
                                                            ...
                                                            <a class="flex items-center font-semibold text-primary hover:text-primary dark:text-primary truncate" href="{{route('Deanrnd.Teaching.research.conferenceattended')}}">
                                                                Attended
                                                            </a>
                                                        </div>
                                                        <div class="flex flex-col">
                                                            <h5 class="mb-0 text-2xl font-semibold text-gray-800 dark:text-white">{{$conferences_conducted}}</h5>
                                                            <a class="flex items-center font-semibold text-primary hover:text-primary dark:text-primary truncate" href="{{route('Deanrnd.Teaching.research.conferenceconducted')}}">
                                                                Conducted
                                                            </a>
                                                        </div>
                                                    </div>
                                ...
                                <div class="col-span-12 md:col-span-6 xxl:col-span-3">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <a class="flex  items-center font-semibold text-primary hover:text-primary dark:text-primary truncate" href="{{route('Deanrnd.Teaching.research.publication')}}">
                                                 view
                                            </a>
                                        </div>
                                        </div>
                                ...
                                <div class="col-span-12 md:col-span-6 xxl:col-span-3">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <a class="flex  items-center font-semibold text-primary hover:text-primary dark:text-primary truncate" href="{{route('Deanrnd.Teaching.research.patents')}}">
                                                 view
                                            </a>
                                        </div>
                                        </div>
                                ...
                                <div class="col-span-12 md:col-span-6 xxl:col-span-3">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <a class="flex  items-center font-semibold text-primary hover:text-primary dark:text-primary truncate" href="{{route('Deanrnd.Teaching.research.copyrights')}}">
                                                 view
                                            </a>
                                        </div>
                                        </div>
                                ...
                                <div class="col-span-12 md:col-span-6 xxl:col-span-3">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <a class="flex  items-center font-semibold text-primary hover:text-primary dark:text-primary truncate" href="{{route('Deanrnd.Teaching.research.achivements')}}">
                                                 view
                                            </a>
                                        </div>
                                        </div>
